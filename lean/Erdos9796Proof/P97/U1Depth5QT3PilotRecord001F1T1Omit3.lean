...
import Erdos9796Proof.P97.U1Depth5HSlotRecord001F1ExtraOmit3002
import Erdos9796Proof.P97.U1Depth5HSlotRecord001F1ExtraOmit3007
import Erdos9796Proof.P97.U1Depth5HSlotRecord001F1ExtraOmit3009

/-!
# Record001 branch-0 `f1:t1` omit3 adapter

This module connects the non-circular hard-`f1` omit3 hslot certificates for
the `f1:t1` extra-incidence branch to the record001 branch-0 source-UNIT replay.
...
/-- Under the `f1:t1` packet-label extra-incidence atom, the three record001
...
theorem false_of_f1t1_extra_omit3
    ...
    (hslot_t1_t3_f1 :
      dist (payload.packet.point U1Depth5.t1)
        ...
        dist (payload.packet.point U1Depth5.t1)
          ((payload.packet.rows.rowAt U1Depth5.CriticalSource.t1).slotPoint 0))
    (hextra_f1_t1 :
      dist (payload.packet.point U1Depth5.f1) (payload.packet.point U1Depth5.t1) =
  ...
  have hrow_4 :
    ...
    cert_00003_d3f607262617799a_hslot_f1_f3_f2_of_row_slot_packet
      ...
      payload.hrow_24 payload.hrow_25 payload.hrow_26 hextra_f1_t1
  have hrow_5 :
      dist (payload.packet.point U1Depth5.f1)
          (payload.packet.point U1Depth5.f4) =
        dist (payload.packet.point U1Depth5.f1)
          (payload.packet.point U1Depth5.f2) :=
    cert_00008_ff9f130169871360_hslot_f1_f4_f2_of_row_slot_packet
      payload.packet hrow_0 hrow_1 hrow_2 payload.hrow_12 hrow_10 hrow_11
      hrow_13 hrow_14 hrow_15 payload.hrow_20 payload.hrow_21 payload.hrow_22
      payload.hrow_24 payload.hrow_25 payload.hrow_26 hextra_f1_t1
  have hrow_6 :
      dist (payload.packet.point U1Depth5.f1)
        ...
        dist (payload.packet.point U1Depth5.f1)
          (payload.packet.point U1Depth5.f2) :=
    cert_00010_2870563cdb3a8536_hslot_f1_p_f2_of_row_slot_packet
      payload.packet hrow_0 hrow_1 hrow_2 payload.hrow_12 hrow_10 hrow_11
      hrow_13 hrow_14 hrow_15 payload.hrow_20 payload.hrow_21 payload.hrow_22
      payload.hrow_24 payload.hrow_25 payload.hrow_26 hextra_f1_t1
  exact
