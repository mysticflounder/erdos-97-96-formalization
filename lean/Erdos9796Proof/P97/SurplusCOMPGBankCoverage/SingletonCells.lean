...
This module collects eight depth-two search cells whose valid results are structurally
...
/-- Every result in one of the eight structurally covered depth-two cells occurs among the
stored rows. -/
