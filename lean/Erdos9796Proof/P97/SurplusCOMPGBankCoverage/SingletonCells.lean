...
This module collects nine depth-two search cells whose valid results are structurally
...
/-- Every result in one of the nine structurally covered depth-two cells occurs among the
stored rows. -/
