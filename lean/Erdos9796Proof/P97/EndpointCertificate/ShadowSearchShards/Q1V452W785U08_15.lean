...
/-- Valid shadows in `.Q1/452/785/284` are row-bank covered. -/
theorem q1_v452_w785_u284_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 452 785 284 =
      true := by
  native_decide
...
/-- Valid shadows in `.Q1/452/785/308` are row-bank covered. -/
theorem q1_v452_w785_u308_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 452 785 308 =
      true := by
  native_decide
