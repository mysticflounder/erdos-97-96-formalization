...
/-- Valid shadows in `.Q1/464/771/556` are row-bank covered. -/
theorem q1_v464_w771_u556_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 464 771 556 =
      true := by
  native_decide

/-- Valid shadows in `.Q1/464/771/564` are row-bank covered. -/
theorem q1_v464_w771_u564_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 464 771 564 =
      true := by
  native_decide

/-- Valid shadows in `.Q1/464/771/568` are row-bank covered. -/
theorem q1_v464_w771_u568_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 464 771 568 =
      true := by
  native_decide
...
/-- Valid shadows in `.Q1/464/771/680` are row-bank covered. -/
theorem q1_v464_w771_u680_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 464 771 680 =
      true := by
  native_decide
