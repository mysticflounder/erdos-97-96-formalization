...
/-- Valid shadows in `.Q1/464/771/344` are row-bank covered. -/
theorem q1_v464_w771_u344_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 464 771 344 =
      true := by
  native_decide
...
/-- Valid shadows in `.Q1/464/771/368` are row-bank covered. -/
theorem q1_v464_w771_u368_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 464 771 368 =
      true := by
  native_decide

/-- Valid shadows in `.Q1/464/771/408` are row-bank covered. -/
theorem q1_v464_w771_u408_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 464 771 408 =
      true := by
  native_decide
...
/-- Valid shadows in `.Q1/464/771/432` are row-bank covered. -/
theorem q1_v464_w771_u432_valid :
    endpointDepth3SubtreeValidAllAccepted .Q1 464 771 432 =
      true := by
  native_decide
