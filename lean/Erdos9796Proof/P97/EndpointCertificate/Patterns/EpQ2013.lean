...
/-!
# Endpoint certificate ep_Q2_013
...
/-- Generator rules for endpoint certificate `ep_Q2_013`. -/
def ep_Q2_013_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_013`. -/
def ep_Q2_013_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_013_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_013`. -/
def ep_Q2_013_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_013` as sparse rational polynomial data. -/
def ep_Q2_013 : Certificate :=
  { generators := ep_Q2_013_generators
    coefficients := ep_Q2_013_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_013`.
...
theorem ep_Q2_013_valid : checkCertificate ep_Q2_013 = true := by
  native_decide
