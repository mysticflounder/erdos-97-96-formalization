...
/-!
# Endpoint certificate ep_Q2_079
...
/-- Generator rules for endpoint certificate `ep_Q2_079`. -/
def ep_Q2_079_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_079`. -/
def ep_Q2_079_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_079_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_079`. -/
def ep_Q2_079_coefficients : List Poly :=
[
  [
...
/-- Endpoint certificate `ep_Q2_079` as sparse rational polynomial data. -/
def ep_Q2_079 : Certificate :=
  { generators := ep_Q2_079_generators
    coefficients := ep_Q2_079_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_079`.
...
theorem ep_Q2_079_valid : checkCertificate ep_Q2_079 = true := by
  native_decide
