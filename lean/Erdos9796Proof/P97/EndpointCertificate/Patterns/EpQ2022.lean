...
/-!
# Endpoint certificate ep_Q2_022
...
/-- Generator rules for endpoint certificate `ep_Q2_022`. -/
def ep_Q2_022_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_022`. -/
def ep_Q2_022_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_022_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_022`. -/
def ep_Q2_022_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_022` as sparse rational polynomial data. -/
def ep_Q2_022 : Certificate :=
  { generators := ep_Q2_022_generators
    coefficients := ep_Q2_022_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_022`.
...
theorem ep_Q2_022_valid : checkCertificate ep_Q2_022 = true := by
  native_decide
