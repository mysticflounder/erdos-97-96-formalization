...
/-!
# Endpoint certificate ep_Q2_046
...
/-- Generator rules for endpoint certificate `ep_Q2_046`. -/
def ep_Q2_046_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_046`. -/
def ep_Q2_046_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_046_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_046`. -/
def ep_Q2_046_coefficients : List Poly :=
[
  [],
  [
  term (-1 : Rat) [(4, 1), (16, 1)],
...
/-- Endpoint certificate `ep_Q2_046` as sparse rational polynomial data. -/
def ep_Q2_046 : Certificate :=
  { generators := ep_Q2_046_generators
    coefficients := ep_Q2_046_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_046`.
...
theorem ep_Q2_046_valid : checkCertificate ep_Q2_046 = true := by
  native_decide
