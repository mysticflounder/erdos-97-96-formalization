...
/-!
# Endpoint certificate ep_Q2_001
...
/-- Generator rules for endpoint certificate `ep_Q2_001`. -/
def ep_Q2_001_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_001`. -/
def ep_Q2_001_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_001_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_001`. -/
def ep_Q2_001_coefficients : List Poly :=
[
  [
  term (-1 : Rat) [(6, 1), (9, 1), (15, 1)],
  term ((-1 : Rat) / 2) [(7, 1), (9, 1)],
  term ((4 : Rat) / 3) [(9, 2)]
],
  [],
  [
  ...
  [
  term (1 : Rat) [],
  term ((-8 : Rat) / 3) [(6, 1), (9, 2)],
  term ((8 : Rat) / 3) [(7, 1), (8, 1), (9, 1)],
  term (-4 : Rat) [(7, 1), (9, 1)],
  term ((-2 : Rat) / 3) [(8, 1)],
  term ((8 : Rat) / 3) [(9, 2)]
],
  ...
  [
  term (1 : Rat) [(6, 1), (7, 1), (9, 1)],
  term (2 : Rat) [(6, 1), (9, 1), (15, 1)],
  term (-1 : Rat) [(7, 1), (9, 1)],
  term (-3 : Rat) [(7, 1), (9, 1), (14, 1)],
  term (1 : Rat) [(9, 1), (15, 1)],
  term ((-4 : Rat) / 3) [(9, 2)]
],
  [
  term (-1 : Rat) [(6, 1), (7, 1), (9, 1)],
  term (-3 : Rat) [(6, 1), (9, 1), (15, 1)],
...
/-- Endpoint certificate `ep_Q2_001` as sparse rational polynomial data. -/
def ep_Q2_001 : Certificate :=
  { generators := ep_Q2_001_generators
    coefficients := ep_Q2_001_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_001`.
...
theorem ep_Q2_001_valid : checkCertificate ep_Q2_001 = true := by
  native_decide
