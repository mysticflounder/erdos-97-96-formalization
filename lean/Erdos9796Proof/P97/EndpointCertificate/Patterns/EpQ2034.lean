...
/-!
# Endpoint certificate ep_Q2_034
...
/-- Generator rules for endpoint certificate `ep_Q2_034`. -/
def ep_Q2_034_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_034`. -/
def ep_Q2_034_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_034_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_034`. -/
def ep_Q2_034_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_034` as sparse rational polynomial data. -/
def ep_Q2_034 : Certificate :=
  { generators := ep_Q2_034_generators
    coefficients := ep_Q2_034_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_034`.
...
theorem ep_Q2_034_valid : checkCertificate ep_Q2_034 = true := by
  native_decide
