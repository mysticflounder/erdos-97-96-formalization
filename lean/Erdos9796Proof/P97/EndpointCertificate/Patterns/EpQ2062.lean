...
/-!
# Endpoint certificate ep_Q2_062
...
/-- Generator rules for endpoint certificate `ep_Q2_062`. -/
def ep_Q2_062_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_062`. -/
def ep_Q2_062_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_062_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_062`. -/
def ep_Q2_062_coefficients : List Poly :=
[
  [],
  [
  term (-2 : Rat) [(13, 1), (15, 1), (16, 2)],
  term (2 : Rat) [(15, 2), (16, 2)],
  term (1 : Rat) [(16, 1)]
],
  [],
  [
  ...
  [],
  [
  term (4 : Rat) [(13, 1), (14, 1), (15, 1), (16, 2)],
  term (-4 : Rat) [(13, 1), (15, 1), (16, 2)],
  term (-2 : Rat) [(13, 2), (14, 1), (16, 2)],
  term (2 : Rat) [(13, 2), (16, 2)],
  term (-2 : Rat) [(14, 1), (15, 2), (16, 2)],
  term (2 : Rat) [(15, 2), (16, 2)],
  term (1 : Rat) [(16, 1)]
],
  [
  ...
  [
  term (2 : Rat) [(4, 1), (13, 1), (15, 1), (16, 2)],
  term (-2 : Rat) [(4, 1), (15, 2), (16, 2)],
  term (-2 : Rat) [(12, 1), (13, 1), (15, 1), (16, 2)],
  term (2 : Rat) [(12, 1), (15, 2), (16, 2)],
  term (-4 : Rat) [(13, 1), (14, 1), (15, 1), (16, 2)],
  term (2 : Rat) [(13, 2), (14, 1), (16, 2)],
  term (2 : Rat) [(14, 1), (15, 2), (16, 2)],
...
/-- Endpoint certificate `ep_Q2_062` as sparse rational polynomial data. -/
def ep_Q2_062 : Certificate :=
  { generators := ep_Q2_062_generators
    coefficients := ep_Q2_062_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_062`.
...
theorem ep_Q2_062_valid : checkCertificate ep_Q2_062 = true := by
  native_decide
