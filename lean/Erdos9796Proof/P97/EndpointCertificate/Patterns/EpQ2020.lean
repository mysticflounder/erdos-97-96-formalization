...
/-- Generator polynomials for endpoint certificate `ep_Q2_020`. -/
...
/-- Coefficient polynomials for endpoint certificate `ep_Q2_020`. -/
def ep_Q2_020_coefficients : List Poly :=
[
  [
...
/-- Endpoint certificate `ep_Q2_020` as sparse rational polynomial data. -/
def ep_Q2_020 : Certificate :=
  { generators := ep_Q2_020_generators
    coefficients := ep_Q2_020_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_020`.
...
theorem ep_Q2_020_valid : checkCertificate ep_Q2_020 = true := by
  native_decide
