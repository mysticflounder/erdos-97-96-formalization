...
/-!
# Endpoint certificate ep_Q1_006
...
/-- Generator rules for endpoint certificate `ep_Q1_006`. -/
def ep_Q1_006_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q1_006`. -/
def ep_Q1_006_generators : List Poly :=
  RowZeros.rulePolys ep_Q1_006_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q1_006`. -/
def ep_Q1_006_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q1_006` as sparse rational polynomial data. -/
def ep_Q1_006 : Certificate :=
  { generators := ep_Q1_006_generators
    coefficients := ep_Q1_006_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q1_006`.
...
theorem ep_Q1_006_valid : checkCertificate ep_Q1_006 = true := by
  native_decide
