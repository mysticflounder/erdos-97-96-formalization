...
/-!
# Endpoint certificate ep_Q2_039
...
/-- Generator rules for endpoint certificate `ep_Q2_039`. -/
def ep_Q2_039_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_039`. -/
def ep_Q2_039_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_039_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_039`. -/
def ep_Q2_039_coefficients : List Poly :=
[
  [],
  [],
  [
...
/-- Endpoint certificate `ep_Q2_039` as sparse rational polynomial data. -/
def ep_Q2_039 : Certificate :=
  { generators := ep_Q2_039_generators
    coefficients := ep_Q2_039_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_039`.
...
theorem ep_Q2_039_valid : checkCertificate ep_Q2_039 = true := by
  native_decide
