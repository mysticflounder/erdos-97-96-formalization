...
/-!
# Endpoint certificate ep_Q2_067
...
/-- Generator rules for endpoint certificate `ep_Q2_067`. -/
def ep_Q2_067_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_067`. -/
def ep_Q2_067_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_067_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_067`. -/
def ep_Q2_067_coefficients : List Poly :=
[
  [],
  [],
  [],
  ...
  [],
  [
  term (8 : Rat) [(2, 1), (5, 1), (7, 1), (16, 1)],
  term (4 : Rat) [(2, 1), (5, 1), (15, 1), (16, 1)],
  term (-8 : Rat) [(2, 1), (5, 2), (16, 1)],
  term (-4 : Rat) [(2, 1), (7, 1), (15, 1), (16, 1)],
  term (8 : Rat) [(3, 1), (4, 1), (5, 1), (16, 1)],
...
/-- Endpoint certificate `ep_Q2_067` as sparse rational polynomial data. -/
def ep_Q2_067 : Certificate :=
  { generators := ep_Q2_067_generators
    coefficients := ep_Q2_067_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_067`.
...
theorem ep_Q2_067_valid : checkCertificate ep_Q2_067 = true := by
  native_decide
