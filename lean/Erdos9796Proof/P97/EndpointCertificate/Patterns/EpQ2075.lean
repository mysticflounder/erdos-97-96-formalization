...
/-!
# Endpoint certificate ep_Q2_075
...
/-- Generator rules for endpoint certificate `ep_Q2_075`. -/
def ep_Q2_075_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_075`. -/
def ep_Q2_075_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_075_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_075`. -/
def ep_Q2_075_coefficients : List Poly :=
[
  [],
  [],
  [
...
/-- Endpoint certificate `ep_Q2_075` as sparse rational polynomial data. -/
def ep_Q2_075 : Certificate :=
  { generators := ep_Q2_075_generators
    coefficients := ep_Q2_075_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_075`.
...
theorem ep_Q2_075_valid : checkCertificate ep_Q2_075 = true := by
  native_decide
