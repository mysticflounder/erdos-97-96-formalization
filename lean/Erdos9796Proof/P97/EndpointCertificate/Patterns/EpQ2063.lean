...
/-!
# Endpoint certificate ep_Q2_063
...
/-- Generator rules for endpoint certificate `ep_Q2_063`. -/
def ep_Q2_063_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_063`. -/
def ep_Q2_063_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_063_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_063`. -/
def ep_Q2_063_coefficients : List Poly :=
[
  [],
  [
  ...
  term ((-3 : Rat) / 2) [(1, 1), (14, 1), (15, 1), (16, 1)],
...
/-- Endpoint certificate `ep_Q2_063` as sparse rational polynomial data. -/
def ep_Q2_063 : Certificate :=
  { generators := ep_Q2_063_generators
    coefficients := ep_Q2_063_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_063`.
...
theorem ep_Q2_063_valid : checkCertificate ep_Q2_063 = true := by
  native_decide
