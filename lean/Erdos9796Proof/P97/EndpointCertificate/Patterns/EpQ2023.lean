...
/-!
# Endpoint certificate ep_Q2_023
...
/-- Generator rules for endpoint certificate `ep_Q2_023`. -/
def ep_Q2_023_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_023`. -/
def ep_Q2_023_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_023_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_023`. -/
def ep_Q2_023_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_023` as sparse rational polynomial data. -/
def ep_Q2_023 : Certificate :=
  { generators := ep_Q2_023_generators
    coefficients := ep_Q2_023_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_023`.
...
theorem ep_Q2_023_valid : checkCertificate ep_Q2_023 = true := by
  native_decide
