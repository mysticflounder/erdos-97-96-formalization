...
/-!
# Endpoint certificate ep_Q2_010
...
/-- Generator rules for endpoint certificate `ep_Q2_010`. -/
def ep_Q2_010_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_010`. -/
def ep_Q2_010_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_010_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_010`. -/
def ep_Q2_010_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_010` as sparse rational polynomial data. -/
def ep_Q2_010 : Certificate :=
  { generators := ep_Q2_010_generators
    coefficients := ep_Q2_010_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_010`.
...
theorem ep_Q2_010_valid : checkCertificate ep_Q2_010 = true := by
  native_decide
