...
/-!
# Endpoint certificate ep_Q2_029
...
/-- Generator rules for endpoint certificate `ep_Q2_029`. -/
def ep_Q2_029_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_029`. -/
def ep_Q2_029_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_029_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_029`. -/
def ep_Q2_029_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_029` as sparse rational polynomial data. -/
def ep_Q2_029 : Certificate :=
  { generators := ep_Q2_029_generators
    coefficients := ep_Q2_029_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_029`.
...
theorem ep_Q2_029_valid : checkCertificate ep_Q2_029 = true := by
  native_decide
