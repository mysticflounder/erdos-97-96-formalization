...
/-!
# Endpoint certificate ep_Q2_068
...
/-- Generator rules for endpoint certificate `ep_Q2_068`. -/
def ep_Q2_068_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_068`. -/
def ep_Q2_068_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_068_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_068`. -/
def ep_Q2_068_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_068` as sparse rational polynomial data. -/
def ep_Q2_068 : Certificate :=
  { generators := ep_Q2_068_generators
    coefficients := ep_Q2_068_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_068`.
...
theorem ep_Q2_068_valid : checkCertificate ep_Q2_068 = true := by
  native_decide
