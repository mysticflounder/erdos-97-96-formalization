...
/-!
# Endpoint certificate ep_Q2_077
...
/-- Generator rules for endpoint certificate `ep_Q2_077`. -/
def ep_Q2_077_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_077`. -/
def ep_Q2_077_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_077_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_077`. -/
def ep_Q2_077_coefficients : List Poly :=
[
  [],
  [],
  [],
  ...
  term (-6 : Rat) [(7, 1), (12, 1), (15, 1), (16, 1)],
  term (-3 : Rat) [(7, 1), (15, 1), (16, 1)],
  term (-6 : Rat) [(9, 1), (12, 1), (15, 1), (16, 1)],
...
/-- Endpoint certificate `ep_Q2_077` as sparse rational polynomial data. -/
def ep_Q2_077 : Certificate :=
  { generators := ep_Q2_077_generators
    coefficients := ep_Q2_077_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_077`.
...
theorem ep_Q2_077_valid : checkCertificate ep_Q2_077 = true := by
  native_decide
