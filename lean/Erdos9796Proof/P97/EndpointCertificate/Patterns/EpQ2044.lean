...
/-!
# Endpoint certificate ep_Q2_044
...
/-- Generator rules for endpoint certificate `ep_Q2_044`. -/
def ep_Q2_044_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_044`. -/
def ep_Q2_044_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_044_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_044`. -/
def ep_Q2_044_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_044` as sparse rational polynomial data. -/
def ep_Q2_044 : Certificate :=
  { generators := ep_Q2_044_generators
    coefficients := ep_Q2_044_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_044`.
...
theorem ep_Q2_044_valid : checkCertificate ep_Q2_044 = true := by
  native_decide
