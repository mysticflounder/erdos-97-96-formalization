...
/-!
# Endpoint certificate ep_Q2_012
...
/-- Generator rules for endpoint certificate `ep_Q2_012`. -/
def ep_Q2_012_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_012`. -/
def ep_Q2_012_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_012_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_012`. -/
def ep_Q2_012_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_012` as sparse rational polynomial data. -/
def ep_Q2_012 : Certificate :=
  { generators := ep_Q2_012_generators
    coefficients := ep_Q2_012_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_012`.
...
theorem ep_Q2_012_valid : checkCertificate ep_Q2_012 = true := by
  native_decide
