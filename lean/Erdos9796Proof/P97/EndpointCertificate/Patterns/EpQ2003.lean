...
/-!
# Endpoint certificate ep_Q2_003
...
/-- Generator rules for endpoint certificate `ep_Q2_003`. -/
def ep_Q2_003_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_003`. -/
def ep_Q2_003_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_003_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_003`. -/
def ep_Q2_003_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_003` as sparse rational polynomial data. -/
def ep_Q2_003 : Certificate :=
  { generators := ep_Q2_003_generators
    coefficients := ep_Q2_003_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_003`.
...
theorem ep_Q2_003_valid : checkCertificate ep_Q2_003 = true := by
  native_decide
