...
/-!
# Endpoint certificate ep_Q2_059
...
/-- Generator rules for endpoint certificate `ep_Q2_059`. -/
def ep_Q2_059_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_059`. -/
def ep_Q2_059_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_059_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_059`. -/
def ep_Q2_059_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_059` as sparse rational polynomial data. -/
def ep_Q2_059 : Certificate :=
  { generators := ep_Q2_059_generators
    coefficients := ep_Q2_059_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_059`.
...
theorem ep_Q2_059_valid : checkCertificate ep_Q2_059 = true := by
  native_decide
