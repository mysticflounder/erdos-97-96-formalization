...
/-!
# Endpoint certificate ep_Q2_052
...
/-- Generator rules for endpoint certificate `ep_Q2_052`. -/
def ep_Q2_052_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_052`. -/
def ep_Q2_052_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_052_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_052`. -/
def ep_Q2_052_coefficients : List Poly :=
[
  [],
  [
  term (-1 : Rat) [(4, 1), (16, 1)],
...
/-- Endpoint certificate `ep_Q2_052` as sparse rational polynomial data. -/
def ep_Q2_052 : Certificate :=
  { generators := ep_Q2_052_generators
    coefficients := ep_Q2_052_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_052`.
...
theorem ep_Q2_052_valid : checkCertificate ep_Q2_052 = true := by
  native_decide
