...
/-!
# Endpoint certificate ep_Q2_042
...
/-- Generator rules for endpoint certificate `ep_Q2_042`. -/
def ep_Q2_042_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_042`. -/
def ep_Q2_042_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_042_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_042`. -/
def ep_Q2_042_coefficients : List Poly :=
[
  [],
  [],
  [
...
/-- Endpoint certificate `ep_Q2_042` as sparse rational polynomial data. -/
def ep_Q2_042 : Certificate :=
  { generators := ep_Q2_042_generators
    coefficients := ep_Q2_042_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_042`.
...
theorem ep_Q2_042_valid : checkCertificate ep_Q2_042 = true := by
  native_decide
