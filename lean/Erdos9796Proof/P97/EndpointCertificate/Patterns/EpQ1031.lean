...
/-!
# Endpoint certificate ep_Q1_031
...
/-- Generator rules for endpoint certificate `ep_Q1_031`. -/
def ep_Q1_031_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q1_031`. -/
def ep_Q1_031_generators : List Poly :=
  RowZeros.rulePolys ep_Q1_031_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q1_031`. -/
def ep_Q1_031_coefficients : List Poly :=
[
  [],
  [
  ...
  [
  term (-8 : Rat) [(0, 1), (8, 1), (11, 1), (15, 1), (16, 1)],
  term (16 : Rat) [(0, 1), (8, 1), (13, 1), (15, 1), (16, 1)],
  term (8 : Rat) [(0, 1), (9, 1), (10, 1), (15, 1), (16, 1)],
  term (-16 : Rat) [(0, 1), (9, 1), (12, 1), (15, 1), (16, 1)],
  term (-8 : Rat) [(0, 1), (10, 1), (13, 1), (15, 1), (16, 1)],
  term (8 : Rat) [(0, 1), (11, 1), (12, 1), (15, 1), (16, 1)],
  term (4 : Rat) [(1, 1), (8, 1), (15, 1), (16, 1)],
...
/-- Endpoint certificate `ep_Q1_031` as sparse rational polynomial data. -/
def ep_Q1_031 : Certificate :=
  { generators := ep_Q1_031_generators
    coefficients := ep_Q1_031_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q1_031`.
...
theorem ep_Q1_031_valid : checkCertificate ep_Q1_031 = true := by
  native_decide
