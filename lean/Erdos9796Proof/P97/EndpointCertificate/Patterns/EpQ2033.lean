...
/-!
# Endpoint certificate ep_Q2_033
...
/-- Generator rules for endpoint certificate `ep_Q2_033`. -/
def ep_Q2_033_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_033`. -/
def ep_Q2_033_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_033_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_033`. -/
def ep_Q2_033_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_033` as sparse rational polynomial data. -/
def ep_Q2_033 : Certificate :=
  { generators := ep_Q2_033_generators
    coefficients := ep_Q2_033_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_033`.
...
theorem ep_Q2_033_valid : checkCertificate ep_Q2_033 = true := by
  native_decide
