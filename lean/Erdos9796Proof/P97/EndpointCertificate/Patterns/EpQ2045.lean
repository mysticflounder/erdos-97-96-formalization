...
/-!
# Endpoint certificate ep_Q2_045
...
/-- Generator rules for endpoint certificate `ep_Q2_045`. -/
def ep_Q2_045_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_045`. -/
def ep_Q2_045_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_045_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_045`. -/
def ep_Q2_045_coefficients : List Poly :=
[
  [],
  [
  term (-1 : Rat) [(4, 1), (16, 1)],
...
/-- Endpoint certificate `ep_Q2_045` as sparse rational polynomial data. -/
def ep_Q2_045 : Certificate :=
  { generators := ep_Q2_045_generators
    coefficients := ep_Q2_045_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_045`.
...
theorem ep_Q2_045_valid : checkCertificate ep_Q2_045 = true := by
  native_decide
