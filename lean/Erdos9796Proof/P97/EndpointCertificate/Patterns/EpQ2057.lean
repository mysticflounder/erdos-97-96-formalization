...
/-!
# Endpoint certificate ep_Q2_057
...
/-- Generator rules for endpoint certificate `ep_Q2_057`. -/
def ep_Q2_057_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_057`. -/
def ep_Q2_057_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_057_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_057`. -/
def ep_Q2_057_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_057` as sparse rational polynomial data. -/
def ep_Q2_057 : Certificate :=
  { generators := ep_Q2_057_generators
    coefficients := ep_Q2_057_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_057`.
...
theorem ep_Q2_057_valid : checkCertificate ep_Q2_057 = true := by
  native_decide
