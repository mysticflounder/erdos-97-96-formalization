...
/-!
# Endpoint certificate ep_Q2_061
...
/-- Generator rules for endpoint certificate `ep_Q2_061`. -/
def ep_Q2_061_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_061`. -/
def ep_Q2_061_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_061_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_061`. -/
def ep_Q2_061_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_061` as sparse rational polynomial data. -/
def ep_Q2_061 : Certificate :=
  { generators := ep_Q2_061_generators
    coefficients := ep_Q2_061_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_061`.
...
theorem ep_Q2_061_valid : checkCertificate ep_Q2_061 = true := by
  native_decide
