...
/-!
# Endpoint certificate ep_Q1_021
...
/-- Generator rules for endpoint certificate `ep_Q1_021`. -/
def ep_Q1_021_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q1_021`. -/
def ep_Q1_021_generators : List Poly :=
  RowZeros.rulePolys ep_Q1_021_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q1_021`. -/
def ep_Q1_021_coefficients : List Poly :=
[
  [],
  [
  ...
  term (12 : Rat) [(9, 1), (12, 1), (15, 1), (16, 1)],
  term (1 : Rat) [(9, 1), (13, 1), (16, 1)],
  term (-3 : Rat) [(9, 2), (12, 1), (16, 1)],
...
/-- Endpoint certificate `ep_Q1_021` as sparse rational polynomial data. -/
def ep_Q1_021 : Certificate :=
  { generators := ep_Q1_021_generators
    coefficients := ep_Q1_021_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q1_021`.
...
theorem ep_Q1_021_valid : checkCertificate ep_Q1_021 = true := by
  native_decide
