...
/-!
# Endpoint certificate ep_Q2_058
...
/-- Generator rules for endpoint certificate `ep_Q2_058`. -/
def ep_Q2_058_rules : List RowZeros.EndpointGeneratorRule :=
[
...
/-- Generator polynomials for endpoint certificate `ep_Q2_058`. -/
def ep_Q2_058_generators : List Poly :=
  RowZeros.rulePolys ep_Q2_058_rules

/-- Coefficient polynomials for endpoint certificate `ep_Q2_058`. -/
def ep_Q2_058_coefficients : List Poly :=
[
  [],
  [],
  [],
...
/-- Endpoint certificate `ep_Q2_058` as sparse rational polynomial data. -/
def ep_Q2_058 : Certificate :=
  { generators := ep_Q2_058_generators
    coefficients := ep_Q2_058_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for endpoint certificate `ep_Q2_058`.
...
theorem ep_Q2_058_valid : checkCertificate ep_Q2_058 = true := by
  native_decide
