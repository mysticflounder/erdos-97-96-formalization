...
The generators are derived from `Patterns.EpQ2019Generators.ep_Q2_019_rules`, so
...
/-- Every generator rule of `ep_Q2_019` is supported by its own row shadow. -/
private theorem ep_Q2_019_rulesOK :
    RowZeros.rulesOK Patterns.EpQ2019Generators.ep_Q2_019_rules
      ep_Q2_019_row.toShadow = true := by
  decide
...
theorem ep_Q2_019_evaluationZeros_of_metricShadow
  ...
  dsimp [Patterns.EpQ2019Generators.ep_Q2_019_generators]
  exact RowZeros.evaluationZeros_of_rulesOK ep_Q2_019_rulesOK hmetric
