...
/-!
# Endpoint product-row block zero ep_Q2_064, block 0:0-1
...
/-- Checked block `0:0-1` in product-sum row `ep_Q2_064`
evaluates to zero under a metric interpretation of the row shadow. -/
theorem ep_Q2_064_block_00_0000_0001_eval_zero
    ...
    evalPoly (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_block_00_0000_0001 = 0 := by
  have hgenerator :
      evalPoly (endpointS1S3Assignment pointOf)
        Patterns.EpQ2064TermShards.ep_Q2_064_generator_00_0000_0001 = 0 := by
  ...
  refine evalPoly_target_eq_zero_of_checkProductSumEq
    ...
    Patterns.EpQ2064TermShards.ep_Q2_064_block_00_0000_0001_valid ?_
  intro p hp
  simp only [Patterns.EpQ2064TermShards.ep_Q2_064_partials_00_0000_0001,
    List.mem_cons, List.not_mem_nil, or_false] at hp
  rcases hp with rfl | rfl
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_partial_00_0000_valid
      hgenerator
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_partial_00_0001_valid
      hgenerator
