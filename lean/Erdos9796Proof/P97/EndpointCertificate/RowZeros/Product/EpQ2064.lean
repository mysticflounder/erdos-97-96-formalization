...
The generators are derived from `Patterns.EpQ2064Generators.ep_Q2_064_rules`, so
...
/-- Every generator rule of `ep_Q2_064` is supported by its own row shadow. -/
private theorem ep_Q2_064_rulesOK :
    RowZeros.rulesOK Patterns.EpQ2064Generators.ep_Q2_064_rules
      ep_Q2_064_row.toShadow = true := by
  decide
...
theorem ep_Q2_064_evaluationZeros_of_metricShadow
  ...
  dsimp [Patterns.EpQ2064Generators.ep_Q2_064_generators]
  exact RowZeros.evaluationZeros_of_rulesOK ep_Q2_064_rulesOK hmetric
