...
The generators are derived from `Patterns.EpQ2024Generators.ep_Q2_024_rules`, so
...
/-- Every generator rule of `ep_Q2_024` is supported by its own row shadow. -/
private theorem ep_Q2_024_rulesOK :
    RowZeros.rulesOK Patterns.EpQ2024Generators.ep_Q2_024_rules
      ep_Q2_024_row.toShadow = true := by
  decide
...
theorem ep_Q2_024_evaluationZeros_of_metricShadow
  ...
  dsimp [Patterns.EpQ2024Generators.ep_Q2_024_generators]
  exact RowZeros.evaluationZeros_of_rulesOK ep_Q2_024_rulesOK hmetric
