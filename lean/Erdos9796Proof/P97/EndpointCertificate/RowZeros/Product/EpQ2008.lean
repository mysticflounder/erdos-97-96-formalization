...
The generators are derived from `Patterns.EpQ2008Generators.ep_Q2_008_rules`, so
...
/-- Every generator rule of `ep_Q2_008` is supported by its own row shadow. -/
private theorem ep_Q2_008_rulesOK :
    RowZeros.rulesOK Patterns.EpQ2008Generators.ep_Q2_008_rules
      ep_Q2_008_row.toShadow = true := by
  decide
...
theorem ep_Q2_008_evaluationZeros_of_metricShadow
  ...
  dsimp [Patterns.EpQ2008Generators.ep_Q2_008_generators]
  exact RowZeros.evaluationZeros_of_rulesOK ep_Q2_008_rulesOK hmetric
