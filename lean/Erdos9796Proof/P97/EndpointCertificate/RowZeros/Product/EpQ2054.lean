...
The generators are derived from `Patterns.EpQ2054Generators.ep_Q2_054_rules`, so
...
/-- Every generator rule of `ep_Q2_054` is supported by its own row shadow. -/
private theorem ep_Q2_054_rulesOK :
    RowZeros.rulesOK Patterns.EpQ2054Generators.ep_Q2_054_rules
      ep_Q2_054_row.toShadow = true := by
  decide
...
theorem ep_Q2_054_evaluationZeros_of_metricShadow
  ...
  dsimp [Patterns.EpQ2054Generators.ep_Q2_054_generators]
  exact RowZeros.evaluationZeros_of_rulesOK ep_Q2_054_rulesOK hmetric
