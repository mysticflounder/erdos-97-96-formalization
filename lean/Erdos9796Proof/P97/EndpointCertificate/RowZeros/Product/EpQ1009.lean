...
The generators are derived from `Patterns.EpQ1009Generators.ep_Q1_009_rules`, so
...
/-- Every generator rule of `ep_Q1_009` is supported by its own row shadow. -/
private theorem ep_Q1_009_rulesOK :
    RowZeros.rulesOK Patterns.EpQ1009Generators.ep_Q1_009_rules
      ep_Q1_009_row.toShadow = true := by
  decide
...
theorem ep_Q1_009_evaluationZeros_of_metricShadow
  ...
  dsimp [Patterns.EpQ1009Generators.ep_Q1_009_generators]
  exact RowZeros.evaluationZeros_of_rulesOK ep_Q1_009_rulesOK hmetric
