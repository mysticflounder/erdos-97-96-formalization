...
/-!
# Endpoint product-row block zero ep_Q2_024, block 6:200-200
...
/-- Checked block `6:200-200` in product-sum row `ep_Q2_024`
evaluates to zero under a metric interpretation of the row shadow. -/
theorem ep_Q2_024_block_06_0200_0200_eval_zero
    ...
    evalPoly (endpointS1S3Assignment pointOf)
      Patterns.EpQ2024TermShards.ep_Q2_024_block_06_0200_0200 = 0 := by
  have hgenerator :
      evalPoly (endpointS1S3Assignment pointOf)
        Patterns.EpQ2024TermShards.ep_Q2_024_generator_06_0200_0200 = 0 := by
  ...
  refine evalPoly_target_eq_zero_of_checkProductSumEq
    ...
    Patterns.EpQ2024TermShards.ep_Q2_024_block_06_0200_0200_valid ?_
  intro p hp
  simp only [Patterns.EpQ2024TermShards.ep_Q2_024_partials_06_0200_0200,
    List.mem_cons, List.not_mem_nil, or_false] at hp
  rcases hp with rfl
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2024TermShards.ep_Q2_024_partial_06_0200_valid
      hgenerator
