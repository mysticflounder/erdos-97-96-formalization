...
/-!
# Endpoint product-row block zero ep_Q2_002, block 28:700-701
...
/-- Checked block `28:700-701` in product-sum row `ep_Q2_002`
evaluates to zero under a metric interpretation of the row shadow. -/
theorem ep_Q2_002_block_28_0700_0701_eval_zero
    ...
    evalPoly (endpointS1S3Assignment pointOf)
      Patterns.EpQ2002TermShards.ep_Q2_002_block_28_0700_0701 = 0 := by
  have hgenerator :
      evalPoly (endpointS1S3Assignment pointOf)
        Patterns.EpQ2002TermShards.ep_Q2_002_generator_28_0700_0701 = 0 := by
  ...
  refine evalPoly_target_eq_zero_of_checkProductSumEq
    ...
    Patterns.EpQ2002TermShards.ep_Q2_002_block_28_0700_0701_valid ?_
  intro p hp
  simp only [Patterns.EpQ2002TermShards.ep_Q2_002_partials_28_0700_0701,
    List.mem_cons, List.not_mem_nil, or_false] at hp
  rcases hp with rfl | rfl
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2002TermShards.ep_Q2_002_partial_28_0700_valid
      hgenerator
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2002TermShards.ep_Q2_002_partial_28_0701_valid
      hgenerator
