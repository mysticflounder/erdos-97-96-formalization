...
/-!
# Endpoint native placement chunk: left family, escapee 9, fourth 6
...
theorem endpointLeftPlacementCheck_e9_f6_d3 :
    endpointLeftPlacementCheck 9 6 3 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointLeftPlacementCheck_e9_f6_d4 :
    endpointLeftPlacementCheck 9 6 4 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointLeftPlacementCheck_e9_f6_d5 :
    endpointLeftPlacementCheck 9 6 5 = true := by
  native_decide
