...
/-!
# Endpoint native placement chunk: left family, escapee 9, fourth 3
...
theorem endpointLeftPlacementCheck_e9_f3_d4 :
    endpointLeftPlacementCheck 9 3 4 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointLeftPlacementCheck_e9_f3_d5 :
    endpointLeftPlacementCheck 9 3 5 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointLeftPlacementCheck_e9_f3_d6 :
    endpointLeftPlacementCheck 9 3 6 = true := by
  native_decide
