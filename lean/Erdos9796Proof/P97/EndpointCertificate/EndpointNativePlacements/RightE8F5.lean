...
/-!
# Endpoint native placement chunk: right family, escapee 8, fourth 5
...
theorem endpointRightPlacementCheck_e8_f5_d3 :
    endpointRightPlacementCheck 8 5 3 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e8_f5_d4 :
    endpointRightPlacementCheck 8 5 4 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e8_f5_d6 :
    endpointRightPlacementCheck 8 5 6 = true := by
  native_decide
