...
/-!
# Endpoint native placement chunk: left family, escapee 9, fourth 4
...
theorem endpointLeftPlacementCheck_e9_f4_d3 :
    endpointLeftPlacementCheck 9 4 3 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointLeftPlacementCheck_e9_f4_d5 :
    endpointLeftPlacementCheck 9 4 5 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointLeftPlacementCheck_e9_f4_d6 :
    endpointLeftPlacementCheck 9 4 6 = true := by
  native_decide
