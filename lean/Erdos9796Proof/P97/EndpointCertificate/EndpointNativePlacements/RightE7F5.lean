...
/-!
# Endpoint native placement chunk: right family, escapee 7, fourth 5
...
theorem endpointRightPlacementCheck_e7_f5_d3 :
    endpointRightPlacementCheck 7 5 3 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e7_f5_d4 :
    endpointRightPlacementCheck 7 5 4 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e7_f5_d6 :
    endpointRightPlacementCheck 7 5 6 = true := by
  native_decide
