...
/-!
# Endpoint native placement chunk: right family, escapee 7, fourth 6
...
theorem endpointRightPlacementCheck_e7_f6_d3 :
    endpointRightPlacementCheck 7 6 3 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e7_f6_d4 :
    endpointRightPlacementCheck 7 6 4 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e7_f6_d5 :
    endpointRightPlacementCheck 7 6 5 = true := by
  native_decide
