...
/-!
# Endpoint native placement chunk: right family, escapee 7, fourth 3
...
theorem endpointRightPlacementCheck_e7_f3_d4 :
    endpointRightPlacementCheck 7 3 4 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e7_f3_d5 :
    endpointRightPlacementCheck 7 3 5 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e7_f3_d6 :
    endpointRightPlacementCheck 7 3 6 = true := by
  native_decide
