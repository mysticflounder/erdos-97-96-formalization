...
/-!
# Endpoint native placement chunk: left family, escapee 10, fourth 3
...
theorem endpointLeftPlacementCheck_e10_f3_d4 :
    endpointLeftPlacementCheck 10 3 4 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointLeftPlacementCheck_e10_f3_d5 :
    endpointLeftPlacementCheck 10 3 5 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointLeftPlacementCheck_e10_f3_d6 :
    endpointLeftPlacementCheck 10 3 6 = true := by
  native_decide
