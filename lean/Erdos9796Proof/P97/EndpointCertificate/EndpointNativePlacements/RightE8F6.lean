...
/-!
# Endpoint native placement chunk: right family, escapee 8, fourth 6
...
theorem endpointRightPlacementCheck_e8_f6_d3 :
    endpointRightPlacementCheck 8 6 3 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e8_f6_d4 :
    endpointRightPlacementCheck 8 6 4 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e8_f6_d5 :
    endpointRightPlacementCheck 8 6 5 = true := by
  native_decide
