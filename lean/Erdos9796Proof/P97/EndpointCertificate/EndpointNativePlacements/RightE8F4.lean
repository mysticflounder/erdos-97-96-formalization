...
/-!
# Endpoint native placement chunk: right family, escapee 8, fourth 4
...
theorem endpointRightPlacementCheck_e8_f4_d3 :
    endpointRightPlacementCheck 8 4 3 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e8_f4_d5 :
    endpointRightPlacementCheck 8 4 5 = true := by
  native_decide
...
set_option maxRecDepth 100000 in
set_option linter.style.nativeDecide false in
theorem endpointRightPlacementCheck_e8_f4_d6 :
    endpointRightPlacementCheck 8 4 6 = true := by
  native_decide
