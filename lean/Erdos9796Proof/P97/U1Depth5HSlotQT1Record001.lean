...
/-- SparsePoly fact table for task `ce05b8a3cfa383b7`. -/
def cert_00001_ce05b8a3cfa383b7_facts : List SparsePoly :=
[
  ...
  rabinowitschSlackFact 22 ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1))
]

set_option maxHeartbeats 0 in
-- Generated certificate data can exceed the default heartbeat budget.
/-- SparsePoly cofactor list for task `ce05b8a3cfa383b7`. -/
def cert_00001_ce05b8a3cfa383b7_cofactors : List (ℕ × SparsePoly) :=
[
  (0, []),
  (1, []),
  (2, []),
...
/-- The SparsePoly unit checker accepts task `ce05b8a3cfa383b7`. -/
theorem cert_00001_ce05b8a3cfa383b7_checker :
    unitIdealCertChecker cert_00001_ce05b8a3cfa383b7_facts cert_00001_ce05b8a3cfa383b7_cofactors = true := by
  native_decide

/-- The SparsePoly unit certificate for task `ce05b8a3cfa383b7`
...
theorem cert_00001_ce05b8a3cfa383b7_false_of_facts_eval_zero (ν : ℕ → ℝ)
    (hfacts : ∀ f ∈ cert_00001_ce05b8a3cfa383b7_facts, eval ν f = 0) : False := by
  exact false_of_unitIdealCertChecker ν cert_00001_ce05b8a3cfa383b7_facts cert_00001_ce05b8a3cfa383b7_cofactors
    cert_00001_ce05b8a3cfa383b7_checker hfacts

/-- Semantic source-fact evaluation for task `ce05b8a3cfa383b7`.
...
theorem cert_00001_ce05b8a3cfa383b7_facts_eval_zero_of_semantic_equalities (ν : ℕ → ℝ)
    ...
    (hfact_26 : ν 22 = (eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)))⁻¹ ∧ eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)) ≠ 0) :
    ∀ f ∈ cert_00001_ce05b8a3cfa383b7_facts, eval ν f = 0 := by
  intro f hf
  simp only [cert_00001_ce05b8a3cfa383b7_facts, List.mem_cons, List.not_mem_nil, or_false] at hf
...
/-- The source UNIT certificate for task `ce05b8a3cfa383b7`
contradicts the concrete semantic source equations. -/
theorem cert_00001_ce05b8a3cfa383b7_false_of_semantic_equalities (ν : ℕ → ℝ)
    (hfact_0 : ν 10 ^ 2 + ν 11 ^ 2 = 1)
    (hfact_1 : ν 12 ^ 2 + ν 13 ^ 2 = 1)
    (hfact_2 : ν 14 ^ 2 + ν 15 ^ 2 = 1)
    (hfact_3 : (ν 0 - ν 2) ^ 2 + (ν 1 - ν 3) ^ 2 = ν 16)
    ...
    (hfact_24 : ν 14 ^ 2 + ν 15 ^ 2 = ν 21)
    (hfact_25 : (ν 14 - ν 10) ^ 2 + (ν 15 - ν 11) ^ 2 = ν 21)
    (hfact_26 : ν 22 = (eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)))⁻¹ ∧ eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)) ≠ 0) : False := by
  exact cert_00001_ce05b8a3cfa383b7_false_of_facts_eval_zero ν
    (cert_00001_ce05b8a3cfa383b7_facts_eval_zero_of_semantic_equalities ν hfact_0 hfact_1 hfact_2 hfact_3 hfact_4 hfact_5 hfact_6 hfact_7 hfact_8 hfact_9 hfact_10 hfact_11 hfact_12 hfact_13 hfact_14 hfact_15 hfact_16 hfact_17 hfact_18 hfact_19 hfact_20 hfact_21 hfact_22 hfact_23 hfact_24 hfact_25 hfact_26)
...
theorem cert_00001_ce05b8a3cfa383b7_facts_eval_zero_of_semantic_equalities_slack_update (ν : ℕ → ℝ)
    (hfact_0 : ν 10 ^ 2 + ν 11 ^ 2 = 1)
    (hfact_1 : ν 12 ^ 2 + ν 13 ^ 2 = 1)
    (hfact_2 : ν 14 ^ 2 + ν 15 ^ 2 = 1)
    (hfact_3 : (ν 0 - ν 2) ^ 2 + (ν 1 - ν 3) ^ 2 = ν 16)
    ...
    (hfact_24 : ν 14 ^ 2 + ν 15 ^ 2 = ν 21)
    (hfact_25 : (ν 14 - ν 10) ^ 2 + (ν 15 - ν 11) ^ 2 = ν 21)
    (htarget_ne : eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)) ≠ 0) :
    ∀ f ∈ cert_00001_ce05b8a3cfa383b7_facts, eval (Function.update ν 22 (eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)))⁻¹) f = 0 := by
  exact cert_00001_ce05b8a3cfa383b7_facts_eval_zero_of_semantic_equalities (Function.update ν 22 (eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)))⁻¹)
    ...
    (rabinowitschSlack_update_hyp ν (s := 22) (target := ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1))) (by decide) htarget_ne)

/-- The source UNIT certificate for task `ce05b8a3cfa383b7`
contradicts the semantic source equations after Rabinowitsch slack
assignment from a nonzero endpoint target. -/
theorem cert_00001_ce05b8a3cfa383b7_false_of_semantic_equalities_slack_update (ν : ℕ → ℝ)
    (hfact_0 : ν 10 ^ 2 + ν 11 ^ 2 = 1)
    (hfact_1 : ν 12 ^ 2 + ν 13 ^ 2 = 1)
    (hfact_2 : ν 14 ^ 2 + ν 15 ^ 2 = 1)
    (hfact_3 : (ν 0 - ν 2) ^ 2 + (ν 1 - ν 3) ^ 2 = ν 16)
    ...
    (hfact_24 : ν 14 ^ 2 + ν 15 ^ 2 = ν 21)
    (hfact_25 : (ν 14 - ν 10) ^ 2 + (ν 15 - ν 11) ^ 2 = ν 21)
    (htarget_ne : eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)) ≠ 0) : False := by
  exact cert_00001_ce05b8a3cfa383b7_false_of_facts_eval_zero (Function.update ν 22 (eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)))⁻¹)
    (cert_00001_ce05b8a3cfa383b7_facts_eval_zero_of_semantic_equalities_slack_update ν
...
/-- The checked hslot UNIT certificate for task `ce05b8a3cfa383b7` proves the packet-label metric equality `hslot_q_t1_f1` from the other recorded row-radius facts. -/
theorem cert_00001_ce05b8a3cfa383b7_hslot_q_t1_f1_of_row_slot_packet
  ...
  have htarget_ne : eval ν ((coordSqDistUnitXPoly 10 11) ++ neg (coordSqDistUnitXPoly 0 1)) ≠ 0 := by
    intro htarget_zero
    have hcoord_ne :=
    ...
    simp [ν] at hzero ⊢
    nlinarith
  exact cert_00001_ce05b8a3cfa383b7_false_of_semantic_equalities_slack_update ν
    (by
      simpa [ν] using
