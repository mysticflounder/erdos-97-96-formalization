...
/-! # Child41 two-Kalmanson cancellation bank, shard 9
...
namespace Problem97
namespace ATailBlockerVExactSeventeenFortiethModelRefinementsShard9
open ATailBlockerVExactSeventeenSourceNormalForm
open ATailBlockerVExactSeventeenSourceCnf
open ATailBlockerVExactSeventeenSourceCnfCdefg
open ATailFrontierLiveClosure.GenericRowNogoodCertificate
open ATailBlockerVExactSeventeenTwentyEighthModelRefinements
/-- P97 ATail BlockerVExactSeventeenFortiethModelRefinementsShard9 abbrev. -/
private abbrev occurrenceClauses :=
  ATailBlockerVExactSeventeenSeventeenthModelRefinements.occurrenceClauses

/-- P97 ATail BlockerVExactSeventeenFortiethModelRefinementsShard9 def. -/
def cancellationOccurrences : List CancellationOccurrence :=
[
  { hits := [(5, 8), (5, 15), (7, 5), (7, 9), (9, 8), (9, 14), (11, 12), (11, 15), (12, 11), (12, 14), (14, 9), (14, 12), (15, 5), (15, 11)]
    ...
    forwardData := {
      ...
      permutation := ⟨2, 3, 1, 0⟩
      path0 := ⟨(1, 7), [], (1, 7)⟩
      path1 := ⟨(8, 9), [.flip 8 9, .row 9 8 14, .flip 9 14, .row 14 9 12, .flip 14 12, .row 12 14 11, .flip 12 11, .row 11 12 15, .flip 11 15, .row 15 11 5, .flip 15 5, .row 5 15 8], (5, 8)⟩
    ...
    reverseData := {
      ...
      permutation := ⟨2, 3, 1, 0⟩
      path0 := ⟨(0, 8), [], (0, 8)⟩
      path1 := ⟨(9, 11), [.row 9 11 7, .flip 9 7], (7, 9)⟩
      path2 := ⟨(7, 8), [.row 7 8 2, .flip 7 2, .row 2 7 4, .flip 2 4, .row 4 2 5, .flip 4 5, .row 5 4 1, .flip 5 1, .row 1 5 11, .flip 1 11, .row 11 1 8, .flip 11 8], (8, 11)⟩
      path3 := ⟨(0, 9), [], (0, 9)⟩ } },
  { hits := [(7, 9), (7, 15), (9, 3), (9, 14), (10, 1), (10, 3), (11, 12), (11, 15), (12, 11), (12, 14), (14, 9), (14, 12), (15, 1), (15, 11)]
    ...
    forwardData := {
      ...
      path1 := ⟨(1, 15), [.flip 1 15, .row 15 1 11, .flip 15 11, .row 11 15 12, .flip 11 12, .row 12 11 14, .flip 12 14, .row 14 12 9, .flip 14 9, .row 9 14 3, .flip 9 3], (3, 9)⟩
    ...
    reverseData := {
      ...
      path3 := ⟨(1, 15), [.row 1 15 5, .flip 1 5, .row 5 1 4, .flip 5 4, .row 4 5 2, .flip 4 2, .row 2 4 7, .flip 2 7, .row 7 2 13], (7, 13)⟩ } },
  { hits := [(0, 5), (0, 14), (5, 4), (5, 15), (9, 10), (9, 14), (11, 9), (11, 15), (12, 10), (12, 11), (14, 0), (14, 9), (15, 5), (15, 11), (16, 0), (16, 4)]
    ...
    forwardData := {
      ...
      permutation := ⟨2, 1, 0, 3⟩
      path0 := ⟨(4, 5), [.flip 4 5, .row 5 4 15, .flip 5 15, .row 15 5 11, .flip 15 11, .row 11 15 9, .flip 11 9], (9, 11)⟩
      path1 := ⟨(0, 16), [.flip 0 16, .row 16 0 4, .flip 16 4], (4, 16)⟩
      path2 := ⟨(9, 10), [.row 9 10 14, .flip 9 14, .row 14 9 0, .flip 14 0, .row 0 14 5], (0, 5)⟩
      path3 := ⟨(11, 12), [.flip 11 12, .row 12 11 10, .flip 12 10], (10, 12)⟩ }
    reverseData := {
      ...
      secondForm := .adjacentSides
      permutation := ⟨3, 0, 2, 1⟩
      path0 := ⟨(11, 12), [.row 11 12 1, .flip 11 1, .row 1 11 5, .flip 1 5, .row 5 1 7], (5, 7)⟩
      path1 := ⟨(0, 16), [.row 0 16 12], (0, 12)⟩
      path2 := ⟨(4, 5), [.row 4 5 6], (4, 6)⟩
      path3 := ⟨(6, 7), [.flip 6 7, .row 7 6 2, .flip 7 2, .row 2 7 16, .flip 2 16, .row 16 2 11, .flip 16 11], (11, 16)⟩ } },
  { hits := [(0, 13), (0, 14), (5, 6), (5, 15), (7, 5), (7, 13), (11, 12), (11, 15), (12, 11), (12, 14), (13, 6), (13, 9), (14, 9), (14, 12), (15, 5), (15, 11)]
    ...
    forwardData := {
      ...
      path2 := ⟨(5, 6), [.row 5 6 15, .flip 5 15, .row 15 5 11, .flip 15 11, .row 11 15 12, .flip 11 12, .row 12 11 14, .flip 12 14, .row 14 12 9, .flip 14 9], (9, 14)⟩
  ...
  { hits := [(0, 13), (0, 14), (7, 13), (7, 15), (11, 12), (11, 15), (12, 11), (12, 14), (13, 4), (13, 16), (14, 0), (14, 12), (15, 11), (15, 16), (16, 0), (16, 4)]
    forwardChoices := [{ center := 0, support := {13, 14} },
    ...
    forwardData := {
      ...
      path3 := ⟨(15, 16), [.row 15 16 11, .flip 15 11, .row 11 15 12, .flip 11 12, .row 12 11 14, .flip 12 14, .row 14 12 0, .flip 14 0, .row 0 14 13], (0, 13)⟩ }
    reverseData := {
      firstQuad := ⟨0, 3, 12, 16⟩
      firstForm := .innerOuter
      secondQuad := ⟨0, 1, 3, 9⟩
      secondForm := .adjacentSides
      permutation := ⟨2, 0, 1, 3⟩
      path0 := ⟨(3, 12), [.row 3 12 0, .flip 3 0], (0, 3)⟩
      path1 := ⟨(0, 16), [.row 0 16 12], (0, 12)⟩
      path2 := ⟨(0, 1), [.flip 0 1, .row 1 0 5, .flip 1 5, .row 5 1 4, .flip 5 4, .row 4 5 2, .flip 4 2, .row 2 4 16, .flip 2 16, .row 16 2 3, .flip 16 3], (3, 16)⟩
      path3 := ⟨(3, 9), [.flip 3 9, .row 9 3 1, .flip 9 1], (1, 9)⟩ } },
  { hits := [(3, 4), (3, 15), (9, 3), (9, 14), (10, 1), (10, 3), (11, 12), (11, 15), (12, 11), (12, 14), (13, 4), (13, 9), (14, 9), (14, 12), (15, 1), (15, 11)]
    ...
    reverseData := {
      ...
      path2 := ⟨(6, 13), [.row 6 13 15], (6, 15)⟩
      path3 := ⟨(1, 15), [.row 1 15 5, .flip 1 5, .row 5 1 4, .flip 5 4, .row 4 5 2, .flip 4 2, .row 2 4 7, .flip 2 7, .row 7 2 13], (7, 13)⟩ } },
  { hits := [(3, 4), (3, 16), (7, 9), (7, 15), (9, 3), (9, 14), (11, 12), (11, 15), (12, 11), (12, 14), (14, 9), (14, 12), (15, 11), (15, 16), (16, 3), (16, 4)]
    ...
    forwardData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨1, 2, 3, 0⟩
      path0 := ⟨(3, 4), [.row 3 4 16, .flip 3 16, .row 16 3 4, .flip 16 4], (4, 16)⟩
...
/-- P97 ATail BlockerVExactSeventeenFortiethModelRefinementsShard9 theorem. -/
...
end ATailBlockerVExactSeventeenFortiethModelRefinementsShard9
end Problem97
