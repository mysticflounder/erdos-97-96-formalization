...
import Erdos9796Proof.P97.ATail.BlockerVExactSeventeenWeightedKalmansonModelRefinements

/-! # Export the checked exact-seventeen weighted-Kalmanson successor root -/

namespace Problem97
namespace ATailBlockerVExactSeventeenWeightedKalmansonModelRefinementsExport
...
def run (args : List String) : IO UInt32 := do
  match args with
  | [outputPath] =>
      IO.FS.writeFile outputPath extendedWeightedKalmansonModelRefinementsDimacsString
      pure 0
  | _ =>
