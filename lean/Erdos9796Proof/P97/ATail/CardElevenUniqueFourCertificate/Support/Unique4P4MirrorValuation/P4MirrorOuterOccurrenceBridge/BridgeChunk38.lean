...
/-- The materialized mirror-valuation bridge entries for chunk 38. -/
...
/-- Mirror-valuation bridge chunk 38 contains 256 entries. -/
theorem bridgeChunk38_length : bridgeChunk38.length = 256 := by native_decide
