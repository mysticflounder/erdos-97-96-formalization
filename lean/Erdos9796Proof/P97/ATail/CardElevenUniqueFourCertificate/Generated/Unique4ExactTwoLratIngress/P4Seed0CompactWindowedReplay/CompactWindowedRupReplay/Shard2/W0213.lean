...
namespace CompactWindowedRupReplay.Shard2.W0213
...
private def actionText : String :=
  include_str "../../data/actions/3db6d9be8443894f6d2be9eedb4dedbbf6cfd37847a64331cea05de3ac25dce2.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0439.text actionText
      Checkpoint.C0440.text = true := by
  unfold n Checkpoint.C0439.text actionText Checkpoint.C0440.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0213
