...
namespace CompactWindowedRupReplay.Shard2.W0231
...
private def actionText : String :=
  include_str "../../data/actions/265548cbaa24ff85ae6100fd873ae5161d9c924334f83fe2e7e0b241117dd51c.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0457.text actionText
      Checkpoint.C0458.text = true := by
  unfold n Checkpoint.C0457.text actionText Checkpoint.C0458.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0231
