...
namespace CompactWindowedRupReplay.Shard2.W0191
...
private def actionText : String :=
  include_str "../../data/actions/3cecd66a2fa6720bc39a438c7573c1aa647de6909a176d23160c4132e565471b.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0417.text actionText
      Checkpoint.C0418.text = true := by
  unfold n Checkpoint.C0417.text actionText Checkpoint.C0418.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0191
