...
namespace CompactWindowedRupReplay.Shard2.W0209
...
private def actionText : String :=
  include_str "../../data/actions/e83edbaf0d383ff3ff6cec75d7bed1345f72ded5710b832b9913c75830d43fbe.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0435.text actionText
      Checkpoint.C0436.text = true := by
  unfold n Checkpoint.C0435.text actionText Checkpoint.C0436.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0209
