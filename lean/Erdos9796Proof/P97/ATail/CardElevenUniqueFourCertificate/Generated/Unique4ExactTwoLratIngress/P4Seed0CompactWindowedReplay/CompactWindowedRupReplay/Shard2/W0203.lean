...
namespace CompactWindowedRupReplay.Shard2.W0203
...
private def actionText : String :=
  include_str "../../data/actions/3e8a6a715606976ea14d67810cf61ceb3e00dbe09ffc4b18bae4dfcbf75cf556.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0429.text actionText
      Checkpoint.C0430.text = true := by
  unfold n Checkpoint.C0429.text actionText Checkpoint.C0430.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0203
