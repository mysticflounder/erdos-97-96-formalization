...
namespace CompactWindowedRupReplay.Shard2.W0164
...
private def actionText : String :=
  include_str "../../data/actions/33833277e07cc490e57f9dfd20f510cf1fcdd621a2d118d70970b1d016a6818e.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0390.text actionText
      Checkpoint.C0391.text = true := by
  unfold n Checkpoint.C0390.text actionText Checkpoint.C0391.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0164
