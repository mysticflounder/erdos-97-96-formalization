...
namespace CompactWindowedRupReplay.Shard2.W0177
...
private def actionText : String :=
  include_str "../../data/actions/70fb8f0e3006fff4f93ca450554aef654ada38ced838c0fc9593b9604627022b.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0403.text actionText
      Checkpoint.C0404.text = true := by
  unfold n Checkpoint.C0403.text actionText Checkpoint.C0404.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0177
