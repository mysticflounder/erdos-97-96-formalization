...
namespace CompactWindowedRupReplay.Shard2.W0189
...
private def actionText : String :=
  include_str "../../data/actions/79b74a8cdcb928d25d9361116fde4ca598ea79c79ac6d52590cc9cda01d1758b.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0415.text actionText
      Checkpoint.C0416.text = true := by
  unfold n Checkpoint.C0415.text actionText Checkpoint.C0416.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0189
