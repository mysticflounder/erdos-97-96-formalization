...
namespace CompactWindowedRupReplay.Shard2.W0175
...
private def actionText : String :=
  include_str "../../data/actions/a37c34a060115b61dfe845ebd2cd98a9b6f4c4d8273281461ece629eda1c0ead.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0401.text actionText
      Checkpoint.C0402.text = true := by
  unfold n Checkpoint.C0401.text actionText Checkpoint.C0402.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0175
