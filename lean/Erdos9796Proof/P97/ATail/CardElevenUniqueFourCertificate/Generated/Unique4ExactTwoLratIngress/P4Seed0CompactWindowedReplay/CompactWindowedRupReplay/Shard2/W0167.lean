...
namespace CompactWindowedRupReplay.Shard2.W0167
...
private def actionText : String :=
  include_str "../../data/actions/f12ab1cd52ac69bcf9e9ed343becf6be8a73159daa8f20b1fb03001b60f4ce58.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0393.text actionText
      Checkpoint.C0394.text = true := by
  unfold n Checkpoint.C0393.text actionText Checkpoint.C0394.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0167
