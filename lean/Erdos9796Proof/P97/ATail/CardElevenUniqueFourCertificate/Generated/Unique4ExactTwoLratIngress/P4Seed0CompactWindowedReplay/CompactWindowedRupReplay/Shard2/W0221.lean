...
namespace CompactWindowedRupReplay.Shard2.W0221
...
private def actionText : String :=
  include_str "../../data/actions/d0dec5b90ce4e7c4d8959bcd7d6cf5adf987938f0090cb22f4aaf70593fd2b3b.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0447.text actionText
      Checkpoint.C0448.text = true := by
  unfold n Checkpoint.C0447.text actionText Checkpoint.C0448.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0221
