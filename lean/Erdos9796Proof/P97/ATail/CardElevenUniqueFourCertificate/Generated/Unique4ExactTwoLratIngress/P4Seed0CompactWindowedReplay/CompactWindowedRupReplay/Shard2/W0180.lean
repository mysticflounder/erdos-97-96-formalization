...
namespace CompactWindowedRupReplay.Shard2.W0180
...
private def actionText : String :=
  include_str "../../data/actions/23e623a4371b4bcf91e70aef51167986c6127bf44f2bc3cd3f6e8800afd60a8b.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0406.text actionText
      Checkpoint.C0407.text = true := by
  unfold n Checkpoint.C0406.text actionText Checkpoint.C0407.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0180
