...
namespace CompactWindowedRupReplay.Shard2.W0207
...
private def actionText : String :=
  include_str "../../data/actions/8a4adb6755a46f0628ee432f7f5d9a94875dde953d52e6fd9a9fc9057dec4fc3.cpa85"

set_option maxHeartbeats 0 in
set_option maxRecDepth 2000000 in
theorem accepted :
    checkRebaseCompact (n := n)
      Checkpoint.C0433.text actionText
      Checkpoint.C0434.text = true := by
  unfold n Checkpoint.C0433.text actionText Checkpoint.C0434.text
  native_decide
...
end CompactWindowedRupReplay.Shard2.W0207
