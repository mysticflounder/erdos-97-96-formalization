#!/usr/bin/env python3
"""Deterministically ingress the verified exact-11 V7 G3 compact replay.

The source manifest authenticates the 334 Lean modules and 330 compact payloads.
This ingress rewrites only project module imports and the generic Lean namespace.
The separately verified source oleans are provenance evidence and are never copied.
"""
...
SOURCE_PACKAGE_REL = Path(
    "scratch/card11-exact5-common-fullradius-v7-g3-windowed/"
    "g3-windowed-replay-package/compact"
)
VERIFIED_OLEANS_REL = Path(
    "scratch/card11-exact5-common-fullradius-v7-g3-windowed/"
    "g3-windowed-oleans"
)
...
EXPECTED_COUNTS = {".lean": 334, ".cpf85": 165, ".cpa85": 165}
SOURCE_NAMESPACE = "CompactWindowedRupReplay"
TARGET_NAMESPACE = "ExactFiveCommonShellV7G3Replay"
MODULE_PREFIX = (
    "Erdos9796Proof.P97.ATail.CardElevenUniqueFourCertificate.Generated."
    "ExactFiveCommonShellV7G3Replay.CompactWindowedRupReplay"
)
