...
/-- Finite V-exact-seventeen model-refinement def. -/
def fortyEighthModelRefinementClauses : ListCNF Atom :=
...
/-- Finite V-exact-seventeen model-refinement def. -/
def extendedFortyEighthModelRefinementsCnf : ListCNF Atom :=
...
theorem false_of_sourceRealization_of_extendedFortyEighthModelRefinementsCnf_unsat
    ...
    (hunsat : ¬ ∃ assignment,
      ListCNF.eval assignment extendedFortyEighthModelRefinementsCnf = true) : False := by
