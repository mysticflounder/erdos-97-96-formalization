...
module fixes the representation boundary for all 76 source-covered four-row
bisector physical slices before any solver result is promoted.
-/

namespace Problem97
namespace ATailBlockerVExactSeventeenSparseSixPointFourRowTwoCircleBisectorPhysicalSliceCertificateIngress
...
open ATailBlockerVExactSeventeenSparseSixPointFourRowTwoCircleBisectorPhysicalSliceCoverage
...
/-- Checked unsatisfiability of a relabelled cell implies typed-cell
unsatisfiability at the source-facing boundary. -/
theorem sparseSixPointFourRowTwoCircleBisectorPhysicalSliceCellCnf_unsat_of_certificateCnf_unsat
...
/-- Checked LRAT theorems for all 76 finite cells feed the source coverage
consumer with no additional representation hypothesis. -/
theorem false_of_all_sparseSixPointFourRowTwoCircleBisectorPhysicalSliceCertificateCells
    ...
    False := by
  apply false_of_all_sparseSixPointFourRowTwoCircleBisectorPhysicalSliceCells
    (hsource := hsource)
  intro center hcenter category hcategory
  exact
    sparseSixPointFourRowTwoCircleBisectorPhysicalSliceCellCnf_unsat_of_certificateCnf_unsat
      (hcell center hcenter category hcategory)

#print axioms certificateVar_injective
#print axioms sparseSixPointFourRowTwoCircleBisectorPhysicalSliceCellCnf_unsat_of_certificateCnf_unsat
#print axioms false_of_all_sparseSixPointFourRowTwoCircleBisectorPhysicalSliceCertificateCells

end ATailBlockerVExactSeventeenSparseSixPointFourRowTwoCircleBisectorPhysicalSliceCertificateIngress
end Problem97
