...
/-! Direct exporter for one exact-17 four-row bisector physical-slice cell. -/

namespace Problem97
namespace ATailBlockerVExactSeventeenSparseSixPointFourRowTwoCircleBisectorPhysicalSliceCellExport
...
/-- P97 ATail BlockerVExactSeventeenSparseSixPointFourRowTwoCircleBisectorPhysicalSliceCellExport def. -/
private def cnfDimacsString (cnf : ListCNF Atom) : String :=
  let dimacs :=
    cnf.map fun clause => clause.map litToDimacs
  let lines :=
...
def rootDimacsString : String :=
  cnfDimacsString extendedCocircularOrderSparseSixPointFourRowBisectorCnf
...
end ATailBlockerVExactSeventeenSparseSixPointFourRowTwoCircleBisectorPhysicalSliceCellExport
end Problem97
...
def main (args : List String) : IO UInt32 :=
  ATailBlockerVExactSeventeenSparseSixPointFourRowTwoCircleBisectorPhysicalSliceCellExport.run
    args
