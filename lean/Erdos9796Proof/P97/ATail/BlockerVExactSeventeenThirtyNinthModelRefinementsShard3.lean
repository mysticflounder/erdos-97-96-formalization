...
/-!
# Child40 two-Kalmanson cancellation bank, shard 3
...
namespace Problem97
namespace ATailBlockerVExactSeventeenThirtyNinthModelRefinementsShard3
open ATailBlockerVExactSeventeenSourceNormalForm
open ATailBlockerVExactSeventeenSourceCnf
open ATailBlockerVExactSeventeenSourceCnfCdefg
open ATailFrontierLiveClosure.GenericRowNogoodCertificate
open ATailBlockerVExactSeventeenTwentyEighthModelRefinements
/-- P97 ATail BlockerVExactSeventeenThirtyNinthModelRefinementsShard3 abbrev. -/
private abbrev occurrenceClauses :=
  ATailBlockerVExactSeventeenSeventeenthModelRefinements.occurrenceClauses

/-- P97 ATail BlockerVExactSeventeenThirtyNinthModelRefinementsShard3 def. -/
def cancellationOccurrences : List CancellationOccurrence :=
[
  { hits := [(3, 15), (3, 16), (11, 14), (11, 15), (14, 0), (14, 16), (16, 0), (16, 14)]
    ...
    forwardData := {
      ...
      permutation := ⟨2, 0, 3, 1⟩
      path0 := ⟨(3, 14), [], (3, 14)⟩
      path1 := ⟨(0, 16), [.flip 0 16, .row 16 0 14, .flip 16 14, .row 14 16 0, .flip 14 0], (0, 14)⟩
    ...
    reverseData := {
      ...
      permutation := ⟨3, 1, 2, 0⟩
      path0 := ⟨(2, 13), [], (2, 13)⟩
      path1 := ⟨(0, 16), [.row 0 16 2, .flip 0 2, .row 2 0 16], (2, 16)⟩
      path2 := ⟨(2, 5), [.flip 2 5, .row 5 2 1, .flip 5 1], (1, 5)⟩
      path3 := ⟨(1, 13), [.flip 1 13, .row 13 1 0, .flip 13 0], (0, 13)⟩ } },
  { hits := [(6, 3), (6, 16), (9, 3), (9, 14), (14, 0), (14, 16), (16, 0), (16, 14)]
    ...
    forwardData := {
      ...
      secondQuad := ⟨0, 9, 14, 16⟩
      secondForm := .innerOuter
      permutation := ⟨1, 3, 0, 2⟩
      path0 := ⟨(3, 6), [.flip 3 6, .row 6 3 16], (6, 16)⟩
      path1 := ⟨(9, 16), [], (9, 16)⟩
      path2 := ⟨(9, 14), [.row 9 14 3, .flip 9 3], (3, 9)⟩
      path3 := ⟨(0, 16), [.flip 0 16, .row 16 0 14, .flip 16 14, .row 14 16 0, .flip 14 0], (0, 14)⟩ }
    reverseData := {
      firstQuad := ⟨0, 2, 10, 16⟩
      firstForm := .innerOuter
      secondQuad := ⟨2, 7, 10, 13⟩
      secondForm := .adjacentSides
      permutation := ⟨2, 1, 3, 0⟩
      path0 := ⟨(2, 10), [], (2, 10)⟩
      path1 := ⟨(0, 16), [.row 0 16 2, .flip 0 2, .row 2 0 16], (2, 16)⟩
      path2 := ⟨(2, 7), [.flip 2 7, .row 7 2 13], (7, 13)⟩
      path3 := ⟨(10, 13), [.row 10 13 0, .flip 10 0], (0, 10)⟩ } },
  { hits := [(9, 10), (9, 14), (11, 9), (11, 14), (12, 0), (12, 9), (14, 0), (14, 10)]
    forwardChoices := [{ center := 9, support := {10, 14} },
        { center := 11, support := {9, 14} },
        { center := 12, support := {0, 9} },
        { center := 14, support := {0, 10} }]
    reverseChoices := [{ center := 2, support := {6, 16} },
        { center := 4, support := {7, 16} },
        { center := 5, support := {2, 7} },
        { center := 7, support := {2, 6} }]
    forwardData := {
      firstQuad := ⟨9, 10, 11, 14⟩
      firstForm := .adjacentSides
      secondQuad := ⟨0, 9, 12, 14⟩
      secondForm := .innerOuter
      permutation := ⟨3, 0, 2, 1⟩
      path0 := ⟨(9, 10), [.row 9 10 14], (9, 14)⟩
      path1 := ⟨(11, 14), [.row 11 14 9, .flip 11 9], (9, 11)⟩
      path2 := ⟨(9, 12), [.flip 9 12, .row 12 9 0, .flip 12 0], (0, 12)⟩
      path3 := ⟨(0, 14), [.flip 0 14, .row 14 0 10, .flip 14 10], (10, 14)⟩ }
    reverseData := {
      firstQuad := ⟨2, 5, 6, 7⟩
      firstForm := .adjacentSides
      secondQuad := ⟨2, 4, 7, 16⟩
      ...
      path1 := ⟨(6, 7), [.flip 6 7, .row 7 6 2, .flip 7 2], (2, 7)⟩
      path2 := ⟨(4, 7), [.row 4 7 16], (4, 16)⟩
      path3 := ⟨(2, 16), [.row 2 16 6], (2, 6)⟩ } },
  { hits := [(1, 4), (1, 8), (3, 4), (3, 15), (8, 0), (8, 15), (15, 1), (15, 8), (16, 0), (16, 1)]
    ...
    forwardData := {
      ...
      path1 := ⟨(1, 15), [.flip 1 15, .row 15 1 8, .flip 15 8, .row 8 15 0, .flip 8 0], (0, 8)⟩
      path2 := ⟨(1, 8), [.row 1 8 4], (1, 4)⟩
      path3 := ⟨(0, 16), [.flip 0 16, .row 16 0 1, .flip 16 1], (1, 16)⟩ }
    reverseData := {
      firstQuad := ⟨0, 8, 15, 16⟩
      firstForm := .innerOuter
      ...
      secondForm := .innerOuter
      permutation := ⟨3, 0, 2, 1⟩
      path0 := ⟨(8, 15), [.flip 8 15, .row 15 8 12, .flip 15 12], (12, 15)⟩
      path1 := ⟨(0, 16), [.row 0 16 15], (0, 15)⟩
      path2 := ⟨(12, 13), [.flip 12 13, .row 13 12 1, .flip 13 1], (1, 13)⟩
      path3 := ⟨(1, 15), [.row 1 15 8, .flip 1 8, .row 8 1 16], (8, 16)⟩ } },
  { hits := [(1, 4), (1, 10), (2, 1), (2, 12), (10, 1), (10, 3), (12, 3), (12, 4), (14, 10), (14, 12)]
    ...
    forwardData := {
      ...
      secondForm := .adjacentSides
      permutation := ⟨2, 1, 3, 0⟩
      path0 := ⟨(3, 10), [.flip 3 10, .row 10 3 1, .flip 10 1, .row 1 10 4], (1, 4)⟩
      path1 := ⟨(12, 14), [.flip 12 14, .row 14 12 10, .flip 14 10], (10, 14)⟩
      path2 := ⟨(1, 2), [.flip 1 2, .row 2 1 12], (2, 12)⟩
      path3 := ⟨(4, 12), [.flip 4 12, .row 12 4 3, .flip 12 3], (3, 12)⟩ }
    reverseData := {
      firstQuad := ⟨2, 4, 6, 13⟩
      firstForm := .adjacentSides
      secondQuad := ⟨4, 12, 14, 15⟩
      secondForm := .adjacentSides
      permutation := ⟨0, 3, 1, 2⟩
      path0 := ⟨(2, 4), [.row 2 4 6], (2, 6)⟩
      path1 := ⟨(6, 13), [.row 6 13 15, .flip 6 15, .row 15 6 12, .flip 15 12], (12, 15)⟩
      path2 := ⟨(4, 12), [.row 4 12 13], (4, 13)⟩
      path3 := ⟨(14, 15), [.row 14 15 4, .flip 14 4], (4, 14)⟩ } },
  { hits := [(1, 8), (1, 13), (7, 13), (7, 15), (8, 0), (8, 15), (15, 1), (15, 8), (16, 0), (16, 1)]
    ...
    reverseData := {
      ...
      path3 := ⟨(1, 15), [.row 1 15 8, .flip 1 8, .row 8 1 16], (8, 16)⟩ } },
  { hits := [(3, 15), (3, 16), (6, 8), (6, 16), (8, 5), (8, 15), (13, 5), (13, 6), (15, 6), (15, 8)]
    forwardChoices := [{ center := 3, support := {15, 16} },
        { center := 6, support := {8, 16} },
    ...
    reverseChoices := [{ center := 1, support := {8, 10} },
        ...
        { center := 8, support := {1, 11} },
        { center := 10, support := {0, 8} },
        { center := 13, support := {0, 1} }]
    forwardData := {
      firstQuad := ⟨5, 6, 8, 13⟩
      firstForm := .innerOuter
      ...
      secondForm := .innerOuter
      permutation := ⟨3, 1, 0, 2⟩
      path0 := ⟨(6, 8), [.row 6 8 16], (6, 16)⟩
      path1 := ⟨(5, 13), [.flip 5 13, .row 13 5 6, .flip 13 6], (6, 13)⟩
      path2 := ⟨(6, 15), [.flip 6 15, .row 15 6 8, .flip 15 8, .row 8 15 5, .flip 8 5], (5, 8)⟩
    ...
    reverseData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨3, 1, 0, 2⟩
      path0 := ⟨(1, 10), [.row 1 10 8, .flip 1 8, .row 8 1 11], (8, 11)⟩
      path1 := ⟨(0, 13), [.flip 0 13, .row 13 0 1, .flip 13 1], (1, 13)⟩
      path2 := ⟨(8, 10), [.flip 8 10, .row 10 8 0, .flip 10 0], (0, 10)⟩
      path3 := ⟨(3, 11), [.row 3 11 10], (3, 10)⟩ } },
]

/-- P97 ATail BlockerVExactSeventeenThirtyNinthModelRefinementsShard3 theorem. -/
...
end ATailBlockerVExactSeventeenThirtyNinthModelRefinementsShard3
end Problem97
