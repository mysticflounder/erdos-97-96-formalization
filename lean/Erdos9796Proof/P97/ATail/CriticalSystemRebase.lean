...
/-!
# Rebasing a critical-pair frontier to another critical-shell system
...
This module makes that quantifier fact explicit. It does not construct a
...
namespace Problem97
namespace ATailCriticalSystemRebase
...
def rebaseCriticalPairFrontierSystem
  ...
  firstApexSplit := by
    simpa [FirstApexSplit, rebaseSurvivorPairCriticalSystem] using
      F.firstApexSplit
  secondApexDouble := by
    simpa [rebaseSurvivorPairCriticalSystem] using F.secondApexDouble
  secondApexSplit := by
