...
/-!
# Certificate ingress for the thirty-first Lean-owned exact-seventeen child
...
namespace Problem97
namespace ATailBlockerVExactSeventeenThirtiethModelRefinementsCertificateIngress
...
def certificateCnf : ListCNF Nat :=
  ListCNF.relabel certificateVar extendedThirtiethModelRefinementsCnf
...
theorem extendedThirtiethModelRefinementsCnf_unsat_of_certificateCnf_unsat
    (hcertificate : certificateCnf.Unsat) :
    ¬ ∃ assignment,
      ListCNF.eval assignment extendedThirtiethModelRefinementsCnf = true := by
  have htyped : extendedThirtiethModelRefinementsCnf.Unsat :=
    (ListCNF.unsat_relabel_iff (f := extendedThirtiethModelRefinementsCnf)
...
exact thirty-first child. -/
theorem false_of_sourceRealization_of_certificateCnf_unsat
    {A}
    (hsource : Nonempty (SourceRealization A))
    (hcertificate : certificateCnf.Unsat) : False :=
  false_of_sourceRealization_of_extendedThirtiethModelRefinementsCnf_unsat
    hsource
    (extendedThirtiethModelRefinementsCnf_unsat_of_certificateCnf_unsat hcertificate)

#print axioms certificateVar_injective
#print axioms extendedThirtiethModelRefinementsCnf_unsat_of_certificateCnf_unsat
#print axioms false_of_sourceRealization_of_certificateCnf_unsat

end ATailBlockerVExactSeventeenThirtiethModelRefinementsCertificateIngress
end Problem97
