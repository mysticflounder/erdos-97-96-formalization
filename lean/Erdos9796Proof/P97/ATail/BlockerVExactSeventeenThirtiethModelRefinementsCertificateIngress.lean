...
def certificateCnf : CNF Nat :=
  CNF.relabel certificateVar extendedThirtiethModelRefinementsCnf
...
theorem extendedThirtiethModelRefinementsCnf_unsat_of_certificateCnf_unsat
    ...
    ¬ ∃ assignment,
      CNF.eval assignment extendedThirtiethModelRefinementsCnf = true := by
  have htyped : extendedThirtiethModelRefinementsCnf.Unsat :=
    (CNF.unsat_relabel_iff (f := extendedThirtiethModelRefinementsCnf)
