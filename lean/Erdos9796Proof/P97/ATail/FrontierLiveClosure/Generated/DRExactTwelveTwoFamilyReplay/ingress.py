#!/usr/bin/env python3
"""Deterministically ingress the verified two-family compact replay.

The source package under the lane run root is the emitter output for the
two-family CNF of the D-R two-radius branch (piqd job 7b1acbc4, profile plain,
--plain proof replay, 0 RAT lemmas).  This ingress rewrites only the generic
module import prefix; the Lean namespace was emitted as the target namespace.
The package manifest authenticates every Lean module and compact payload.
"""
...
SOURCE_PACKAGE_REL = Path(
    "scratch/runs/dr-two-radius-20260901/p35-proof-retention/artifacts/replay-package"
)
VERIFIED_OLEANS_REL = Path("(none: oleans are built in place by lake-build)")
EXPECTED_PACKAGE_SHA256 = "2be9d35b873f076d1a94f5f36530fb192bb1211f72c429a7039248f5624fed07"
EXPECTED_COUNTS = {".lean": 782, ".cpf85": 389, ".cpa85": 389}
SOURCE_NAMESPACE = "CompactWindowedRupReplay"
TARGET_NAMESPACE = "DRExactTwelveTwoFamilyReplay"
MODULE_PREFIX = (
    "Erdos9796Proof.P97.ATail.FrontierLiveClosure.Generated."
    "DRExactTwelveTwoFamilyReplay.CompactWindowedRupReplay"
)
