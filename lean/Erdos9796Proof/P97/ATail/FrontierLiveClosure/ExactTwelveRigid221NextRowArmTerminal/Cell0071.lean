...
-/
import Erdos9796Proof.P97.ATail.FrontierLiveClosure.ExactTwelveRigid221NextRowArmTerminal.Generated.Cell0071.CompactWindowedRupReplay.Compose
...
named-deletion-arm cell of the 20260811-v2 direct wave: arm cell 71
(placement 11, joint deletion 11, v = 3, arm xu_w).  The
compact windowed pure-RUP replay under `Generated/Cell0071/` proves the
...
/-- Arm cell 71 terminal DIMACS unsatisfiability, obtained from the
compact windowed pure-RUP replay with no new native steps beyond the
window checks. -/
theorem cell0071_dimacsUnsatisfiable :
    DimacsUnsatisfiable
      (signedClausesOfFormula
        (formulaOfCompact
          (n := ExactTwelveRigid221NextRowArmCell0071Replay.n)
          ExactTwelveRigid221NextRowArmCell0071Replay.Checkpoint.C0000.text)) :=
  TerminalRupIngress.dimacsUnsatisfiable_of_formula rfl
    ExactTwelveRigid221NextRowArmCell0071Replay.startUnsatisfiable
