#!/usr/bin/env python3
"""Deterministically ingress the verified next-row arm cell 65 compact replay.
...
SOURCE_PACKAGE_REL = Path(
    ...
    "exact12-next-row-arm-terminal-replay-20260813/cell-65/compact"
)
EXPECTED_PACKAGE_SHA256 = "bd3340fb608e13408ce183dafdaeaf51b8bccb71516696fe3e67f73c68be6c4f"
EXPECTED_COUNTS = {".lean": 8, ".cpf85": 2, ".cpa85": 2}
SOURCE_NAMESPACE = "CompactWindowedRupReplay"
TARGET_NAMESPACE = "ExactTwelveRigid221NextRowArmCell0065Replay"
MODULE_PREFIX = (
    "Erdos9796Proof.P97.ATail.FrontierLiveClosure."
    "ExactTwelveRigid221NextRowArmTerminal.Generated."
    "Cell0065.CompactWindowedRupReplay"
)
