#!/usr/bin/env python3
"""Deterministically ingress the verified next-row arm cell 52 compact replay.
...
SOURCE_PACKAGE_REL = Path(
    ...
    "exact12-next-row-arm-terminal-replay-20260813/cell-52/compact"
)
EXPECTED_PACKAGE_SHA256 = "f51b92048e0d2406c3b3e5c039ae97a91b8b2094fb0f47bb283df7978f8995b9"
EXPECTED_COUNTS = {".lean": 8, ".cpf85": 2, ".cpa85": 2}
SOURCE_NAMESPACE = "CompactWindowedRupReplay"
TARGET_NAMESPACE = "ExactTwelveRigid221NextRowArmCell0052Replay"
MODULE_PREFIX = (
    "Erdos9796Proof.P97.ATail.FrontierLiveClosure."
    "ExactTwelveRigid221NextRowArmTerminal.Generated."
    "Cell0052.CompactWindowedRupReplay"
)
