#!/usr/bin/env python3
"""Deterministically ingress the verified next-row arm cell 71 compact replay.
...
SOURCE_PACKAGE_REL = Path(
    ...
    "exact12-next-row-arm-terminal-replay-20260813/cell-71/compact"
)
EXPECTED_PACKAGE_SHA256 = "1f943e3e8fcb2b5fee3e5d6a341817c7dc588a2303e372d294dd788cf084db45"
EXPECTED_COUNTS = {".lean": 8, ".cpf85": 2, ".cpa85": 2}
SOURCE_NAMESPACE = "CompactWindowedRupReplay"
TARGET_NAMESPACE = "ExactTwelveRigid221NextRowArmCell0071Replay"
MODULE_PREFIX = (
    "Erdos9796Proof.P97.ATail.FrontierLiveClosure."
    "ExactTwelveRigid221NextRowArmTerminal.Generated."
    "Cell0071.CompactWindowedRupReplay"
)
