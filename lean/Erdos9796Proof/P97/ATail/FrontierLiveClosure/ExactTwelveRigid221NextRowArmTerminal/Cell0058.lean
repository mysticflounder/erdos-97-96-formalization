...
-/
import Erdos9796Proof.P97.ATail.FrontierLiveClosure.ExactTwelveRigid221NextRowArmTerminal.Generated.Cell0058.CompactWindowedRupReplay.Compose
...
named-deletion-arm cell of the 20260811-v2 direct wave: arm cell 58
(placement 9, joint deletion 10, v = 3, arm xu_q).  The
compact windowed pure-RUP replay under `Generated/Cell0058/` proves the
...
/-- Arm cell 58 terminal DIMACS unsatisfiability, obtained from the
compact windowed pure-RUP replay with no new native steps beyond the
window checks. -/
theorem cell0058_dimacsUnsatisfiable :
    DimacsUnsatisfiable
      (signedClausesOfFormula
        (formulaOfCompact
          (n := ExactTwelveRigid221NextRowArmCell0058Replay.n)
          ExactTwelveRigid221NextRowArmCell0058Replay.Checkpoint.C0000.text)) :=
  TerminalRupIngress.dimacsUnsatisfiable_of_formula rfl
    ExactTwelveRigid221NextRowArmCell0058Replay.startUnsatisfiable
