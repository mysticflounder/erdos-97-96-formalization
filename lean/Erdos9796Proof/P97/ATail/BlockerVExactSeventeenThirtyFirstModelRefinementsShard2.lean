...
/-- P97 ATail BlockerVExactSeventeenThirtyFirstModelRefinementsShard2 abbrev. -/
private abbrev occurrenceClauses :=
  ATailBlockerVExactSeventeenSeventeenthModelRefinements.occurrenceClauses

/-- P97 ATail BlockerVExactSeventeenThirtyFirstModelRefinementsShard2 def. -/
...
[
  { hits := [(1, 4), (1, 8), (6, 9), (6, 14), (9, 8), (9, 14), (13, 4), (13, 6), (14, 6), (14, 9)]
    ...
    reverseData := {
      ...
      path2 := ⟨(7, 8), [.row 7 8 2, .flip 7 2, .row 2 7 10, .flip 2 10, .row 10 2 7, .flip 10 7], (7, 10)⟩
      path3 := ⟨(10, 15), [], (10, 15)⟩ } },
  { hits := [(1, 8), (1, 10), (4, 6), (4, 10), (6, 9), (6, 14), (9, 8), (9, 14), (14, 6), (14, 9)]
    ...
    forwardData := {
      ...
      permutation := ⟨2, 1, 3, 0⟩
      path0 := ⟨(1, 6), [], (1, 6)⟩
      path1 := ⟨(8, 9), [.flip 8 9, .row 9 8 14, .flip 9 14, .row 14 9 6, .flip 14 6, .row 6 14 9], (6, 9)⟩
  ...
  { hits := [(1, 10), (1, 13), (3, 4), (3, 16), (4, 2), (4, 10), (13, 4), (13, 16), (16, 2), (16, 13)]
    ...
    forwardData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨2, 0, 3, 1⟩
      path0 := ⟨(4, 10), [.row 4 10 2, .flip 4 2], (2, 4)⟩
      path1 := ⟨(1, 13), [.row 1 13 10], (1, 10)⟩
      path2 := ⟨(3, 4), [.row 3 4 16], (3, 16)⟩
      path3 := ⟨(2, 16), [.flip 2 16, .row 16 2 13, .flip 16 13, .row 13 16 4, .flip 13 4], (4, 13)⟩ }
    reverseData := {
      firstQuad := ⟨3, 6, 12, 15⟩
      firstForm := .innerOuter
  ...
  { hits := [(2, 6), (2, 13), (3, 4), (3, 16), (4, 2), (4, 6), (13, 4), (13, 16), (16, 2), (16, 13)]
    ...
    forwardData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨2, 0, 3, 1⟩
      path0 := ⟨(4, 6), [.row 4 6 2, .flip 4 2], (2, 4)⟩
      path1 := ⟨(2, 13), [.row 2 13 6], (2, 6)⟩
      path2 := ⟨(3, 4), [.row 3 4 16], (3, 16)⟩
      path3 := ⟨(2, 16), [.flip 2 16, .row 16 2 13, .flip 16 13, .row 13 16 4, .flip 13 4], (4, 13)⟩ }
    reverseData := {
  ...
  { hits := [(3, 4), (3, 16), (4, 2), (4, 6), (7, 4), (7, 13), (13, 6), (13, 16), (16, 2), (16, 13)]
    ...
    forwardData := {
      ...
      path2 := ⟨(3, 4), [.row 3 4 16], (3, 16)⟩
      path3 := ⟨(2, 16), [.flip 2 16, .row 16 2 13, .flip 16 13, .row 13 16 6, .flip 13 6], (6, 13)⟩ }
    reverseData := {
      firstQuad := ⟨3, 9, 10, 12⟩
      firstForm := .adjacentSides
      secondQuad := ⟨0, 12, 13, 14⟩
  ...
  { hits := [(5, 8), (5, 12), (8, 11), (8, 16), (11, 5), (11, 8), (13, 5), (13, 16), (15, 11), (15, 12)]
    ...
    forwardData := {
      ...
      secondForm := .adjacentSides
      permutation := ⟨2, 0, 1, 3⟩
      path0 := ⟨(5, 8), [.row 5 8 12], (5, 12)⟩
      path1 := ⟨(13, 16), [.row 13 16 5, .flip 13 5], (5, 13)⟩
      path2 := ⟨(5, 11), [.flip 5 11, .row 11 5 8, .flip 11 8, .row 8 11 16], (8, 16)⟩
...
/-- P97 ATail BlockerVExactSeventeenThirtyFirstModelRefinementsShard2 theorem. -/
