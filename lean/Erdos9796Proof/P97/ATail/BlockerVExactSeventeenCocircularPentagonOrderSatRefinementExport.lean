...
/-! Direct exporter for the Lean-owned cocircular-order SAT refinement. -/

namespace Problem97
namespace ATailBlockerVExactSeventeenCocircularPentagonOrderSatRefinementExport
...
def run (args : List String) : IO UInt32 := do
  match args with
  | [outputPath] =>
      IO.FS.writeFile outputPath extendedCocircularOrderSatRefinementDimacsString
      pure 0
  | _ =>
