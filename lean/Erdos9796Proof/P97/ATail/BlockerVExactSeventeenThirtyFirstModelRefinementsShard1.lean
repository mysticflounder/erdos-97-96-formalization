...
/-- P97 ATail BlockerVExactSeventeenThirtyFirstModelRefinementsShard1 abbrev. -/
private abbrev occurrenceClauses :=
  ATailBlockerVExactSeventeenSeventeenthModelRefinements.occurrenceClauses

/-- P97 ATail BlockerVExactSeventeenThirtyFirstModelRefinementsShard1 def. -/
...
[
  ...
  { hits := [(11, 0), (11, 5), (13, 5), (13, 6), (14, 0), (14, 6)]
    ...
    forwardData := {
      ...
      path1 := ⟨(0, 13), [], (0, 13)⟩
      path2 := ⟨(6, 13), [.flip 6 13, .row 13 6 5, .flip 13 5], (5, 13)⟩
  ...
  { hits := [(0, 8), (0, 9), (8, 7), (8, 11), (11, 7), (11, 8), (12, 9), (12, 11)]
    ...
    forwardData := {
      ...
      permutation := ⟨3, 1, 0, 2⟩
      path0 := ⟨(7, 9), [], (7, 9)⟩
      path1 := ⟨(11, 12), [.flip 11 12, .row 12 11 9, .flip 12 9], (9, 12)⟩
      path2 := ⟨(7, 8), [.flip 7 8, .row 8 7 11, .flip 8 11, .row 11 8 7, .flip 11 7], (7, 11)⟩
  ...
  { hits := [(2, 12), (2, 13), (7, 13), (7, 15), (12, 11), (12, 15), (15, 11), (15, 12)]
    ...
    forwardData := {
      ...
      path2 := ⟨(11, 12), [.flip 11 12, .row 12 11 15, .flip 12 15, .row 15 12 11, .flip 15 11], (11, 15)⟩
  ...
  { hits := [(0, 1), (0, 9), (4, 6), (4, 10), (6, 1), (6, 14), (9, 10), (9, 14), (14, 6), (14, 9)]
    ...
    reverseData := {
      firstQuad := ⟨6, 7, 12, 16⟩
      firstForm := .adjacentSides
      secondQuad := ⟨10, 12, 15, 16⟩
      secondForm := .adjacentSides
      permutation := ⟨2, 3, 0, 1⟩
      path0 := ⟨(6, 7), [.flip 6 7, .row 7 6 2, .flip 7 2, .row 2 7 10, .flip 2 10, .row 10 2 15], (10, 15)⟩
      path1 := ⟨(12, 16), [], (12, 16)⟩
  ...
  { hits := [(0, 8), (0, 16), (3, 15), (3, 16), (5, 3), (5, 15), (11, 5), (11, 8), (15, 3), (15, 5)]
    ...
    forwardData := {
      ...
      path2 := ⟨(3, 5), [.flip 3 5, .row 5 3 15, .flip 5 15, .row 15 5 3, .flip 15 3, .row 3 15 16], (3, 16)⟩
  ...
  { hits := [(0, 9), (0, 16), (3, 15), (3, 16), (5, 3), (5, 12), (12, 9), (12, 15), (15, 3), (15, 12)]
    ...
    reverseData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨2, 3, 0, 1⟩
      path0 := ⟨(4, 7), [.row 4 7 1, .flip 4 1, .row 1 4 13, .flip 1 13, .row 13 1 0, .flip 13 0], (0, 13)⟩
      path1 := ⟨(11, 16), [], (11, 16)⟩
      path2 := ⟨(11, 13), [.row 11 13 4, .flip 11 4], (4, 11)⟩
...
/-- P97 ATail BlockerVExactSeventeenThirtyFirstModelRefinementsShard1 theorem. -/
