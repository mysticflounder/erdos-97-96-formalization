...
/-!
# Child40 two-Kalmanson cancellation bank, shard 2
...
namespace Problem97
namespace ATailBlockerVExactSeventeenThirtyNinthModelRefinementsShard2
open ATailBlockerVExactSeventeenSourceNormalForm
open ATailBlockerVExactSeventeenSourceCnf
open ATailBlockerVExactSeventeenSourceCnfCdefg
open ATailFrontierLiveClosure.GenericRowNogoodCertificate
open ATailBlockerVExactSeventeenTwentyEighthModelRefinements
/-- P97 ATail BlockerVExactSeventeenThirtyNinthModelRefinementsShard2 abbrev. -/
private abbrev occurrenceClauses :=
  ATailBlockerVExactSeventeenSeventeenthModelRefinements.occurrenceClauses

/-- P97 ATail BlockerVExactSeventeenThirtyNinthModelRefinementsShard2 def. -/
def cancellationOccurrences : List CancellationOccurrence :=
[
  { hits := [(6, 3), (6, 16), (12, 3), (12, 4), (13, 4), (13, 16)]
  ...
  { hits := [(6, 5), (6, 16), (8, 0), (8, 5), (14, 0), (14, 16)]
  ...
  { hits := [(8, 0), (8, 5), (12, 0), (12, 4), (13, 4), (13, 5)]
    forwardChoices := [{ center := 8, support := {0, 5} },
        { center := 12, support := {0, 4} },
    ...
    forwardData := {
      ...
      path0 := ⟨(4, 8), [], (4, 8)⟩
      path1 := ⟨(0, 12), [.flip 0 12, .row 12 0 4, .flip 12 4], (4, 12)⟩
      path2 := ⟨(5, 8), [.flip 5 8, .row 8 5 0, .flip 8 0], (0, 8)⟩
      path3 := ⟨(4, 13), [.flip 4 13, .row 13 4 5, .flip 13 5], (5, 13)⟩ }
    reverseData := {
      firstQuad := ⟨3, 4, 11, 12⟩
      firstForm := .innerOuter
      secondQuad := ⟨4, 8, 11, 16⟩
      secondForm := .innerOuter
      permutation := ⟨2, 0, 3, 1⟩
      path0 := ⟨(4, 11), [], (4, 11)⟩
      path1 := ⟨(3, 12), [.row 3 12 11], (3, 11)⟩
      path2 := ⟨(8, 11), [.row 8 11 16], (8, 16)⟩
      path3 := ⟨(4, 16), [.row 4 16 12], (4, 12)⟩ } },
...
/-- P97 ATail BlockerVExactSeventeenThirtyNinthModelRefinementsShard2 theorem. -/
...
end ATailBlockerVExactSeventeenThirtyNinthModelRefinementsShard2
end Problem97
