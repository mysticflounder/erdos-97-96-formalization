...
/-!
# Relaxed split surplus certificate R011:u=v:R011YNY
...
/-- Reflected generator rules for relaxed split surplus certificate `R011:u=v:R011YNY`. -/
def rs_R011_ueqv_R011YNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R011:u=v:R011YNY`. -/
def rs_R011_ueqv_R011YNY_generators : List Poly :=
  rs_R011_ueqv_R011YNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R011:u=v:R011YNY`. -/
def rs_R011_ueqv_R011YNY_coefficients : List Poly :=
[
  [],
  [
...
/-- Relaxed split surplus certificate `R011:u=v:R011YNY` as sparse rational polynomial data. -/
def rs_R011_ueqv_R011YNY : Certificate :=
  { generators := rs_R011_ueqv_R011YNY_generators
    coefficients := rs_R011_ueqv_R011YNY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R011:u=v:R011YNY`. -/
theorem rs_R011_ueqv_R011YNY_valid : checkCertificate rs_R011_ueqv_R011YNY = true := by
  native_decide
