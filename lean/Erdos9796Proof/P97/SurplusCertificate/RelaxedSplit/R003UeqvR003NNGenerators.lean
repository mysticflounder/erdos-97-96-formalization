...
/-!
# Relaxed split surplus certificate R003:u=v:R003NN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R003:u=v:R003NN`. -/
def rs_R003_ueqv_R003NN_rules : List Bank.RowZeros.GeneratorRule :=
[
  ...
  .ordinary .s1 .s2 .s3 EndpointVar.s1x EndpointVar.s1y EndpointVar.s2x EndpointVar.s2y EndpointVar.s3x EndpointVar.s3y,
  .ordinary .s1 .s2 .Pu EndpointVar.s1x EndpointVar.s1y EndpointVar.s2x EndpointVar.s2y EndpointVar.pux EndpointVar.puy,
  .ordinary .s1 .s2 .Q2 EndpointVar.s1x EndpointVar.s1y EndpointVar.s2x EndpointVar.s2y EndpointVar.q2x EndpointVar.q2y,
...
/-- Generator polynomials for relaxed split surplus certificate `R003:u=v:R003NN`. -/
def rs_R003_ueqv_R003NN_generators : List Poly :=
  rs_R003_ueqv_R003NN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
