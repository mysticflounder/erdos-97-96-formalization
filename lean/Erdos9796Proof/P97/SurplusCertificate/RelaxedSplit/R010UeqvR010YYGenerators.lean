...
/-!
# Relaxed split surplus certificate R010:u=v:R010YY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R010:u=v:R010YY`. -/
def rs_R010_ueqv_R010YY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R010:u=v:R010YY`. -/
def rs_R010_ueqv_R010YY_generators : List Poly :=
  rs_R010_ueqv_R010YY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
