...
/-!
# Relaxed split surplus certificate R009:u=v:R009YYYNY
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009YYYNY`. -/
def rs_R009_ueqv_R009YYYNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009YYYNY`. -/
def rs_R009_ueqv_R009YYYNY_generators : List Poly :=
  rs_R009_ueqv_R009YYYNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R009:u=v:R009YYYNY`. -/
def rs_R009_ueqv_R009YYYNY_coefficients : List Poly :=
[
  [],
  [
...
/-- Relaxed split surplus certificate `R009:u=v:R009YYYNY` as sparse rational polynomial data. -/
def rs_R009_ueqv_R009YYYNY : Certificate :=
  { generators := rs_R009_ueqv_R009YYYNY_generators
    coefficients := rs_R009_ueqv_R009YYYNY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R009:u=v:R009YYYNY`. -/
theorem rs_R009_ueqv_R009YYYNY_valid : checkCertificate rs_R009_ueqv_R009YYYNY = true := by
  native_decide
