...
/-!
# Relaxed split surplus certificate R009:u=v:R009NNYNNN
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009NNYNNN`. -/
def rs_R009_ueqv_R009NNYNNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009NNYNNN`. -/
def rs_R009_ueqv_R009NNYNNN_generators : List Poly :=
  rs_R009_ueqv_R009NNYNNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R009:u=v:R009NNYNNN`. -/
def rs_R009_ueqv_R009NNYNNN_coefficients : List Poly :=
[
  [
...
/-- Relaxed split surplus certificate `R009:u=v:R009NNYNNN` as sparse rational polynomial data. -/
def rs_R009_ueqv_R009NNYNNN : Certificate :=
  { generators := rs_R009_ueqv_R009NNYNNN_generators
    coefficients := rs_R009_ueqv_R009NNYNNN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R009:u=v:R009NNYNNN`. -/
theorem rs_R009_ueqv_R009NNYNNN_valid : checkCertificate rs_R009_ueqv_R009NNYNNN = true := by
  native_decide
