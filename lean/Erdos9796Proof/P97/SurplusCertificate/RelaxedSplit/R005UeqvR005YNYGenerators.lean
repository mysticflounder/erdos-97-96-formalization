...
/-!
# Relaxed split surplus certificate R005:u=v:R005YNY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R005:u=v:R005YNY`. -/
def rs_R005_ueqv_R005YNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R005:u=v:R005YNY`. -/
def rs_R005_ueqv_R005YNY_generators : List Poly :=
  rs_R005_ueqv_R005YNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
