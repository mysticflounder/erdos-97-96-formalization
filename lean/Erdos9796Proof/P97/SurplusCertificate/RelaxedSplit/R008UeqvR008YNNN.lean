...
/-!
# Relaxed split surplus certificate R008:u=v:R008YNNN
...
/-- Reflected generator rules for relaxed split surplus certificate `R008:u=v:R008YNNN`. -/
def rs_R008_ueqv_R008YNNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R008:u=v:R008YNNN`. -/
def rs_R008_ueqv_R008YNNN_generators : List Poly :=
  rs_R008_ueqv_R008YNNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R008:u=v:R008YNNN`. -/
def rs_R008_ueqv_R008YNNN_coefficients : List Poly :=
[
  [],
  [
...
/-- Relaxed split surplus certificate `R008:u=v:R008YNNN` as sparse rational polynomial data. -/
def rs_R008_ueqv_R008YNNN : Certificate :=
  { generators := rs_R008_ueqv_R008YNNN_generators
    coefficients := rs_R008_ueqv_R008YNNN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R008:u=v:R008YNNN`. -/
theorem rs_R008_ueqv_R008YNNN_valid : checkCertificate rs_R008_ueqv_R008YNNN = true := by
  native_decide
