...
/-!
# Relaxed split surplus certificate R013:u=v:R013YYNYY
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013YYNYY`. -/
def rs_R013_ueqv_R013YYNYY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013YYNYY`. -/
def rs_R013_ueqv_R013YYNYY_generators : List Poly :=
  rs_R013_ueqv_R013YYNYY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R013:u=v:R013YYNYY`. -/
def rs_R013_ueqv_R013YYNYY_coefficients : List Poly :=
[
  [],
  [],
  [
...
/-- Relaxed split surplus certificate `R013:u=v:R013YYNYY` as sparse rational polynomial data. -/
def rs_R013_ueqv_R013YYNYY : Certificate :=
  { generators := rs_R013_ueqv_R013YYNYY_generators
    coefficients := rs_R013_ueqv_R013YYNYY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R013:u=v:R013YYNYY`. -/
theorem rs_R013_ueqv_R013YYNYY_valid : checkCertificate rs_R013_ueqv_R013YYNYY = true := by
  native_decide
