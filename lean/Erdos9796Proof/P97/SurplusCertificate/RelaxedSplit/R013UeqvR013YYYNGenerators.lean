...
/-!
# Relaxed split surplus certificate R013:u=v:R013YYYN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013YYYN`. -/
def rs_R013_ueqv_R013YYYN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013YYYN`. -/
def rs_R013_ueqv_R013YYYN_generators : List Poly :=
  rs_R013_ueqv_R013YYYN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
