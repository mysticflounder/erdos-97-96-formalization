...
/-!
# Relaxed split surplus certificate R011:u=v:R011NNNN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R011:u=v:R011NNNN`. -/
def rs_R011_ueqv_R011NNNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R011:u=v:R011NNNN`. -/
def rs_R011_ueqv_R011NNNN_generators : List Poly :=
  rs_R011_ueqv_R011NNNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
