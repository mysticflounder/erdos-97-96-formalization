...
/-!
# Relaxed split surplus certificate R007:u=v:R007NY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R007:u=v:R007NY`. -/
def rs_R007_ueqv_R007NY_rules : List Bank.RowZeros.GeneratorRule :=
[
  ...
  .ordinary .Pw .u .Q1 EndpointVar.pwx EndpointVar.pwy EndpointVar.ux EndpointVar.uy EndpointVar.q1x EndpointVar.q1y,
...
/-- Generator polynomials for relaxed split surplus certificate `R007:u=v:R007NY`. -/
def rs_R007_ueqv_R007NY_generators : List Poly :=
  rs_R007_ueqv_R007NY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
