...
/-!
# Relaxed split surplus certificate R013:u=v:R013NNYN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013NNYN`. -/
def rs_R013_ueqv_R013NNYN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013NNYN`. -/
def rs_R013_ueqv_R013NNYN_generators : List Poly :=
  rs_R013_ueqv_R013NNYN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
