...
/-!
# Relaxed split surplus certificate R002:u=v:R002YNYN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R002:u=v:R002YNYN`. -/
def rs_R002_ueqv_R002YNYN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R002:u=v:R002YNYN`. -/
def rs_R002_ueqv_R002YNYN_generators : List Poly :=
  rs_R002_ueqv_R002YNYN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
