...
/-!
# Relaxed split surplus certificate R013:u=v:R013YNYN
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013YNYN`. -/
def rs_R013_ueqv_R013YNYN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013YNYN`. -/
def rs_R013_ueqv_R013YNYN_generators : List Poly :=
  rs_R013_ueqv_R013YNYN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R013:u=v:R013YNYN`. -/
def rs_R013_ueqv_R013YNYN_coefficients : List Poly :=
[
  [],
  [],
  [
...
/-- Relaxed split surplus certificate `R013:u=v:R013YNYN` as sparse rational polynomial data. -/
def rs_R013_ueqv_R013YNYN : Certificate :=
  { generators := rs_R013_ueqv_R013YNYN_generators
    coefficients := rs_R013_ueqv_R013YNYN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R013:u=v:R013YNYN`. -/
theorem rs_R013_ueqv_R013YNYN_valid : checkCertificate rs_R013_ueqv_R013YNYN = true := by
  native_decide
