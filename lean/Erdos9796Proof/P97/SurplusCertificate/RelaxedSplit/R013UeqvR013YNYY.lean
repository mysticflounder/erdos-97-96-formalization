...
/-!
# Relaxed split surplus certificate R013:u=v:R013YNYY
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013YNYY`. -/
def rs_R013_ueqv_R013YNYY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013YNYY`. -/
def rs_R013_ueqv_R013YNYY_generators : List Poly :=
  rs_R013_ueqv_R013YNYY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R013:u=v:R013YNYY`. -/
def rs_R013_ueqv_R013YNYY_coefficients : List Poly :=
[
  [],
  [],
  [
...
/-- Relaxed split surplus certificate `R013:u=v:R013YNYY` as sparse rational polynomial data. -/
def rs_R013_ueqv_R013YNYY : Certificate :=
  { generators := rs_R013_ueqv_R013YNYY_generators
    coefficients := rs_R013_ueqv_R013YNYY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R013:u=v:R013YNYY`. -/
theorem rs_R013_ueqv_R013YNYY_valid : checkCertificate rs_R013_ueqv_R013YNYY = true := by
  native_decide
