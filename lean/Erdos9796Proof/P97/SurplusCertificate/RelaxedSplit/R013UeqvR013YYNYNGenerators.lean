...
/-!
# Relaxed split surplus certificate R013:u=v:R013YYNYN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013YYNYN`. -/
def rs_R013_ueqv_R013YYNYN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013YYNYN`. -/
def rs_R013_ueqv_R013YYNYN_generators : List Poly :=
  rs_R013_ueqv_R013YYNYN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
