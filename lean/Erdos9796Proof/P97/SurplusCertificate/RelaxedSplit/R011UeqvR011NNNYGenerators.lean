...
/-!
# Relaxed split surplus certificate R011:u=v:R011NNNY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R011:u=v:R011NNNY`. -/
def rs_R011_ueqv_R011NNNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R011:u=v:R011NNNY`. -/
def rs_R011_ueqv_R011NNNY_generators : List Poly :=
  rs_R011_ueqv_R011NNNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
