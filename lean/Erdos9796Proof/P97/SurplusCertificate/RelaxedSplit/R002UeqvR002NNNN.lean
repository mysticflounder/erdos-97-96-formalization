...
/-!
# Relaxed split surplus certificate R002:u=v:R002NNNN
...
/-- Reflected generator rules for relaxed split surplus certificate `R002:u=v:R002NNNN`. -/
def rs_R002_ueqv_R002NNNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R002:u=v:R002NNNN`. -/
def rs_R002_ueqv_R002NNNN_generators : List Poly :=
  rs_R002_ueqv_R002NNNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R002:u=v:R002NNNN`. -/
def rs_R002_ueqv_R002NNNN_coefficients : List Poly :=
[
  [
  term (1 : Rat) [(16, 1)]
],
...
/-- Relaxed split surplus certificate `R002:u=v:R002NNNN` as sparse rational polynomial data. -/
def rs_R002_ueqv_R002NNNN : Certificate :=
  { generators := rs_R002_ueqv_R002NNNN_generators
    coefficients := rs_R002_ueqv_R002NNNN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R002:u=v:R002NNNN`. -/
theorem rs_R002_ueqv_R002NNNN_valid : checkCertificate rs_R002_ueqv_R002NNNN = true := by
  native_decide
