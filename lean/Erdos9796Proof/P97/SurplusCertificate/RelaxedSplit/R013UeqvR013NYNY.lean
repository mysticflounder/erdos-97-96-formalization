...
/-!
# Relaxed split surplus certificate R013:u=v:R013NYNY
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013NYNY`. -/
def rs_R013_ueqv_R013NYNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013NYNY`. -/
def rs_R013_ueqv_R013NYNY_generators : List Poly :=
  rs_R013_ueqv_R013NYNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R013:u=v:R013NYNY`. -/
def rs_R013_ueqv_R013NYNY_coefficients : List Poly :=
[
  [],
  [
  term (1 : Rat) [(16, 1)]
...
/-- Relaxed split surplus certificate `R013:u=v:R013NYNY` as sparse rational polynomial data. -/
def rs_R013_ueqv_R013NYNY : Certificate :=
  { generators := rs_R013_ueqv_R013NYNY_generators
    coefficients := rs_R013_ueqv_R013NYNY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R013:u=v:R013NYNY`. -/
theorem rs_R013_ueqv_R013NYNY_valid : checkCertificate rs_R013_ueqv_R013NYNY = true := by
  native_decide
