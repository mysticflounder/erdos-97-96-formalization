...
/-!
# Relaxed split surplus certificate R009:u=v:R009NNNNN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009NNNNN`. -/
def rs_R009_ueqv_R009NNNNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009NNNNN`. -/
def rs_R009_ueqv_R009NNNNN_generators : List Poly :=
  rs_R009_ueqv_R009NNNNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
