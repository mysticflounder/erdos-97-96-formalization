...
/-!
# Relaxed split surplus certificate R004:u=v:R004YNY
...
/-- Reflected generator rules for relaxed split surplus certificate `R004:u=v:R004YNY`. -/
def rs_R004_ueqv_R004YNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R004:u=v:R004YNY`. -/
def rs_R004_ueqv_R004YNY_generators : List Poly :=
  rs_R004_ueqv_R004YNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R004:u=v:R004YNY`. -/
def rs_R004_ueqv_R004YNY_coefficients : List Poly :=
[
  [
  term (-1 : Rat) [(16, 1)]
],
...
/-- Relaxed split surplus certificate `R004:u=v:R004YNY` as sparse rational polynomial data. -/
def rs_R004_ueqv_R004YNY : Certificate :=
  { generators := rs_R004_ueqv_R004YNY_generators
    coefficients := rs_R004_ueqv_R004YNY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R004:u=v:R004YNY`. -/
theorem rs_R004_ueqv_R004YNY_valid : checkCertificate rs_R004_ueqv_R004YNY = true := by
  native_decide
