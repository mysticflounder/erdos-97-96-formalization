...
/-!
# Relaxed split surplus certificate R009:u=s1:R009NN
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=s1:R009NN`. -/
def rs_R009_ueqs1_R009NN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=s1:R009NN`. -/
def rs_R009_ueqs1_R009NN_generators : List Poly :=
  rs_R009_ueqs1_R009NN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R009:u=s1:R009NN`. -/
def rs_R009_ueqs1_R009NN_coefficients : List Poly :=
[
  [],
  [],
  [],
  ...
  [
  term (6 : Rat) [(2, 1), (3, 1), (6, 1), (15, 1), (16, 1)],
  term (-12 : Rat) [(2, 1), (3, 1), (12, 1), (15, 1), (16, 1)],
  term (-6 : Rat) [(2, 1), (6, 1), (13, 1), (15, 1), (16, 1)],
  term (6 : Rat) [(2, 1), (7, 1), (12, 1), (15, 1), (16, 1)],
  term (-3 : Rat) [(2, 1), (7, 1), (15, 1), (16, 1)],
  term (-6 : Rat) [(2, 1), (13, 1), (15, 1), (16, 1)],
  term (-6 : Rat) [(2, 2), (7, 1), (15, 1), (16, 1)],
...
/-- Relaxed split surplus certificate `R009:u=s1:R009NN` as sparse rational polynomial data. -/
def rs_R009_ueqs1_R009NN : Certificate :=
  { generators := rs_R009_ueqs1_R009NN_generators
    coefficients := rs_R009_ueqs1_R009NN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R009:u=s1:R009NN`. -/
theorem rs_R009_ueqs1_R009NN_valid : checkCertificate rs_R009_ueqs1_R009NN = true := by
  native_decide
