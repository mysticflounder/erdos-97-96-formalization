...
/-!
# Relaxed split surplus certificate R013:u=v:R013NNNN
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013NNNN`. -/
def rs_R013_ueqv_R013NNNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013NNNN`. -/
def rs_R013_ueqv_R013NNNN_generators : List Poly :=
  rs_R013_ueqv_R013NNNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R013:u=v:R013NNNN`. -/
def rs_R013_ueqv_R013NNNN_coefficients : List Poly :=
[
  [],
  [
  ...
  term (-8 : Rat) [(6, 1), (11, 2), (16, 1)],
  term (-4 : Rat) [(7, 1), (8, 1), (11, 1), (16, 1)],
  term (8 : Rat) [(7, 1), (10, 1), (11, 1), (16, 1)],
...
/-- Relaxed split surplus certificate `R013:u=v:R013NNNN` as sparse rational polynomial data. -/
def rs_R013_ueqv_R013NNNN : Certificate :=
  { generators := rs_R013_ueqv_R013NNNN_generators
    coefficients := rs_R013_ueqv_R013NNNN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R013:u=v:R013NNNN`. -/
theorem rs_R013_ueqv_R013NNNN_valid : checkCertificate rs_R013_ueqv_R013NNNN = true := by
  native_decide
