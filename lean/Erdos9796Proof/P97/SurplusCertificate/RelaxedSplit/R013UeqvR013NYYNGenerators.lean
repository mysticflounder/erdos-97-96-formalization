...
/-!
# Relaxed split surplus certificate R013:u=v:R013NYYN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013NYYN`. -/
def rs_R013_ueqv_R013NYYN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013NYYN`. -/
def rs_R013_ueqv_R013NYYN_generators : List Poly :=
  rs_R013_ueqv_R013NYYN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
