...
/-- Reflected generator rules for relaxed split surplus certificate `R014:u=v:R014NNY`. -/
def rs_R014_ueqv_R014NNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
def rs_R014_ueqv_R014NNY_generators : List Poly :=
  rs_R014_ueqv_R014NNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
