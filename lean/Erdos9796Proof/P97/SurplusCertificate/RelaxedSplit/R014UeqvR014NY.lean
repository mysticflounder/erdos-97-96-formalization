...
/-!
# Relaxed split surplus certificate R014:u=v:R014NY
...
/-- Reflected generator rules for relaxed split surplus certificate `R014:u=v:R014NY`. -/
def rs_R014_ueqv_R014NY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R014:u=v:R014NY`. -/
def rs_R014_ueqv_R014NY_generators : List Poly :=
  rs_R014_ueqv_R014NY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R014:u=v:R014NY`. -/
def rs_R014_ueqv_R014NY_coefficients : List Poly :=
[
  [
  ...
  term (4 : Rat) [(6, 1), (11, 2), (16, 1)],
  term (4 : Rat) [(7, 1), (8, 1), (11, 1), (16, 1)],
  term (-4 : Rat) [(7, 1), (10, 1), (11, 1), (16, 1)],
  term (-4 : Rat) [(7, 1), (11, 1), (16, 1)],
  term (-8 : Rat) [(8, 1), (11, 2), (16, 1)],
  term (8 : Rat) [(9, 1), (10, 1), (11, 1), (16, 1)],
...
/-- Relaxed split surplus certificate `R014:u=v:R014NY` as sparse rational polynomial data. -/
def rs_R014_ueqv_R014NY : Certificate :=
  { generators := rs_R014_ueqv_R014NY_generators
    coefficients := rs_R014_ueqv_R014NY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R014:u=v:R014NY`. -/
theorem rs_R014_ueqv_R014NY_valid : checkCertificate rs_R014_ueqv_R014NY = true := by
  native_decide
