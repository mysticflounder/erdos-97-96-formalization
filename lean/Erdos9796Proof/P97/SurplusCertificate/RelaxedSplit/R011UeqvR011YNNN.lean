...
/-!
# Relaxed split surplus certificate R011:u=v:R011YNNN
...
/-- Reflected generator rules for relaxed split surplus certificate `R011:u=v:R011YNNN`. -/
def rs_R011_ueqv_R011YNNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R011:u=v:R011YNNN`. -/
def rs_R011_ueqv_R011YNNN_generators : List Poly :=
  rs_R011_ueqv_R011YNNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R011:u=v:R011YNNN`. -/
def rs_R011_ueqv_R011YNNN_coefficients : List Poly :=
[
  [],
  [
  ...
  [
  term (2 : Rat) [(2, 1), (3, 1), (11, 1), (16, 1)],
  term (-1 : Rat) [(2, 1), (3, 1), (15, 1), (16, 1)],
  term (8 : Rat) [(2, 1), (5, 1), (9, 1), (16, 1)],
  term (-8 : Rat) [(2, 1), (9, 1), (11, 1), (16, 1)],
  term (4 : Rat) [(2, 1), (11, 1), (15, 1), (16, 1)],
  term (-6 : Rat) [(2, 1), (11, 2), (16, 1)],
...
/-- Relaxed split surplus certificate `R011:u=v:R011YNNN` as sparse rational polynomial data. -/
def rs_R011_ueqv_R011YNNN : Certificate :=
  { generators := rs_R011_ueqv_R011YNNN_generators
    coefficients := rs_R011_ueqv_R011YNNN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R011:u=v:R011YNNN`. -/
theorem rs_R011_ueqv_R011YNNN_valid : checkCertificate rs_R011_ueqv_R011YNNN = true := by
  native_decide
