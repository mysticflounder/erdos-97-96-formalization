...
/-!
# Relaxed split surplus certificate R010:u=v:R010NYY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R010:u=v:R010NYY`. -/
def rs_R010_ueqv_R010NYY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R010:u=v:R010NYY`. -/
def rs_R010_ueqv_R010NYY_generators : List Poly :=
  rs_R010_ueqv_R010NYY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
