...
/-!
# Relaxed split surplus certificate R008:u=v:R008YYNN
...
/-- Reflected generator rules for relaxed split surplus certificate `R008:u=v:R008YYNN`. -/
def rs_R008_ueqv_R008YYNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R008:u=v:R008YYNN`. -/
def rs_R008_ueqv_R008YYNN_generators : List Poly :=
  rs_R008_ueqv_R008YYNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R008:u=v:R008YYNN`. -/
def rs_R008_ueqv_R008YYNN_coefficients : List Poly :=
[
  [],
  [
  ...
  term (8 : Rat) [(1, 1), (11, 1), (14, 1), (16, 1)],
  term (8 : Rat) [(1, 1), (14, 1), (15, 1), (16, 1)],
...
/-- Relaxed split surplus certificate `R008:u=v:R008YYNN` as sparse rational polynomial data. -/
def rs_R008_ueqv_R008YYNN : Certificate :=
  { generators := rs_R008_ueqv_R008YYNN_generators
    coefficients := rs_R008_ueqv_R008YYNN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R008:u=v:R008YYNN`. -/
theorem rs_R008_ueqv_R008YYNN_valid : checkCertificate rs_R008_ueqv_R008YYNN = true := by
  native_decide
