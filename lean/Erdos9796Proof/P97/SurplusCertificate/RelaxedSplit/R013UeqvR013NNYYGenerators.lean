...
/-!
# Relaxed split surplus certificate R013:u=v:R013NNYY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013NNYY`. -/
def rs_R013_ueqv_R013NNYY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013NNYY`. -/
def rs_R013_ueqv_R013NNYY_generators : List Poly :=
  rs_R013_ueqv_R013NNYY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
