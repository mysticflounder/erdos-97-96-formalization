...
/-!
# Relaxed split surplus certificate R009:u=v:R009NNYY
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009NNYY`. -/
def rs_R009_ueqv_R009NNYY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009NNYY`. -/
def rs_R009_ueqv_R009NNYY_generators : List Poly :=
  rs_R009_ueqv_R009NNYY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R009:u=v:R009NNYY`. -/
def rs_R009_ueqv_R009NNYY_coefficients : List Poly :=
[
  [
...
/-- Relaxed split surplus certificate `R009:u=v:R009NNYY` as sparse rational polynomial data. -/
def rs_R009_ueqv_R009NNYY : Certificate :=
  { generators := rs_R009_ueqv_R009NNYY_generators
    coefficients := rs_R009_ueqv_R009NNYY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R009:u=v:R009NNYY`. -/
theorem rs_R009_ueqv_R009NNYY_valid : checkCertificate rs_R009_ueqv_R009NNYY = true := by
  native_decide
