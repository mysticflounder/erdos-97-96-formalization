...
/-!
# Relaxed split surplus certificate R008:u=v:R008NNYY
...
/-- Reflected generator rules for relaxed split surplus certificate `R008:u=v:R008NNYY`. -/
def rs_R008_ueqv_R008NNYY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R008:u=v:R008NNYY`. -/
def rs_R008_ueqv_R008NNYY_generators : List Poly :=
  rs_R008_ueqv_R008NNYY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R008:u=v:R008NNYY`. -/
def rs_R008_ueqv_R008NNYY_coefficients : List Poly :=
[
  [
...
/-- Relaxed split surplus certificate `R008:u=v:R008NNYY` as sparse rational polynomial data. -/
def rs_R008_ueqv_R008NNYY : Certificate :=
  { generators := rs_R008_ueqv_R008NNYY_generators
    coefficients := rs_R008_ueqv_R008NNYY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R008:u=v:R008NNYY`. -/
theorem rs_R008_ueqv_R008NNYY_valid : checkCertificate rs_R008_ueqv_R008NNYY = true := by
  native_decide
