...
/-!
# Relaxed split surplus certificate R009:u=v:R009NYYYNN
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009NYYYNN`. -/
def rs_R009_ueqv_R009NYYYNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009NYYYNN`. -/
def rs_R009_ueqv_R009NYYYNN_generators : List Poly :=
  rs_R009_ueqv_R009NYYYNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R009:u=v:R009NYYYNN`. -/
def rs_R009_ueqv_R009NYYYNN_coefficients : List Poly :=
[
  [
...
/-- Relaxed split surplus certificate `R009:u=v:R009NYYYNN` as sparse rational polynomial data. -/
def rs_R009_ueqv_R009NYYYNN : Certificate :=
  { generators := rs_R009_ueqv_R009NYYYNN_generators
    coefficients := rs_R009_ueqv_R009NYYYNN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R009:u=v:R009NYYYNN`. -/
theorem rs_R009_ueqv_R009NYYYNN_valid : checkCertificate rs_R009_ueqv_R009NYYYNN = true := by
  native_decide
