...
/-!
# Relaxed split surplus certificate R009:u=v:R009NYNNN
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009NYNNN`. -/
def rs_R009_ueqv_R009NYNNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009NYNNN`. -/
def rs_R009_ueqv_R009NYNNN_generators : List Poly :=
  rs_R009_ueqv_R009NYNNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R009:u=v:R009NYNNN`. -/
def rs_R009_ueqv_R009NYNNN_coefficients : List Poly :=
[
  [
  ...
  [
  term (1 : Rat) [(0, 1), (10, 1), (16, 1)],
  term (-8 : Rat) [(1, 1), (6, 1), (10, 1), (13, 1), (16, 1)],
  term (4 : Rat) [(1, 1), (6, 1), (10, 1), (15, 1), (16, 1)],
  term (8 : Rat) [(1, 1), (6, 1), (11, 1), (12, 1), (16, 1)],
  term (-4 : Rat) [(1, 1), (6, 1), (11, 1), (14, 1), (16, 1)],
...
/-- Relaxed split surplus certificate `R009:u=v:R009NYNNN` as sparse rational polynomial data. -/
def rs_R009_ueqv_R009NYNNN : Certificate :=
  { generators := rs_R009_ueqv_R009NYNNN_generators
    coefficients := rs_R009_ueqv_R009NYNNN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R009:u=v:R009NYNNN`. -/
theorem rs_R009_ueqv_R009NYNNN_valid : checkCertificate rs_R009_ueqv_R009NYNNN = true := by
  native_decide
