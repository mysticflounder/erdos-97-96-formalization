...
/-!
# Relaxed split surplus certificate R014:u=v:R014YY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R014:u=v:R014YY`. -/
def rs_R014_ueqv_R014YY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R014:u=v:R014YY`. -/
def rs_R014_ueqv_R014YY_generators : List Poly :=
  rs_R014_ueqv_R014YY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
