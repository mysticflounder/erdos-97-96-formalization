...
/-!
# Relaxed split surplus certificate R009:u=v:R009NYYYY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009NYYYY`. -/
def rs_R009_ueqv_R009NYYYY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009NYYYY`. -/
def rs_R009_ueqv_R009NYYYY_generators : List Poly :=
  rs_R009_ueqv_R009NYYYY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
