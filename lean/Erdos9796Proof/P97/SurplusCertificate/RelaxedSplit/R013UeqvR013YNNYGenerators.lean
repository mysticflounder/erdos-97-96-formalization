...
/-!
# Relaxed split surplus certificate R013:u=v:R013YNNY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013YNNY`. -/
def rs_R013_ueqv_R013YNNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013YNNY`. -/
def rs_R013_ueqv_R013YNNY_generators : List Poly :=
  rs_R013_ueqv_R013YNNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
