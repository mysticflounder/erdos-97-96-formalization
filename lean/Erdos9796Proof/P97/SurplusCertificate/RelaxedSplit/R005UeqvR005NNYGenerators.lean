...
/-!
# Relaxed split surplus certificate R005:u=v:R005NNY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R005:u=v:R005NNY`. -/
def rs_R005_ueqv_R005NNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R005:u=v:R005NNY`. -/
def rs_R005_ueqv_R005NNY_generators : List Poly :=
  rs_R005_ueqv_R005NNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
