...
/-!
# Relaxed split surplus certificate R011:u=s1:R011Y
...
/-- Reflected generator rules for relaxed split surplus certificate `R011:u=s1:R011Y`. -/
def rs_R011_ueqs1_R011Y_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R011:u=s1:R011Y`. -/
def rs_R011_ueqs1_R011Y_generators : List Poly :=
  rs_R011_ueqs1_R011Y_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R011:u=s1:R011Y`. -/
def rs_R011_ueqs1_R011Y_coefficients : List Poly :=
[
  [],
  [],
  [],
  ...
  term (-6 : Rat) [(2, 1), (13, 1), (15, 1)],
  term (1 : Rat) [(2, 1), (13, 1), (15, 1), (16, 1)],
  term (-12 : Rat) [(3, 1), (10, 1), (15, 1)],
  term (-2 : Rat) [(3, 1), (10, 1), (15, 1), (16, 1)],
  ...
  term (-6 : Rat) [(10, 1), (13, 1), (15, 1)],
  term (-1 : Rat) [(10, 1), (13, 1), (15, 1), (16, 1)],
  term (-24 : Rat) [(10, 1), (15, 2)],
  term (-4 : Rat) [(10, 1), (15, 2), (16, 1)],
  term (-27 : Rat) [(11, 1), (15, 1)],
  ...
  term (-12 : Rat) [(3, 1), (10, 1), (15, 1)],
  term (-2 : Rat) [(3, 1), (10, 1), (15, 1), (16, 1)],
  term (6 : Rat) [(6, 1), (11, 1), (15, 1)],
  term (-1 : Rat) [(6, 1), (11, 1), (15, 1), (16, 1)],
  term (-6 : Rat) [(7, 1), (10, 1), (15, 1)],
  term (1 : Rat) [(7, 1), (10, 1), (15, 1), (16, 1)],
  term (-6 : Rat) [(10, 1), (13, 1), (15, 1)],
  term (1 : Rat) [(10, 1), (13, 1), (15, 1), (16, 1)],
  ...
  term (2 : Rat) [(10, 1), (11, 1), (12, 1), (15, 1), (16, 1)],
  term (-24 : Rat) [(10, 1), (11, 1), (14, 1), (15, 1)],
  term (-4 : Rat) [(10, 1), (11, 1), (14, 1), (15, 1), (16, 1)],
  term (-12 : Rat) [(10, 1), (11, 1), (15, 1)],
  term (-2 : Rat) [(10, 1), (11, 1), (15, 1), (16, 1)],
  term (-12 : Rat) [(10, 1), (12, 1), (15, 2)],
  term (-2 : Rat) [(10, 1), (12, 1), (15, 2), (16, 1)],
  term (12 : Rat) [(10, 1), (13, 1), (14, 1), (15, 1)],
...
/-- Relaxed split surplus certificate `R011:u=s1:R011Y` as sparse rational polynomial data. -/
def rs_R011_ueqs1_R011Y : Certificate :=
  { generators := rs_R011_ueqs1_R011Y_generators
    coefficients := rs_R011_ueqs1_R011Y_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R011:u=s1:R011Y`. -/
theorem rs_R011_ueqs1_R011Y_valid : checkCertificate rs_R011_ueqs1_R011Y = true := by
  native_decide
