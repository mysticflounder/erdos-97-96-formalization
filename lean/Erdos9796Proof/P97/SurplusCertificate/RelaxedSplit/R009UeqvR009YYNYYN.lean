...
/-!
# Relaxed split surplus certificate R009:u=v:R009YYNYYN
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009YYNYYN`. -/
def rs_R009_ueqv_R009YYNYYN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009YYNYYN`. -/
def rs_R009_ueqv_R009YYNYYN_generators : List Poly :=
  rs_R009_ueqv_R009YYNYYN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R009:u=v:R009YYNYYN`. -/
def rs_R009_ueqv_R009YYNYYN_coefficients : List Poly :=
[
  [],
  [
...
/-- Relaxed split surplus certificate `R009:u=v:R009YYNYYN` as sparse rational polynomial data. -/
def rs_R009_ueqv_R009YYNYYN : Certificate :=
  { generators := rs_R009_ueqv_R009YYNYYN_generators
    coefficients := rs_R009_ueqv_R009YYNYYN_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R009:u=v:R009YYNYYN`. -/
theorem rs_R009_ueqv_R009YYNYYN_valid : checkCertificate rs_R009_ueqv_R009YYNYYN = true := by
  native_decide
