...
/-!
# Relaxed split surplus certificate R009:u=v:R009NNNYN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009NNNYN`. -/
def rs_R009_ueqv_R009NNNYN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009NNNYN`. -/
def rs_R009_ueqv_R009NNNYN_generators : List Poly :=
  rs_R009_ueqv_R009NNNYN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
