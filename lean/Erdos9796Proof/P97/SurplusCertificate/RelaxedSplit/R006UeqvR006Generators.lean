...
/-!
# Relaxed split surplus certificate R006:u=v:R006, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R006:u=v:R006`. -/
def rs_R006_ueqv_R006_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R006:u=v:R006`. -/
def rs_R006_ueqv_R006_generators : List Poly :=
  rs_R006_ueqv_R006_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
