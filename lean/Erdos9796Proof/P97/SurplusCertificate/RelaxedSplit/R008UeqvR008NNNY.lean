...
/-!
# Relaxed split surplus certificate R008:u=v:R008NNNY
...
/-- Reflected generator rules for relaxed split surplus certificate `R008:u=v:R008NNNY`. -/
def rs_R008_ueqv_R008NNNY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R008:u=v:R008NNNY`. -/
def rs_R008_ueqv_R008NNNY_generators : List Poly :=
  rs_R008_ueqv_R008NNNY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly

/-- Coefficient polynomials for relaxed split surplus certificate `R008:u=v:R008NNNY`. -/
def rs_R008_ueqv_R008NNNY_coefficients : List Poly :=
[
  [],
  [
...
/-- Relaxed split surplus certificate `R008:u=v:R008NNNY` as sparse rational polynomial data. -/
def rs_R008_ueqv_R008NNNY : Certificate :=
  { generators := rs_R008_ueqv_R008NNNY_generators
    coefficients := rs_R008_ueqv_R008NNNY_coefficients }

set_option linter.style.nativeDecide false in
/-- The checked identity for relaxed split surplus certificate `R008:u=v:R008NNNY`. -/
theorem rs_R008_ueqv_R008NNNY_valid : checkCertificate rs_R008_ueqv_R008NNNY = true := by
  native_decide
