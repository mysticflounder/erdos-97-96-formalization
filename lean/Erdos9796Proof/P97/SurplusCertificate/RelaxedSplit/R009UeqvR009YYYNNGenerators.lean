...
/-!
# Relaxed split surplus certificate R009:u=v:R009YYYNN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009YYYNN`. -/
def rs_R009_ueqv_R009YYYNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009YYYNN`. -/
def rs_R009_ueqv_R009YYYNN_generators : List Poly :=
  rs_R009_ueqv_R009YYYNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
