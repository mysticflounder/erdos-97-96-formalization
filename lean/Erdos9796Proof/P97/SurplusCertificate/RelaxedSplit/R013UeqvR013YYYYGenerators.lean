...
/-!
# Relaxed split surplus certificate R013:u=v:R013YYYY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R013:u=v:R013YYYY`. -/
def rs_R013_ueqv_R013YYYY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R013:u=v:R013YYYY`. -/
def rs_R013_ueqv_R013YYYY_generators : List Poly :=
  rs_R013_ueqv_R013YYYY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
