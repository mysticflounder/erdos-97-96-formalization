...
/-!
# Relaxed split surplus certificate R011:u=v:R011YYY, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R011:u=v:R011YYY`. -/
def rs_R011_ueqv_R011YYY_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R011:u=v:R011YYY`. -/
def rs_R011_ueqv_R011YYY_generators : List Poly :=
  rs_R011_ueqv_R011YYY_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
