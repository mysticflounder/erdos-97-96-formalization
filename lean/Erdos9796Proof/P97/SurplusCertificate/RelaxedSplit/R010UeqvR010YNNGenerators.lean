...
/-!
# Relaxed split surplus certificate R010:u=v:R010YNN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R010:u=v:R010YNN`. -/
def rs_R010_ueqv_R010YNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R010:u=v:R010YNN`. -/
def rs_R010_ueqv_R010YNN_generators : List Poly :=
  rs_R010_ueqv_R010YNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
