...
/-!
# Relaxed split surplus certificate R009:u=v:R009YNNNN, generators
...
/-- Reflected generator rules for relaxed split surplus certificate `R009:u=v:R009YNNNN`. -/
def rs_R009_ueqv_R009YNNNN_rules : List Bank.RowZeros.GeneratorRule :=
[
...
/-- Generator polynomials for relaxed split surplus certificate `R009:u=v:R009YNNNN`. -/
def rs_R009_ueqv_R009YNNNN_generators : List Poly :=
  rs_R009_ueqv_R009YNNNN_rules.map Bank.RowZeros.GeneratorRule.normalizedPoly
