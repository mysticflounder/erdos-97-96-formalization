...
private theorem rs_R008_ueqv_R008YYNY_rules_check :
    rulesValidForPid "s2_004" (.pair .u .v)
      rs_R008_ueqv_R008YYNY_rules = true := by
  native_decide

/-- The matched exact row has the generated singleton exact pid. -/
private theorem rs_R008_ueqv_R008YYNY_exactRow_pid_eq
    {exactRow : SurplusCOMPGBank.Row}
    (hpid : ["s2_004"] = [exactRow.pid]) :
...
theorem rs_R008_ueqv_R008YYNY_evaluationZeros_of_metricShadow
  ...
  simpa [rs_R008_ueqv_R008YYNY_generators, RowAssignment.evaluation] using
    (evaluationZeros_of_rulesValidForPid
      (pointOf := pointOf) (centerClass := centerClass)
      (exactRow := exactRow) (pid := "s2_004")
      (assignment := (.pair .u .v)) (rules := rs_R008_ueqv_R008YYNY_rules)
      rs_R008_ueqv_R008YYNY_rules_check hmetric hrow hmasks hpidEq)
