...
private theorem rs_R009_ueqs1_R009Y_rules_check :
    rulesValidForPid "s2_030" (.pair .u .s1)
      rs_R009_ueqs1_R009Y_rules = true := by
  native_decide

/-- The matched exact row has the generated singleton exact pid. -/
private theorem rs_R009_ueqs1_R009Y_exactRow_pid_eq
    {exactRow : SurplusCOMPGBank.Row}
    (hpid : ["s2_030"] = [exactRow.pid]) :
...
theorem rs_R009_ueqs1_R009Y_evaluationZeros_of_metricShadow
  ...
  simpa [rs_R009_ueqs1_R009Y_generators, RowAssignment.evaluation] using
    (evaluationZeros_of_rulesValidForPid
      (pointOf := pointOf) (centerClass := centerClass)
      (exactRow := exactRow) (pid := "s2_030")
      (assignment := (.pair .u .s1)) (rules := rs_R009_ueqs1_R009Y_rules)
      rs_R009_ueqs1_R009Y_rules_check hmetric hrow hmasks hpidEq)
