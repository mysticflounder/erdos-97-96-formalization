...
/-- Generator 23 for `R009:u=v:R009NYYNY` evaluates to zero. -/
theorem rs_R009_ueqv_R009NYYNY_generator_23_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R009_ueqv_R009NYYNY_generators.get (Fin.mk 23 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R009_ueqv_R009NYYNY_generator_23_shape
    (by
      exact (
