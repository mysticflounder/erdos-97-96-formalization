...
/-- Generator 11 for `R013:u=v:R013NNNY` evaluates to zero. -/
theorem rs_R013_ueqv_R013NNNY_generator_11_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R013_ueqv_R013NNNY_generators.get (Fin.mk 11 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R013_ueqv_R013NNNY_generator_11_shape
    (by
      exact (
        eval_sqDistCenter_zero_of_exactRow_members
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s3_010") (center := .s1) (label := .u) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_010_s1_u)
          (maskHas_exactRow_of_pid (pid := "s3_010") (center := .s1) (label := .s2) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_010_s1_s2)
