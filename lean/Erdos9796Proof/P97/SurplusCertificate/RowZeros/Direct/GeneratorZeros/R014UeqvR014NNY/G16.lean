...
/-- Generator 16 for `R014:u=v:R014NNY` evaluates to zero. -/
theorem rs_R014_ueqv_R014NNY_generator_16_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R014_ueqv_R014NNY_generators.get (Fin.mk 16 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    (endpointPairAssignment pointOf .u .v) (q := twiceVarMinusOnePoly EndpointVar.s3x.index)
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R014_ueqv_R014NNY_generator_16_shape
    (by
      exact (
        eval_twiceVarMinusOne_zero_of_exactRow_v_w_members
          ...
          (maskHas_exactRow_of_pid (pid := "s3_020") (center := .s3) (label := .w) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_020_s3_w)
          (by native_decide)))
