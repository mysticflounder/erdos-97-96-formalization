...
/-- Generator 22 for `R005:u=v:R005YNY` evaluates to zero. -/
theorem rs_R005_ueqv_R005YNY_generator_22_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R005_ueqv_R005YNY_generators.get (Fin.mk 22 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R005_ueqv_R005YNY_generator_22_shape
    (by
      exact (
