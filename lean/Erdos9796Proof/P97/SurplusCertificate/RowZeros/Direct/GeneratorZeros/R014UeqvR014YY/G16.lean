...
/-- Generator 16 for `R014:u=v:R014YY` evaluates to zero. -/
theorem rs_R014_ueqv_R014YY_generator_16_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R014_ueqv_R014YY_generators.get (Fin.mk 16 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    (endpointPairAssignment pointOf .u .v) (q := twiceVarMinusOnePoly EndpointVar.s3x.index)
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R014_ueqv_R014YY_generator_16_shape
    (by
      exact (
