...
/-- Generator 0 for `R002:u=v:R002YYY` evaluates to zero. -/
theorem rs_R002_ueqv_R002YYY_generator_00_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R002_ueqv_R002YYY_generators.get (Fin.mk 0 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R002_ueqv_R002YYY_generator_00_shape
    (by
      exact (
        eval_sqNormDiff_zero_of_exactRow_v_center_members
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s1_009") (center := .v) (label := .u) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_009_v_u)
          (maskHas_exactRow_of_pid (pid := "s1_009") (center := .v) (label := .s1) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_009_v_s1)
