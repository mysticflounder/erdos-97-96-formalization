...
/-- Generator 22 for `R002:u=v:R002YYY` evaluates to zero. -/
theorem rs_R002_ueqv_R002YYY_generator_22_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R002_ueqv_R002YYY_generators.get (Fin.mk 22 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R002_ueqv_R002YYY_generator_22_shape
    (by
      exact (
        eval_sqDistCenter_zero_of_exactRow_members
          ...
          (maskHas_exactRow_of_pid (pid := "s1_009") (center := .Pu) (label := .s3) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_009_Pu_s3)
