...
/-- Generator 28 for `R013:u=v:R013NYNN` evaluates to zero. -/
theorem rs_R013_ueqv_R013NYNN_generator_28_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R013_ueqv_R013NYNN_generators.get (Fin.mk 28 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R013_ueqv_R013NYNN_generator_28_shape
    (by
      exact (
        eval_sqDistPointToUnitX_zero_of_exactRow_w_member
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s3_013") (center := .Q2) (label := .w) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_013_Q2_w)
