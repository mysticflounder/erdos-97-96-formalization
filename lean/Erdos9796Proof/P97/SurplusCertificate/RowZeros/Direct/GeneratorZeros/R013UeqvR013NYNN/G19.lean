...
/-- Generator 19 for `R013:u=v:R013NYNN` evaluates to zero. -/
theorem rs_R013_ueqv_R013NYNN_generator_19_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R013_ueqv_R013NYNN_generators.get (Fin.mk 19 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R013_ueqv_R013NYNN_generator_19_shape
    (by
      exact (
        eval_sqNormVsDist_zero_of_exactRow_v_member
          ...
          (maskHas_exactRow_of_pid (pid := "s3_013") (center := .Pw) (label := .s1) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_013_Pw_s1)
