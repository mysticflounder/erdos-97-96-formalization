...
/-- Generator 16 for `R011:u=s1:R011NY` evaluates to zero. -/
theorem rs_R011_ueqs1_R011NY_generator_16_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .s1) (Problem97.SurplusCertificate.RelaxedSplit.rs_R011_ueqs1_R011NY_generators.get (Fin.mk 16 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    (endpointPairAssignment pointOf .u .s1) (q := twiceVarMinusOnePoly EndpointVar.s3x.index)
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R011_ueqs1_R011NY_generator_16_shape
    (by
      exact (
        eval_twiceVarMinusOne_zero_of_exactRow_v_w_members
          ...
          (maskHas_exactRow_of_pid (pid := "s2_061") (center := .s3) (label := .w) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_061_s3_w)
          (by native_decide)))
