...
/-- Generator 13 for `R008:u=v:R008YYYN` evaluates to zero. -/
theorem rs_R008_ueqv_R008YYYN_generator_13_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R008_ueqv_R008YYYN_generators.get (Fin.mk 13 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R008_ueqv_R008YYYN_generator_13_shape
    (by
      exact (
        eval_sqNormVsDist_zero_of_exactRow_v_member
          ...
          (maskHas_exactRow_of_pid (pid := "s2_003") (center := .s2) (label := .s1) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_003_s2_s1)
