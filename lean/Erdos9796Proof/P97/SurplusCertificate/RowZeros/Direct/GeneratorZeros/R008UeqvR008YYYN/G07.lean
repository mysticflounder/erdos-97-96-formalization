...
/-- Generator 7 for `R008:u=v:R008YYYN` evaluates to zero. -/
theorem rs_R008_ueqv_R008YYYN_generator_07_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R008_ueqv_R008YYYN_generators.get (Fin.mk 7 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R008_ueqv_R008YYYN_generator_07_shape
    (by
      exact (
        eval_sqDistCenter_zero_of_exactRow_members
          ...
          (maskHas_exactRow_of_pid (pid := "s2_003") (center := .u) (label := .s3) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_003_u_s3)
