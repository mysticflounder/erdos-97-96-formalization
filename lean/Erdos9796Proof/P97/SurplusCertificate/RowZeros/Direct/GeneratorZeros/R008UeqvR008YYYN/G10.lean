...
/-- Generator 10 for `R008:u=v:R008YYYN` evaluates to zero. -/
theorem rs_R008_ueqv_R008YYYN_generator_10_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R008_ueqv_R008YYYN_generators.get (Fin.mk 10 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    (endpointPairAssignment pointOf .u .v) (q := twiceVarMinusOnePoly EndpointVar.s1x.index)
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R008_ueqv_R008YYYN_generator_10_shape
    (by
      exact (
        eval_twiceVarMinusOne_zero_of_exactRow_v_w_members
          ...
          (maskHas_exactRow_of_pid (pid := "s2_003") (center := .s1) (label := .w) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_003_s1_w)
          (by native_decide)))
