...
/-- Generator 27 for `R001:no_separator:R001N` evaluates to zero. -/
theorem rs_R001_no_separator_R001N_generator_27_zero
    ...
    evalPoly (endpointS1S3Assignment pointOf) (Problem97.SurplusCertificate.RelaxedSplit.rs_R001_no_separator_R001N_generators.get (Fin.mk 27 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R001_no_separator_R001N_generator_27_shape
    (by
      exact (
        eval_sqNormVsDist_zero_of_exactRow_v_member
          ...
          (maskHas_exactRow_of_pid (pid := "s1_001") (center := .Q2) (label := .s1) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_001_Q2_s1)
