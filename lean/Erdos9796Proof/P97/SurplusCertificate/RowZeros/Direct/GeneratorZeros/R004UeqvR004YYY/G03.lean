...
/-- Generator 3 for `R004:u=v:R004YYY` evaluates to zero. -/
theorem rs_R004_ueqv_R004YYY_generator_03_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R004_ueqv_R004YYY_generators.get (Fin.mk 3 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R004_ueqv_R004YYY_generator_03_shape
    (by
      exact (
        eval_sqDistToUnitX_zero_of_exactRow_w_center_members
          ...
          (maskHas_exactRow_of_pid (pid := "s1_031") (center := .w) (label := .Pw) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_031_w_Pw)
