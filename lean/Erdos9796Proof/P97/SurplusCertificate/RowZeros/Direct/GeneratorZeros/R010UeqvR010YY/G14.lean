...
/-- Generator 14 for `R010:u=v:R010YY` evaluates to zero. -/
theorem rs_R010_ueqv_R010YY_generator_14_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R010_ueqv_R010YY_generators.get (Fin.mk 14 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R010_ueqv_R010YY_generator_14_shape
    (by
      exact (
