...
/-- Generator 11 for `R011:u=v:R011YNY` evaluates to zero. -/
theorem rs_R011_ueqv_R011YNY_generator_11_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R011_ueqv_R011YNY_generators.get (Fin.mk 11 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R011_ueqv_R011YNY_generator_11_shape
    (by
      exact (
        eval_sqNormVsDist_zero_of_exactRow_v_member
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s2_055") (center := .s1) (label := .v) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_055_s1_v)
          (maskHas_exactRow_of_pid (pid := "s2_055") (center := .s1) (label := .s2) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_055_s1_s2)
