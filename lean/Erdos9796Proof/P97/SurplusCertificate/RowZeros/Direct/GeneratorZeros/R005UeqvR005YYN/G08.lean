...
/-- Generator 8 for `R005:u=v:R005YYN` evaluates to zero. -/
theorem rs_R005_ueqv_R005YYN_generator_08_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R005_ueqv_R005YYN_generators.get (Fin.mk 8 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R005_ueqv_R005YYN_generator_08_shape
    (by
      exact (
        eval_sqDistCenter_zero_of_exactRow_members
          ...
          (maskHas_exactRow_of_pid (pid := "s1_020") (center := .u) (label := .Pu) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_020_u_Pu)
