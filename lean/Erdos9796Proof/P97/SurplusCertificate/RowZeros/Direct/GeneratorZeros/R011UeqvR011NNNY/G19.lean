...
/-- Generator 19 for `R011:u=v:R011NNNY` evaluates to zero. -/
theorem rs_R011_ueqv_R011NNNY_generator_19_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R011_ueqv_R011NNNY_generators.get (Fin.mk 19 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R011_ueqv_R011NNNY_generator_19_shape
    (by
      exact (
