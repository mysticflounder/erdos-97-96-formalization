...
/-- Generator 2 for `R013:u=v:R013YNYN` evaluates to zero. -/
theorem rs_R013_ueqv_R013YNYN_generator_02_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R013_ueqv_R013YNYN_generators.get (Fin.mk 2 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R013_ueqv_R013YNYN_generator_02_shape
    (by
      exact (
        eval_sqNormDiff_zero_of_exactRow_v_center_members
          ...
          (maskHas_exactRow_of_pid (pid := "s3_002") (center := .v) (label := .Pu) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_002_v_Pu)
