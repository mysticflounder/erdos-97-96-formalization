...
/-- Generator 15 for `R013:u=v:R013YNYN` evaluates to zero. -/
theorem rs_R013_ueqv_R013YNYN_generator_15_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R013_ueqv_R013YNYN_generators.get (Fin.mk 15 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R013_ueqv_R013YNYN_generator_15_shape
    (by
      exact (
        eval_sqDistUnitXToPoint_zero_of_exactRow_w_member
          ...
          (maskHas_exactRow_of_pid (pid := "s3_002") (center := .s2) (label := .Q2) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_002_s2_Q2)
