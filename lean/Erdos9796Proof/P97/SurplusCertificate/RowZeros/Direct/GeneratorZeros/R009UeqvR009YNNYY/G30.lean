...
/-- Generator 30 for `R009:u=v:R009YNNYY` evaluates to zero. -/
theorem rs_R009_ueqv_R009YNNYY_generator_30_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R009_ueqv_R009YNNYY_generators.get (Fin.mk 30 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R009_ueqv_R009YNNYY_generator_30_shape
    (by
      exact (
        eval_sqDistCenter_zero_of_exactRow_members
          ...
          (maskHas_exactRow_of_pid (pid := "s2_039") (center := .Q2) (label := .Q1) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_039_Q2_Q1)
