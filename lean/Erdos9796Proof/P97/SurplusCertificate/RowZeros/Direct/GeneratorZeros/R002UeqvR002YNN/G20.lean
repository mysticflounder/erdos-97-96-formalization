...
/-- Generator 20 for `R002:u=v:R002YNN` evaluates to zero. -/
theorem rs_R002_ueqv_R002YNN_generator_20_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R002_ueqv_R002YNN_generators.get (Fin.mk 20 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R002_ueqv_R002YNN_generator_20_shape
    (by
      exact (
        eval_sqNormVsDist_zero_of_exactRow_v_member
          ...
          (maskHas_exactRow_of_pid (pid := "s1_012") (center := .Pw) (label := .s2) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_012_Pw_s2)
