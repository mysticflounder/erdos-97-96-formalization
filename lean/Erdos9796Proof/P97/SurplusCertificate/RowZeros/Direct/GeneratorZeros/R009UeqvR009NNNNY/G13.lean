...
/-- Generator 13 for `R009:u=v:R009NNNNY` evaluates to zero. -/
theorem rs_R009_ueqv_R009NNNNY_generator_13_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R009_ueqv_R009NNNNY_generators.get (Fin.mk 13 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R009_ueqv_R009NNNNY_generator_13_shape
    (by
      exact (
