...
/-- Generator 30 for `R003:u=v:R003NN` evaluates to zero. -/
theorem rs_R003_ueqv_R003NN_generator_30_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R003_ueqv_R003NN_generators.get (Fin.mk 30 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R003_ueqv_R003NN_generator_30_shape
    (by
      exact (
