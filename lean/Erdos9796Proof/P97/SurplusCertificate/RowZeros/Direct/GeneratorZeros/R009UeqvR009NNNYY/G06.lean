...
/-- Generator 6 for `R009:u=v:R009NNNYY` evaluates to zero. -/
theorem rs_R009_ueqv_R009NNNYY_generator_06_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R009_ueqv_R009NNNYY_generators.get (Fin.mk 6 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R009_ueqv_R009NNNYY_generator_06_shape
    (by
      exact (
