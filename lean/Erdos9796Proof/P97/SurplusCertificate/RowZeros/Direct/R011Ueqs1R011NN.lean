...
private theorem rs_R011_ueqs1_R011NN_rules_check :
    rulesValidForPid "s2_062" (.pair .u .s1)
      rs_R011_ueqs1_R011NN_rules = true := by
  native_decide

/-- The matched exact row has the generated singleton exact pid. -/
private theorem rs_R011_ueqs1_R011NN_exactRow_pid_eq
    {exactRow : SurplusCOMPGBank.Row}
    (hpid : ["s2_062"] = [exactRow.pid]) :
...
theorem rs_R011_ueqs1_R011NN_evaluationZeros_of_metricShadow
  ...
  simpa [rs_R011_ueqs1_R011NN_generators, RowAssignment.evaluation] using
    (evaluationZeros_of_rulesValidForPid
      (pointOf := pointOf) (centerClass := centerClass)
      (exactRow := exactRow) (pid := "s2_062")
      (assignment := (.pair .u .s1)) (rules := rs_R011_ueqs1_R011NN_rules)
      rs_R011_ueqs1_R011NN_rules_check hmetric hrow hmasks hpidEq)
