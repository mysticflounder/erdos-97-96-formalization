...
private theorem rs_R008_ueqv_R008YNYY_rules_check :
    rulesValidForPid "s2_011" (.pair .u .v)
      rs_R008_ueqv_R008YNYY_rules = true := by
  native_decide

/-- The matched exact row has the generated singleton exact pid. -/
private theorem rs_R008_ueqv_R008YNYY_exactRow_pid_eq
    {exactRow : SurplusCOMPGBank.Row}
    (hpid : ["s2_011"] = [exactRow.pid]) :
...
theorem rs_R008_ueqv_R008YNYY_evaluationZeros_of_metricShadow
  ...
  simpa [rs_R008_ueqv_R008YNYY_generators, RowAssignment.evaluation] using
    (evaluationZeros_of_rulesValidForPid
      (pointOf := pointOf) (centerClass := centerClass)
      (exactRow := exactRow) (pid := "s2_011")
      (assignment := (.pair .u .v)) (rules := rs_R008_ueqv_R008YNYY_rules)
      rs_R008_ueqv_R008YNYY_rules_check hmetric hrow hmasks hpidEq)
