...
import Erdos9796Proof.P97.U1Depth5HSlotRecord001F1ExtraOmit3000
import Erdos9796Proof.P97.U1Depth5HSlotRecord001F1ExtraOmit3006
import Erdos9796Proof.P97.U1Depth5HSlotRecord001F1ExtraOmit3010

/-!
# Record001 branch-0 `f1:q` omit3 adapter

This module connects the non-circular hard-`f1` omit3 hslot certificates for
the `f1:q` extra-incidence branch to the record001 branch-0 source-UNIT replay.
...
/-- Under the `f1:q` packet-label extra-incidence atom, the three record001
...
theorem false_of_f1q_extra_omit3
    ...
    (hslot_t1_t3_f1 :
      dist (payload.packet.point U1Depth5.t1)
        ...
        dist (payload.packet.point U1Depth5.t1)
          ((payload.packet.rows.rowAt U1Depth5.CriticalSource.t1).slotPoint 0))
    (hextra_f1_q :
      dist (payload.packet.point U1Depth5.f1) (payload.packet.point U1Depth5.q) =
  ...
  have hrow_4 :
    ...
    cert_00001_9076bb8feb808d94_hslot_f1_f3_f2_of_row_slot_packet
      ...
      payload.hrow_24 payload.hrow_25 payload.hrow_26 hextra_f1_q
  have hrow_5 :
      dist (payload.packet.point U1Depth5.f1)
          (payload.packet.point U1Depth5.f4) =
        dist (payload.packet.point U1Depth5.f1)
          (payload.packet.point U1Depth5.f2) :=
    cert_00007_bfc2d4d2cfe13c97_hslot_f1_f4_f2_of_row_slot_packet
      payload.packet hrow_0 hrow_1 hrow_2 payload.hrow_12 hrow_10 hrow_11
      hrow_13 hrow_14 hrow_15 payload.hrow_20 payload.hrow_21 payload.hrow_22
      payload.hrow_24 payload.hrow_25 payload.hrow_26 hextra_f1_q
  have hrow_6 :
      dist (payload.packet.point U1Depth5.f1)
        ...
        dist (payload.packet.point U1Depth5.f1)
          (payload.packet.point U1Depth5.f2) :=
    cert_00011_2999a49f6dff542a_hslot_f1_p_f2_of_row_slot_packet
      payload.packet hrow_0 hrow_1 hrow_2 payload.hrow_12 hrow_10 hrow_11
      hrow_13 hrow_14 hrow_15 payload.hrow_20 payload.hrow_21 payload.hrow_22
      payload.hrow_24 payload.hrow_25 payload.hrow_26 hextra_f1_q
  exact
