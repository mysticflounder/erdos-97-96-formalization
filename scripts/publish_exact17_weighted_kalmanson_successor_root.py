"""Create-once publication of the Lean-owned weighted-Kalmanson successor CNF."""
...
AUDIT_SCHEMA = "p97-exact17-weighted-kalmanson-successor-independent-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "source": {
            ...
            "theorem": (
                "Problem97."
                "ATailBlockerVExactSeventeenFortySeventhModelRefinements."
                "sourceAssign_extendedFortySeventhModelRefinementsCnf"
            ),
            "terminal_adapter": (
                "Problem97."
                "ATailBlockerVExactSeventeenFortySeventhModelRefinements."
                "false_of_sourceRealization_of_extendedFortySeventhModelRefinementsCnf_unsat"
            ),
        },
        "parent": {
