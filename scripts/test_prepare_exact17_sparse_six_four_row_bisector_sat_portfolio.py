...
"""Adversarial tests for center-02 SAT-profile portfolio preparation."""
...
import prepare_exact17_sparse_six_four_row_bisector_sat_portfolio as subject
import pytest
...
def test_mutation_is_rejected_before_output(
    ...
    with pytest.raises(subject.PreparationError, match="byte identity drifted"):
        subject.prepare_portfolio(
            root=fixture["root"],
            campaign_path=fixture["campaign"],
            source_run_manifest_path=fixture["source_run"],
