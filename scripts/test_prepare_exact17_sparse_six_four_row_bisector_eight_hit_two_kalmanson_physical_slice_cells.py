...
"""Adversarial tests for the eight-hit two-Kalmanson successor preparer."""
...
def _successor(
    *,
    ...
    clauses = subject.EXPECTED_EIGHT_HIT_SUFFIX if suffix is None else suffix
    body = parent.split(b"\n", 1)[1]
    suffix_bytes = b"".join(
...
def test_parent_duplicate_suffix_clause_fails_before_children(
    ...
    paths, calls = _fixture(tmp_path, monkeypatch)
    duplicate = subject.EXPECTED_EIGHT_HIT_SUFFIX[0]
    original = (
