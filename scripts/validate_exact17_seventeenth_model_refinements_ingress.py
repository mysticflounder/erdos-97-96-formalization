"""Fail-closed PIQD ingress for the exact-17 eighteenth child."""
...
SCHEMA = "p97-exact17-lean-seventeenth-model-refinements-piqd-ingress/v1"
DAEMON_SHA256 = "0cfc9577656fa3aef143a9fe7e5577d938dba9fd39f3b7118ed91735c97fc360"
ROOT_SHA256 = "40497f4c54505f66071aa7006040843d16592136d64b0a0508d895b11860577a"
PARENT_ROOT_SHA256 = "f02af969370d424cc45059e6f7996dce60b5efdabe0f9d8a34d89d42da40448c"
ROOT_BYTES = 291_571_538
VARIABLES = 308
ROOT_CLAUSES = 5_846_160
PARENT_CLAUSES = 5_846_144
NEW_CLAUSES = 16
EXPECTED_SOURCE_PATHS = (
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenSeventeenthModelRefinements.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenSeventeenthModelRefinementsExport.lean",
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    parent_result = load_module(
        parent_validator, "exact17_sixteenth_model_refinements_ingress"
    ...
    regenerated = load_module(
        validator, "exact17_seventeenth_model_refinements_export"
    ...
    require(len(cuts) == 4 and all(cuts.values()), "not every model motif is cut")
    ...
    require(
        validation["motivating_model_cut_by_all_four_orbits"] is True,
    ...
    return {
        "schema": "p97-exact17-lean-seventeenth-model-refinements-piqd-ingress-validation/v1",
