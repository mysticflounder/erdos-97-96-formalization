...
"""Run the authenticated six-cell center-02 SAT-profile portfolio once.
...
there is deliberately no recovery/finalize command.
"""
...
import prepare_exact17_sparse_six_four_row_bisector_sat_portfolio as preparation
...
LAUNCH_SCHEMA = "p97-exact17-sparse-six-four-row-bisector-sat-profile-launch/v1"
RESULT_SCHEMA = "p97-exact17-sparse-six-four-row-bisector-sat-profile-result/v1"
PROJECT = "erdos-97-96-exact17-sparse-six-four-row-bisector-center02-sat-v1"
DAEMON_IDENTITY = {
    "name": "piqd",
    "version": "0.1.0",
    "protocol_version": 1,
    ...
    *,
    ...
    if launch_mode == "REMAINING_FIVE":
        canary_cells = [
            ...
            if cell["cell_id"] == "four-row-bisector-next-center-02-physical-none"
        ]
