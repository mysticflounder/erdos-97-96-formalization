"""Fail-closed PIQD ingress for the exact-17 two-Kalmanson child root."""
...
SCHEMA = "p97-exact17-lean-two-kalmanson-piqd-ingress/v1"
DAEMON_SHA256 = "fd1cacee52677a555f8b3d24c6052c71022e4dfd6ccc9037f165d1d22ec384eb"
ROOT_SHA256 = "ae29c7b97602f2e6ff6c746badb13ee8abad13afec3b005da0e6c632d5e1f7fd"
ROOT_BYTES = 260_039_332
VARIABLES = 308
ROOT_CLAUSES = 5_301_532
PARENT_CLAUSES = 4_756_988
NEW_CLAUSES = 544_544
PARENT_ROOT_SHA256 = "38db47b94b1f259feeb427a48850a94c58adf300deea0b37302a39435676e76a"
EXPECTED_SOURCE_PATHS = (
    "lean/Erdos9796Proof/P97/ATail/TwoKalmansonEqualityChainSchemas.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenSourceCnfCdefgEqualK4TwoCircleThreeRowHijkInterleavedEqualityChainPerpBisectorChainTwoKalmanson.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenSourceCnfCdefgEqualK4TwoCircleThreeRowHijkInterleavedEqualityChainPerpBisectorChainTwoKalmansonExport.lean",
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    require(
        root_record["checked_two_kalmanson_clauses"] == NEW_CLAUSES,
        "wrong two-Kalmanson count",
    )
    ...
    perp_manifest = load_json(parent_manifest_path)
    ...
    perp_validator = check_named_hash(repo, validation, "parent_validator")
    ...
    regenerated = load_module(validator, "exact17_two_kalmanson_export").validate(
    ...
    require(
        regenerated["two_kalmanson_clauses"] == NEW_CLAUSES,
        "validator suffix mismatch",
    )
    require(regenerated["parent_prefix_byte_identical"] is True, "prefix mismatch")
    require(
        isinstance(regenerated["motivating_model_cut_clause"], int), "model not cut"
    )
    require(validation["parent_prefix_byte_identical"] is True, "prefix claim missing")
    require(
        validation["all_two_kalmanson_clauses_independently_regenerated"] is True,
    ...
    return {
        "schema": "p97-exact17-lean-two-kalmanson-piqd-ingress-validation/v1",
        "manifest_sha256": sha256(manifest_path),
        "dimacs_sha256": sha256(root),
        "dimacs_bytes": root.stat().st_size,
        "variables": VARIABLES,
        "clauses": ROOT_CLAUSES,
        "two_kalmanson_clauses": NEW_CLAUSES,
