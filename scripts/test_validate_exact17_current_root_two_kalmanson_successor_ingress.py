"""Focused fail-closed tests for the current-root-two-kalmanson-successor PIQD ingress."""
...
import pytest
import validate_exact17_current_root_two_kalmanson_successor_ingress as subject
...
def test_production_ingress_replays_and_binds_every_published_identity() -> None:
    ...
    assert subject.RECEIPT_SHA256 == (
        "bcca9a4cfa98bd7a548078191b58d3a7616d21d8cdf46a8800fa83804663a8ee"
    )
    ...
    assert subject.AUDIT_REPORT_SHA256 == (
        "1b5b6df92ac111311f6f11a373359fac1574dfff81019f441c9562b6aa7c29cb"
    )
    assert subject.VALIDATOR_SOURCE_COMMIT == "423d51453169495a498c33f612a1ced4f2ac8cbe"
    assert subject.PUBLISHER_SOURCE_COMMIT == "00c941c5f2f0f603a0c6d77004c17dcc89ccc8d4"
