"""Fail-closed PIQD ingress for the exact-17 seventeenth child."""
...
SCHEMA = "p97-exact17-lean-sixteenth-model-refinements-piqd-ingress/v1"
DAEMON_SHA256 = "0cfc9577656fa3aef143a9fe7e5577d938dba9fd39f3b7118ed91735c97fc360"
ROOT_SHA256 = "f02af969370d424cc45059e6f7996dce60b5efdabe0f9d8a34d89d42da40448c"
PARENT_ROOT_SHA256 = "c8e6011fce2f0373fffa23b45285d38e95224a60778623bdb5c53e323b951d38"
ROOT_BYTES = 291_570_878
VARIABLES = 308
ROOT_CLAUSES = 5_846_144
PARENT_CLAUSES = 5_846_112
NEW_CLAUSES = 32
EXPECTED_SOURCE_PATHS = (
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenConvexFivePointFifthRows.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenSixteenthModelRefinements.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenSixteenthModelRefinementsExport.lean",
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    parent_result = load_module(
        parent_validator, "exact17_fifth_convex_five_point_ingress"
    ...
    regenerated = load_module(
        validator, "exact17_sixteenth_model_refinements_export"
    ...
    require(len(cuts) == 8 and all(cuts.values()), "not every model motif is cut")
    ...
    require(
        validation["motivating_model_cut_by_all_eight_orbits"] is True,
    ...
    return {
        "schema": "p97-exact17-lean-sixteenth-model-refinements-piqd-ingress-validation/v1",
