...
"""Offline adversarial tests for the six-job two-Kalmanson portfolio runner."""
...
import pytest
import run_piqd_exact17_sparse_six_four_row_bisector_two_kalmanson_sat_portfolio as subject
import test_prepare_exact17_sparse_six_four_row_bisector_two_kalmanson_sat_portfolio as fixtures
...
def test_unknown_single_cell_canary_aggregates_with_rest_without_portfolio_complete(
    ...
    canary_id = (
        "four-row-bisector-two-kalmanson-next-center-02-physical-none-sat-profile-v1"
    )
