...
# Immutable production pins remain deliberately empty until the source preparer
# has completed and its retained campaign can be authenticated independently.
