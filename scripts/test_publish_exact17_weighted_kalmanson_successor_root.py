...
import publish_exact17_weighted_kalmanson_successor_root as publisher
import pytest
...
def test_coverage_ledger_binds_weighted_profile() -> None:
    ...
    assert ledger["profile_id"] == "exact17-weighted-kalmanson-successor"
    assert ledger["enumeration"]["clauses"] == 32
