#!/usr/bin/env python3
"""Submit and finalize the twenty-fourth Lean-owned exact-17 PIQD root.
...
rooted at the twenty-third model refinements. The inherited persisted-state
...
def load_runner() -> dict[str, Any]:
    ...
    source = source.replace("twentieth", "twenty-fourth")
    namespace: dict[str, Any] = {
        "__file__": str(BASE_RUNNER),
        "__name__": "_piqd_exact17_twenty_fourth_root_base",
    }
    ...
    runner.update(
        {
            ...
            / "piqd-ingress-manifest-twenty-third-model-refinements.json",
            "INGRESS_REPORT": scratch
            / "exact17-twenty-fourth-root-validation.json",
            "VARIABLES": 308,
            "CLAUSES": 5_846_232,
            "BYTES": 291_574_986,
            "CNF_SHA256": "588dffabc01a84dd3990045b87995d9679b158b77f41bf7f8ee2499d091fe1eb",
            "MANIFEST_SHA256": "8fb781e79e6a2a4acb43aa139b2f7bdfa9260b7675e88e7a4712133602c8323f",
