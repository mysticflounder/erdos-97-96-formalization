...
"""Prepare the exact-17 survivor FourPointTwoCircle physical-slice cells.
...
root identity with the four-clause survivor FourPointTwoCircle successor identities.
...
V2 survivor-refinement parent and proves that every successor clause is
...
ROOT = REPO_ROOT
LANE_ID = "exact17-canary-perp-bisector-survivor-four-point-two-circle-preparer-20260822"
RUN_ID = "preparation-v1"
RUN_OWNER = "exact17-canary-perp-bisector-survivor-four-point-two-circle-preparer"
...
SOURCE_PATH = ROOT / (
    ...
    "BlockerVExactSeventeenCanaryPerpBisectorSurvivorFourPointTwoCircleRefinementsPhysicalSliceCoverage.lean"
)
...
EXPORTER_PATH = ROOT / (
    "lean/Erdos9796Proof/P97/ATail/"
    "BlockerVExactSeventeenCanaryPerpBisectorSurvivorFourPointTwoCircleRefinementsPhysicalSliceCellExport.lean"
)
IMMEDIATE_PARENT_EXPORTER_PATH = ROOT / (
    "lean/Erdos9796Proof/P97/ATail/"
    "BlockerVExactSeventeenCanaryPerpBisectorSurvivorTwoKalmansonRefinementsV2Export.lean"
)
...
TEST_PATH = ROOT / (
    "scripts/test_prepare_exact17_canary_perp_bisector_survivor_four_point_two_circle_refinements_physical_slice_cells.py"
)
PRODUCTION_CONFIG_RELATIVE = Path(
    "census/p97_search/waves/exact17/"
    "canary-perp-bisector-survivor-four-point-two-circle-refinements-preparation-config.json"
)
PRODUCTION_CONFIG_PATH = ROOT / PRODUCTION_CONFIG_RELATIVE
PRODUCTION_CONFIG_SCHEMA = "p97-exact17-canary-perp-bisector-survivor-four-point-two-circle-refinements-preparation-config/v1"
...
IMMEDIATE_PARENT_CLAUSES = 7_409_512
CELL_CLAUSES = 7_409_522
CELL_COUNT = 76
DIRECT_SENTINELS = (
    (0, "none"),
    (0, "unique-06"),
...
SOURCE_THEOREM = (
    "Problem97."
    "ATailBlockerVExactSeventeenCanaryPerpBisectorSurvivorFourPointTwoCircleRefinementsPhysicalSliceCoverage."
...
EXPECTED_CANARY_PERP_BISECTOR_SURVIVOR_FOUR_POINT_TWO_CIRCLE_REFINEMENT_SUFFIX = (
    (-307, -7, -2, -103, -108, -176, -172, -18, -24, -28),
    (-307, -252, -247, -236, -233, -80, -77, -151, -150, -141),
    (-308, -7, -2, -103, -108, -176, -172, -18, -24, -28),
    (-308, -252, -247, -236, -233, -80, -77, -151, -150, -141),
)
...
SCHEMA = "p97-exact17-canary-perp-bisector-survivor-four-point-two-circle-refinements-physical-slice-preparation/v1"
CAMPAIGN_SCHEMA = "p97-exact17-canary-perp-bisector-survivor-four-point-two-circle-refinements-physical-slice-campaign/v1"
PRODUCER_SCHEMA = accepted.PRODUCER_SCHEMA
SOURCE_SCHEMA = accepted.SOURCE_SCHEMA
WAVE_SCHEMA = accepted.WAVE_SCHEMA
FINITE_SCHEMA = "p97-exact17-canary-perp-bisector-survivor-four-point-two-circle-refinements-physical-slice/v1"
ROOT_PRODUCER_SCHEMA = "p97-exact17-canary-perp-bisector-survivor-four-point-two-circle-refinements-root-producer/v1"
...
def category_id(center: int, category: str) -> str:
    ...
    return f"canary-perp-bisector-survivor-four-point-two-circle-refinements-next-center-{center:02d}-physical-{category}"
...
def _validate_canary_perp_bisector_survivor_four_point_two_circle_refinement_contract() -> None:
    suffix = EXPECTED_CANARY_PERP_BISECTOR_SURVIVOR_FOUR_POINT_TWO_CIRCLE_REFINEMENT_SUFFIX
    if len(suffix) != 4 or len(set(suffix)) != 4:
        raise PreparationError(
    ...
    for clause in suffix:
        if not clause:
            raise PreparationError("survivor FourPointTwoCircle refinement clause is empty")
    ...
    if PARENT_CLAUSES != IMMEDIATE_PARENT_CLAUSES + len(suffix):
        raise PreparationError("successor root is not parent plus four-clause suffix")
...
def validate_canary_perp_bisector_survivor_four_point_two_circle_refinement_parent_novelty(
    immediate_parent: _PublishedFile,
    successor_root: _PublishedFile,
) -> dict[str, Any]:
    """Authenticate the exact four-clause suffix against the complete parent."""
    _validate_canary_perp_bisector_survivor_four_point_two_circle_refinement_contract()
    parent_before = immediate_parent.verify("immediate survivor-refinement parent")
    successor_before = successor_root.verify("survivor FourPointTwoCircle successor root")
    ...
    successor_after = successor_root.verify("survivor FourPointTwoCircle successor root")
    ...
    return {
        "schema": "p97-exact17-canary-perp-bisector-survivor-four-point-two-circle-refinements-parent-novelty/v1",
        "policy": {
    ...
    *,
    ...
    with _retained_support(support_files) as custody:
        ...
        try:
            ...
            parent_novelty = validate_canary_perp_bisector_survivor_four_point_two_circle_refinement_parent_novelty(
