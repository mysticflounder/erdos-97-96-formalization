"""Create-once publication adapter for the V49 wave-v8 seventeen-support child."""
...
import validate_exact17_forty_ninth_wave_v8_seventeen_size8_promotion_export as validator

ROOT = Path(__file__).resolve().parents[1]
PACKAGE_ROOT = (
    ROOT
    / "scratch/runs/exact17-forty-ninth-wave-v8-seventeen-size8-publication-20260817/export-v1"
)
...
VALIDATOR_SOURCE_COMMIT = "b96f9d86799a4699e9dcf1684a4d59e3157ec584"
VALIDATOR_SHA256 = "b35f6d79a3652a3502f509c12087988e30d00c67b211c458669540dc656a1dcf"
VALIDATOR_BYTES = 14_226
RECEIPT_SCHEMA = "p97-exact17-forty-ninth-wave-v8-seventeen-size8-promotion-receipt/v1"
COVERAGE_SCHEMA = (
    "p97-exact17-forty-ninth-wave-v8-seventeen-size8-promotion-coverage/v1"
)
AUDIT_SCHEMA = "p97-exact17-forty-ninth-wave-v8-seventeen-size8-promotion-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-wave-v8-seventeen-size8-promotion",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV8SeventeenSize8Promotion.sourceAssign_extendedFortyNinthWaveV8SeventeenSize8PromotionCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV8SeventeenSize8Promotion.false_of_sourceRealization_of_extendedFortyNinthWaveV8SeventeenSize8PromotionCnf_unsat",
        },
