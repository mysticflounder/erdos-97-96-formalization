"""Create-once publication for the two direct zero-atom V49 successor child."""
...
import validate_exact17_forty_ninth_next_zero_atom_promotion_export as validator

ROOT = Path(__file__).resolve().parents[1]
PACKAGE_ROOT = ROOT / (
    "scratch/runs/exact17-forty-ninth-next-zero-atoms-20260817/export-v1"
)
...
VALIDATOR_SOURCE_COMMIT = "38e0d1473f80ab3e76d5d33bef737a3107c8a698"
VALIDATOR_SHA256 = "804bfc00f89c5f2bc86f3d898a0f7444c7ee36d2d77b5105d26c11f27b969386"
VALIDATOR_BYTES = 5432
RECEIPT_SCHEMA = "p97-exact17-forty-ninth-next-zero-atom-promotion-receipt/v1"
COVERAGE_SCHEMA = "p97-exact17-forty-ninth-next-zero-atom-promotion-coverage/v1"
AUDIT_SCHEMA = "p97-exact17-forty-ninth-next-zero-atom-promotion-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-next-zero-atom-promotion",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthNextZeroAtomPromotion.sourceAssign_extendedFortyNinthNextZeroAtomPromotionCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthNextZeroAtomPromotion.false_of_sourceRealization_of_extendedFortyNinthNextZeroAtomPromotionCnf_unsat",
        },
