"""Create-once publication for the three direct-zero V49 wave-v4 child."""
...
import validate_exact17_forty_ninth_wave_v4_three_zero_atom_promotion_export as validator

ROOT = Path(__file__).resolve().parents[1]
PACKAGE_ROOT = ROOT / (
    "scratch/runs/exact17-forty-ninth-wave-v4-three-zero-atoms-20260817/export-v1"
)
...
VALIDATOR_SOURCE_COMMIT = "957dc029495acc566b31526efab1fa73aed01275"
VALIDATOR_SHA256 = "40e8736632cbec34ec5adef12cf576bffd6d7f4e57dd46603484e7ec846e850d"
VALIDATOR_BYTES = 5273
RECEIPT_SCHEMA = "p97-exact17-forty-ninth-wave-v4-three-zero-atom-promotion-receipt/v1"
COVERAGE_SCHEMA = "p97-exact17-forty-ninth-wave-v4-three-zero-atom-promotion-coverage/v1"
AUDIT_SCHEMA = "p97-exact17-forty-ninth-wave-v4-three-zero-atom-promotion-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-wave-v4-three-zero-atom-promotion",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV4ThreeZeroAtomPromotion.sourceAssign_extendedFortyNinthWaveV4ThreeZeroAtomPromotionCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV4ThreeZeroAtomPromotion.false_of_sourceRealization_of_extendedFortyNinthWaveV4ThreeZeroAtomPromotionCnf_unsat",
        },
