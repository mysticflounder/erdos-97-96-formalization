...
SCHEMA = "p97-exact17-lean-nineteenth-model-refinements-piqd-ingress/v1"
DAEMON_SHA256 = "e00419994dac6c4ae8446b94eac0ae84a7025ea97ee0b3ffa42a20734367cd8f"
ROOT_SHA256 = "e719b8c17edf85e089d859fbc1ab8aaa43d8a6e9514f32eb4a76842a665dd3ce"
ROOT_BYTES = 291_573_096
PARENT_ROOT_SHA256 = "534ae4fb643f76f5cdf7cecdd6ee984fb41da3dc76da202e082075d3d82c3db2"
ROOT_PATH = "scratch/exact17-lean-to-sat/exact17-twentieth-root-nineteenth-model-refinements.cnf"
PARENT_INGRESS_PATH = "scratch/exact17-lean-to-sat/piqd-ingress-manifest-eighteenth-model-refinements.json"
VARIABLES = 308
ROOT_CLAUSES = 5_846_188
PARENT_CLAUSES = 5_846_164
NEW_CLAUSES = 24
EXPECTED_SOURCE_PATHS = (
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenNineteenthModelRefinements.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenNineteenthModelRefinementsExport.lean",
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    parent_result = load_module(
        parent_validator, "exact17_eighteenth_model_refinements_ingress"
    ...
    regenerated = load_module(
        validator, "exact17_nineteenth_model_refinements_export"
    ...
    require(all(cuts.get(name) for name in (
        "five_row", "bisector_one", "bisector_two", "convex_five",
        "cancellation", "duplicate_center",
    )), "not every motif cuts the motivating model")
    ...
    require(validation["motivating_model_cut_by_all_six_orbits"] is True, "model-cut claim missing")
    ...
    return {
        "schema": "p97-exact17-nineteenth-model-refinements-piqd-ingress-validation/v1",
