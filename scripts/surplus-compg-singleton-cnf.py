...
CELL_SPECS = {
    ...
    for spec in (
        ...
        CellSpec(
            "s1840",
            "s1",
            (368, 201, 840, 275, 170, 86, 660, 45, 547, 390),
            ("u", "Q1", "Q2", "Pw", "Pu", "s2", "s3", "s1"),
            "s1840",
            (
                (368, 201, 840, 660, 294, 29, 142, 581, 674, 275),
                (368, 201, 840, 278, 676, 29, 142, 581, 658, 291),
                (432, 201, 840, 86, 43, 156, 390, 609, 531, 300),
                (432, 201, 840, 275, 45, 86, 156, 593, 646, 298),
                (432, 201, 840, 275, 45, 86, 156, 609, 646, 298),
                (432, 201, 840, 86, 291, 29, 170, 549, 531, 390),
                (432, 201, 840, 86, 291, 29, 170, 609, 531, 390),
                (432, 201, 840, 86, 291, 29, 172, 609, 531, 390),
                (432, 201, 840, 86, 291, 533, 154, 45, 610, 390),
                (688, 201, 840, 533, 43, 156, 418, 337, 582, 300),
            ),
            (
                "s1840TargetA",
                "s1840TargetB",
        ...
        CellSpec(
            "s1864",
            "s1",
            (114, 201, 864, 531, 680, 78, 390, 281, 660, 300),
            ("u", "Q1", "Q2", "Pw", "Pu", "s3", "s2", "s1"),
            "s1864",
            (
                (178, 201, 864, 531, 106, 652, 390, 281, 596, 300),
                (284, 201, 864, 688, 102, 525, 170, 323, 531, 390),
                (284, 201, 864, 688, 291, 525, 170, 101, 531, 390),
                (284, 201, 864, 294, 553, 660, 170, 113, 582, 275),
                (284, 201, 864, 294, 553, 660, 170, 113, 582, 402),
                (284, 201, 864, 688, 291, 525, 170, 101, 594, 390),
                (284, 201, 864, 402, 680, 86, 43, 593, 646, 293),
            ),
            (
                "s1864TargetA",
                "s1864TargetB",
        ...
        CellSpec(
            "s3864",
            "s3",
            (344, 225, 864, 306, 556, 86, 170, 579, 533, 390),
            ("u", "Q1", "Q2", "Pw", "Pu", "s2", "s1", "s3"),
            "s3864",
            (
                (344, 225, 864, 306, 556, 86, 170, 579, 533, 396),
                (344, 225, 864, 306, 556, 86, 170, 579, 660, 269),
                (344, 225, 864, 306, 652, 86, 45, 579, 533, 267),
                (344, 225, 864, 306, 652, 86, 166, 579, 533, 267),
                (344, 225, 864, 306, 652, 86, 45, 579, 533, 394),
                (344, 225, 864, 306, 652, 86, 166, 579, 533, 394),
                (344, 225, 864, 402, 652, 86, 45, 579, 533, 267),
                (344, 225, 864, 562, 652, 86, 390, 45, 533, 267),
                (408, 225, 864, 306, 556, 86, 170, 579, 533, 390),
                (408, 225, 864, 306, 556, 86, 43, 593, 646, 269),
                (408, 225, 864, 306, 556, 86, 170, 593, 646, 269),
                (408, 225, 864, 306, 652, 86, 45, 579, 533, 267),
                (408, 225, 864, 306, 652, 86, 166, 579, 533, 267),
                (408, 225, 864, 531, 46, 660, 390, 85, 525, 306),
                (408, 225, 864, 562, 652, 86, 390, 45, 533, 267),
                (408, 225, 864, 562, 652, 86, 390, 75, 533, 300),
            ),
            (
                "s3864TargetA", "s3864TargetB", "s3864TargetC", "s3864TargetD",
                "s3864TargetE", "s3864TargetF", "s3864TargetG", "s3864TargetH",
                "s3864TargetI", "s3864TargetJ", "s3864TargetK", "s3864TargetL",
                "s3864TargetM", "s3864TargetN", "s3864TargetO", "s3864TargetP",
                "s3864TargetQ",
            ),
        ),
        CellSpec(
        ...
        CellSpec(
            "s1904",
            "s1",
            (432, 201, 904, 338, 43, 533, 150, 325, 610, 300),
            ("u", "Q1", "Q2", "Pw", "Pu", "s3", "s2", "s1"),
            "s1904",
            (
                (432, 201, 904, 338, 46, 596, 29, 609, 646, 291),
                (432, 201, 904, 275, 106, 29, 150, 581, 547, 300),
                (432, 201, 904, 275, 106, 150, 45, 593, 547, 326),
                (432, 201, 904, 278, 106, 596, 45, 83, 646, 291),
                (432, 201, 904, 534, 354, 92, 43, 593, 549, 275),
                (432, 201, 904, 275, 610, 92, 150, 593, 549, 298),
                (688, 201, 904, 549, 354, 150, 43, 337, 582, 284),
                (688, 201, 904, 338, 549, 150, 29, 353, 582, 298),
                (688, 201, 904, 354, 549, 150, 43, 337, 582, 284),
            ),
            (
                "s1904TargetA",
                "s1904TargetB",
        ...
        CellSpec(
            "s2785",
            "s2",
            (424, 209, 785, 306, 556, 86, 156, 75, 547, 390),
            ("u", "Q1", "Q2", "Pu", "Pw", "s1", "s3", "s2"),
            "s2785",
            (
                (424, 209, 785, 306, 616, 86, 156, 75, 547, 390),
                (424, 209, 785, 306, 616, 86, 156, 75, 549, 390),
                (424, 209, 785, 306, 45, 86, 156, 99, 523, 390),
                (424, 209, 785, 534, 354, 92, 178, 75, 525, 390),
                (424, 209, 785, 534, 354, 92, 178, 75, 549, 390),
                (424, 209, 785, 534, 616, 156, 390, 75, 549, 306),
                (424, 209, 785, 534, 106, 156, 390, 77, 549, 306),
                (424, 209, 785, 534, 616, 156, 390, 77, 549, 306),
                (424, 209, 785, 534, 43, 156, 390, 101, 525, 306),
                (424, 209, 785, 562, 652, 86, 390, 75, 549, 284),
                (424, 209, 785, 562, 652, 86, 390, 99, 549, 284),
                (424, 209, 785, 562, 652, 90, 390, 77, 549, 354),
                (424, 209, 785, 562, 652, 90, 390, 99, 549, 332),
                (424, 209, 785, 564, 354, 92, 674, 75, 525, 390),
                (424, 209, 785, 564, 354, 92, 652, 75, 547, 390),
            ),
            (
                "s2785TargetA",
                "s2785TargetB",
        ...
        CellSpec(
            "s2912",
            "s2",
            (424, 209, 912, 291, 556, 86, 29, 609, 646, 330),
            ("u", "Q1", "Q2", "Pw", "Pu", "s3", "s1", "s2"),
            "s2912",
            (
                (424, 209, 912, 306, 616, 86, 29, 579, 549, 267),
                (424, 209, 912, 306, 549, 86, 29, 99, 646, 267),
                (424, 209, 912, 306, 556, 86, 29, 99, 646, 267),
                (424, 209, 912, 306, 556, 86, 29, 609, 646, 267),
                (424, 209, 912, 306, 556, 86, 29, 609, 646, 330),
                (424, 209, 912, 278, 610, 92, 51, 585, 549, 267),
                (424, 209, 912, 534, 354, 92, 51, 585, 549, 267),
                (424, 209, 912, 534, 354, 92, 51, 585, 549, 270),
                (424, 209, 912, 534, 291, 92, 166, 609, 525, 330),
                (616, 209, 912, 549, 170, 332, 29, 323, 646, 306),
                (680, 209, 912, 354, 549, 142, 51, 329, 582, 284),
                (680, 209, 912, 549, 354, 142, 51, 329, 582, 284),
            ),
            (
                "s2912TargetA",
                "s2912TargetB",
