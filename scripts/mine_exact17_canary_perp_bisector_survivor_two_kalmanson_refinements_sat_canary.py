...
gated survivor two-Kalmanson-refinement portfolio runner.
...
from scripts import (
    run_piqd_exact17_canary_perp_bisector_survivor_two_kalmanson_refinements_sat_portfolio as runner,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"canary perp-bisector survivor two-Kalmanson SAT mine rejected: {exc}", file=sys.stderr)
        return 1
