...
"""Contracts for the authenticated SixHitBisector canary-two-Kalmanson canary-two-Kalmanson SAT-profile portfolio."""
...
import pytest
import run_piqd_exact17_sparse_six_four_row_bisector_eight_hit_two_kalmanson_six_hit_bisector_canary_two_kalmanson_sat_portfolio as subject
...
def test_lane_is_bound_to_audited_six_hit_canary_two_kalmanson_v1_source() -> None:
    ...
    assert preparation.SOURCE_PREPARER_COMMIT == (
        "70565a5b8ccc05a9e179f9cbe2267f8169280c58"
    )
    for value in (
...
def test_public_cli_exposes_prepare_and_six_hit_identity() -> None:
    ...
    assert "SixHitBisector canary-two-Kalmanson" in result.stdout
