"""Fail-closed PIQD ingress for the exact-17 thirty-first child."""
...
SCHEMA = "p97-exact17-lean-thirtieth-model-refinements-piqd-ingress/v1"
DAEMON_SHA256 = "aa47e2ff3000890d11da79296721f0f51c3a228d4ef8446af3c3d2a73d969107"
ROOT_SHA256 = "3c847c1ebcacf85256b65d54563584a8b89eb50f427fe268e2f916d4cdafa204"
ROOT_BYTES = 291_602_886
PARENT_ROOT_SHA256 = "02aca42eb22814540816d9e4f1d19b2c71888700147e6b832d735f9efc41acd0"
PARENT_MANIFEST_SHA256 = "db261da1107184863e18a56ebbba69ce44653560add981679e235accc9be80b4"
ROOT_PATH = (
...
EXPECTED_SOURCE_PATHS = (
    (
        ...
        "BlockerVExactSeventeenThirtiethModelRefinements.lean"
    ),
    (
        "lean/Erdos9796Proof/P97/ATail/"
        "BlockerVExactSeventeenThirtiethModelRefinementsExport.lean"
    ),
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    require(parent_manifest["dimacs"]["sha256"] == PARENT_ROOT_SHA256, "parent root drift")
    ...
    regenerated = load_module(
        validator, "exact17_thirtieth_model_refinements_export"
    ...
    require(regenerated["all_serialized_certificates_replayed"] is True, "certificate replay missing")
    require(regenerated["minimal_occurrences"] == 40, "wrong occurrence count")
    cuts = regenerated["motivating_model_cut_occurrences"]
    require(len(cuts) == 40 and all(cuts.values()), "not every occurrence cuts the motivating model")
    require(validation["parent_prefix_byte_identical"] is True, "prefix claim missing")
    require(
        validation["all_thirtieth_model_refinement_clauses_independently_regenerated"] is True,
        "regeneration claim missing",
    )
    require(validation["all_serialized_certificates_replayed"] is True, "replay claim missing")
    require(
    ...
    return {
        "schema": "p97-exact17-thirtieth-model-refinements-piqd-ingress-validation/v1",
