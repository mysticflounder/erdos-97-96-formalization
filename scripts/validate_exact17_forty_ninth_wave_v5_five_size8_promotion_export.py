"""Fail-closed streaming validator for the V49 wave-v5 five-support child."""
...
SOURCE_COMMIT = "bb30bf999965588aa30d21c98c98efeb3968a383"
PARENT_SOURCE_COMMIT = "de528be70b83f28ce62c289769f1d8a3a7eb7b31"
SOURCE_BRIDGE_COMMIT = "f78cade13a875a2c6b4fdd9482c0d2c89c14624f"
LEAN_ROOT_SHA256 = "cdee8c853a5c8a5160703c69287e4a78c7caa7685bc75e8c65911e56db429c42"
SOURCE_BASELINE_SHA256 = LEAN_ROOT_SHA256
LEAN_EXPORT_SHA256 = "7b713089e6fb2c5f41879c3dc0b02b21118885a96646e3c82e20173b71e876cf"
PARENT_LEAN_ROOT_SHA256 = (
    "0c5dff349eb26aa8375a949bcbc94c6c9cee03271f2dab0c38e91698e58478ec"
)
PARENT_LEAN_EXPORT_SHA256 = (
    "7383a208b30b7228a83d9ee369cbe4712af4db64fca8e93cc7b7c15828054d7f"
)
SOURCE_BRIDGE_SHA256 = (
    "7eae140b28dfed1c6765b29140f06846e150121d05e747179010a075f3e69e92"
)
MINE_SHA256 = "42beef4643ab09424fcf37ba10b403b8cd52f81c72416316525fd4ce4c93b6e9"
MINE_BYTES = 296_100

PARENT_SHA256 = "1245397a6da8f74ee909a0efb162dfcea2c34e38d7d118403060515ff7d3c4f6"
PARENT_BYTES = 338_664_334
PARENT_CLAUSES = 7_198_720
CHILD_SHA256 = "43af619c68cbbb9e810986f078257b92039c8590e91472f81a8ed8c9472bea57"
CHILD_BYTES = 338_665_214
CHILD_CLAUSES = 7_198_740
VARIABLES = 308
OCCURRENCES = 5
CLAUSES_PER_OCCURRENCE = 4
SUFFIX_CLAUSES = 20
EXPECTED_SUFFIX_SHA256 = (
    "bb3a0fe7ceafa9dc4fa41f7dfa2546db1016613561119abd1756d9130a16ddfd"
)
VALIDATION_SCHEMA = (
    "p97-exact17-forty-ninth-wave-v5-five-size8-promotion-export-validation/v1"
)
EXPECTED_PARENT_SUBSUMED_SUFFIX_INDICES = (1, 3, 4, 17, 19)
EXPECTED_PARENT_SUBSUMPTION_WITNESS_COUNTS = (3, 2, 2, 1, 4)
...
def _mine() -> dict[str, object]:
    ...
    if len(raw) != MINE_BYTES or hashlib.sha256(raw).hexdigest() != MINE_SHA256:
        raise ValueError("V4 wave mine identity drifted")
    mine = json.loads(raw)
    if set(mine) != {
        "cancellations",
        "formalized_counts",
        ...
        raise ValueError("V4 wave mine shape drifted")
    if mine["next_centers"] != [16] or mine["selected_orders"] != [1]:
        raise ValueError("V4 wave mine selection drifted")
    candidates = mine["cancellations"][0]["candidates"]
    supports = tuple(
        tuple(tuple(pair) for pair in candidate["support"])
        for candidate in candidates
        if candidate.get("support_size") == 8
    )
    if supports != _SUPPORTS or len(supports) != OCCURRENCES:
        raise ValueError("V5 size-8 support census drifted")
    return mine
    ...
    *,
    ...
    if check_support:
        for path, commit, digest, label in (
            (LEAN_ROOT_PATH, SOURCE_COMMIT, LEAN_ROOT_SHA256, "V5 Lean source"),
            (LEAN_EXPORT_PATH, SOURCE_COMMIT, LEAN_EXPORT_SHA256, "V5 Lean exporter"),
            (
                PARENT_LEAN_ROOT_PATH,
                PARENT_SOURCE_COMMIT,
                PARENT_LEAN_ROOT_SHA256,
    ...
    with (
        ...
        for expected in suffix_lines:
            ...
            if actual != expected:
                raise ValueError("V5 suffix drifted")
