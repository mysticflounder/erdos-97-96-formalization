...
"""Prepare the exact-17 survivor two-Kalmanson physical-slice cells.
...
root identity with the 68-clause survivor two-Kalmanson successor identities.
...
three-clause survivor-refinement parent and proves that every successor clause is
genuinely new, unsubsumed by the parent, and the exact ordered suffix of the
successor root.
"""
...
ROOT = REPO_ROOT
LANE_ID = "exact17-canary-perp-bisector-survivor-two-kalmanson-preparer-20260822"
RUN_ID = "preparation-v1"
RUN_OWNER = "exact17-canary-perp-bisector-survivor-two-kalmanson-preparer"
BASE_HEAD = "64b32aec6e78f6b9bbd0975e2ed1d36b368560ef"
STANDARD_ID = re.compile(r"^[A-Za-z0-9][A-Za-z0-9._-]{0,127}$")

SOURCE_PATH = ROOT / (
    "lean/Erdos9796Proof/P97/ATail/"
    "BlockerVExactSeventeenCanaryPerpBisectorSurvivorTwoKalmansonRefinementsPhysicalSliceCoverage.lean"
)
...
EXPORTER_PATH = ROOT / (
    "lean/Erdos9796Proof/P97/ATail/"
    "BlockerVExactSeventeenCanaryPerpBisectorSurvivorTwoKalmansonRefinementsPhysicalSliceCellExport.lean"
)
IMMEDIATE_PARENT_EXPORTER_PATH = ROOT / (
    "lean/Erdos9796Proof/P97/ATail/"
    "BlockerVExactSeventeenCanaryPerpBisectorRefinementSurvivorRefinementsPhysicalSliceCellExport.lean"
)
...
TEST_PATH = ROOT / (
    "scripts/test_prepare_exact17_canary_perp_bisector_survivor_two_kalmanson_refinements_physical_slice_cells.py"
)
PRODUCTION_CONFIG_RELATIVE = Path(
    "census/p97_search/waves/exact17/"
    "canary-perp-bisector-survivor-two-kalmanson-refinements-preparation-config.json"
)
PRODUCTION_CONFIG_PATH = ROOT / PRODUCTION_CONFIG_RELATIVE
PRODUCTION_CONFIG_SCHEMA = "p97-exact17-canary-perp-bisector-survivor-two-kalmanson-refinements-preparation-config/v1"
...
PARENT_CLAUSES = 7_409_372
IMMEDIATE_PARENT_CLAUSES = 7_409_304
CELL_CLAUSES = 7_409_378
CELL_COUNT = 76
DIRECT_SENTINELS = (
    (0, "none"),
    (0, "unique-06"),
...
SOURCE_THEOREM = (
    "Problem97."
    "ATailBlockerVExactSeventeenCanaryPerpBisectorSurvivorTwoKalmansonRefinementsPhysicalSliceCoverage."
    "sourceAssign_canaryPerpBisectorSurvivorTwoKalmansonRefinementPhysicalSliceCell"
)
EXPECTED_CANARY_PERP_BISECTOR_SURVIVOR_TWO_KALMANSON_REFINEMENT_SUFFIX = (
    (
        -307,
        -143,
        -140,
    ...
    (-307, -277, -274, -77, -82, -230, -223, -243, -252),
    (-307, -215, -213, -172, -177, -104, -111, -11, -7),
    (-308, -277, -274, -77, -82, -230, -223, -243, -252),
    (-308, -164, -162, -172, -177, -104, -111, -11, -7),
    (
        -307,
        -146,
        -140,
    ...
    (-307, -180, -175, -161, -167, -129, -132, -47, -39, -76, -82),
    (-307, -72, -79, -67, -58, -259, -272, -51, -45, -186, -177),
    (
        -308,
        -248,
        -251,
    ...
    (-307, -17, -4, -143, -140, -160, -161, -212, -221, -129, -132, -60, -64, -77, -78),
    (
        -307,
        -251,
        -248,
    ...
    (-308, -17, -4, -143, -140, -211, -212, -161, -170, -132, -129, -60, -61, -77, -81),
    (
        -308,
        -248,
        -251,
...
SCHEMA = "p97-exact17-canary-perp-bisector-survivor-two-kalmanson-refinements-physical-slice-preparation/v1"
CAMPAIGN_SCHEMA = "p97-exact17-canary-perp-bisector-survivor-two-kalmanson-refinements-physical-slice-campaign/v1"
PRODUCER_SCHEMA = accepted.PRODUCER_SCHEMA
SOURCE_SCHEMA = accepted.SOURCE_SCHEMA
WAVE_SCHEMA = accepted.WAVE_SCHEMA
FINITE_SCHEMA = "p97-exact17-canary-perp-bisector-survivor-two-kalmanson-refinements-physical-slice/v1"
ROOT_PRODUCER_SCHEMA = "p97-exact17-canary-perp-bisector-survivor-two-kalmanson-refinements-root-producer/v1"
...
def category_id(center: int, category: str) -> str:
    ...
    return f"canary-perp-bisector-survivor-two-kalmanson-refinements-next-center-{center:02d}-physical-{category}"
...
def _validate_canary_perp_bisector_survivor_two_kalmanson_refinement_contract() -> None:
    suffix = EXPECTED_CANARY_PERP_BISECTOR_SURVIVOR_TWO_KALMANSON_REFINEMENT_SUFFIX
    if len(suffix) != 68 or len(set(suffix)) != 68:
        raise PreparationError(
            "survivor two-Kalmanson refinement suffix inventory drifted"
        )
    if (
        sha256_bytes(canonical_json_bytes(suffix))
        != EXPECTED_CANARY_PERP_BISECTOR_SURVIVOR_TWO_KALMANSON_REFINEMENT_SUFFIX_SHA256
    ):
        raise PreparationError(
            "survivor two-Kalmanson refinement suffix digest drifted"
        )
    for clause in suffix:
        if not clause:
            raise PreparationError("survivor two-Kalmanson refinement clause is empty")
        if len(set(clause)) != len(clause):
            raise PreparationError(
                "survivor two-Kalmanson refinement clause repeats a literal"
            )
        if any(literal == 0 or abs(literal) > PARENT_VARIABLES for literal in clause):
            raise PreparationError(
                "survivor two-Kalmanson refinement clause exceeds the variable map"
            )
        literal_set = set(clause)
        if any(-literal in literal_set for literal in literal_set):
            raise PreparationError(
                "survivor two-Kalmanson refinement clause is tautological"
            )
    if PARENT_CLAUSES != IMMEDIATE_PARENT_CLAUSES + len(suffix):
        raise PreparationError("successor root is not parent plus 68-clause suffix")
    ...
    if DIRECT_SENTINELS != (
        ...
        raise PreparationError("direct Lean sentinel inventory drifted")


def validate_canary_perp_bisector_survivor_two_kalmanson_refinement_parent_novelty(
    immediate_parent: _PublishedFile,
    successor_root: _PublishedFile,
) -> dict[str, Any]:
    """Authenticate the exact 68-clause suffix against the complete parent."""
    _validate_canary_perp_bisector_survivor_two_kalmanson_refinement_contract()
    parent_before = immediate_parent.verify("immediate survivor-refinement parent")
    successor_before = successor_root.verify("survivor two-Kalmanson successor root")
    parent_fd = os.dup(immediate_parent.descriptor)
    successor_fd = os.dup(successor_root.descriptor)
    suffix = EXPECTED_CANARY_PERP_BISECTOR_SURVIVOR_TWO_KALMANSON_REFINEMENT_SUFFIX
    exact_parent_multiplicity = [0] * len(suffix)
    parent_subsumer_count = [0] * len(suffix)
    parent_subsumer_witness: list[dict[str, Any] | None] = [None] * len(suffix)
    successor_multiplicity = [0] * len(suffix)
    candidate_sets = [set(clause) for clause in suffix]
    observed_suffix: list[tuple[int, ...]] = []
    try:
        os.lseek(parent_fd, 0, os.SEEK_SET)
        os.lseek(successor_fd, 0, os.SEEK_SET)
        with (
            os.fdopen(parent_fd, "rb", closefd=True) as parent_handle,
            ...
            if _parent_header(parent_header) != (
                ...
                raise PreparationError(
                    "immediate survivor-refinement parent dimensions drifted"
                )
            if _parent_header(successor_header) != (
                ...
                raise PreparationError(
                    "survivor two-Kalmanson successor dimensions drifted"
                )
            for index in range(IMMEDIATE_PARENT_CLAUSES):
                ...
                for suffix_index, candidate in enumerate(suffix):
                    if clause == candidate:
                        exact_parent_multiplicity[suffix_index] += 1
                        successor_multiplicity[suffix_index] += 1
                    if clause_set <= candidate_sets[suffix_index]:
                        parent_subsumer_count[suffix_index] += 1
                        if parent_subsumer_witness[suffix_index] is None:
                            parent_subsumer_witness[suffix_index] = {
                                "parent_clause_index": index,
                                "clause": list(clause),
                            }
            if parent_handle.readline():
                raise PreparationError(
                    "immediate survivor-refinement parent has trailing clauses"
                )
            for suffix_index, expected in enumerate(
                ...
                if not line:
                    raise PreparationError(
                        "survivor two-Kalmanson successor suffix ended early"
                    )
                clause = _clause_tuple(
                    line,
                    PARENT_VARIABLES,
                    f"canary perpendicular-bisector suffix clause {suffix_index}",
                )
                observed_suffix.append(clause)
                for candidate_index, candidate in enumerate(suffix):
                    if clause == candidate:
                        successor_multiplicity[candidate_index] += 1
                if clause != expected:
                    raise PreparationError(
                        "canary perpendicular-bisector suffix order/value drifted"
                    )
            if successor_handle.readline():
                raise PreparationError(
                    "survivor two-Kalmanson successor has trailing clauses"
                )
    finally:
        if parent_fd >= 0:
            os.close(parent_fd)
    ...
    parent_after = immediate_parent.verify("immediate survivor-refinement parent")
    successor_after = successor_root.verify("survivor two-Kalmanson successor root")
    if _anchor(parent_before) != _anchor(parent_after):
        raise PreparationError(
            "immediate survivor-refinement parent changed during novelty scan"
        )
    if _anchor(successor_before) != _anchor(successor_after):
        raise PreparationError(
            "survivor two-Kalmanson successor changed during novelty scan"
        )
    ...
    if successor_multiplicity != [1] * len(suffix):
        raise PreparationError(
            "survivor two-Kalmanson refinement suffix multiplicity is not exactly one"
        )
    return {
        "schema": "p97-exact17-canary-perp-bisector-survivor-two-kalmanson-refinements-parent-novelty/v1",
        "policy": {
...
def _configured_production(config: _ProductionConfig) -> Iterator[None]:
    ...
    replacements = {
        ...
        "EXPECTED_IMMEDIATE_PARENT_EXPORTER_SHA256": support[
            "immediate_parent_exporter"
        ]["sha256"],
...
def _support_files(
    *,
    ...
    exporter_path: Path,
    immediate_parent_exporter_path: Path,
    delegated_preparer_path: Path,
    hardened_preparer_path: Path,
...
def _validate_support(
    *,
    ...
    expected_paths = {
        ...
        "immediate_parent_exporter": immediate_parent_exporter_path,
...
def build_producer(
    ...
    exporter_path: str,
    exporter_sha256: str,
    immediate_parent_exporter_path: str,
    immediate_parent_exporter_sha256: str,
    ...
    return canonical_json_bytes(
        {
            ...
            "immediate_parent_exporter_path": immediate_parent_exporter_path,
            "immediate_parent_exporter_sha256": immediate_parent_exporter_sha256,
    ...
    return canonical_json_bytes(
        {
            ...
            "immediate_parent_exporter_sha256": kwargs[
...
def build_run_manifest(
    ...
    *,
    ...
    source_digests = {
        ...
        _repo_relative(repo_root, immediate_parent_exporter_path): digests[
            "immediate_parent_exporter"
        ],
...
def _initialize_run_root_authenticated(
    *,
    ...
    immediate_parent_exporter_path: Path = IMMEDIATE_PARENT_EXPORTER_PATH,
...
def _prepare_campaign_authenticated(
    *,
    ...
    with _retained_support(support_files) as custody:
        ...
        immediate_candidate_path = (
            output / "tmp" / "immediate-survivor-refinement-parent.lean.cnf"
        )
        ...
        custody.verify()
        immediate_candidate = _capture_export_result(
            immediate_result,
            immediate_candidate_path,
            "immediate survivor-refinement parent export",
        )
        immediate_parent = _inspect_published_cnf(
            immediate_candidate,
            label="immediate survivor-refinement parent export",
            expected_variables=PARENT_VARIABLES,
            expected_clauses=IMMEDIATE_PARENT_CLAUSES,
        )
        ...
        try:
            ...
            parent_novelty = validate_canary_perp_bisector_survivor_two_kalmanson_refinement_parent_novelty(
                immediate_candidate, root_candidate
            )
            parent_novelty.update(
                {
                    "immediate_parent_sha256": immediate_parent["sha256"],
                    "immediate_parent_bytes": immediate_parent["bytes"],
                    "successor_root_sha256": parent["sha256"],
                    "successor_root_bytes": parent["bytes"],
                }
            )
            immediate_candidate.unlink(
                "immediate survivor-refinement parent temporary export"
            )
        ...
        try:
            root_producer = build_root_producer(
                ...
                immediate_parent_exporter_path=_repo_relative(
                    root, immediate_parent_exporter_path
                ),
                immediate_parent_exporter_sha256=digests["immediate_parent_exporter"],
                parent_novelty=parent_novelty,
                delegated_dependencies=delegated_dependencies,
                production_config=production_config,
            ...
            for center in LEGAL_CENTERS:
                ...
                for category in categories:
                    ...
                    producer = build_producer(
                        ...
                        digests["exporter"],
                        _repo_relative(root, immediate_parent_exporter_path),
                        digests["immediate_parent_exporter"],
            ...
            campaign = {
                ...
                "source": {
                    ...
                    "immediate_parent_exporter_sha256": digests[
                        "immediate_parent_exporter"
                    ],
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--immediate-parent-exporter", type=Path, required=True)
    ...
    common = {
        ...
        "immediate_parent_exporter_path": args.immediate_parent_exporter,
