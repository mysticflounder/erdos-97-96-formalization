"""Create-once publication for the four-occurrence V49 zero-atom child."""
...
import validate_exact17_forty_ninth_zero_atom_promotion_export as validator

ROOT = Path(__file__).resolve().parents[1]
PACKAGE_ROOT = ROOT / (
    "scratch/runs/exact17-forty-ninth-zero-promotion-20260817/export-v1"
)
...
VALIDATOR_SOURCE_COMMIT = "4ca622de05cf8d38ebbab0d7216c12eb017bbd24"
VALIDATOR_SHA256 = "82da7a3ee3051ee04750d90f86bb2aa25c6ca18f448090134e75c332e0a46240"
VALIDATOR_BYTES = 5840
RECEIPT_SCHEMA = "p97-exact17-forty-ninth-zero-atom-promotion-receipt/v1"
COVERAGE_SCHEMA = "p97-exact17-forty-ninth-zero-atom-promotion-coverage/v1"
AUDIT_SCHEMA = "p97-exact17-forty-ninth-zero-atom-promotion-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-zero-atom-promotion",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthZeroAtomPromotion.sourceAssign_extendedFortyNinthZeroAtomPromotionCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthZeroAtomPromotion.false_of_sourceRealization_of_extendedFortyNinthZeroAtomPromotionCnf_unsat",
        },
