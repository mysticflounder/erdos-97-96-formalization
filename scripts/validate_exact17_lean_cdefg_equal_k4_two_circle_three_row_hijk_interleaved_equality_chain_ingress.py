"""Fail-closed ingress validation for the exact-17 equality-chain PIQD root."""
...
SCHEMA = "p97-exact17-lean-equality-chain-piqd-ingress/v1"
DAEMON_SHA256 = "fd1cacee52677a555f8b3d24c6052c71022e4dfd6ccc9037f165d1d22ec384eb"
ROOT_SHA256 = "d5c09fd5e139f88df5966907485a2f80b208a3917431dbd07d189ae505f16b9e"
ROOT_BYTES = 194_448_664
VARIABLES = 308
ROOT_CLAUSES = 4_212_444
PARENT_CLAUSES = 3_915_420
EQUALITY_CHAIN_CLAUSES = 297_024
PARENT_ROOT_SHA256 = "db8f493b4a8312efcf99d0e3e198537233b83dbb6cc5f4dad6f1423e22d90bd9"
EXPECTED_SOURCE_PATHS = (
    "lean/Erdos9796Proof/P97/ATail/TwoCircleEqualityChainSchemas.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenSourceCnfCdefgEqualK4TwoCircleThreeRowHijkInterleavedEqualityChain.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenSourceCnfCdefgEqualK4TwoCircleThreeRowHijkInterleavedEqualityChainExport.lean",
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    require(
        root_record["checked_equality_chain_clauses"] == EQUALITY_CHAIN_CLAUSES,
    ...
    interleaved_validator = check_named_hash(repo, validation, "parent_validator")
    ...
    regenerated = load_module(validator, "exact17_equality_chain_export").validate(
    ...
    require(
        regenerated["equality_chain_clauses"] == EQUALITY_CHAIN_CLAUSES,
        "validator equality-chain mismatch",
    )
    require(regenerated["parent_prefix_byte_identical"] is True, "prefix mismatch")
    require(
        isinstance(regenerated["motivating_model_cut_clause"], int),
        "model not cut",
    )
    require(
        validation["parent_prefix_byte_identical"] is True,
        "manifest prefix claim missing",
    )
    require(
        validation["all_equality_chain_clauses_independently_regenerated"] is True,
    ...
    return {
        "schema": "p97-exact17-lean-equality-chain-piqd-ingress-validation/v1",
        "manifest_sha256": sha256(manifest_path),
        "dimacs_sha256": sha256(root),
        "dimacs_bytes": root.stat().st_size,
        "variables": VARIABLES,
        "clauses": ROOT_CLAUSES,
        "equality_chain_clauses": EQUALITY_CHAIN_CLAUSES,
