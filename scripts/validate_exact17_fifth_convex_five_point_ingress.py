"""Fail-closed PIQD ingress for the combined exact-17 sixteenth child."""
...
SCHEMA = "p97-exact17-lean-fifth-convex-five-point-piqd-ingress/v1"
DAEMON_SHA256 = "0cfc9577656fa3aef143a9fe7e5577d938dba9fd39f3b7118ed91735c97fc360"
ROOT_SHA256 = "c8e6011fce2f0373fffa23b45285d38e95224a60778623bdb5c53e323b951d38"
PARENT_ROOT_SHA256 = "394b93e9e79fc36cdfbcb943832e46898da3944e6f24f6a0d777802e761238fd"
ROOT_BYTES = 291_569_428
VARIABLES = 308
ROOT_CLAUSES = 5_846_112
PARENT_CLAUSES = 5_846_104
NEW_CLAUSES = 8
EXPECTED_SOURCE_PATHS = (
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenGenericCancellationThird.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenConvexFivePointFifthRows.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenConvexFivePointFifthRowsExport.lean",
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    parent_result = load_module(
        parent_validator, "exact17_four_row_two_circle_bisector_ingress"
    ...
    regenerated = load_module(
        validator, "exact17_fifth_convex_five_point_export"
    ...
    require(
        regenerated["generic_cancellation_clauses"]
        + regenerated["convex_five_point_clauses"]
        == NEW_CLAUSES,
    ...
    require(cuts["cancellation"] and cuts["convex_five"], "model not cut by both orbits")
    require(validation["parent_prefix_byte_identical"] is True, "prefix claim missing")
    require(validation["all_new_clauses_independently_regenerated"] is True,
        "regeneration claim missing")
    require(validation["motivating_model_cut_by_both_orbits"] is True,
    ...
    return {
        "schema": "p97-exact17-lean-fifth-convex-five-point-piqd-ingress-validation/v1",
