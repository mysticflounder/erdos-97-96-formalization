"""Create-once publication adapter for the V49 wave-v9 four-support child."""
...
import validate_exact17_forty_ninth_wave_v9_four_size8_promotion_export as validator

ROOT = Path(__file__).resolve().parents[1]
PACKAGE_ROOT = (
    ROOT
    / "scratch/runs/exact17-forty-ninth-wave-v9-four-size8-publication-20260817/export-v1"
)
...
VALIDATOR_SOURCE_COMMIT = "a18532c96b320cc2dc25d84163d0f78c9ef55f24"
VALIDATOR_SHA256 = "3197d619bc07c61961239257d8dfcdeba2670951c2eefa10b80f4d74f1dd7f51"
VALIDATOR_BYTES = 12_777
RECEIPT_SCHEMA = "p97-exact17-forty-ninth-wave-v9-four-size8-promotion-receipt/v1"
COVERAGE_SCHEMA = "p97-exact17-forty-ninth-wave-v9-four-size8-promotion-coverage/v1"
AUDIT_SCHEMA = "p97-exact17-forty-ninth-wave-v9-four-size8-promotion-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-wave-v9-four-size8-promotion",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV9FourSize8Promotion.sourceAssign_extendedFortyNinthWaveV9FourSize8PromotionCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV9FourSize8Promotion.false_of_sourceRealization_of_extendedFortyNinthWaveV9FourSize8PromotionCnf_unsat",
        },
