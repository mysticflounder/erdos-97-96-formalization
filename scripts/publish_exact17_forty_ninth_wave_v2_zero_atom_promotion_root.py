"""Create-once publication for the direct-zero V49 wave-v2 child."""
...
import validate_exact17_forty_ninth_wave_v2_zero_atom_promotion_export as validator

ROOT = Path(__file__).resolve().parents[1]
PACKAGE_ROOT = ROOT / (
    "scratch/runs/exact17-forty-ninth-wave-v2-zero-atom-20260817/export-v1"
)
...
VALIDATOR_SOURCE_COMMIT = "089433f827349c3daa508acfdc9d7f82ed60ea8b"
VALIDATOR_SHA256 = "a4eeefd7250ae936d633b5622956d43fd469b1f04bf97afa8d0bf92932f21a18"
VALIDATOR_BYTES = 4910
RECEIPT_SCHEMA = "p97-exact17-forty-ninth-wave-v2-zero-atom-promotion-receipt/v1"
COVERAGE_SCHEMA = "p97-exact17-forty-ninth-wave-v2-zero-atom-promotion-coverage/v1"
AUDIT_SCHEMA = "p97-exact17-forty-ninth-wave-v2-zero-atom-promotion-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-wave-v2-zero-atom-promotion",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV2ZeroAtomPromotion.sourceAssign_extendedFortyNinthWaveV2ZeroAtomPromotionCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV2ZeroAtomPromotion.false_of_sourceRealization_of_extendedFortyNinthWaveV2ZeroAtomPromotionCnf_unsat",
        },
