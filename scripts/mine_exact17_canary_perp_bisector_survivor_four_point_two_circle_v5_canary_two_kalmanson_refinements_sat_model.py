...
content-addressed and conforms to the canary-two-kalmanson-v6 acceptance schemas consumed
by the gated survivor FourPointTwoCircle runner.
...
from scripts import (
    run_piqd_exact17_canary_perp_bisector_survivor_four_point_two_circle_v5_canary_two_kalmanson_refinements_sat_portfolio as runner,
)

MINER_NAME = (
    "exact17-survivor-four-point-two-circle-v5-canary-two-kalmanson-v6-source-valid-theorem-miner"
)
MINER_SCHEMA = "p97-exact17-survivor-four-point-two-circle-v5-canary-two-kalmanson-v6-source-valid-theorem-miner/v1"
MINER_VERSION = "6"
VERIFICATION_SCHEMA = "p97-exact17-survivor-four-point-two-circle-v5-canary-two-kalmanson-v6-source-valid-theorem-mine-verification/v1"
MINER_RELATIVE = (
