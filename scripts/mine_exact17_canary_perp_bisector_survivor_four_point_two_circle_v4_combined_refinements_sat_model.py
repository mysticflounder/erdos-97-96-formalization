...
content-addressed and conforms to the combined-v5 acceptance schemas consumed
...
from scripts import (
    run_piqd_exact17_canary_perp_bisector_survivor_four_point_two_circle_v4_combined_refinements_sat_portfolio as runner,
)

MINER_NAME = (
    "exact17-survivor-four-point-two-circle-v4-combined-v5-source-valid-theorem-miner"
)
MINER_SCHEMA = "p97-exact17-survivor-four-point-two-circle-v4-combined-v5-source-valid-theorem-miner/v1"
MINER_VERSION = "5"
VERIFICATION_SCHEMA = "p97-exact17-survivor-four-point-two-circle-v4-combined-v5-source-valid-theorem-mine-verification/v1"
MINER_RELATIVE = (
