"""Create-once publication adapter for the V49 wave-v7 two-support child."""
...
import validate_exact17_forty_ninth_wave_v7_two_size8_promotion_export as validator

ROOT = Path(__file__).resolve().parents[1]
PACKAGE_ROOT = (
    ROOT / "scratch/runs/exact17-forty-ninth-wave-v7-two-size8-20260817/export-v1"
)
...
AUDIT_SCHEMA = "p97-exact17-forty-ninth-wave-v7-two-size8-promotion-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-wave-v7-two-size8-promotion",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV7TwoSize8Promotion.sourceAssign_extendedFortyNinthWaveV7TwoSize8PromotionCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV7TwoSize8Promotion.false_of_sourceRealization_of_extendedFortyNinthWaveV7TwoSize8PromotionCnf_unsat",
        },
