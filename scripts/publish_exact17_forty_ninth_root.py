"""Create-once, fail-closed publication for the FortyNinth model2 root."""
...
AUDIT_SCHEMA = "p97-exact17-forty-ninth-independent-audit/v1"
...
def _require_publisher_provenance(
    ...
    _configure_base()
    return _base._require_publisher_provenance(paths, baseline)


def _validation(paths: PublicationPaths, child: Path) -> dict[str, object]:
    return validator._validate_export(paths.parent, child)
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-model2",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthModelRefinements.sourceAssign_extendedFortyNinthModelRefinementsCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthModelRefinements.false_of_sourceRealization_of_extendedFortyNinthModelRefinementsCnf_unsat",
        },
...
def publish(
    ...
    """Run direct Lean export, replay it, and publish create-once artifacts."""
    _configure_base()
    ...
    try:
        ...
        receipt = {
            ...
            "artifacts": {
                ...
                "independent_audit_script": _base._artifact(paths.validator_script),
                "independent_audit_report": _base._artifact(paths.audit_report),
        ...
        _base._write_exclusive_readonly(
