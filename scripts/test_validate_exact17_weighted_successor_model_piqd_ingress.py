"""Focused fail-closed tests for the weighted-successor-model PIQD ingress."""
...
import pytest
import validate_exact17_weighted_successor_model_piqd_ingress as subject
...
def test_production_ingress_replays_and_binds_every_published_identity() -> None:
    ...
    assert subject.VALIDATOR_SOURCE_COMMIT == "de83a55209bf209e9fc55046ba8f44b223b31923"
    assert subject.PUBLISHER_SOURCE_COMMIT == "61e2238cffd23a252224fbb67c834c1c043a05ee"
