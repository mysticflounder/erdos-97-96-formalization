...
"""Adversarial tests for the generic survivor-refinement SAT theorem miner."""
...
from scripts import (
    mine_exact17_canary_perp_bisector_refinement_survivor_refinements_sat_canary as mine,
)
...
def test_scanner_modules_are_not_imported_before_dependency_preflight() -> None:
    code = (
        "import sys; "
        "from scripts import "
        "mine_exact17_canary_perp_bisector_refinement_survivor_refinements_sat_canary as m; "
