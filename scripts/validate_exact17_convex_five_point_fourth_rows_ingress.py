"""Fail-closed PIQD ingress for the exact-17 fourth-row five-point child."""
...
SCHEMA = "p97-exact17-lean-convex-five-point-fourth-rows-piqd-ingress/v1"
DAEMON_SHA256 = "0cfc9577656fa3aef143a9fe7e5577d938dba9fd39f3b7118ed91735c97fc360"
ROOT_SHA256 = "82a0fe73b57b3c28e9b622eacde46b9ed4f789846231db912014624c46b31ae8"
PARENT_ROOT_SHA256 = "f3b2abfd20baf6fbd61a2d31cf7635b946fe69f4cd383b1cdf97233d624e38bd"
ROOT_BYTES = 291_568_704
VARIABLES = 308
ROOT_CLAUSES = 5_846_096
PARENT_CLAUSES = 5_846_088
NEW_CLAUSES = 8
EXPECTED_SOURCE_PATHS = (
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenConvexFivePointFourthRows.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenConvexFivePointFourthRowsExport.lean",
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    parent_result = load_module(
        parent_validator, "exact17_convex_five_point_third_rows_ingress"
    ...
    regenerated = load_module(
        validator, "exact17_convex_five_point_fourth_rows_export"
    ...
    return {
        "schema": "p97-exact17-lean-convex-five-point-fourth-rows-piqd-ingress-validation/v1",
