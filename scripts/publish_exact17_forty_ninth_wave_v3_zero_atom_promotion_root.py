"""Create-once publication for the direct-zero V49 wave-v3 child."""
...
import validate_exact17_forty_ninth_wave_v3_zero_atom_promotion_export as validator

ROOT = Path(__file__).resolve().parents[1]
PACKAGE_ROOT = ROOT / (
    "scratch/runs/exact17-forty-ninth-wave-v3-zero-atom-20260817/export-v1"
)
...
VALIDATOR_SOURCE_COMMIT = "71dab74d2b14b3835871340ea1ae918811b2c5be"
VALIDATOR_SHA256 = "c87fb369e31a6acd4b76151a41e46b200c73e0e6c154364cb7adf03ca1612454"
VALIDATOR_BYTES = 4993
RECEIPT_SCHEMA = "p97-exact17-forty-ninth-wave-v3-zero-atom-promotion-receipt/v1"
COVERAGE_SCHEMA = "p97-exact17-forty-ninth-wave-v3-zero-atom-promotion-coverage/v1"
AUDIT_SCHEMA = "p97-exact17-forty-ninth-wave-v3-zero-atom-promotion-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-wave-v3-zero-atom-promotion",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV3ZeroAtomPromotion.sourceAssign_extendedFortyNinthWaveV3ZeroAtomPromotionCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV3ZeroAtomPromotion.false_of_sourceRealization_of_extendedFortyNinthWaveV3ZeroAtomPromotionCnf_unsat",
        },
