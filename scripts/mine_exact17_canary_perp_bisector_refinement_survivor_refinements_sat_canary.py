...
gated survivor-refinement portfolio runner.
...
from scripts import (
    run_piqd_exact17_canary_perp_bisector_refinement_survivor_refinements_sat_portfolio as runner,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"survivor-refinement SAT mine rejected: {exc}", file=sys.stderr)
        return 1
