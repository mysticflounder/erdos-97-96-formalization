"""Fail-closed PIQD ingress for the exact-17 twenty-seventh child."""
...
PARENT_MANIFEST_SHA256 = "138d488c822f0a3abdd1443bac0f5386fc254ce6efec2964a804557d5ae7cd33"
ROOT_PATH = (
...
EXPECTED_SOURCE_PATHS = (
    (
        ...
        "BlockerVExactSeventeenTwentySixthModelRefinements.lean"
    ),
    (
        "lean/Erdos9796Proof/P97/ATail/"
        "BlockerVExactSeventeenTwentySixthModelRefinementsExport.lean"
    ),
)
EXPECTED_CUTS = {"bisector", "convex_five", "cancellation"}
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    regenerated = load_module(
        validator, "exact17_twenty_sixth_model_refinements_export"
    ...
    require(
        regenerated["perpendicular_bisector_subsumed_by_bisector"] is True,
        "perpendicular-bisector subsumption missing",
    )
    ...
    require(
        validation["all_twenty_sixth_model_refinement_clauses_independently_regenerated"]
        is True,
        "regeneration claim missing",
    )
    require(
        validation["all_three_nonredundant_motivating_occurrences_cut"] is True,
        "model-cut claim missing",
    )
    require(
        validation["perpendicular_bisector_subsumed_by_bisector"] is True,
        "subsumption claim missing",
    )
    ...
    return {
        "schema": "p97-exact17-twenty-sixth-model-refinements-piqd-ingress-validation/v1",
