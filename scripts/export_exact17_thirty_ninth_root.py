"""Immutable Lean exporter for the fail-closed exact-17 Child39 boundary."""
...
def export_child39(paths: ExportPaths = PRODUCTION_PATHS, *, spec: ExportSpec = PRODUCTION_SPEC) -> dict[str, Any]:
    ...
    if paths.child.exists() or paths.receipt.exists():
        raise FileExistsError("refusing to replace existing Child39 or receipt")
...
if __name__ == "__main__":
    print(json.dumps(export_child39(), indent=2, sort_keys=True))
