...
"""Adversarial tests for the canary perp-bisector survivor two-Kalmanson SAT theorem miner."""
...
from scripts import (
    mine_exact17_canary_perp_bisector_survivor_two_kalmanson_refinements_sat_canary as mine,
)
...
def test_successor_lane_identity_and_dimensions_are_runner_bound() -> None:
    ...
    assert mine.NUM_CLAUSES == mine.runner.NUM_CLAUSES == 7_409_378
    assert mine.MINER_RELATIVE == (
        "scripts/mine_exact17_canary_perp_bisector_survivor_two_kalmanson_"
    ...
    assert mine.runner.CAMPAIGN_SCHEMA == (
        ...
        "refinements-sat-profile-campaign/v1"
    )
    ...
    assert mine.runner.WAVE_MINE_LEDGER_SCHEMA == (
        "p97-exact17-canary-perp-bisector-survivor-two-kalmanson-"
        "refinements-wave-only-candidate-ledger/v1"
    )
...
def test_scanner_modules_are_not_imported_before_dependency_preflight() -> None:
    code = (
        "import sys; "
        "from scripts import "
        "mine_exact17_canary_perp_bisector_survivor_two_kalmanson_refinements_sat_canary as m; "
