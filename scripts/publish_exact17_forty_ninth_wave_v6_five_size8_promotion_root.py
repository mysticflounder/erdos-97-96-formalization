"""Create-once publication adapter for the V49 wave-v6 five-support child."""
...
import validate_exact17_forty_ninth_wave_v6_five_size8_promotion_export as validator

ROOT = Path(__file__).resolve().parents[1]
PACKAGE_ROOT = (
    ROOT / "scratch/runs/exact17-forty-ninth-wave-v6-five-size8-20260817/export-v1"
)
...
VALIDATOR_SOURCE_COMMIT = "4bfff8a7be498866aa77a4373516c314ab0a8299"
VALIDATOR_SHA256 = "b074b1d1f14fe3f6d93e1ca3f12aacdaaff458830082d5c04f112786e4b3e2c0"
VALIDATOR_BYTES = 12_636
RECEIPT_SCHEMA = "p97-exact17-forty-ninth-wave-v6-five-size8-promotion-receipt/v1"
COVERAGE_SCHEMA = "p97-exact17-forty-ninth-wave-v6-five-size8-promotion-coverage/v1"
AUDIT_SCHEMA = "p97-exact17-forty-ninth-wave-v6-five-size8-promotion-audit/v1"
...
def coverage_ledger(
    ...
    return {
        ...
        "status": "PASS",
        "profile_id": "exact17-forty-ninth-wave-v6-five-size8-promotion",
        "source": {
            ...
            "theorem": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV6FiveSize8Promotion.sourceAssign_extendedFortyNinthWaveV6FiveSize8PromotionCnf",
            "terminal_adapter": "Problem97.ATailBlockerVExactSeventeenFortyNinthWaveV6FiveSize8Promotion.false_of_sourceRealization_of_extendedFortyNinthWaveV6FiveSize8PromotionCnf_unsat",
        },
