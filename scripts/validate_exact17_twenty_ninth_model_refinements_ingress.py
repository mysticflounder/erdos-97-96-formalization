"""Fail-closed PIQD ingress for the exact-17 thirtieth child."""
...
SCHEMA = "p97-exact17-lean-twenty-ninth-model-refinements-piqd-ingress/v1"
DAEMON_SHA256 = "aa47e2ff3000890d11da79296721f0f51c3a228d4ef8446af3c3d2a73d969107"
ROOT_SHA256 = "02aca42eb22814540816d9e4f1d19b2c71888700147e6b832d735f9efc41acd0"
ROOT_BYTES = 291_596_500
PARENT_ROOT_SHA256 = "620ea5ad066edf6526d11eb51c4cff93284130f6fd27de46d8d0c2e5ff9c0c53"
PARENT_MANIFEST_SHA256 = "29bfc11cfb30f807252e38aa0e0ea0cc4470fd1e6a805e552596a0b4b3573a4a"
ROOT_PATH = (
...
EXPECTED_SOURCE_PATHS = (
    (
        ...
        "BlockerVExactSeventeenTwentyNinthModelRefinements.lean"
    ),
    (
        "lean/Erdos9796Proof/P97/ATail/"
        "BlockerVExactSeventeenTwentyNinthModelRefinementsExport.lean"
    ),
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    regenerated = load_module(
        validator, "exact17_twenty_ninth_model_refinements_export"
    ...
    require(regenerated["minimal_occurrences"] == 50, "wrong occurrence count")
    cuts = regenerated["motivating_model_cut_occurrences"]
    require(len(cuts) == 50 and all(cuts.values()), "not every occurrence cuts the motivating model")
    require(validation["parent_prefix_byte_identical"] is True, "prefix claim missing")
    require(
        validation["all_twenty_ninth_model_refinement_clauses_independently_regenerated"] is True,
    ...
    return {
        "schema": "p97-exact17-twenty-ninth-model-refinements-piqd-ingress-validation/v1",
