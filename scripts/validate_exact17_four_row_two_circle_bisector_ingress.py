"""Fail-closed PIQD ingress for the exact-17 four-row two-circle child."""
...
SCHEMA = "p97-exact17-lean-four-row-two-circle-bisector-piqd-ingress/v1"
DAEMON_SHA256 = "0cfc9577656fa3aef143a9fe7e5577d938dba9fd39f3b7118ed91735c97fc360"
ROOT_SHA256 = "394b93e9e79fc36cdfbcb943832e46898da3944e6f24f6a0d777802e761238fd"
PARENT_ROOT_SHA256 = "5bfbfe47d66930e446613403f33cbbf87044c448f488879c098b986cce2348fc"
ROOT_BYTES = 291_569_030
VARIABLES = 308
ROOT_CLAUSES = 5_846_104
PARENT_CLAUSES = 5_846_100
NEW_CLAUSES = 4
EXPECTED_SOURCE_PATHS = (
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenFourRowTwoCircleBisector.lean",
    "lean/Erdos9796Proof/P97/ATail/BlockerVExactSeventeenFourRowTwoCircleBisectorExport.lean",
)
...
def validate(repo: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    require(
        root_record["checked_four_row_two_circle_bisector_clauses"] == NEW_CLAUSES,
        "wrong suffix count",
    )
    ...
    parent_result = load_module(
        parent_validator, "exact17_four_point_two_circle_bisector_rows_ingress"
    ...
    regenerated = load_module(
        validator, "exact17_four_row_two_circle_bisector_export"
    ...
    require(
        regenerated["four_row_two_circle_bisector_clauses"] == NEW_CLAUSES,
    ...
    require(
        validation["all_four_row_two_circle_bisector_clauses_independently_regenerated"]
        is True,
    ...
    return {
        "schema": "p97-exact17-lean-four-row-two-circle-bisector-piqd-ingress-validation/v1",
        "manifest_sha256": sha256(manifest_path),
        "dimacs_sha256": sha256(root),
        "dimacs_bytes": root.stat().st_size,
        "variables": VARIABLES,
        "clauses": ROOT_CLAUSES,
        "four_row_two_circle_bisector_clauses": NEW_CLAUSES,
