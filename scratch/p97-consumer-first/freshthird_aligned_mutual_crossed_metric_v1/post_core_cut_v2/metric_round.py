#!/usr/bin/env python3
"""Shared-coordinate replay after the singleton/K4 incidence preflight."""
...
ASSIGNMENT = HERE / "generated" / "post_core_cut_v2_assignment.json"
...
def run(timeout_ms: int, cvc5_timeout_ms: int) -> dict[str, Any]:
    ...
    results: dict[str, Any] = {
        ...
        "fidelity": (
            ...
            "first-apex source-singleton incidence preflights; incomplete as an "
            "original-P97 model"
        ),
    ...
    results["queries"].append(
        metric.run_query(
            "post_core_cut_v2_row_equalities_only_preflight",
            encoding,
