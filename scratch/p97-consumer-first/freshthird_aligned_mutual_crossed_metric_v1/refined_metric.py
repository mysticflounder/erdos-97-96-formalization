#!/usr/bin/env python3
"""Shared-coordinate replay of the post-singleton-cut exact-17 assignment."""
...
ASSIGNMENT = HERE / "generated" / "refined_global_k4_assignment.json"
RESULTS = HERE / "refined_metric_results.json"
...
def run(timeout_ms: int, cvc5_timeout_ms: int) -> dict[str, Any]:
    ...
    results: dict[str, Any] = {
        ...
        "fidelity": (
            "source-entitled shared-coordinate assignment test; incomplete as an "
            "original-P97 model"
        ),
    ...
    results["queries"].append(
        metric.run_query(
            "refined_row_equalities_only_preflight",
            encoding,
