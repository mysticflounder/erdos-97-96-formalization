#!/usr/bin/env python3
"""Positive model audit and mutation-rejection tests for full-radius clauses."""
...
def main() -> int:
    ...
    # Mutation 2: choose a row but merge one outside incident edge into it.
    row_mutation = probe.build_instance()
    row_instance, _, _, _, row_layer, _ = row_mutation
    center = 0
    row_index = 0
    ...
    _, row_result = solve_artifact(
        "mutation-selected-row-proper-subset", row_mutation, row_extra,
        expect="UNSAT",
    )

    # Mutation 3: four labels outside a chosen blocker row are made one class.
    ...
    # Mutation 4: an outside edge is forced into the named first-apex class.
    ...
    summary = {
        ...
        "mutations": {
            ...
            "selected_row_proper_subset": row_result["independent_verification"],
    ...
    print(
        ...
        "transitivity, whole-row, no_qfree, and exact-five mutations rejected "
