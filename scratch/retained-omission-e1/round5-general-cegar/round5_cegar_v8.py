...
SCHEMA_PATH = HERE / "schema_v8.json"
...
SOURCE_FILES = {
    ...
    "four_point_squared_cnd": PROJECT_ROOT / "lean/Erdos9796Proof/P97/Foundation.lean",
    "triple_center_uniqueness": PROJECT_ROOT / "lean/Erdos9796Proof/P97/N4d/SmallSReductions.lean",
}
...
# encoding of `centerAt`; schema v8 imposes the proved apex exclusion separately.
...
class Encoding:
    ...
    def _build(self) -> None:
        ...
        self._build_four_point_squared_cnd()
    ...
    def _build_four_point_squared_cnd(self) -> None:
        """Add all balanced four-point conditional-negative inequalities."""
        for a, b, c, d in itertools.combinations(POINTS, 4):
            self.add(
                "four_point_squared_cnd",
                self.s(a, b) + self.s(c, d)
                <= self.s(a, c) + self.s(a, d) + self.s(b, c) + self.s(b, d),
                self.s(a, c) + self.s(b, d)
                <= self.s(a, b) + self.s(a, d) + self.s(b, c) + self.s(c, d),
                self.s(a, d) + self.s(b, c)
                <= self.s(a, b) + self.s(a, c) + self.s(b, d) + self.s(c, d),
            )
    ...
    return {
        ...
        "role_map": {
            ...
            "rich_apex_exclusion": (
                ...
                "FullyDeletionRobustAt.centerAt_ne; schema v8 keeps apices in "
                "the syntactic blocker domain but explicitly forbids their use"
            ),
            "four_point_squared_cnd": "Problem97.four_point_balanced_sqdist_le_cross",
            "triple_center_multiplicity": "Problem97.eq_of_dist_eq_three_of_pairwise_ne",
