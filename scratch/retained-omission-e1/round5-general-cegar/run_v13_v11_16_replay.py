#!/usr/bin/env python3
"""Authenticate and replay the 16 completed v11 cases through v13."""
...
MANIFEST = Path(
    "artifacts-v13-canary/v11-16-selection-20260802T093313.097282Z.json"
)
CASE_IDS = (
    "fresh_DDD_k0_d2_f1",
    "fresh_DDD_k0_d2_f3",
...
def main() -> int:
        ...
        selection.append(
            {
                ...
                "source_result_sha256": sha256(raw),
            }
        )
    ...
    args = v13.parser().parse_args(
        [
            ...
            "--max-power-cuts",
            "256",
            "--max-power-candidates",
            "2000000",
            "--max-bool-power-cuts",
            "256",
            "--max-bool-power-candidates",
            "2000000",
            "--artifacts",
            "artifacts-v13-canary",
        ]
    )
    return v13.run_matrix(
        args,
        [universe[case_id] for case_id in CASE_IDS],
        "v11-16-replay",
        MANIFEST,
