#!/usr/bin/env python3
"""Authenticate and replay the 16 completed v11 cases through v14."""
...
MANIFEST = Path(
    "artifacts-v14-canary/v11-16-selection-20260802T093313.097282Z.json"
)
CASE_IDS = (
...
def main() -> int:
    ...
    manifest = {
        ...
        "destination_provenance": v14.provenance(),
        "cases": selection,
    }
    ...
    args = argparse.Namespace(
        ...
        artifacts=Path("artifacts-v14-canary"),
    )
    return v14.run_matrix(
