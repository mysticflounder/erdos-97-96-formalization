...
def reducedUnionChunk131Assertions : List BVLogicalExpr :=
  [ bnot (bands [bvar 10, bvar 12, bvar 1065, bvar 1067]),
    ...
    bnot (bands [bvar 1, bvar 11, bvar 1069, bvar 1079]),
    ...
    bnot (bands [bvar 2, bvar 5, bvar 1083, bvar 1086]),
    ...
    bnot (bands [bvar 2, bvar 11, bvar 1083, bvar 1092]),
    bnot (bands [bvar 2, bvar 12, bvar 1083, bvar 1093]),
    ...
    bnot (bands [bvar 0, bvar 6, bvar 1107, bvar 1113]),
    bnot (bands [bvar 0, bvar 7, bvar 1107, bvar 1114]),
    bnot (bands [bvar 0, bvar 8, bvar 1107, bvar 1115]),
    ...
    bnot (bands [bvar 2, bvar 6, bvar 1109, bvar 1113]),
    bnot (bands [bvar 2, bvar 7, bvar 1109, bvar 1114]),
    bnot (bands [bvar 2, bvar 8, bvar 1109, bvar 1115]),
