...
def reducedUnionChunk017Assertions : List BVLogicalExpr :=
  [ bnot (bands [bvar 1166, bvar 1171, bvar 1192, bvar 1197]),
    ...
    bnot (bands [bvar 1159, bvar 1162, bvar 1198, bvar 1201]),
    bnot (bands [bvar 1159, bvar 1163, bvar 1198, bvar 1202]),
    bnot (bands [bvar 1159, bvar 1164, bvar 1198, bvar 1203]),
    ...
    bnot (bands [bvar 1160, bvar 1164, bvar 1199, bvar 1203]),
    ...
    bnot (bands [bvar 1161, bvar 1164, bvar 1200, bvar 1203]),
    ...
    bnot (bands [bvar 1162, bvar 1164, bvar 1201, bvar 1203]),
    bnot (bands [bvar 1162, bvar 1165, bvar 1201, bvar 1204]),
    ...
    bnot (bands [bvar 1164, bvar 1165, bvar 1203, bvar 1204]),
    bnot (bands [bvar 1164, bvar 1166, bvar 1203, bvar 1205]),
    bnot (bands [bvar 1164, bvar 1167, bvar 1203, bvar 1206]),
    ...
    bnot (bands [bvar 1173, bvar 1184, bvar 1186, bvar 1197]),
    ...
    bnot (bands [bvar 1175, bvar 1177, bvar 1188, bvar 1190]),
    ...
    bnot (bands [bvar 1175, bvar 1181, bvar 1188, bvar 1194]),
