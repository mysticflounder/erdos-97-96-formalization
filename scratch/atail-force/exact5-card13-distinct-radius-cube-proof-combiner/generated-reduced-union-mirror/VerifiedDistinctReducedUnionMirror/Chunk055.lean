...
def reducedUnionChunk055Assertions : List BVLogicalExpr :=
  [ bnot (bands [bvar 55, bvar 66, bvar 1108, bvar 1119]),
    bnot (bands [bvar 60, bvar 63, bvar 1113, bvar 1116]),
    bnot (bands [bvar 60, bvar 65, bvar 1113, bvar 1118]),
    bnot (bands [bvar 60, bvar 66, bvar 1113, bvar 1119]),
    bnot (bands [bvar 61, bvar 62, bvar 1114, bvar 1115]),
    bnot (bands [bvar 61, bvar 65, bvar 1114, bvar 1118]),
    bnot (bands [bvar 62, bvar 63, bvar 1115, bvar 1116]),
    bnot (bands [bvar 62, bvar 65, bvar 1115, bvar 1118]),
    bnot (bands [bvar 62, bvar 66, bvar 1115, bvar 1119]),
    bnot (bands [bvar 63, bvar 65, bvar 1116, bvar 1118]),
    bnot (bands [bvar 63, bvar 66, bvar 1116, bvar 1119]),
    bnot (bands [bvar 64, bvar 65, bvar 1117, bvar 1118]),
    bnot (bands [bvar 1071, bvar 1073, bvar 109, bvar 111]),
    ...
    bnot (bands [bvar 61, bvar 65, bvar 1127, bvar 1131]),
    bnot (bands [bvar 61, bvar 66, bvar 1127, bvar 1132]),
    bnot (bands [bvar 62, bvar 63, bvar 1128, bvar 1129]),
    bnot (bands [bvar 62, bvar 64, bvar 1128, bvar 1130]),
    ...
    bnot (bands [bvar 64, bvar 66, bvar 1143, bvar 1145]),
    bnot (bands [bvar 1071, bvar 1074, bvar 135, bvar 138]),
    bnot (bands [bvar 1071, bvar 1075, bvar 135, bvar 139]),
    ...
    bnot (bands [bvar 60, bvar 62, bvar 1165, bvar 1167]),
    bnot (bands [bvar 64, bvar 65, bvar 1169, bvar 1170]),
    ...
    bnot (bands [bvar 59, bvar 60, bvar 1177, bvar 1178]),
    bnot (bands [bvar 60, bvar 63, bvar 1178, bvar 1181]),
    bnot (bands [bvar 61, bvar 63, bvar 1179, bvar 1181]),
    bnot (bands [bvar 62, bvar 63, bvar 1180, bvar 1181]),
    bnot (bands [bvar 55, bvar 66, bvar 1186, bvar 1197]),
    bnot (bands [bvar 57, bvar 59, bvar 1188, bvar 1190]) ]
