...
def reducedUnionChunk012Assertions : List BVLogicalExpr :=
  [ bnot (bands [bvar 1094, bvar 1105, bvar 1159, bvar 1170]),
    ...
    bnot (bands [bvar 1096, bvar 1106, bvar 1161, bvar 1171]),
    bnot (bands [bvar 1097, bvar 1104, bvar 1162, bvar 1169]),
    bnot (bands [bvar 1097, bvar 1105, bvar 1162, bvar 1170]),
    bnot (bands [bvar 1097, bvar 1106, bvar 1162, bvar 1171]),
    bnot (bands [bvar 1099, bvar 1101, bvar 1164, bvar 1166]),
    bnot (bands [bvar 1101, bvar 1102, bvar 1166, bvar 1167]),
    bnot (bands [bvar 1104, bvar 1106, bvar 1169, bvar 1171]),
    bnot (bands [bvar 1105, bvar 1106, bvar 1170, bvar 1171]),
    bnot (bands [bvar 1094, bvar 1095, bvar 1172, bvar 1173]),
    bnot (bands [bvar 1094, bvar 1105, bvar 1172, bvar 1183]),
    bnot (bands [bvar 1094, bvar 1106, bvar 1172, bvar 1184]),
    bnot (bands [bvar 1095, bvar 1105, bvar 1173, bvar 1183]),
    bnot (bands [bvar 1095, bvar 1106, bvar 1173, bvar 1184]),
    bnot (bands [bvar 1096, bvar 1106, bvar 1174, bvar 1184]),
    bnot (bands [bvar 1097, bvar 1106, bvar 1175, bvar 1184]),
    bnot (bands [bvar 1099, bvar 1102, bvar 1177, bvar 1180]),
    bnot (bands [bvar 1099, bvar 1103, bvar 1177, bvar 1181]),
    bnot (bands [bvar 1100, bvar 1102, bvar 1178, bvar 1180]),
    bnot (bands [bvar 1100, bvar 1103, bvar 1178, bvar 1181]),
    bnot (bands [bvar 1101, bvar 1102, bvar 1179, bvar 1180]),
    bnot (bands [bvar 1101, bvar 1103, bvar 1179, bvar 1181]),
    bnot (bands [bvar 1102, bvar 1103, bvar 1180, bvar 1181]),
    bnot (bands [bvar 1105, bvar 1106, bvar 1183, bvar 1184]),
    bnot (bands [bvar 1094, bvar 1096, bvar 1185, bvar 1187]),
    bnot (bands [bvar 1096, bvar 1106, bvar 1187, bvar 1197]),
    bnot (bands [bvar 1099, bvar 1103, bvar 1190, bvar 1194]),
    bnot (bands [bvar 1099, bvar 1104, bvar 1190, bvar 1195]),
    bnot (bands [bvar 1100, bvar 1103, bvar 1191, bvar 1194]),
    bnot (bands [bvar 1100, bvar 1104, bvar 1191, bvar 1195]),
    bnot (bands [bvar 1101, bvar 1103, bvar 1192, bvar 1194]),
    bnot (bands [bvar 1101, bvar 1104, bvar 1192, bvar 1195]),
    bnot (bands [bvar 1102, bvar 1103, bvar 1193, bvar 1194]),
    ...
    bnot (bands [bvar 1099, bvar 1105, bvar 1203, bvar 1209]),
    ...
    bnot (bands [bvar 1108, bvar 1111, bvar 1121, bvar 1124]),
    bnot (bands [bvar 1108, bvar 1114, bvar 1121, bvar 1127]),
    bnot (bands [bvar 1108, bvar 1115, bvar 1121, bvar 1128]),
    bnot (bands [bvar 1109, bvar 1110, bvar 1122, bvar 1123]),
    bnot (bands [bvar 1109, bvar 1111, bvar 1122, bvar 1124]),
    bnot (bands [bvar 1109, bvar 1114, bvar 1122, bvar 1127]),
    bnot (bands [bvar 1109, bvar 1115, bvar 1122, bvar 1128]),
    ...
    bnot (bands [bvar 1111, bvar 1115, bvar 1124, bvar 1128]),
