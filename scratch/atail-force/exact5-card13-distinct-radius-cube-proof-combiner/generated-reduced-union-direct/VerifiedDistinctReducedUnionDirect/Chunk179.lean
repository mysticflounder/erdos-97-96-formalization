...
def reducedUnionChunk179Assertions : List BVLogicalExpr :=
  [ bimplies (bnot (bbeq (bvar 5) (bvar 11))) (bands [bnot (bveq ((.var 1591 : BVExpr 7)) ((.var 1597 : BVExpr 7)))]),
    ...
    bimplies (bnot (bbeq (bvar 1656) (bvar 1659))) (bands [bnot (bveq ((.var 1586 : BVExpr 7)) ((.var 1607 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1656) (bvar 1660))) (bands [bnot (bveq ((.var 1586 : BVExpr 7)) ((.var 1612 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1656) (bvar 1662))) (bands [bnot (bveq ((.var 1586 : BVExpr 7)) ((.var 1617 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1656) (bvar 1663))) (bands [bnot (bveq ((.var 1586 : BVExpr 7)) ((.var 1618 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1656) (bvar 1664))) (bands [bnot (bveq ((.var 1586 : BVExpr 7)) ((.var 1619 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1656) (bvar 1665))) (bands [bnot (bveq ((.var 1586 : BVExpr 7)) ((.var 1620 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1657) (bvar 1658))) (bands [bnot (bveq ((.var 1594 : BVExpr 7)) ((.var 1601 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1657) (bvar 1659))) (bands [bnot (bveq ((.var 1594 : BVExpr 7)) ((.var 1607 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1657) (bvar 1660))) (bands [bnot (bveq ((.var 1594 : BVExpr 7)) ((.var 1612 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1657) (bvar 1662))) (bands [bnot (bveq ((.var 1594 : BVExpr 7)) ((.var 1617 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1657) (bvar 1663))) (bands [bnot (bveq ((.var 1594 : BVExpr 7)) ((.var 1618 : BVExpr 7)))]),
    bimplies (bnot (bbeq (bvar 1657) (bvar 1664))) (bands [bnot (bveq ((.var 1594 : BVExpr 7)) ((.var 1619 : BVExpr 7)))]) ]

def reducedUnionChunk179 : BVLogicalExpr :=
  bands reducedUnionChunk179Assertions
