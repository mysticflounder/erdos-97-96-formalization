...
def reducedUnionChunk001Assertions : List BVLogicalExpr :=
  [ bnot (bands [bvar 1047, bvar 1048, bvar 1060, bvar 1061]),
    ...
    bnot (bands [bvar 1048, bvar 1052, bvar 1074, bvar 1078]),
    bnot (bands [bvar 1048, bvar 1053, bvar 1074, bvar 1079]),
    bnot (bands [bvar 1048, bvar 1054, bvar 1074, bvar 1080]),
    bnot (bands [bvar 1049, bvar 1050, bvar 1075, bvar 1076]),
    bnot (bands [bvar 1049, bvar 1051, bvar 1075, bvar 1077]),
