...
def reducedUnionChunk136Assertions : List BVLogicalExpr :=
  [ bimplies (bvar 644) (bvar 1658),
    bimplies (bvar 645) (bvar 1659),
    bimplies (bvar 646) (bvar 1660),
    bimplies (bvar 648) (bvar 1662),
    bimplies (bvar 649) (bvar 1663),
    bimplies (bvar 650) (bvar 1664),
    bimplies (bvar 651) (bvar 1665),
    ...
    bnot (bvar 1648),
    atMost [bvar 1628, bvar 1629, bvar 1630] 1,
