...
def reducedUnionChunk000Assertions : List BVLogicalExpr :=
  [ bnot (bvar 1042),
    ...
    atMost [bands [bvar 1081, bvar 1120], bands [bvar 1082, bvar 1121], bands [bvar 1083, bvar 1122], bands [bvar 1084, bvar 1123], bands [bvar 1085, bvar 1124], bands [bvar 1086, bvar 1125], bands [bvar 1087, bvar 1126], bands [bvar 1088, bvar 1127], bands [bvar 1089, bvar 1128], bands [bvar 1090, bvar 1129], bands [bvar 1091, bvar 1130], bands [bvar 1092, bvar 1131], bands [bvar 1093, bvar 1132]] 2,
    atMost [bands [bvar 1107, bvar 1172], bands [bvar 1108, bvar 1173], bands [bvar 1109, bvar 1174], bands [bvar 1110, bvar 1175], bands [bvar 1111, bvar 1176], bands [bvar 1112, bvar 1177], bands [bvar 1113, bvar 1178], bands [bvar 1114, bvar 1179], bands [bvar 1115, bvar 1180], bands [bvar 1116, bvar 1181], bands [bvar 1117, bvar 1182], bands [bvar 1118, bvar 1183], bands [bvar 1119, bvar 1184]] 2,
    atMost [bands [bvar 1120, bvar 1172], bands [bvar 1121, bvar 1173], bands [bvar 1122, bvar 1174], bands [bvar 1123, bvar 1175], bands [bvar 1124, bvar 1176], bands [bvar 1125, bvar 1177], bands [bvar 1126, bvar 1178], bands [bvar 1127, bvar 1179], bands [bvar 1128, bvar 1180], bands [bvar 1129, bvar 1181], bands [bvar 1130, bvar 1182], bands [bvar 1131, bvar 1183], bands [bvar 1132, bvar 1184]] 2,
    atMost [bands [bvar 1133, bvar 1172], bands [bvar 1134, bvar 1173], bands [bvar 1135, bvar 1174], bands [bvar 1136, bvar 1175], bands [bvar 1137, bvar 1176], bands [bvar 1138, bvar 1177], bands [bvar 1139, bvar 1178], bands [bvar 1140, bvar 1179], bands [bvar 1141, bvar 1180], bands [bvar 1142, bvar 1181], bands [bvar 1143, bvar 1182], bands [bvar 1144, bvar 1183], bands [bvar 1145, bvar 1184]] 2,
    atMost [bands [bvar 1159, bvar 1198], bands [bvar 1160, bvar 1199], bands [bvar 1161, bvar 1200], bands [bvar 1162, bvar 1201], bands [bvar 1163, bvar 1202], bands [bvar 1164, bvar 1203], bands [bvar 1165, bvar 1204], bands [bvar 1166, bvar 1205], bands [bvar 1167, bvar 1206], bands [bvar 1168, bvar 1207], bands [bvar 1169, bvar 1208], bands [bvar 1170, bvar 1209], bands [bvar 1171, bvar 1210]] 2,
    ...
    atMost [bands [bvar 1045, bvar 1052], bands [bvar 1058, bvar 1065], bands [bvar 1071, bvar 1078], bands [bvar 1084, bvar 1091], bands [bvar 1097, bvar 1104], bands [bvar 1110, bvar 1117], bands [bvar 1123, bvar 1130], bands [bvar 1136, bvar 1143], bands [bvar 1149, bvar 1156], bands [bvar 1162, bvar 1169], bands [bvar 1175, bvar 1182], bands [bvar 1188, bvar 1195], bands [bvar 1201, bvar 1208]] 2,
    ...
    atMost [bands [bvar 1047, bvar 1051], bands [bvar 1060, bvar 1064], bands [bvar 1073, bvar 1077], bands [bvar 1086, bvar 1090], bands [bvar 1099, bvar 1103], bands [bvar 1112, bvar 1116], bands [bvar 1125, bvar 1129], bands [bvar 1138, bvar 1142], bands [bvar 1151, bvar 1155], bands [bvar 1164, bvar 1168], bands [bvar 1177, bvar 1181], bands [bvar 1190, bvar 1194], bands [bvar 1203, bvar 1207]] 2,
    ...
    atMost [bands [bvar 1047, bvar 1053], bands [bvar 1060, bvar 1066], bands [bvar 1073, bvar 1079], bands [bvar 1086, bvar 1092], bands [bvar 1099, bvar 1105], bands [bvar 1112, bvar 1118], bands [bvar 1125, bvar 1131], bands [bvar 1138, bvar 1144], bands [bvar 1151, bvar 1157], bands [bvar 1164, bvar 1170], bands [bvar 1177, bvar 1183], bands [bvar 1190, bvar 1196], bands [bvar 1203, bvar 1209]] 2,
    ...
    atMost [bands [bvar 1049, bvar 1053], bands [bvar 1062, bvar 1066], bands [bvar 1075, bvar 1079], bands [bvar 1088, bvar 1092], bands [bvar 1101, bvar 1105], bands [bvar 1114, bvar 1118], bands [bvar 1127, bvar 1131], bands [bvar 1140, bvar 1144], bands [bvar 1153, bvar 1157], bands [bvar 1166, bvar 1170], bands [bvar 1179, bvar 1183], bands [bvar 1192, bvar 1196], bands [bvar 1205, bvar 1209]] 2,
