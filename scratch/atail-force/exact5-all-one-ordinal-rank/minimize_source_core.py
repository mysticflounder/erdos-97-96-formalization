#!/usr/bin/env python3
"""Shrink a source-indexed all-one core with Z3 assumptions."""
...
def main() -> None:
    ...
    outer, _rank, counts = ordinal.build(old["orbit"], args.seed, 0)
    ...
    payload: dict[str, object] = {
        "schema": "p97-exact5-card13-all-one-minimized-source-core-v1",
        "orbit": old["orbit"],
