...
# Exact QQ change-matrix certificate for the deletion-minimal five-row core
# extracted from the source-indexed (6,5,4) target-negative survivor.
...
# AbstractAlgebra prints rationals as `a//b`; `/` is the shared syntax used by
# the independent SymPy replay and the generated Lean source.
...
output = isempty(ARGS) ?
    joinpath(@__DIR__, "unit_core_source_indexed_654_certificate.json") : ARGS[1]
open(output, "w") do io
    println(io, "{")
    println(io, "  \"schema\": \"p97-atail-qq-change-matrix-certificate-v1\",")
    println(io, "  \"target\": \"normalized_unit_core_source_indexed_654\",")
    println(io, "  \"coordinate_model\": \"p0_zero_p1_e1\",")
    println(io, "  \"source_row_signature_sha256\": ",
        json_quote("5fd78b83e7ba5150f3607a15f7d59da01a7ae7645a07640762a72bbc659af344"), ",")
    println(io, "  \"source_full_equality_sha256\": ",
        json_quote("8bd0b3bc69181488231d58874ccac6945c044619135dcf3e39bb28ead0b86407"), ",")
