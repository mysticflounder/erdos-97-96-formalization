...
import unit_core_source_indexed_654_33_scalar_certificate
...
private theorem sourceIndexed_654_33_dist_sq_coord (x y : ℝ²) :
    dist x y ^ 2 = (x 0 - y 0) ^ 2 + (x 1 - y 1) ^ 2 := by
  rw [EuclideanSpace.dist_sq_eq]
  simp [Fin.sum_univ_two, Real.dist_eq, sq_abs]

/-- The normalized active equality subsystem is inconsistent. -/
private theorem normalized_sourceIndexed_654_33_incompatible
    {P2 P3 P4 P5 P9 P11 : ℝ²}
    ...
    (h08 : dist P2 (pt 0 0) = dist P2 P5)
    (h09 : dist P2 (pt 0 0) = dist P2 P9)
    (h10 : dist P3 P2 = dist P3 P5)
    (h12 : dist P3 P2 = dist P3 P11)
    (h13 : dist P4 P2 = dist P4 P3)
    (h15 : dist P4 P2 = dist P4 P9)
    (h16 : dist P5 (pt 1 0) = dist P5 P4)
    : False := by
  ...
  change dist P2 (pt 0 0) ^ 2 = dist P2 P5 ^ 2 at h08sq
  change dist P2 (pt 0 0) ^ 2 = dist P2 P9 ^ 2 at h09sq
  change dist P3 P2 ^ 2 = dist P3 P5 ^ 2 at h10sq
  change dist P3 P2 ^ 2 = dist P3 P11 ^ 2 at h12sq
  change dist P4 P2 ^ 2 = dist P4 P3 ^ 2 at h13sq
  change dist P4 P2 ^ 2 = dist P4 P9 ^ 2 at h15sq
  change dist P5 (pt 1 0) ^ 2 = dist P5 P4 ^ 2 at h16sq
  rw [sourceIndexed_654_33_dist_sq_coord, sourceIndexed_654_33_dist_sq_coord] at h01sq h02sq h04sq h05sq h06sq h07sq h08sq h09sq h10sq h12sq h13sq h15sq h16sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at
    h01sq h02sq h04sq h05sq h06sq h07sq h08sq h09sq h10sq h12sq h13sq h15sq h16sq
  apply normalizedUnitCoreSourceIndexed65433Certificate
    (P2 0) (P2 1) (P3 0) (P3 1) (P4 0) (P4 1) (P5 0) (P5 1) (P9 0) (P9 1) (P11 0) (P11 1)
  · nlinarith [h01sq]
  · nlinarith [h02sq]
  · nlinarith [h04sq]
  · nlinarith [h05sq]
...
theorem sourceIndexed_654_33_anchor_collision
    {P0 P1 P2 P3 P4 P5 P9 P11 : ℝ²}
    ...
    (h08 : dist P2 P0 = dist P2 P5)
    (h09 : dist P2 P0 = dist P2 P9)
    (h10 : dist P3 P2 = dist P3 P5)
    (h12 : dist P3 P2 = dist P3 P11)
    (h13 : dist P4 P2 = dist P4 P3)
    (h15 : dist P4 P2 = dist P4 P9)
    (h16 : dist P5 P1 = dist P5 P4)
    : P0 = P1 := by
  by_contra h01ne
  ...
  have map_dist_eq {X Y Z R : ℝ²} (h : dist X Y = dist Z R) :
    ...
    rw [hdist, hdist, h]
  apply normalized_sourceIndexed_654_33_incompatible
      (P2 := p2) (P3 := p3) (P4 := p4) (P5 := p5) (P9 := p9) (P11 := p11)
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h01
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h02
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h04
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h05
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h06
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h07
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h08
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h09
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h10
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h12
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h13
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h15
  · simpa [p2, p3, p4, p5, p9, p11, hT0, hT1] using map_dist_eq h16

/-- Equality-closure form of the generated anchor collision. -/
structure UnitCoreSourceIndexed65433CollisionCore {alpha : Type*}
  ...
  h08 : Census554.EqualityCore.EdgeClosure P (P2, P0) (P2, P5)
  h09 : Census554.EqualityCore.EdgeClosure P (P2, P0) (P2, P9)
  h10 : Census554.EqualityCore.EdgeClosure P (P3, P2) (P3, P5)
  h12 : Census554.EqualityCore.EdgeClosure P (P3, P2) (P3, P11)
  h13 : Census554.EqualityCore.EdgeClosure P (P4, P2) (P4, P3)
  h15 : Census554.EqualityCore.EdgeClosure P (P4, P2) (P4, P9)
  h16 : Census554.EqualityCore.EdgeClosure P (P5, P1) (P5, P4)

/-- A matching equality-closure core has no injective planar realization. -/
theorem not_realizes_of_unitCoreSourceIndexed65433CollisionCore
    {alpha : Type*} {P : Census554.EqualityCore.RowPattern alpha}
    (core : UnitCoreSourceIndexed65433CollisionCore P) :
  ...
  have hcollision := sourceIndexed_654_33_anchor_collision
...
#print axioms normalizedUnitCoreSourceIndexed65433Certificate
#print axioms sourceIndexed_654_33_anchor_collision
#print axioms not_realizes_of_unitCoreSourceIndexed65433CollisionCore
