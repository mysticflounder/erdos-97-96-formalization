...
import unit_core_source_indexed_654_47_scalar_certificate
...
private theorem sourceIndexed_654_47_dist_sq_coord (x y : ℝ²) :
    dist x y ^ 2 = (x 0 - y 0) ^ 2 + (x 1 - y 1) ^ 2 := by
  rw [EuclideanSpace.dist_sq_eq]
  simp [Fin.sum_univ_two, Real.dist_eq, sq_abs]

/-- The normalized active equality subsystem is inconsistent. -/
private theorem normalized_sourceIndexed_654_47_incompatible
    {P2 P4 P8 P9 P10 P11 : ℝ²}
  ...
  rw [sourceIndexed_654_47_dist_sq_coord, sourceIndexed_654_47_dist_sq_coord] at h01sq h03sq h04sq h05sq h06sq h07sq h09sq h10sq h11sq h14sq h18sq h19sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at
    h01sq h03sq h04sq h05sq h06sq h07sq h09sq h10sq h11sq h14sq h18sq h19sq
  apply normalizedUnitCoreSourceIndexed65447Certificate
    (P2 0) (P2 1) (P4 0) (P4 1) (P8 0) (P8 1) (P9 0) (P9 1) (P10 0) (P10 1) (P11 0) (P11 1)
  · nlinarith [h01sq]
  · nlinarith [h03sq]
  · nlinarith [h04sq]
  · nlinarith [h05sq]
...
theorem sourceIndexed_654_47_anchor_collision
    {P0 P1 P2 P4 P8 P9 P10 P11 : ℝ²}
  ...
  have map_dist_eq {X Y Z R : ℝ²} (h : dist X Y = dist Z R) :
    ...
    rw [hdist, hdist, h]
  apply normalized_sourceIndexed_654_47_incompatible
      (P2 := p2) (P4 := p4) (P8 := p8) (P9 := p9) (P10 := p10) (P11 := p11)
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h01
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h03
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h04
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h05
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h06
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h07
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h09
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h10
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h11
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h14
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h18
  · simpa [p2, p4, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h19

/-- Equality-closure form of the generated anchor collision. -/
structure UnitCoreSourceIndexed65447CollisionCore {alpha : Type*}
...
theorem not_realizes_of_unitCoreSourceIndexed65447CollisionCore
    {alpha : Type*} {P : Census554.EqualityCore.RowPattern alpha}
    (core : UnitCoreSourceIndexed65447CollisionCore P) :
  ...
  have hcollision := sourceIndexed_654_47_anchor_collision
...
#print axioms normalizedUnitCoreSourceIndexed65447Certificate
#print axioms sourceIndexed_654_47_anchor_collision
#print axioms not_realizes_of_unitCoreSourceIndexed65447CollisionCore
