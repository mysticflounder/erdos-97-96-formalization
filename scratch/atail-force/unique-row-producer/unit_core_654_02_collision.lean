...
import unit_core_654_02_scalar_certificate
...
private theorem unit_core_654_02_dist_sq_coord (x y : ℝ²) :
    dist x y ^ 2 = (x 0 - y 0) ^ 2 + (x 1 - y 1) ^ 2 := by
  rw [EuclideanSpace.dist_sq_eq]
  simp [Fin.sum_univ_two, Real.dist_eq, sq_abs]

/-- The normalized active equality subsystem is inconsistent. -/
private theorem normalized_unit_core_654_02_incompatible
    {P2 P3 P4 P5 P7 P8 P9 P11 : ℝ²}
    ...
    (h05 : dist (pt 1 0) (pt 0 0) = dist (pt 1 0) P4)
    ...
    (h11 : dist P8 P3 = dist P8 P7)
    (h12 : dist P8 P3 = dist P8 P9)
    (h13 : dist P8 P3 = dist P8 P11)
    (h14 : dist P9 P2 = dist P9 P3)
    (h15 : dist P9 P2 = dist P9 P4)
    (h16 : dist P9 P2 = dist P9 P5)
  ...
  change dist (pt 1 0) (pt 0 0) ^ 2 = dist (pt 1 0) P4 ^ 2 at h05sq
  ...
  change dist P8 P3 ^ 2 = dist P8 P7 ^ 2 at h11sq
  change dist P8 P3 ^ 2 = dist P8 P9 ^ 2 at h12sq
  change dist P8 P3 ^ 2 = dist P8 P11 ^ 2 at h13sq
  change dist P9 P2 ^ 2 = dist P9 P3 ^ 2 at h14sq
  change dist P9 P2 ^ 2 = dist P9 P4 ^ 2 at h15sq
  change dist P9 P2 ^ 2 = dist P9 P5 ^ 2 at h16sq
  change dist P11 (pt 0 0) ^ 2 = dist P11 P5 ^ 2 at h17sq
  change dist P11 (pt 0 0) ^ 2 = dist P11 P7 ^ 2 at h18sq
  rw [unit_core_654_02_dist_sq_coord, unit_core_654_02_dist_sq_coord] at h01sq h02sq h03sq h04sq h05sq h06sq h07sq h09sq h10sq h11sq h12sq h13sq h14sq h15sq h16sq h17sq h18sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at
    h01sq h02sq h03sq h04sq h05sq h06sq h07sq h09sq h10sq h11sq h12sq h13sq h14sq h15sq h16sq h17sq h18sq
  apply normalizedUnitCore65402Certificate
    (P2 0) (P2 1) (P3 0) (P3 1) (P4 0) (P4 1) (P5 0) (P5 1) (P7 0) (P7 1) (P8 0) (P8 1) (P9 0) (P9 1) (P11 0) (P11 1)
  · nlinarith [h01sq]
  · nlinarith [h02sq]
  · nlinarith [h03sq]
  · nlinarith [h04sq]
...
theorem unit_core_654_02_anchor_collision
  ...
  have map_dist_eq {X Y Z R : ℝ²} (h : dist X Y = dist Z R) :
    ...
    rw [hdist, hdist, h]
  apply normalized_unit_core_654_02_incompatible
      (P2 := p2) (P3 := p3) (P4 := p4) (P5 := p5) (P7 := p7) (P8 := p8) (P9 := p9) (P11 := p11)
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h01
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h02
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h03
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h04
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h05
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h06
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h07
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h09
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h10
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h11
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h12
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h13
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h14
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h15
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h16
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h17
  · simpa [p2, p3, p4, p5, p7, p8, p9, p11, hT0, hT1] using map_dist_eq h18

/-- Equality-closure form of the generated anchor collision. -/
structure UnitCore65402CollisionCore {alpha : Type*}
  ...
  h05 : Census554.EqualityCore.EdgeClosure P (P1, P0) (P1, P4)
  ...
  h11 : Census554.EqualityCore.EdgeClosure P (P8, P3) (P8, P7)
  h12 : Census554.EqualityCore.EdgeClosure P (P8, P3) (P8, P9)
  h13 : Census554.EqualityCore.EdgeClosure P (P8, P3) (P8, P11)
  h14 : Census554.EqualityCore.EdgeClosure P (P9, P2) (P9, P3)
  h15 : Census554.EqualityCore.EdgeClosure P (P9, P2) (P9, P4)
  h16 : Census554.EqualityCore.EdgeClosure P (P9, P2) (P9, P5)
...
theorem not_realizes_of_unitCore65402CollisionCore
    {alpha : Type*} {P : Census554.EqualityCore.RowPattern alpha}
    (core : UnitCore65402CollisionCore P) :
  ...
  have hcollision := unit_core_654_02_anchor_collision
...
#print axioms normalizedUnitCore65402Certificate
#print axioms unit_core_654_02_anchor_collision
#print axioms not_realizes_of_unitCore65402CollisionCore
