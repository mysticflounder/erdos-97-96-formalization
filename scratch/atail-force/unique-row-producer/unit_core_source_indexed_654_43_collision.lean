...
import unit_core_source_indexed_654_43_scalar_certificate
...
private theorem sourceIndexed_654_43_dist_sq_coord (x y : ℝ²) :
    dist x y ^ 2 = (x 0 - y 0) ^ 2 + (x 1 - y 1) ^ 2 := by
  rw [EuclideanSpace.dist_sq_eq]
  simp [Fin.sum_univ_two, Real.dist_eq, sq_abs]

/-- The normalized active equality subsystem is inconsistent. -/
private theorem normalized_sourceIndexed_654_43_incompatible
    ...
    (h08 : dist P8 P6 = dist P8 P7)
    (h09 : dist P8 P6 = dist P8 P9)
    (h10 : dist P8 P6 = dist P8 P11)
    (h11 : dist P9 (pt 0 0) = dist P9 P2)
    (h12 : dist P9 (pt 0 0) = dist P9 P3)
    (h14 : dist P10 (pt 0 0) = dist P10 (pt 1 0))
    (h17 : dist P11 (pt 1 0) = dist P11 P3)
  ...
  change dist P8 P6 ^ 2 = dist P8 P7 ^ 2 at h08sq
  change dist P8 P6 ^ 2 = dist P8 P9 ^ 2 at h09sq
  change dist P8 P6 ^ 2 = dist P8 P11 ^ 2 at h10sq
  change dist P9 (pt 0 0) ^ 2 = dist P9 P2 ^ 2 at h11sq
  change dist P9 (pt 0 0) ^ 2 = dist P9 P3 ^ 2 at h12sq
  change dist P10 (pt 0 0) ^ 2 = dist P10 (pt 1 0) ^ 2 at h14sq
  change dist P11 (pt 1 0) ^ 2 = dist P11 P3 ^ 2 at h17sq
  change dist P11 (pt 1 0) ^ 2 = dist P11 P7 ^ 2 at h18sq
  change dist P11 (pt 1 0) ^ 2 = dist P11 P10 ^ 2 at h19sq
  rw [sourceIndexed_654_43_dist_sq_coord, sourceIndexed_654_43_dist_sq_coord] at h01sq h02sq h03sq h04sq h05sq h06sq h07sq h08sq h09sq h10sq h11sq h12sq h14sq h17sq h18sq h19sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at
    h01sq h02sq h03sq h04sq h05sq h06sq h07sq h08sq h09sq h10sq h11sq h12sq h14sq h17sq h18sq h19sq
  apply normalizedUnitCoreSourceIndexed65443Certificate
...
theorem sourceIndexed_654_43_anchor_collision
    ...
    (h12 : dist P9 P0 = dist P9 P3)
    (h14 : dist P10 P0 = dist P10 P1)
    (h17 : dist P11 P1 = dist P11 P3)
  ...
  have map_dist_eq {X Y Z R : ℝ²} (h : dist X Y = dist Z R) :
    ...
    rw [hdist, hdist, h]
  apply normalized_sourceIndexed_654_43_incompatible
  ...
  · simpa [p2, p3, p6, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h05
  ...
  · simpa [p2, p3, p6, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h12
  · simpa [p2, p3, p6, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h14
  · simpa [p2, p3, p6, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h17
...
structure UnitCoreSourceIndexed65443CollisionCore {alpha : Type*}
  ...
  h08 : Census554.EqualityCore.EdgeClosure P (P8, P6) (P8, P7)
  h09 : Census554.EqualityCore.EdgeClosure P (P8, P6) (P8, P9)
  h10 : Census554.EqualityCore.EdgeClosure P (P8, P6) (P8, P11)
  h11 : Census554.EqualityCore.EdgeClosure P (P9, P0) (P9, P2)
  h12 : Census554.EqualityCore.EdgeClosure P (P9, P0) (P9, P3)
  h14 : Census554.EqualityCore.EdgeClosure P (P10, P0) (P10, P1)
  h17 : Census554.EqualityCore.EdgeClosure P (P11, P1) (P11, P3)
...
theorem not_realizes_of_unitCoreSourceIndexed65443CollisionCore
    {alpha : Type*} {P : Census554.EqualityCore.RowPattern alpha}
    (core : UnitCoreSourceIndexed65443CollisionCore P) :
  ...
  have hcollision := sourceIndexed_654_43_anchor_collision
...
#print axioms normalizedUnitCoreSourceIndexed65443Certificate
#print axioms sourceIndexed_654_43_anchor_collision
#print axioms not_realizes_of_unitCoreSourceIndexed65443CollisionCore
