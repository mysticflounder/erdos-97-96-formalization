...
import unit_core_source_indexed_654_58_scalar_certificate
...
private theorem normalized_sourceIndexed_654_58_incompatible
  ...
  change dist (pt 1 0) P3 ^ 2 = dist (pt 1 0) P9 ^ 2 at h05sq
  change dist (pt 1 0) P3 ^ 2 = dist (pt 1 0) P11 ^ 2 at h06sq
  ...
  change dist P3 P2 ^ 2 = dist P3 P9 ^ 2 at h12sq
  change dist P3 P2 ^ 2 = dist P3 P10 ^ 2 at h13sq
  change dist P4 (pt 0 0) ^ 2 = dist P4 (pt 1 0) ^ 2 at h14sq
  change dist P4 (pt 0 0) ^ 2 = dist P4 P9 ^ 2 at h16sq
  rw [sourceIndexed_654_58_dist_sq_coord, sourceIndexed_654_58_dist_sq_coord] at h01sq h02sq h03sq h05sq h06sq h07sq h08sq h10sq h12sq h13sq h14sq h16sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at
    h01sq h02sq h03sq h05sq h06sq h07sq h08sq h10sq h12sq h13sq h14sq h16sq
  apply normalizedUnitCoreSourceIndexed65458Certificate
    (P2 0) (P2 1) (P3 0) (P3 1) (P4 0) (P4 1) (P9 0) (P9 1) (P10 0) (P10 1) (P11 0) (P11 1)
  · nlinarith [h01sq]
  · nlinarith [h02sq]
  · nlinarith [h03sq]
  · nlinarith [h05sq]
...
theorem sourceIndexed_654_58_anchor_collision
    {P0 P1 P2 P3 P4 P9 P10 P11 : ℝ²}
    (h01 : dist P0 P1 = dist P0 P2)
    (h02 : dist P0 P1 = dist P0 P3)
    (h03 : dist P0 P1 = dist P0 P11)
    (h05 : dist P1 P3 = dist P1 P9)
    (h06 : dist P1 P3 = dist P1 P11)
  ...
  have map_dist_eq {X Y Z R : ℝ²} (h : dist X Y = dist Z R) :
    ...
    rw [hdist, hdist, h]
  apply normalized_sourceIndexed_654_58_incompatible
      (P2 := p2) (P3 := p3) (P4 := p4) (P9 := p9) (P10 := p10) (P11 := p11)
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h01
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h02
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h03
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h05
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h06
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h07
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h08
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h10
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h12
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h13
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h14
  · simpa [p2, p3, p4, p9, p10, p11, hT0, hT1] using map_dist_eq h16

/-- Equality-closure form of the generated anchor collision. -/
structure UnitCoreSourceIndexed65458CollisionCore {alpha : Type*}
  ...
  h05 : Census554.EqualityCore.EdgeClosure P (P1, P3) (P1, P9)
  h06 : Census554.EqualityCore.EdgeClosure P (P1, P3) (P1, P11)
  ...
  h12 : Census554.EqualityCore.EdgeClosure P (P3, P2) (P3, P9)
  h13 : Census554.EqualityCore.EdgeClosure P (P3, P2) (P3, P10)
  h14 : Census554.EqualityCore.EdgeClosure P (P4, P0) (P4, P1)
  h16 : Census554.EqualityCore.EdgeClosure P (P4, P0) (P4, P9)

/-- A matching equality-closure core has no injective planar realization. -/
theorem not_realizes_of_unitCoreSourceIndexed65458CollisionCore
    {alpha : Type*} {P : Census554.EqualityCore.RowPattern alpha}
    (core : UnitCoreSourceIndexed65458CollisionCore P) :
  ...
  have hcollision := sourceIndexed_654_58_anchor_collision
...
#print axioms normalizedUnitCoreSourceIndexed65458Certificate
#print axioms sourceIndexed_654_58_anchor_collision
#print axioms not_realizes_of_unitCoreSourceIndexed65458CollisionCore
