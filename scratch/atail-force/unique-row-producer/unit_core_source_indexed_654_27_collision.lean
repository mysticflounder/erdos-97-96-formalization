...
import unit_core_source_indexed_654_27_scalar_certificate
...
private theorem unit_core_sourceIndexed_654_27_dist_sq_coord (x y : ℝ²) :
    dist x y ^ 2 = (x 0 - y 0) ^ 2 + (x 1 - y 1) ^ 2 := by
  rw [EuclideanSpace.dist_sq_eq]
  simp [Fin.sum_univ_two, Real.dist_eq, sq_abs]

/-- The normalized active equality subsystem is inconsistent. -/
private theorem normalized_unit_core_sourceIndexed_654_27_incompatible
    {P2 P3 P4 P5 P6 P7 P9 P10 : ℝ²}
    ...
    (h06 : dist (pt 1 0) P4 = dist (pt 1 0) P9)
    (h07 : dist (pt 1 0) P4 = dist (pt 1 0) P10)
    (h08 : dist P3 (pt 1 0) = dist P3 P5)
    (h09 : dist P3 (pt 1 0) = dist P3 P6)
    (h11 : dist P4 P2 = dist P4 P3)
    (h12 : dist P4 P2 = dist P4 P5)
    (h13 : dist P4 P2 = dist P4 P10)
    (h14 : dist P5 (pt 0 0) = dist P5 P4)
    (h15 : dist P5 (pt 0 0) = dist P5 P6)
    (h16 : dist P5 (pt 0 0) = dist P5 P7)
    (h17 : dist P9 (pt 0 0) = dist P9 P3)
    (h18 : dist P9 (pt 0 0) = dist P9 P5)
    (h19 : dist P9 (pt 0 0) = dist P9 P7)
    : False := by
  ...
  change dist (pt 1 0) P4 ^ 2 = dist (pt 1 0) P9 ^ 2 at h06sq
  change dist (pt 1 0) P4 ^ 2 = dist (pt 1 0) P10 ^ 2 at h07sq
  change dist P3 (pt 1 0) ^ 2 = dist P3 P5 ^ 2 at h08sq
  change dist P3 (pt 1 0) ^ 2 = dist P3 P6 ^ 2 at h09sq
  change dist P4 P2 ^ 2 = dist P4 P3 ^ 2 at h11sq
  change dist P4 P2 ^ 2 = dist P4 P5 ^ 2 at h12sq
  change dist P4 P2 ^ 2 = dist P4 P10 ^ 2 at h13sq
  change dist P5 (pt 0 0) ^ 2 = dist P5 P4 ^ 2 at h14sq
  change dist P5 (pt 0 0) ^ 2 = dist P5 P6 ^ 2 at h15sq
  change dist P5 (pt 0 0) ^ 2 = dist P5 P7 ^ 2 at h16sq
  change dist P9 (pt 0 0) ^ 2 = dist P9 P3 ^ 2 at h17sq
  change dist P9 (pt 0 0) ^ 2 = dist P9 P5 ^ 2 at h18sq
  change dist P9 (pt 0 0) ^ 2 = dist P9 P7 ^ 2 at h19sq
  rw [unit_core_sourceIndexed_654_27_dist_sq_coord, unit_core_sourceIndexed_654_27_dist_sq_coord] at h01sq h02sq h03sq h04sq h06sq h07sq h08sq h09sq h11sq h12sq h13sq h14sq h15sq h16sq h17sq h18sq h19sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at
    h01sq h02sq h03sq h04sq h06sq h07sq h08sq h09sq h11sq h12sq h13sq h14sq h15sq h16sq h17sq h18sq h19sq
  apply normalizedUnitCoreSourceIndexed65427Certificate
    (P2 0) (P2 1) (P3 0) (P3 1) (P4 0) (P4 1) (P5 0) (P5 1) (P6 0) (P6 1) (P7 0) (P7 1) (P9 0) (P9 1) (P10 0) (P10 1)
  · nlinarith [h01sq]
  · nlinarith [h02sq]
  · nlinarith [h03sq]
  · nlinarith [h04sq]
...
theorem unit_core_sourceIndexed_654_27_anchor_collision
    {P0 P1 P2 P3 P4 P5 P6 P7 P9 P10 : ℝ²}
    (h01 : dist P0 P1 = dist P0 P3)
    (h02 : dist P0 P1 = dist P0 P6)
    (h03 : dist P0 P1 = dist P0 P9)
    (h04 : dist P1 P4 = dist P1 P7)
    (h06 : dist P1 P4 = dist P1 P9)
    (h07 : dist P1 P4 = dist P1 P10)
    (h08 : dist P3 P1 = dist P3 P5)
    (h09 : dist P3 P1 = dist P3 P6)
    (h11 : dist P4 P2 = dist P4 P3)
    (h12 : dist P4 P2 = dist P4 P5)
    (h13 : dist P4 P2 = dist P4 P10)
    (h14 : dist P5 P0 = dist P5 P4)
    (h15 : dist P5 P0 = dist P5 P6)
    (h16 : dist P5 P0 = dist P5 P7)
    (h17 : dist P9 P0 = dist P9 P3)
    (h18 : dist P9 P0 = dist P9 P5)
    (h19 : dist P9 P0 = dist P9 P7)
    : P0 = P1 := by
  by_contra h01ne
  ...
  have map_dist_eq {X Y Z R : ℝ²} (h : dist X Y = dist Z R) :
    ...
    rw [hdist, hdist, h]
  apply normalized_unit_core_sourceIndexed_654_27_incompatible
      (P2 := p2) (P3 := p3) (P4 := p4) (P5 := p5) (P6 := p6) (P7 := p7) (P9 := p9) (P10 := p10)
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h01
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h02
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h03
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h04
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h06
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h07
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h08
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h09
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h11
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h12
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h13
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h14
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h15
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h16
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h17
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h18
  · simpa [p2, p3, p4, p5, p6, p7, p9, p10, hT0, hT1] using map_dist_eq h19

/-- Equality-closure form of the generated anchor collision. -/
structure UnitCoreSourceIndexed65427CollisionCore {alpha : Type*}
  ...
  h06 : Census554.EqualityCore.EdgeClosure P (P1, P4) (P1, P9)
  h07 : Census554.EqualityCore.EdgeClosure P (P1, P4) (P1, P10)
  h08 : Census554.EqualityCore.EdgeClosure P (P3, P1) (P3, P5)
  h09 : Census554.EqualityCore.EdgeClosure P (P3, P1) (P3, P6)
  h11 : Census554.EqualityCore.EdgeClosure P (P4, P2) (P4, P3)
  h12 : Census554.EqualityCore.EdgeClosure P (P4, P2) (P4, P5)
  h13 : Census554.EqualityCore.EdgeClosure P (P4, P2) (P4, P10)
  h14 : Census554.EqualityCore.EdgeClosure P (P5, P0) (P5, P4)
  h15 : Census554.EqualityCore.EdgeClosure P (P5, P0) (P5, P6)
  h16 : Census554.EqualityCore.EdgeClosure P (P5, P0) (P5, P7)
  h17 : Census554.EqualityCore.EdgeClosure P (P9, P0) (P9, P3)
  h18 : Census554.EqualityCore.EdgeClosure P (P9, P0) (P9, P5)
  h19 : Census554.EqualityCore.EdgeClosure P (P9, P0) (P9, P7)

/-- A matching equality-closure core has no injective planar realization. -/
theorem not_realizes_of_unitCoreSourceIndexed65427CollisionCore
    {alpha : Type*} {P : Census554.EqualityCore.RowPattern alpha}
    (core : UnitCoreSourceIndexed65427CollisionCore P) :
  ...
  have hcollision := unit_core_sourceIndexed_654_27_anchor_collision
...
#print axioms normalizedUnitCoreSourceIndexed65427Certificate
#print axioms unit_core_sourceIndexed_654_27_anchor_collision
#print axioms not_realizes_of_unitCoreSourceIndexed65427CollisionCore
