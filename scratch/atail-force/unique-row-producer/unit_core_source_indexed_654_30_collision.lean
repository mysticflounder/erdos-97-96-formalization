...
import unit_core_source_indexed_654_30_scalar_certificate
...
private theorem sourceIndexed_654_30_dist_sq_coord (x y : ℝ²) :
    dist x y ^ 2 = (x 0 - y 0) ^ 2 + (x 1 - y 1) ^ 2 := by
  rw [EuclideanSpace.dist_sq_eq]
  simp [Fin.sum_univ_two, Real.dist_eq, sq_abs]

/-- The normalized active equality subsystem is inconsistent. -/
private theorem normalized_sourceIndexed_654_30_incompatible
    {P2 P3 P4 P7 P8 P11 : ℝ²}
    (h01 : dist (pt 0 0) P3 = dist (pt 0 0) P4)
    (h03 : dist (pt 0 0) P3 = dist (pt 0 0) P11)
    ...
    (h09 : dist P2 (pt 0 0) = dist P2 P11)
    (h10 : dist P3 P2 = dist P3 P7)
    (h13 : dist P3 P2 = dist P3 P11)
    (h14 : dist P4 (pt 0 0) = dist P4 (pt 1 0))
    (h15 : dist P4 (pt 0 0) = dist P4 P2)
    (h16 : dist P4 (pt 0 0) = dist P4 P3)
    (h17 : dist P8 (pt 1 0) = dist P8 P4)
    (h18 : dist P8 (pt 1 0) = dist P8 P7)
    : False := by
  ...
  change dist (pt 0 0) P3 ^ 2 = dist (pt 0 0) P4 ^ 2 at h01sq
  change dist (pt 0 0) P3 ^ 2 = dist (pt 0 0) P11 ^ 2 at h03sq
  ...
  change dist P2 (pt 0 0) ^ 2 = dist P2 P11 ^ 2 at h09sq
  change dist P3 P2 ^ 2 = dist P3 P7 ^ 2 at h10sq
  change dist P3 P2 ^ 2 = dist P3 P11 ^ 2 at h13sq
  ...
  change dist P8 (pt 1 0) ^ 2 = dist P8 P4 ^ 2 at h17sq
  change dist P8 (pt 1 0) ^ 2 = dist P8 P7 ^ 2 at h18sq
  rw [sourceIndexed_654_30_dist_sq_coord, sourceIndexed_654_30_dist_sq_coord] at h01sq h03sq h04sq h05sq h06sq h08sq h09sq h10sq h13sq h14sq h15sq h16sq h17sq h18sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at
    h01sq h03sq h04sq h05sq h06sq h08sq h09sq h10sq h13sq h14sq h15sq h16sq h17sq h18sq
  apply normalizedUnitCoreSourceIndexed65430Certificate
    (P2 0) (P2 1) (P3 0) (P3 1) (P4 0) (P4 1) (P7 0) (P7 1) (P8 0) (P8 1) (P11 0) (P11 1)
  · nlinarith [h01sq]
  · nlinarith [h03sq]
  · nlinarith [h04sq]
  · nlinarith [h05sq]
...
theorem sourceIndexed_654_30_anchor_collision
    {P0 P1 P2 P3 P4 P7 P8 P11 : ℝ²}
    (h01 : dist P0 P3 = dist P0 P4)
    (h03 : dist P0 P3 = dist P0 P11)
    (h04 : dist P1 P0 = dist P1 P3)
    (h05 : dist P1 P0 = dist P1 P7)
    (h06 : dist P1 P0 = dist P1 P8)
    (h08 : dist P2 P0 = dist P2 P8)
    (h09 : dist P2 P0 = dist P2 P11)
    (h10 : dist P3 P2 = dist P3 P7)
    (h13 : dist P3 P2 = dist P3 P11)
    (h14 : dist P4 P0 = dist P4 P1)
    (h15 : dist P4 P0 = dist P4 P2)
    (h16 : dist P4 P0 = dist P4 P3)
    (h17 : dist P8 P1 = dist P8 P4)
    (h18 : dist P8 P1 = dist P8 P7)
    : P0 = P1 := by
  by_contra h01ne
  ...
  have map_dist_eq {X Y Z R : ℝ²} (h : dist X Y = dist Z R) :
    ...
    rw [hdist, hdist, h]
  apply normalized_sourceIndexed_654_30_incompatible
      (P2 := p2) (P3 := p3) (P4 := p4) (P7 := p7) (P8 := p8) (P11 := p11)
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h01
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h03
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h04
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h05
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h06
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h08
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h09
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h10
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h13
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h14
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h15
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h16
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h17
  · simpa [p2, p3, p4, p7, p8, p11, hT0, hT1] using map_dist_eq h18

/-- Equality-closure form of the generated anchor collision. -/
structure UnitCoreSourceIndexed65430CollisionCore {alpha : Type*}
  ...
  P11 : alpha
  h01ne : P0 ≠ P1
  h01 : Census554.EqualityCore.EdgeClosure P (P0, P3) (P0, P4)
  h03 : Census554.EqualityCore.EdgeClosure P (P0, P3) (P0, P11)
  ...
  h09 : Census554.EqualityCore.EdgeClosure P (P2, P0) (P2, P11)
  h10 : Census554.EqualityCore.EdgeClosure P (P3, P2) (P3, P7)
  h13 : Census554.EqualityCore.EdgeClosure P (P3, P2) (P3, P11)
  ...
  h17 : Census554.EqualityCore.EdgeClosure P (P8, P1) (P8, P4)
  h18 : Census554.EqualityCore.EdgeClosure P (P8, P1) (P8, P7)

/-- A matching equality-closure core has no injective planar realization. -/
theorem not_realizes_of_unitCoreSourceIndexed65430CollisionCore
    {alpha : Type*} {P : Census554.EqualityCore.RowPattern alpha}
    (core : UnitCoreSourceIndexed65430CollisionCore P) :
  ...
  have hcollision := sourceIndexed_654_30_anchor_collision
...
#print axioms normalizedUnitCoreSourceIndexed65430Certificate
#print axioms sourceIndexed_654_30_anchor_collision
#print axioms not_realizes_of_unitCoreSourceIndexed65430CollisionCore
