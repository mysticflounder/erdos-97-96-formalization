...
import unit_core_source_indexed_654_42_scalar_certificate
...
private theorem sourceIndexed_654_42_dist_sq_coord (x y : ℝ²) :
    dist x y ^ 2 = (x 0 - y 0) ^ 2 + (x 1 - y 1) ^ 2 := by
  rw [EuclideanSpace.dist_sq_eq]
  simp [Fin.sum_univ_two, Real.dist_eq, sq_abs]

/-- The normalized active equality subsystem is inconsistent. -/
private theorem normalized_sourceIndexed_654_42_incompatible
    {P2 P3 P4 P6 P7 P9 P11 : ℝ²}
    ...
    (h07 : dist P2 P3 = dist P2 P6)
    (h08 : dist P2 P3 = dist P2 P7)
    (h09 : dist P2 P3 = dist P2 P9)
    (h10 : dist P3 (pt 0 0) = dist P3 P4)
    ...
    (h17 : dist P6 (pt 1 0) = dist P6 P4)
    (h19 : dist P6 (pt 1 0) = dist P6 P7)
    : False := by
  ...
  change dist P2 P3 ^ 2 = dist P2 P6 ^ 2 at h07sq
  change dist P2 P3 ^ 2 = dist P2 P7 ^ 2 at h08sq
  change dist P2 P3 ^ 2 = dist P2 P9 ^ 2 at h09sq
  change dist P3 (pt 0 0) ^ 2 = dist P3 P4 ^ 2 at h10sq
  ...
  change dist P6 (pt 1 0) ^ 2 = dist P6 P4 ^ 2 at h17sq
  change dist P6 (pt 1 0) ^ 2 = dist P6 P7 ^ 2 at h19sq
  rw [sourceIndexed_654_42_dist_sq_coord, sourceIndexed_654_42_dist_sq_coord] at h01sq h02sq h03sq h04sq h07sq h08sq h09sq h10sq h11sq h13sq h14sq h15sq h16sq h17sq h19sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at
    h01sq h02sq h03sq h04sq h07sq h08sq h09sq h10sq h11sq h13sq h14sq h15sq h16sq h17sq h19sq
  apply normalizedUnitCoreSourceIndexed65442Certificate
    (P2 0) (P2 1) (P3 0) (P3 1) (P4 0) (P4 1) (P6 0) (P6 1) (P7 0) (P7 1) (P9 0) (P9 1) (P11 0) (P11 1)
  · nlinarith [h01sq]
  · nlinarith [h02sq]
  · nlinarith [h03sq]
  · nlinarith [h04sq]
...
theorem sourceIndexed_654_42_anchor_collision
    {P0 P1 P2 P3 P4 P6 P7 P9 P11 : ℝ²}
    ...
    (h17 : dist P6 P1 = dist P6 P4)
    (h19 : dist P6 P1 = dist P6 P7)
    : P0 = P1 := by
  by_contra h01ne
  ...
  have map_dist_eq {X Y Z R : ℝ²} (h : dist X Y = dist Z R) :
    ...
    rw [hdist, hdist, h]
  apply normalized_sourceIndexed_654_42_incompatible
      (P2 := p2) (P3 := p3) (P4 := p4) (P6 := p6) (P7 := p7) (P9 := p9) (P11 := p11)
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h01
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h02
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h03
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h04
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h07
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h08
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h09
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h10
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h11
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h13
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h14
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h15
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h16
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h17
  · simpa [p2, p3, p4, p6, p7, p9, p11, hT0, hT1] using map_dist_eq h19

/-- Equality-closure form of the generated anchor collision. -/
structure UnitCoreSourceIndexed65442CollisionCore {alpha : Type*}
  ...
  h07 : Census554.EqualityCore.EdgeClosure P (P2, P3) (P2, P6)
  h08 : Census554.EqualityCore.EdgeClosure P (P2, P3) (P2, P7)
  h09 : Census554.EqualityCore.EdgeClosure P (P2, P3) (P2, P9)
  h10 : Census554.EqualityCore.EdgeClosure P (P3, P0) (P3, P4)
  ...
  h17 : Census554.EqualityCore.EdgeClosure P (P6, P1) (P6, P4)
  h19 : Census554.EqualityCore.EdgeClosure P (P6, P1) (P6, P7)

/-- A matching equality-closure core has no injective planar realization. -/
theorem not_realizes_of_unitCoreSourceIndexed65442CollisionCore
    {alpha : Type*} {P : Census554.EqualityCore.RowPattern alpha}
    (core : UnitCoreSourceIndexed65442CollisionCore P) :
  ...
  have hcollision := sourceIndexed_654_42_anchor_collision
...
#print axioms normalizedUnitCoreSourceIndexed65442Certificate
#print axioms sourceIndexed_654_42_anchor_collision
#print axioms not_realizes_of_unitCoreSourceIndexed65442CollisionCore
