...
import unit_core_source_indexed_654_11_scalar_certificate
...
private theorem sourceIndexed_654_11_dist_sq_coord (x y : ℝ²) :
    dist x y ^ 2 = (x 0 - y 0) ^ 2 + (x 1 - y 1) ^ 2 := by
  rw [EuclideanSpace.dist_sq_eq]
  simp [Fin.sum_univ_two, Real.dist_eq, sq_abs]

/-- The normalized active equality subsystem is inconsistent. -/
private theorem normalized_sourceIndexed_654_11_incompatible
    {P2 P3 P7 P8 P9 P10 P11 : ℝ²}
    ...
    (h09 : dist P7 P2 = dist P7 P9)
    (h10 : dist P7 P2 = dist P7 P11)
    (h13 : dist P9 (pt 0 0) = dist P9 P8)
    (h15 : dist P10 P3 = dist P10 P7)
    (h16 : dist P10 P3 = dist P10 P11)
    (h18 : dist P11 (pt 1 0) = dist P11 P8)
  ...
  change dist P7 P2 ^ 2 = dist P7 P9 ^ 2 at h09sq
  change dist P7 P2 ^ 2 = dist P7 P11 ^ 2 at h10sq
  change dist P9 (pt 0 0) ^ 2 = dist P9 P8 ^ 2 at h13sq
  change dist P10 P3 ^ 2 = dist P10 P7 ^ 2 at h15sq
  change dist P10 P3 ^ 2 = dist P10 P11 ^ 2 at h16sq
  change dist P11 (pt 1 0) ^ 2 = dist P11 P8 ^ 2 at h18sq
  change dist P11 (pt 1 0) ^ 2 = dist P11 P10 ^ 2 at h19sq
  rw [sourceIndexed_654_11_dist_sq_coord, sourceIndexed_654_11_dist_sq_coord] at h01sq h02sq h03sq h04sq h05sq h06sq h07sq h09sq h10sq h13sq h15sq h16sq h18sq h19sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at
    h01sq h02sq h03sq h04sq h05sq h06sq h07sq h09sq h10sq h13sq h15sq h16sq h18sq h19sq
  apply normalizedUnitCoreSourceIndexed65411Certificate
    (P2 0) (P2 1) (P3 0) (P3 1) (P7 0) (P7 1) (P8 0) (P8 1) (P9 0) (P9 1) (P10 0) (P10 1) (P11 0) (P11 1)
  · nlinarith [h01sq]
  · nlinarith [h02sq]
  · nlinarith [h03sq]
  · nlinarith [h04sq]
...
theorem sourceIndexed_654_11_anchor_collision
    {P0 P1 P2 P3 P7 P8 P9 P10 P11 : ℝ²}
    ...
    (h09 : dist P7 P2 = dist P7 P9)
    (h10 : dist P7 P2 = dist P7 P11)
    (h13 : dist P9 P0 = dist P9 P8)
    (h15 : dist P10 P3 = dist P10 P7)
    (h16 : dist P10 P3 = dist P10 P11)
    (h18 : dist P11 P1 = dist P11 P8)
  ...
  have map_dist_eq {X Y Z R : ℝ²} (h : dist X Y = dist Z R) :
    ...
    rw [hdist, hdist, h]
  apply normalized_sourceIndexed_654_11_incompatible
      (P2 := p2) (P3 := p3) (P7 := p7) (P8 := p8) (P9 := p9) (P10 := p10) (P11 := p11)
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h01
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h02
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h03
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h04
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h05
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h06
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h07
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h09
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h10
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h13
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h15
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h16
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h18
  · simpa [p2, p3, p7, p8, p9, p10, p11, hT0, hT1] using map_dist_eq h19

/-- Equality-closure form of the generated anchor collision. -/
structure UnitCoreSourceIndexed65411CollisionCore {alpha : Type*}
  ...
  h09 : Census554.EqualityCore.EdgeClosure P (P7, P2) (P7, P9)
  h10 : Census554.EqualityCore.EdgeClosure P (P7, P2) (P7, P11)
  h13 : Census554.EqualityCore.EdgeClosure P (P9, P0) (P9, P8)
  h15 : Census554.EqualityCore.EdgeClosure P (P10, P3) (P10, P7)
  h16 : Census554.EqualityCore.EdgeClosure P (P10, P3) (P10, P11)
  h18 : Census554.EqualityCore.EdgeClosure P (P11, P1) (P11, P8)
...
theorem not_realizes_of_unitCoreSourceIndexed65411CollisionCore
    {alpha : Type*} {P : Census554.EqualityCore.RowPattern alpha}
    (core : UnitCoreSourceIndexed65411CollisionCore P) :
  ...
  have hcollision := sourceIndexed_654_11_anchor_collision
...
#print axioms normalizedUnitCoreSourceIndexed65411Certificate
#print axioms sourceIndexed_654_11_anchor_collision
#print axioms not_realizes_of_unitCoreSourceIndexed65411CollisionCore
