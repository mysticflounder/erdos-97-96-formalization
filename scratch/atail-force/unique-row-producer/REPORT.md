...
| 84 | 555 | `f61c2073…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — sixty-fifth consecutive unit-grade 555 witness (337,501 nodes, caps=12 — +8,849 past iter-83, ninth consecutive climb); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities incl. Moser row (deletion verdicts 5 UNIT / 4 TIMEOUT fail-closed / 3 NONUNIT), retained core CROSSCHECKED_UNIT x3 on this literal row set; not a transposition image of any banked core; kin 6 with the immediately preceding 555-71 — near-twin differing only in row 10 ({4,5,9,11} → {5,7,9,11}; near-twin precedent 555-10/-11); NO new supports — all seven rows previously banked (13th zero-new-support 555 unit core); row 2:{0,1,9,11} in its TENTH consecutive core (63–72), extending its own record | `unit-core-555-72` |
| 85 | 555 | `b1656948…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — sixty-sixth consecutive unit-grade 555 witness (347,410 nodes, caps=12 — +9,909 past iter-84, tenth consecutive climb); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities incl. Moser row (deletion verdicts 5 UNIT / 3 TIMEOUT fail-closed / 4 NONUNIT), retained core CROSSCHECKED_UNIT x3 on this literal row set; not a transposition image of any banked core; kin 5 with both 555-71 and 555-72 (the same rows 0,2,7,9,11); one NEW support 8:{2,5,7,9} (support set previously banked only at center 6, in 555-69/-70); row 2:{0,1,9,11} in its ELEVENTH consecutive core (63–73), extending its own record | `unit-core-555-73` |
| 86 | 555 | `319efd87…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — sixty-seventh consecutive unit-grade 555 witness (347,413 nodes, caps=12 — +3 past iter-85, eleventh consecutive climb); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities incl. Moser row (deletion verdicts 5 UNIT / 4 TIMEOUT fail-closed / 3 NONUNIT), retained core CROSSCHECKED_UNIT x3 on this literal row set; not a transposition image of any banked core; kin 6 with the immediately preceding 555-73 — near-twin differing only in row 8 ({2,5,7,9} → {2,5,7,10}; near-twin precedents 555-10/-11, 555-71/-72); NO new supports — all seven rows previously banked (8:{2,5,7,10} in 555-50/-60); row 2:{0,1,9,11} in its TWELFTH consecutive core (63–74), extending its own record | `unit-core-555-74` |
| 87 | 555 | `6375ec09…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — sixty-eighth consecutive unit-grade 555 witness (347,429 nodes, caps=12 — +16 past iter-86, twelfth consecutive climb); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities incl. Moser row (deletion verdicts 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT), retained core CROSSCHECKED_UNIT x3 on this literal row set; not a transposition image of any banked core; kin 6 with 555-73 (rows 0,2,8,9,10,11); NO new supports — all seven rows previously banked (7:{3,5,6,8} only in 555-56, 8:{2,5,7,9} only in 555-73); row 2:{0,1,9,11} in its THIRTEENTH consecutive core (63–75), extending its own record | `unit-core-555-75` |
| 88 | 555 | `4b536aea…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — sixty-ninth consecutive unit-grade 555 witness (358,528 nodes, caps=12 — +11,099 past iter-87, thirteenth consecutive climb, largest step since iter-83); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities incl. Moser row (deletion verdicts 5 UNIT / 4 TIMEOUT fail-closed / 3 NONUNIT), retained core CROSSCHECKED_UNIT x3 on this literal row set; not a transposition image of any banked core; kin capped at 4, uniquely with 555-63 (rows 0,2,5,9); ONE new support 11:{3,5,8,9}; row 10:{0,3,7,11} returns — its only prior core is unit-core-555-07; row 9:{0,1,5,6} previously only in 555-63/-66; row 2:{0,1,9,11} in its FOURTEENTH consecutive core (63–76), extending its own record | `unit-core-555-76` |
| 89 | 555 | `a1b4c6ec…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — seventieth consecutive unit-grade 555 witness (362,616 nodes, caps=12 — +4,088 past iter-88, fourteenth consecutive climb); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities incl. Moser row (deletion verdicts 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT), retained core CROSSCHECKED_UNIT x3 on this literal row set; IS the (7,8)-transposition image of unit-core-555-69 — banked in its own right since `--bank-negative` blocks literal row sets only; THIRD admission-time image hit (after 555-51, fp-654-37), second on a unit core; literal kin capped at 3 shared rows (14 cores, incl. the image parent via rows 0,2,10); TWO new supports 9:{0,3,8,11}, 11:{0,5,7,10}; row 2:{0,1,9,11} in its FIFTEENTH consecutive core (63–77), extending its own record | `unit-core-555-77` |
| 90 | 555 | `83ae8519…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — seventy-first consecutive unit-grade 555 witness (363,751 nodes, caps=12 — +1,135 past iter-89, fifteenth consecutive climb); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities incl. Moser row (deletion verdicts 5 UNIT / 3 TIMEOUT fail-closed / 4 NONUNIT), retained core CROSSCHECKED_UNIT x3 on this literal row set; not a transposition image of any banked core; kin 6 with 555-70 (rows 0,2,8,9,10,11 — near-twin differing only in row 6); ZERO new supports — all seven rows previously banked (8:{0,5,7,10} only in 555-70, 9:{0,3,7,11} only in 555-69/-70); row 2:{0,1,9,11} in its SIXTEENTH consecutive core (63–78), extending its own record | `unit-core-555-78` |
| 91 | 555 | `77743ff0…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — seventy-second consecutive unit-grade 555 witness (363,757 nodes, caps=12 — +6 past iter-90, sixteenth consecutive climb); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities incl. Moser row (deletion verdicts 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin 5 with 555-69/-70/-78; ZERO new supports — all seven rows previously banked (8:{0,5,7,10} only in 555-70/-78, 7:{2,6,10,11} last unit appearance 555-69); row 2:{0,1,9,11} in its SEVENTEENTH consecutive core (63–79), extending its own record | `unit-core-555-79` |
| 92 | 555 | `fe94967e…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — seventy-third consecutive unit-grade 555 witness (83,242 nodes, caps=13 — lowest 555 node count since iter-69's 59,946, ending the sixteen-climb streak 76–91); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities (deletion verdicts 5 UNIT / 4 TIMEOUT fail-closed / 3 NONUNIT), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin capped at 2 shared rows; TWO new supports 8:{3,4,6,9}, 9:{2,4,7,10}; row 0:{1,2,3,5} (non-Moser) only prior in 555-05; row 11:{1,4,9,10} previously only in 654 unit cores (654-11/-13) — its first 555 core; row 2:{0,1,9,11} in its EIGHTEENTH consecutive core (63–80), extending its own record | `unit-core-555-80` |
| 93 | 555 | `4710c9b4…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — seventy-fourth consecutive unit-grade 555 witness (106,071 nodes, caps=13 — +22,829 past iter-92); `system_unit_recheck.py` 900 s pass retained 6 rows / 18 equalities (deletion verdicts 6 UNIT / 4 TIMEOUT fail-closed / 2 NONUNIT), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin capped at 2 shared rows; THREE new supports 3:{1,4,5,10}, 5:{0,4,7,10}, 10:{2,4,8,11}; row 8:{3,4,7,9} previously only in fp-654-12 — its first unit core; row 0:{1,2,3,5} (non-Moser) second consecutive after 555-80; row 2:{0,1,9,11} DELETED here — its consecutive-core streak ends at eighteen (63–80) | `unit-core-555-81` |
| 94 | 555 | `42fbda90…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_NONUNIT — FIRST NONUNIT-track 555 witness after the 74-witness consecutive unit-grade run (iters 20–93), routed to the forced-pair track for the first time since the original fp-555 bank of 13; 19,474 nodes, caps=14; cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 7-row / 21-equality core forcing pair (6,7), retained core Rabinowitsch UNIT ×3 (deletion 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT — apex/surplus row and witness rows 2, 4, 5, 8 dropped, Moser row retained); not a transposition image of any banked core; kin capped at 2 shared rows; THREE new supports 3:{1,4,7,11}, 7:{2,5,10,11}, 11:{0,3,5,9}; row 6:{0,4,5,7} previously only in fp-654-05/-06 | `forced-pair-core-555-14` |
| 95 | 555 | `cd5f382b…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_NONUNIT — second consecutive NONUNIT-track 555 witness; 52,942 nodes, caps=14; cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 8-row / 24-equality core forcing pair (6,7), retained core Rabinowitsch UNIT ×3 (deletion 4 UNIT / 7 TIMEOUT fail-closed / 1 NONUNIT — apex/surplus row and witness rows 2, 4, 5 dropped, Moser row 0:{1,2,3,4} retained); not a transposition image of any banked core; kin reaches 3 shared rows with unit-core-555-53 (rows 0, 6, 9 — supports 6:{0,3,5,8} and 9:{0,3,6,10} previously only there); TWO new supports 8:{2,5,10,11}, 11:{0,4,5,9}; row 3:{1,4,8,11} previously only in fp-654-24; 8-row/24-eq ties the largest existing fp-555 grade (4 prior) | `forced-pair-core-555-15` |
| 96 | 555 | `29e715ed…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_NONUNIT — third consecutive NONUNIT-track 555 witness; 53,196 nodes, caps=14; cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 7-row / 21-equality core forcing pair (6,7), retained core Rabinowitsch UNIT ×3 (deletion 5 UNIT / 7 TIMEOUT fail-closed / 0 NONUNIT — witness rows 0, 1, 2, 4, 5 dropped: Moser row dropped, unlike fp-555-14/-15; apexless like 7 of the original 13 fp-555 cores); not a transposition image of any banked core; kin reaches 4 shared rows with fp-555-15 (rows 3, 8, 10, 11); TWO new supports 6:{3,5,8,9}, 7:{0,4,6,10}; row 9:{0,3,8,10} previously only in 555 unit cores (50, 54–57, 81) | `forced-pair-core-555-16` |
| 97 | 555 | `b3dcc775…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_NONUNIT — fourth consecutive NONUNIT-track 555 witness; 56,116 nodes, caps=14; cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 8-row / 24-equality core forcing pair (6,7), retained core Rabinowitsch UNIT ×3 (deletion 4 UNIT / 5 TIMEOUT fail-closed / 3 NONUNIT — witness rows 1, 2, 3, 4 dropped, Moser row 0:{1,2,3,4} retained); not a transposition image of any banked core; kin reaches 3 shared rows with unit-core-555-48/-49 (rows 0, 9, 10); THREE new supports 5:{0,2,8,11}, 6:{3,5,7,9}, 8:{0,4,6,10}; row 11:{0,4,5,9} now in fp-555-15/-16/-17 — three consecutive fp-555 admissions | `forced-pair-core-555-17` |
| 98 | 555 | `e2c379ae…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — unit track resumes after the four-witness NONUNIT run (iters 94–97); 73,984 nodes, caps=14; `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities (deletion verdicts 5 UNIT / 2 TIMEOUT fail-closed / 5 NONUNIT), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin reaches 3 shared rows with unit-core-555-48/-49 (rows 2, 9, 10); THREE new supports 7:{0,3,4,8}, 8:{2,4,7,9}, 11:{0,1,4,6}; non-Moser row 0:{1,2,3,5} third in four unit admissions (555-80/-81/-82); rows 9:{0,3,7,10}, 10:{3,8,9,11} shared with the just-admitted fp-555-17; row 2:{0,1,9,10} (not the old {0,1,9,11} streak row) | `unit-core-555-82` |
| 99 | 555 | `52336a96…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — unit track continues; 77,256 nodes, caps=14; `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities (deletion verdicts 5 UNIT / 4 TIMEOUT fail-closed / 3 NONUNIT, card-five row dropped), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin reaches 4 shared rows with unit-core-555-58 (rows 2, 6, 9, 10) and 4 with unit-core-555-82 (rows 0, 2, 9, 11); ONE new support 7:{0,5,8,11}; row 11:{0,1,4,6} in a third consecutive admission across tracks (555-82 → fp-654-52 → here); non-Moser row 0:{1,2,3,5} in four consecutive 555 unit admissions (555-80/-81/-82/-83); 10:{3,6,9,11} shared with unit-core-654-12/-15 cross-profile | `unit-core-555-83` |
| 100 | 555 | `b403dfdb…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — third consecutive unit-track 555 witness; 79,372 nodes, caps=14; `system_unit_recheck.py` 900 s pass retained 8 rows / 24 equalities (deletion verdicts 4 UNIT / 4 TIMEOUT fail-closed / 4 NONUNIT, card-five row dropped), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin reaches 6 shared rows with unit-core-555-82 (rows 0, 2, 8, 9, 10, 11 — rows 5, 7 differ, not a superset) and 4 with unit-core-555-83; ONE new support 5:{2,4,10,11}; non-Moser row 0:{1,2,3,5} in five consecutive 555 unit admissions (555-80..-84); row 11:{0,1,4,6} in four of the last five admissions across tracks | `unit-core-555-84` |
| 101 | 555 | `d251c6df…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — fourth consecutive unit-track 555 witness; 79,377 nodes, caps=14; `system_unit_recheck.py` 900 s pass retained 8 rows / 24 equalities (deletion verdicts 4 UNIT / 5 TIMEOUT fail-closed / 3 NONUNIT, card-five row dropped), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin reaches 6 shared rows with unit-core-555-82 (rows 0, 2, 7, 9, 10, 11 — row 8 differs, not a superset), 5 with 555-83 and 5 with 555-84; ZERO new supports (every row previously banked, row set distinct); non-Moser row 0:{1,2,3,5} in six consecutive 555 unit admissions (555-80..-85); row 11:{0,1,4,6} in five of the last six admissions across tracks; 8:{2,7,9,11} shared with fp-654-01/-08 cross-profile | `unit-core-555-85` |
| 102 | 555 | `204f91a2…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — fifth consecutive unit-track 555 witness; 100,781 nodes, caps=14 (jumps past the recent 53–79k range); `system_unit_recheck.py` 900 s pass retained 6 rows / 18 equalities (deletion verdicts 6 UNIT / 2 TIMEOUT fail-closed / 4 NONUNIT, card-five row dropped), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin capped at 2 shared rows — the 555-82..-85 high-kin pattern breaks; TWO new supports 5:{2,4,7,11}, 9:{0,5,10,11}; row 11:{0,1,4,7} previously only in forced-pair cores (fp-654-08, fp-555-10/-11/-13), first unit core containing it; non-Moser row 0:{1,2,3,5} in seven consecutive 555 unit admissions (555-80..-86) | `unit-core-555-86` |
| 103 | 555 | `a978af98…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — sixth consecutive unit-track 555 witness; 116,956 nodes, caps=14 (climbing 79k → 100k → 117k); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities (deletion verdicts 5 UNIT / 3 TIMEOUT fail-closed / 4 NONUNIT, card-five row dropped), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin reaches 5 shared rows with unit-core-555-82 and 5 with unit-core-555-84 (rows 0, 2, 8, 9, 10 both); ONE new support 7:{0,3,4,6}; row 11:{0,1,4,8} previously only in fp-654-09 — second consecutive unit admission whose row 11 was previously fp-only; non-Moser row 0:{1,2,3,5} in eight consecutive 555 unit admissions (555-80..-87) | `unit-core-555-87` |
| 104 | 555 | `c18d09c9…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — seventh consecutive unit-track 555 witness; 123,232 nodes, caps=14 (climb continues 79k → 100k → 117k → 123k); `system_unit_recheck.py` 900 s pass retained 6 rows / 18 equalities (deletion verdicts 6 UNIT / 2 TIMEOUT fail-closed / 4 NONUNIT, card-five row dropped), retained core CROSSCHECKED_UNIT ×3 on this literal row set. **Transposition (7,8) image of unit-core-555-86 — FIRST image admission**: the `--bank-negative` constraint operates on literal row sets (this witness was found with 555-86 banked), so the image is banked to exclude the shape; certificate independent of the image relation. Kin 4 with unit-core-555-87; literal-new support 5:{2,4,8,11}; non-Moser row 0:{1,2,3,5} in nine consecutive 555 unit admissions (555-80..-88) | `unit-core-555-88` |
| 105 | 555 | `0f697c99…` | SAT witness, sources (6,7), inline audit CROSSCHECKED_UNIT — eighth consecutive unit-track 555 witness; 135,986 nodes, caps=14 (climb 79k → 100k → 117k → 123k → 136k); `system_unit_recheck.py` 900 s pass retained 7 rows / 21 equalities (deletion verdicts 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT, card-five row dropped), retained core CROSSCHECKED_UNIT ×3 on this literal row set; NOT a transposition image (checker-verified) despite kin 6 with unit-core-555-83 — only row 11 differs ({0,2,4,6} vs {0,1,4,6}), and no label swap produces it without disturbing rows 0/2; ONE new support 11:{0,2,4,6}; non-Moser row 0:{1,2,3,5} in ten consecutive 555 unit admissions (555-80..-89) | `unit-core-555-89` |
| 106 | 555 | — | **NO_WITNESS_WITHIN_BOUNDED_FINITE_SHADOW, caps=16** — first 555 iteration with no witness at the default node cap, after 105 consecutive witness iterations; NOT the exhaustive-UNSAT stop condition (that requires `stats.node_caps == 0`; 16 branches were truncated by the per-node cap). The iters 100–105 node climb (79k → 100k → 117k → 123k → 136k) was the exhaustion signal for the default-cap shadow. 555 idle pending Adam's cap decision (654 precedent: cap raise is Adam's call); the search is deterministic given the bank, so a same-cap relaunch would reproduce this result | — |
...
| 67 | 654 | `cf0a86c8…` | SAT witness, sources (7,8), 13,364,410 nodes (caps=0, 20 M run — +14,037 past iter-66, stepping out of the ~13.35M pocket) — FIRST unit-grade 654 witness since iter-53, ends the thirteen-witness NONUNIT run (iters 54-66, fp-654-35..47), deepest 654 witness yet; msolve UNIT ×2 but Singular TIMEOUT at 45 s / 900 s / 3600 s under the production fixed order — resolved by the Adam-authorized flux.local strategy race ({std,slimgb,groebner} × 6 variable orders on the replayed system; `cf0a86c8-flux-race/RACE.md`): slimgb over the seed-4 permuted dp order returned UNIT in 20 s; admission recheck (perm4 Singular order, msolve canonical fwd/rev) retained 6 rows / 19 equalities incl. surplus row 1:{0,2,7,8,9} (deletion verdicts 6 UNIT / 6 TIMEOUT fail-closed), retained core CROSSCHECKED_UNIT; not a transposition image of any banked core; kin capped at 2 shared rows; row 0:{3,6,9,10} in a unit core for the first time (previously fp-654-11/-12 only); THREE new supports 5:{1,6,7,10}, 9:{1,3,5,7}, 10:{1,4,6,8}; 6-row/19-eq is the modal 654 unit grade | `unit-core-654-33` |
| 68 | 654 | `ff2eb8fb…` | SAT witness, sources (7,8), 13,869,343 nodes (caps=0, 20 M run — +504,933 past iter-67, deepest 654 witness yet) — thirty-eighth NONUNIT-track 654 witness (inline msolve NONUNIT ×2), breaking the unit-track resumption after one iteration; production-order fp cert (pair (7,8), Rabinowitsch) hit msolve UNIT ×2 + Singular TIMEOUT at 900 s, `--core` refused; resolved by the second flux.local strategy race (12 jobs, smoke gates 6/6; `ff2eb8fb-flux-race/RACE.md`): slimgb + seed-4 permuted order UNIT in 20 s — SAME winner as cf0a86c8, two-for-two; admission cert (`ff2eb8fb_admit_cert.py`, all Singular calls in perm4 order, msolve canonical fwd/rev) certified full system + retained core UNIT ×3, retained 7 rows / 21 equalities (deletion 5 UNIT / 5 TIMEOUT / 2 NONUNIT fail-closed — apex/surplus row and witness rows 0, 2, 7, 9 dropped); not a transposition image; kin 5 shared rows (fp-654-43); ONE new support 6:{3,4,7,11}, ending the three-core all-banked run (-45/-46/-47); row 4:{3,5,9,10} previously only in fp-654-43 | `forced-pair-core-654-48` |
| 69 | 654 | `925ac51d…` | SAT witness, sources (7,8), 16,364,643 nodes (caps=0, 20 M run — +2,495,300 past iter-68, NEW deepest 654 witness, decisively out of the ~13.35M pocket) — unit track resumes after the single NONUNIT interruption at iter-68 (inline CROSSCHECKED_UNIT); `system_unit_recheck.py` 900 s pass retained 5 rows / 16 equalities incl. surplus row 1:{0,2,7,8,9} (deletion verdicts 7 UNIT / 3 TIMEOUT fail-closed / 2 NONUNIT), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin capped at 2 shared rows; TWO new supports 7:{2,3,6,9}, 9:{0,2,4,5}; rows 0:{1,3,4,8} and 8:{4,7,9,10} previously appeared only in 555 unit cores (555-06, 555-14) — first 654 core for each | `unit-core-654-34` |
| 70 | 654 | `0e70fb54…` | SAT witness, sources (7,8), 17,262,366 nodes (caps=0, 20 M run — +897,723 past iter-69, NEW deepest 654 witness, second consecutive depth record; 86% of the 20 M budget) — thirty-ninth NONUNIT-track 654 witness (inline msolve NONUNIT ×2); cert passed at the production order (no strategy race needed, unlike ff2eb8fb): CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 7-row / 21-equality core forcing pair (7,8), retained core Rabinowitsch UNIT ×3 (deletion 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT — apex/surplus row and witness rows 2, 5, 6, 8 dropped); not a transposition image of any banked core; kin capped at 2 shared rows; THREE new supports 0:{3,4,8,10}, 4:{1,3,9,11}, 11:{3,6,9,10}; row 9:{0,3,5,7} previously only in fp-654-11 | `forced-pair-core-654-49` |
| 71 | 654 | `3ece9f69…` | SAT witness, sources (7,8), 17,421,886 nodes (caps=0, 20 M run — +159,520 past iter-70, NEW deepest 654 witness, THIRD consecutive depth record; 87% of the 20 M budget) — unit track (inline CROSSCHECKED_UNIT); `system_unit_recheck.py` 900 s pass retained 7 rows / 22 equalities incl. surplus row 1:{0,2,7,8,9} (deletion verdicts 5 UNIT / 3 TIMEOUT fail-closed / 4 NONUNIT), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin capped at 2 shared rows; FOUR new supports 0:{1,5,6,8}, 6:{1,3,4,8}, 8:{2,4,6,9}, 10:{0,4,5,11}; rows 9:{0,3,5,7} and 11:{3,6,9,10} shared with the just-admitted fp-654-49; FIRST 7-row and first 22-equality 654 unit core (all prior 31 are 5–6 rows / ≤19 eq) | `unit-core-654-35` |
| 72 | 654 | `ed7e977f…` | SAT witness, sources (7,8), 17,838,635 nodes (caps=0, 20 M run — +416,749 past iter-71, NEW deepest 654 witness, FOURTH consecutive depth record; 89% of the 20 M budget) — fortieth NONUNIT-track 654 witness (inline msolve NONUNIT ×2); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 8-row / 24-equality core forcing pair (7,8), retained core Rabinowitsch UNIT ×3 (deletion 4 UNIT / 7 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 1, 4, 6 dropped, leaving an APEXLESS core with no row centered at 0 or 1, like fp-654-48); not a transposition image of any banked core; kin capped at 2 shared rows; FOUR new supports 2:{0,6,10,11}, 5:{2,3,6,11}, 7:{0,2,3,5}, 9:{3,4,6,8}; row 8:{5,7,9,11} previously only in fp-555-10..13 — first 654 core containing it | `forced-pair-core-654-50` |
| 73 | 654 | `14c491e7…` | SAT witness, sources (7,8), 17,951,372 nodes (caps=0, 20 M run — +112,737 past iter-72, NEW deepest 654 witness, FIFTH consecutive depth record; ~90% of the 20 M budget) — forty-first NONUNIT-track 654 witness (inline msolve NONUNIT ×2); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 7-row / 21-equality core forcing pair (7,8), retained core Rabinowitsch UNIT ×3 (deletion 5 UNIT / 6 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 1, 2, 6, 8 dropped, APEXLESS core like fp-654-48/-50); not a transposition image of any banked core; kin reaches 4 shared rows with fp-654-49 (rows 3, 7, 9, 10) and 3 with fp-654-50 (rows 3, 10, 11); TWO new supports 4:{3,5,9,11}, 5:{1,6,8,11} | `forced-pair-core-654-51` |
| 74 | 654 | `a41eb4e4…` | SAT witness, sources (7,8), 18,556,391 nodes (caps=0, 20 M run — +605,019 past iter-73, NEW deepest 654 witness, SIXTH consecutive depth record; ~93% of the 20 M budget) — forty-second NONUNIT-track 654 witness (inline msolve NONUNIT ×2); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 6-row / 18-equality core forcing pair (7,8), retained core Rabinowitsch UNIT ×3 (deletion 6 UNIT / 5 TIMEOUT fail-closed / 1 NONUNIT — witness rows 1, 2, 4, 8, 9, 10 dropped: row 8 of the forced pair dropped, row 7 retained; APEXLESS core; eighth 6-row and fourth 18-equality fp-654 core); not a transposition image of any banked core; kin capped at 2 shared rows; TWO new supports 0:{3,5,6,7}, 6:{1,5,8,10}; row 11:{0,1,4,6} previously only in unit-core-555-82 (the immediately preceding admission) and row 3:{1,4,7,11} previously only in fp-555-14 | `forced-pair-core-654-52` |
| 75 | 654 | `1dfe7188…` | SAT witness, sources (7,8), 19,675,874 nodes (caps=0, 20 M run — +1,119,483 past iter-74, NEW deepest 654 witness, SEVENTH consecutive depth record; ~98% of the 20 M budget) — forty-third NONUNIT-track 654 witness (inline msolve NONUNIT ×2); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 7-row / 21-equality core forcing pair (7,8), retained core Rabinowitsch UNIT ×3 (deletion 5 UNIT / 6 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 1, 2, 3, 9 dropped, both pair rows 7 and 8 retained; APEXLESS core); not a transposition image of any banked core; kin capped at 2 shared rows; ONE new support 11:{3,6,7,10}; row 4:{2,3,5,10} previously only in fp-555-11, row 8:{2,4,6,9} previously only in unit-core-654-35, row 7:{2,3,8,11} repeats from the just-admitted fp-654-52 | `forced-pair-core-654-53` |
| 76 | 654 | `9f8185ed…` | SAT witness, sources (7,8), 3,755,885 nodes (caps=1, 20 M run) — inline audit CROSSCHECKED_UNIT: first 654 unit-track witness since iter-71, ending the five-witness NONUNIT run (iters 72–75) and the seven-record depth climb (19.7 M → 3.8 M); `system_unit_recheck.py` 900 s pass retained 6 rows / 19 equalities (deletion verdicts 6 UNIT / 5 TIMEOUT fail-closed / 1 NONUNIT, retaining the 5-element row 1:{0,3,7,8,9}), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin capped at 2 shared rows; THREE new supports 1:{0,3,7,8,9}, 7:{3,6,9,10}, 9:{2,5,8,10}; rows 3:{1,4,5,9} and 10:{0,5,6,11} previously only in unit-core-555-05/-45 cross-profile; 6-row/19-eq is the modal 654 unit grade | `unit-core-654-36` |
| 77 | 654 | `0b6a2123…` | SAT witness, sources (7,8), 3,767,949 nodes (caps=1, 20 M run — nearly the same depth as iter-76's 3,755,885) — inline audit CROSSCHECKED_UNIT: second consecutive 654 unit-track witness; `system_unit_recheck.py` 900 s pass retained 6 rows / 19 equalities (deletion verdicts 6 UNIT / 5 TIMEOUT fail-closed / 1 NONUNIT, retaining the 5-element row 1:{0,3,7,8,9} — same 5-row as unit-core-654-36, two consecutive), retained core CROSSCHECKED_UNIT ×3 on this literal row set; not a transposition image of any banked core; kin capped at 2 shared rows; ONE new support 7:{3,6,8,10}; rows 3:{1,4,5,8} and 8:{2,5,9,10} previously fp-only (fp-555-06/-07, fp-654-19); 6-row/19-eq is the modal 654 unit grade | `unit-core-654-37` |
| 78 | 654 | `0a68e92d…` | SAT witness, sources (7,8), 6,053,746 nodes (caps=1, 20 M run — back to the NONUNIT track after the iters 76–77 unit pair, at an intermediate depth between the 3.8 M unit pair and the 19.7 M peak) — forty-fourth NONUNIT-track 654 witness (inline msolve NONUNIT ×2); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 7-row / 21-equality core forcing pair (7,8), retained core Rabinowitsch UNIT ×3 (deletion 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT — witness rows 1, 3, 4, 6, 9 dropped, both pair rows retained; APEXLESS core); not a transposition image of any banked core; kin capped at 2 shared rows; THREE new supports 0:{2,3,6,11}, 5:{2,3,4,7}, 10:{1,2,5,8}; rows 7:{3,5,8,10}, 8:{2,4,9,10}, 11:{1,6,7,10} previously unit-only (555u-08/-09, 654u-28, 654u-05/-06) | `forced-pair-core-654-54` |
| 79 | 654 | `5e15de6c…` | SAT witness, sources (7,8), 6,081,265 nodes (caps=1, 20 M run — second consecutive at the ~6M depth band) — forty-fifth NONUNIT-track 654 witness (inline NONUNIT ×3: Singular + msolve fwd/rev); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 8-row / 24-equality core forcing pair (7,8), Rabinowitsch UNIT ×3 on full system and retained core (deletion 4 UNIT / 7 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 1, 2, 6 dropped, both pair rows retained; APEXLESS core); not a transposition image of any banked core; kin capped at 2 shared rows; THREE new supports 3:{2,4,8,11}, 7:{4,6,9,10}, 11:{1,6,8,10}; row 8:{5,7,9,11} previously in fp555-10/-11/-12/-13 and fp654-50 | `forced-pair-core-654-55` |
| 80 | 654 | `f3d4e7c8…` | SAT witness, sources (7,8), 6,081,547 nodes (caps=1, 20 M run — third consecutive at the ~6M depth band, within 282 nodes of iter-79) — forty-sixth NONUNIT-track 654 witness (inline NONUNIT ×3: Singular + msolve fwd/rev); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 7-row / 21-equality core forcing pair (7,8), Rabinowitsch UNIT ×3 on full system and retained core (deletion 5 UNIT / 6 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 1, 2, 6, 10 dropped, both pair rows retained; APEXLESS core); NOT a transposition image of any banked core (checker-verified) despite kin 5 with fp-654-55 (rows 3, 4, 5, 8, 11 identical; rows 7 and 9 differ, no row 10); TWO new supports 7:{3,4,9,10}, 9:{0,4,5,6}; row 8:{5,7,9,11} stays fp-only (sixth fp appearance) | `forced-pair-core-654-56` |
| 81 | 654 | `5cb4bee1…` | SAT witness, sources (7,8), 6,084,777 nodes (caps=1, 20 M run — fourth consecutive at the ~6M depth band) — forty-seventh NONUNIT-track 654 witness (inline NONUNIT ×3: Singular + msolve fwd/rev); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 7-row / 21-equality core forcing pair (7,8), Rabinowitsch UNIT ×3 on full system and retained core (deletion 5 UNIT / 6 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 1, 2, 6, 10 dropped, same drop set as iter-80; APEXLESS core); NOT a transposition image of any banked core (checker-verified; kin 4 with fp-654-55/-56); verified relation: under swap 7↔9 its row set equals fp-654-55 minus row 10:{1,2,5,9} but the forced pair transports to (8,9), not (7,8) — distinct statement; TWO new supports 7:{0,3,4,5}, 9:{4,6,7,10}; row 8:{5,7,9,11} stays fp-only (seventh fp appearance) | `forced-pair-core-654-57` |
| 82 | 654 | `ec70977e…` | SAT witness, sources (7,8), 6,325,669 nodes (caps=1, 20 M run — fifth consecutive at the ~6M depth band, ~240k deeper than the iters 79–81 cluster) — forty-eighth NONUNIT-track 654 witness (inline NONUNIT ×3: Singular + msolve fwd/rev); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 6-row / 18-equality core forcing pair (7,8), Rabinowitsch UNIT ×3 on full system and retained core (deletion 6 UNIT / 5 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 1, 3, 4, 5, 11 dropped, both pair rows retained; APEXLESS core); not a transposition image of any banked core; kin capped at 2 shared rows — breaks out of the fp-654-55/-56/-57 neighborhood; TWO new supports 6:{2,3,8,11}, 10:{4,6,8,11}; tenth fp-654 core with ≤6 rows | `forced-pair-core-654-58` |
| 83 | 654 | `69ea264b…` | SAT witness, sources (7,8), 6,442,468 nodes (caps=1, 20 M run — sixth consecutive at the ~6M depth band, gradual deepening 6.05→6.44M) — forty-ninth NONUNIT-track 654 witness (inline NONUNIT ×3: Singular + msolve fwd/rev); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 8-row / 24-equality core forcing pair (7,8), Rabinowitsch UNIT ×3 on full system and retained core (deletion 4 UNIT / 7 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 1, 2, 3 dropped, both pair rows retained; APEXLESS core); not a transposition image of any banked core; kin capped at 2 shared rows; TWO new supports 6:{2,5,7,11}, 7:{2,4,8,11} (the latter support banked at center 3 in fp-654-55/-56/-57, center-shifted here); rows 5:{1,3,6,7}, 8:{0,4,5,7}, 9:{2,5,8,10}, 11:{1,4,8,10} previously unit-only (654u-30, 555u-03/-08/-19, 654u-36, 654u-12/-16/-19) | `forced-pair-core-654-59` |
| 84 | 654 | `0986ce44…` | SAT witness, sources (7,8), 6,687,672 nodes (caps=1, 20 M run — seventh consecutive at the ~6M depth band, monotone drift 6.05→6.69M) — fiftieth NONUNIT-track 654 witness (inline NONUNIT ×3: Singular + msolve fwd/rev); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 5-row / 16-equality core forcing pair (7,8), Rabinowitsch UNIT ×3 on full system and retained core (deletion 7 UNIT / 4 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 3, 4, 5, 6, 9, 10 dropped, both pair rows retained); ties fp-654-01 as the only 5-row fp-654 cores; NOT apexless — carries the 5-element surplus row 1:{0,3,7,8,9}, its first fp appearance (previously only 654u-36/-37); not a transposition image; kin capped at 2 shared rows; ZERO new supports (row set still distinct); **200th banked core** | `forced-pair-core-654-60` |
| 85 | 654 | `4f4e8626…` | SAT witness, sources (7,8), 7,469,100 nodes (caps=1, 20 M run — eighth consecutive band witness, step up 6.69→7.47M) — fifty-first NONUNIT-track 654 witness (inline NONUNIT ×3: Singular + msolve fwd/rev); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 9-row / 27-equality core forcing pair (7,8), Rabinowitsch UNIT ×3 on full system and retained core (deletion 3 UNIT / 8 TIMEOUT fail-closed / 1 NONUNIT — witness rows 0, 1, 9 dropped, both pair rows retained; APEXLESS core); second 9-row and second 27-eq fp-654 core; not a transposition image; kin capped at 2 shared rows; FOUR new supports 3:{2,4,8,10}, 4:{1,5,6,8}, 5:{3,6,7,10}, 6:{2,3,4,9}; row 7:{3,6,8,11} previously unit-only (555u-47, 654u-10) | `forced-pair-core-654-61` |
| 86 | 654 | `630268b5…` | SAT witness, sources (7,8), 7,541,624 nodes (caps=1, 20 M run — ninth consecutive band witness, ~7.5M plateau) — fifty-second NONUNIT-track 654 witness (inline NONUNIT ×3: Singular + msolve fwd/rev); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 7-row / 21-equality core forcing pair (7,8) with **no row centered at 7** (deletion 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT — witness rows 1, 3, 6, 7, 9 dropped, pair row 8 retained; APEXLESS core), Rabinowitsch UNIT ×3 on full system and retained core; not a transposition image; kin capped at 2 shared rows; ONE new support 0:{4,5,7,10}; row 10:{4,6,9,11} previously 555-unit-only (555u-02/-46) | `forced-pair-core-654-62` |
| 87 | 654 | `c043d92b…` | SAT witness, sources (7,8), 7,682,414 nodes (caps=1, 20 M run — tenth consecutive band witness, ~7.5–7.7M plateau) — fifty-third NONUNIT-track 654 witness (inline NONUNIT ×3: Singular + msolve fwd/rev); cert passed at the production order: CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP, retained 6-row / 18-equality core forcing pair (7,8) with **no row centered at 8** (deletion 6 UNIT / 6 TIMEOUT fail-closed / 0 NONUNIT — witness rows 0, 1, 3, 4, 8, 9 dropped, pair row 7 retained; APEXLESS core), Rabinowitsch UNIT ×3 on full system and retained core; not a transposition image; kin capped at 3 shared rows (rows 5, 10, 11 with fp-654-59); ONE new support 6:{2,4,7,11} | `forced-pair-core-654-63` |
| 88 | 654 | `eeeea212…` | SAT witness, sources (7,8), 7,691,875 nodes (caps=1, 20 M run) — **first unit-track 654 witness since iters 76–77**, ending ten consecutive NONUNIT band witnesses (inline UNIT); system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 7-row / 22-equality core also CROSSCHECKED_UNIT ×3 (deletion 5 UNIT / 2 TIMEOUT fail-closed / 5 NONUNIT — retains the 5-element row 1:{0,3,7,8,9}, fourth banked appearance after 654u-36/-37 and fp-654-60); not a transposition image; kin capped at 3 shared rows (rows 8, 9, 10 with 654u-22); ONE new support 7:{3,5,8,11}; second 7-row and second 22-eq 654 unit core | `unit-core-654-38` |
| 89 | 654 | `ec6bf19d…` | SAT witness, sources (7,8), 7,700,266 nodes (caps=1, 20 M run) — second consecutive unit-track witness (inline UNIT), depth holding the ~7.7 M band; system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 6-row / 19-equality core also CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 3 TIMEOUT fail-closed / 3 NONUNIT — retains the 5-element row 1:{0,3,7,8,9}, fifth banked appearance); not a transposition image; kin capped at 3 shared rows (rows 1, 3, 8 with 654u-38); ZERO new supports — 6:{2,4,7,11} (fp-654-63-only before) and 11:{1,2,4,9} (fp-654-07-only before) make first 654-unit appearances; 6-row/19-eq modal grade | `unit-core-654-39` |
| 90 | 654 | `4d8d1875…` | SAT witness, sources (7,8), 7,700,267 nodes (caps=1, 20 M run) — third consecutive unit-track witness (inline UNIT), depth exactly one node past iter-89; system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 6-row / 19-equality core also CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 2 TIMEOUT fail-closed / 4 NONUNIT — retains the 5-element row 1:{0,3,7,8,9}, sixth banked appearance); not a transposition image; kin 5 (rows 1, 3, 8, 10, 11 with 654u-38 — equals 654u-38 minus row 7:{3,5,8,11} with row-9 support {0,2,3,4}→{0,2,3,6}), tying the 654-unit pairwise kin maximum of 5 (654u-02∩03, -15∩20, -24∩25); ZERO new supports | `unit-core-654-40` |
| 91 | 654 | `4d04d610…` | SAT witness, sources (7,8), 7,710,917 nodes (caps=1, 20 M run) — fourth consecutive unit-track witness (inline UNIT), +10.6k nodes past iter-90 (adjacent-node pair ended); system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 6-row / 19-equality core also CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 4 TIMEOUT fail-closed / 2 NONUNIT — retains the 5-element row 1:{0,3,7,8,9}, seventh banked appearance); not a transposition image; kin capped at 4 shared rows (rows 1, 6, 9, 11 with 654u-39); TWO new supports 7:{1,3,5,8} and 8:{1,6,7,9}; 6-row/19-eq modal grade | `unit-core-654-41` |
| 92 | 654 | `98e7bc2a…` | SAT witness, sources (7,8), 7,730,184 nodes (caps=1, 20 M run) — fifth consecutive unit-track witness (inline UNIT), +19.3k nodes past iter-91; system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 6-row / 19-equality core also CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 4 TIMEOUT fail-closed / 2 NONUNIT — retains the 5-element row 1:{0,3,7,8,9}, eighth banked appearance); not a transposition image; kin 5 (rows 1, 7, 8, 9, 11 with 654u-41 — equals 654u-41 with the single element 7→8 swapped in row 6's support), tying the 654-unit pairwise kin maximum of 5; ONE new support 6:{2,4,8,11}, fifth distinct banked center for that support (3, 5, 7, 10 before) | `unit-core-654-42` |
| 93 | 654 | `4f50e670…` | SAT witness, sources (7,8), 7,782,129 nodes (caps=1, 20 M run) — first NONUNIT-track witness after five consecutive unit-track iters 88–92 (inline NONUNIT ×3); cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core, status CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP; 8-row / 24-equality core forcing (7,8) (deletion 4 UNIT / 5 TIMEOUT fail-closed / 3 NONUNIT — rows 1, 3, 4, 5 dropped, both pair centers retained), APEXLESS; not a transposition image; kin capped at 2 shared rows (breakout core); TWO new supports 7:{2,3,6,10} and 11:{1,2,5,9}; row 9:{0,5,6,8} previously 654-unit-only (654u-12/-19), first fp appearance | `forced-pair-core-654-64` |
| 94 | 654 | `21dca8f2…` | SAT witness, sources (7,8), 7,782,134 nodes (caps=1, 20 M run) — second consecutive NONUNIT-track witness (inline NONUNIT ×3), five nodes past iter-93; cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core; 7-row / 21-equality core forcing (7,8) with no row centered at 7 (deletion 5 UNIT / 6 TIMEOUT fail-closed / 1 NONUNIT — rows 1, 3, 4, 5, 7 dropped, pair center 8 retained), APEXLESS; not a transposition image; kin 6 (rows 0, 2, 6, 8, 9, 10 with fp-654-64 — equals fp-654-64 minus row 7:{2,3,6,10} with row 11's support {1,2,5,9}→{1,5,9,10}); first new fp-track genmine-eligible pair (kin ≥6) since the 2026-07-16 backlog memo; ZERO new supports | `forced-pair-core-654-65` |
| 95 | 654 | `dcdb760e…` | SAT witness, sources (7,8), 7,783,283 nodes (caps=1, 20 M run) — third consecutive NONUNIT-track witness (inline NONUNIT ×3), +1.1k past iter-94; cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core; 7-row / 22-equality core forcing (7,8) with both pair centers retained (deletion 5 UNIT / 4 TIMEOUT fail-closed / 3 NONUNIT — rows 0, 2, 3, 4, 9 dropped); retains the 5-element row 1:{0,3,7,8,9} (ninth banked appearance, second fp carrier after fp-654-60); not a transposition image; kin capped at 2 shared rows (breakout core); TWO new supports 7:{3,4,8,11} and 8:{0,2,3,5}; row 11:{1,5,8,10} previously unit-only (555u-01/-03/-17/-18, 654u-14), first fp appearance | `forced-pair-core-654-66` |
| 96 | 654 | `091c1bb9…` | SAT witness, sources (7,8), 7,817,519 nodes (caps=1, 20 M run) — fourth consecutive NONUNIT-track witness (inline NONUNIT ×3), +34.2k past iter-95; cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core; 6-row / 18-equality core forcing (7,8) with no row centered at 8 (deletion 6 UNIT / 5 TIMEOUT fail-closed / 1 NONUNIT — rows 0, 1, 3, 5, 8, 9 dropped, pair center 7 retained), APEXLESS. **IMAGE: the core is the transposition (4,5) relabeling of fp-654-63** (pair (7,8) fixed) — SECOND banked image after unit-core-555-88, admitted as found per that precedent; image-policy decision for Adam now covers both entries | `forced-pair-core-654-67` |
| 97 | 654 | `ffa62a90…` | SAT witness, sources (7,8), 7,827,304 nodes (caps=1, 20 M run) — unit track returns after four NONUNIT iters 93–96 (inline UNIT); system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 6-row / 19-equality core also CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 2 TIMEOUT fail-closed / 4 NONUNIT — retains the 5-element row 1:{0,3,7,8,9}, tenth banked appearance); not a transposition image; kin capped at 2 shared rows (breakout unit core); TWO new supports 3:{1,4,6,9} and 7:{0,2,3,4} (center-shifts of banked 5:{1,4,6,9} and 9:{0,2,3,4}); rows 6:{2,5,8,11} and 8:{2,7,9,11} first 654-unit appearances; 6-row/19-eq modal grade | `unit-core-654-43` |
| 98 | 654 | `662f4de3…` | SAT witness, sources (7,8), 7,846,922 nodes (caps=1, 20 M run) — second consecutive unit-track witness (inline UNIT), +19.6k past iter-97; system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 6-row / 19-equality core also CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 4 TIMEOUT fail-closed / 2 NONUNIT). **IMAGE: the core is the transposition (4,5) relabeling of unit-core-654-42** — THIRD banked image (555u-88, fp-654-67) and second (4,5) image in three iterations; the 654 shadow at this depth band is now mining (4,5)-relabelings of banked cores; admitted as found per precedent — image-policy decision for Adam is now pressing | `unit-core-654-44` |
| 99 | 654 | `daaa6b01…` | SAT witness, sources (7,8), 7,972,392 nodes (caps=1, 20 M run) — third consecutive unit-track witness (inline UNIT), +125.5k past iter-98 (largest single-iteration depth jump since the band began at iter-88); system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 6-row / 19-equality core also CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 3 TIMEOUT fail-closed / 3 NONUNIT — retains the 5-element row 1:{0,3,7,8,9}, twelfth banked appearance); NOT a transposition image (the two-iteration (4,5)-image streak ends); kin capped at 2 shared rows (breakout unit core — rows 1,3 with 654u-43, rows 8,11 with 654u-12/-16); new (center,support) pair 9:{2,6,8,10}, a center-shift of banked 7:{2,6,8,10} (555u-19, fp-654-20); 6-row/19-eq modal grade | `unit-core-654-45` |
| 100 | 654 | `27457fe8…` | SAT witness, sources (7,8), 7,972,517 nodes (caps=1, 20 M run) — fourth consecutive unit-track witness (inline UNIT), +125 past iter-99, the third-smallest consecutive-witness gap of the band (after 89/90 +1 and 93/94 +5); system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 5-row / 16-equality core also CROSSCHECKED_UNIT ×3 (deletion 7 UNIT / 1 TIMEOUT fail-closed / 4 NONUNIT — retains the 5-element row 1:{0,3,7,8,9}, thirteenth banked appearance); not a transposition image; kin 4 with 654u-45 (rows 1,3,9,10 — equals 654u-45 minus 8:{0,2,3,4} and 11:{1,4,8,10} with new row 8:{3,5,9,10}); that support's third distinct banked center (4, 11 in fp-654-43/-44/-47/-48) and first unit-track appearance; ties the 5-row 654-unit minimum (thirteenth 5-row 654 unit core) | `unit-core-654-46` |
| 101 | 654 | `f26f2757…` | SAT witness, sources (7,8), 7,972,652 nodes (caps=1, 20 M run) — NONUNIT track resumes after four unit iters 97–100 (inline NONUNIT ×3), +135 past iter-100 (iters 99/100/101 all inside a 260-node window); cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core, status CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP; **5-row / 15-equality core forcing (7,8)** with no row centered at 8 (deletion 7 UNIT / 5 TIMEOUT fail-closed / 0 NONUNIT — rows 0,1,2,3,8,9,11 dropped, pair center 7 retained), APEXLESS — ties the bank-wide joint minimum grade, third such core (654u-08, fp-654-01) and third 5-row fp654 core; not a transposition image; kin ≤2 (breakout core); TWO new (center,support) pairs, both center-shifts: 5:{3,6,7,11} (third center for that support) and 7:{3,4,6,8} (second); row 6:{2,4,7,10} previously fp-555-only (fp-555-10/-11), first 654 appearance | `forced-pair-core-654-68` |
| 102 | 654 | `9eed45ec…` | SAT witness, sources (7,8), 8,014,328 nodes (caps=1, 20 M run) — unit track returns after NONUNIT iter-101 (inline UNIT), first band witness past 8M; system_unit_recheck.py 900 s: CROSSCHECKED_UNIT, retained 6-row / 19-equality core also CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 3 TIMEOUT fail-closed / 3 NONUNIT). **IMAGE: the core is the transposition (10,11) relabeling of unit-core-654-39** — FOURTH banked image (555u-88, fp-654-67, 654u-44) and the FIRST under a transposition other than (4,5): the band's image mining is not confined to one transposition; admitted as found per precedent — image-policy decision for Adam remains pressing; kin 3 with 654u-39/-40 (rows 1,3,9); row 1:{0,3,7,8,9} fourteenth banked appearance | `unit-core-654-47` |
| 103 | 654 | `7972c4bb…` | SAT witness, sources (7,8), 8,029,453 nodes (caps=1, 20 M run) — inline metric **UNDECIDED_ORACLE_DISAGREEMENT_OR_TIMEOUT**, the band's first non-decisive inline verdict, resolved CROSSCHECKED_UNIT by the 900 s recheck; retained 7-row / 22-equality core also CROSSCHECKED_UNIT ×3 (deletion 5 UNIT / 4 TIMEOUT fail-closed / 3 NONUNIT — retains the 5-element row 1:{0,3,7,8,9}, fifteenth banked appearance); not a transposition image; kin ≤2 (breakout unit core; rows 1,10 with 654u-47); FOUR new (center,support) pairs — 0:{4,5,7,11} and 11:{5,6,9,10} are BANK-NEW supports, 7:{1,3,5,9} and 9:{0,4,6,8} center-shifts; third 7-row and third 22-eq 654 unit core | `unit-core-654-48` |
| 104 | 654 | `1bc9a5e3…` | SAT witness, sources (7,8), 8,068,477 nodes (caps=1, 20 M run) — NONUNIT track resumes after unit iters 102–103, inline NONUNIT ×3; cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core, status CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP; 6-row / 19-equality core forcing (7,8) with rows centered at both pair members retained (deletion 6 UNIT / 3 TIMEOUT fail-closed / 3 NONUNIT — rows 0,2,5,6,9,11 dropped); not a transposition image; kin 3 (fp-654-55 rows 3,4,10; fp-654-56 rows 3,4,7); NO bank-new (center,support) pairs — row 1:{0,3,7,8,9} sixteenth banked appearance, 8:{2,6,9,11} fifteenth, 7:{3,4,9,10} second (previously fp-654-56 only) | `forced-pair-core-654-69` |
| 105 | 654 | `da50f9ed…` | SAT witness, sources (7,8), 8,068,885 nodes (caps=1, 20 M run) — NONUNIT track continues, +408 past iter-104, inline NONUNIT ×3; cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core, status CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP; 8-row / 24-equality core forcing (7,8) with rows centered at both pair members retained (deletion 4 UNIT / 5 TIMEOUT fail-closed / 3 NONUNIT — rows 1,3,4,5 dropped); **IMAGE: the (10,11) transposition relabeling of fp-654-64 — FIFTH banked image, SECOND under (10,11); preimage is half the genmine-eligible pair (64,65)** — verified row-by-row, admitted per precedent; literal kin ≤2 (rows 2,9 fixed by the transposition); TWO new (center,support) pairs, both center-shifts: 6:{2,5,7,10} and 7:{2,3,6,11} | `forced-pair-core-654-70` |
| 106 | 654 | `41ca051b…` | SAT witness, sources (7,8), 8,077,251 nodes (caps=1, 20 M run) — third consecutive NONUNIT iteration, inline NONUNIT ×3; cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core, status CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP; 7-row / 22-equality core forcing (7,8) with rows centered at both pair members retained (deletion 5 UNIT / 6 TIMEOUT fail-closed / 1 NONUNIT — rows 0,2,3,4,5 dropped); not a transposition image; kin ≤2 (breakout core); row 7:{2,3,6,8} is a **BANK-NEW support**; 6:{2,4,8,10} previously fp-555-only (fp-555-12/-13), first 654 appearance; row 1:{0,3,7,8,9} seventeenth banked appearance; row 10:{1,2,5,9} in three consecutive fp admissions (69/70/71) | `forced-pair-core-654-71` |
| 107 | 654 | `9937ae6c…` | SAT witness, sources (7,8), 8,329,392 nodes (caps=1, 20 M run) — fourth consecutive NONUNIT iteration, +252,141 past iter-106, inline NONUNIT ×3; cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core, status CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP; 7-row / 21-equality core forcing (7,8) with rows centered at both pair members retained (deletion 5 UNIT / 7 TIMEOUT fail-closed / 0 NONUNIT — rows 0,1,2,4,10 dropped, the 5-element row 1:{0,3,7,8,9} among them); not a transposition image; kin ≤2 (breakout core); ONE new (center,support) pair, a center-shift: 3:{2,4,7,11} (elsewhere fp-654-63, 555u-86, 654u-39/-41); row 8:{6,7,9,11} sixteenth banked appearance | `forced-pair-core-654-72` |
| 108 | 654 | `e101769c…` | SAT witness, sources (7,8), 8,333,658 nodes (caps=1, 20 M run) — fifth consecutive NONUNIT iteration, +4,266 past iter-107, inline NONUNIT ×3; cert passed at production order: Rabinowitsch UNIT ×3 full system + retained core, status CROSSCHECKED_REAL_INFEASIBLE_RADICAL_MEMBERSHIP; 7-row / 21-equality core forcing (7,8) with rows centered at both pair members retained (deletion 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT — rows 1,2,3,6,9 dropped); not a transposition image; kin 3 (fp-654-65 rows 8,10,11); THREE new (center,support) pairs, all center-shifts: 0:{4,5,8,10}, 4:{1,3,5,7}, 5:{4,6,8,11}; rows 7:{2,6,8,10} and 8:{6,7,9,11} repeat verbatim from fp-654-72, the latter at seventeen banked appearances | `forced-pair-core-654-73` |
| 109 | 654 | `65bc7190…` | SAT witness, sources (7,8), 8,464,901 nodes (caps=1, 20 M run) — unit track returns after five consecutive NONUNIT iters 104–108; inline UNIT, recheck CROSSCHECKED_UNIT; retained 6-row / 19-equality core CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 6 TIMEOUT fail-closed / 0 NONUNIT); not a transposition image; kin 3 (654u-48 rows 1,10,11); row 7:{1,3,6,8} is a **BANK-NEW support** — third bank-new support of the band segment; 6:{2,3,7,10} a center-shift (fp-654-03); 9:{2,3,5,11} previously fp-654-10 only, first unit-core appearance; row 1:{0,3,7,8,9} eighteenth banked appearance | `unit-core-654-49` |
| 110 | 654 | `265af28f…` | SAT witness, sources (7,8), 8,482,958 nodes (caps=1, 20 M run, +18,057 past iter-109) — second consecutive unit iteration; inline UNIT, recheck CROSSCHECKED_UNIT; retained 6-row / 19-equality core CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 4 TIMEOUT fail-closed / 2 NONUNIT); not a transposition image; kin ≤2 (breakout); both new (center,support) pairs are center-shifts — 6:{2,3,7,11} (center 4 in fp-654-05/06), 8:{1,5,7,9} (center 11 in 555u-45, cross-profile); row 7:{1,3,6,8} recurs immediately after its 654u-49 bank-new debut; row 1:{0,3,7,8,9} nineteenth banked appearance | `unit-core-654-50` |
| 111 | 654 | `06079be1…` | SAT witness, sources (7,8), 8,577,096 nodes (caps=1, 20 M run, +94,138 past iter-110) — NONUNIT track returns after two unit iters 109–110; inline NONUNIT ×3; cert passed at production order, full Rabinowitsch UNIT ×3 + core UNIT ×3; 6-row / 18-equality core forcing (7,8) (deletion 6 UNIT / 3 TIMEOUT fail-closed / 3 NONUNIT; rows 0,1,3,4,5,9 dropped); not a transposition image; kin 4 (shares 3 rows with fp-654-64/65/72/73); one new (center,support), a center-shift — 6:{2,3,9,10} (center 8 in fp-654-25); row 8:{6,7,9,11} at eighteen banked appearances | `forced-pair-core-654-74` |
| 112 | 654 | `3050d612…` | SAT witness, sources (7,8), 8,577,127 nodes (caps=1, 20 M run, +31 past iter-111) — second consecutive NONUNIT iteration; inline NONUNIT ×3; cert passed at production order, full Rabinowitsch UNIT ×3 + core UNIT ×3; 7-row / 22-equality core forcing (7,8) (deletion 5 UNIT / 5 TIMEOUT fail-closed / 2 NONUNIT; rows 0,2,3,5,9 dropped); not a transposition image; kin 4 (shares four rows 6,7,8,11 with fp-654-74); row 10:{1,3,4,6} is a **BANK-NEW support**; 4:{1,5,6,9} a center-shift (center 11 in 555u-44, cross-profile); row 1:{0,3,7,8,9} twentieth banked appearance | `forced-pair-core-654-75` |
| 113 | 654 | `7711b002…` | SAT witness, sources (7,8), 8,614,985 nodes (caps=1, 20 M run, +37,858 past iter-112) — unit track returns after two NONUNIT iters 111–112; inline UNIT, recheck CROSSCHECKED_UNIT; retained 6-row / 19-equality core CROSSCHECKED_UNIT ×3 (deletion 6 UNIT / 5 TIMEOUT fail-closed / 1 NONUNIT); **IMAGE** — this core is exactly the transposition (2,4) image of banked `unit-core-654-41` (verified row-by-row both directions); admitted per image-precedent as found, **sixth banked image**, flagged to Adam; the checker-flagged NEW support 9:{0,3,4,6} is just the (2,4) image of 654-41's 9:{0,2,3,6}, so not bank-new; row 1:{0,3,7,8,9} twenty-first banked appearance | `unit-core-654-51` |
| 114 | 654 | `b22761f7…` | SAT witness, sources (7,8), 8,642,797 nodes (caps=1, 20 M run, +27,812 past iter-113) — NONUNIT track returns after iter-113 unit; inline NONUNIT ×3; cert passed at production order, full Rabinowitsch UNIT ×3 + core UNIT ×3; 8-row / 24-equality core forcing (7,8) (deletion 4 UNIT / 8 TIMEOUT fail-closed / 0 NONUNIT; rows 0,1,2,3 dropped); not a transposition image; kin 3 (shares rows 9,10,11 with `unit-core-654-38`); **no bank-new support** — every retained support has a prior bank appearance; 5:{1,3,6,8} a center-shift (center 7 in unit-core-654-49/50); row 10:{0,1,5,6} at forty-nine prior exact-center banked appearances (third most common banked support, after 0:{1,2,3,4} and 2:{0,1,9,10}) | `forced-pair-core-654-76` |
| 115 | 654 | `1b41c88c…` | SAT witness, sources (7,8), 8,642,835 nodes (caps=1, 20 M run, +38 past iter-114) — third NONUNIT in the last four iters; inline NONUNIT ×3; cert passed at production order, full Rabinowitsch UNIT ×3 + core UNIT ×3; 9-row / 27-equality core forcing (7,8) (deletion 3 UNIT / 9 TIMEOUT fail-closed / 0 NONUNIT; rows 0,1,2 dropped); not a transposition image; **kin 7 with `forced-pair-core-654-76`** (shares rows 5,6,7,8,9,10,11 — fp-654-77 = fp-654-76 plus row 3:{4,6,7,11}, with row 4 support {2,3,5,10}→{2,3,7,10}), a fresh genmine-eligible pair (76,77); also kin 3 with unit-core-654-38; **no bank-new support** — both checker-flagged supports are center-shifts: 3:{4,6,7,11} (center 5 in fp-654-08), 4:{2,3,7,10} (centers 6,9 in fp-654-03 / unit-core-654-49) | `forced-pair-core-654-77` |
