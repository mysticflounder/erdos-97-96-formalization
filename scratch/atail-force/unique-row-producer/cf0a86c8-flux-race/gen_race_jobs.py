"""Generate the flux Singular race jobs for witness cf0a86c8.
...
OUT = SP / "flux_race_cf0a86c8"
OUT.mkdir(exist_ok=True)

system = json.loads((SP / "cf0a86c8_system.json").read_text())
...
manifest = {
    ...
    "equality_sha256": system["equality_sha256"],
