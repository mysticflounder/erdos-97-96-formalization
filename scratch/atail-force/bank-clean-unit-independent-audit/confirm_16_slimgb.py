#!/usr/bin/env python3
"""Exact Singular slimgb arbitration of the 16-equation proposal."""
...
def main() -> None:
    ...
    source = core.HERE / "target_16_slimgb.sing"
    ...
    report = {
        ...
        "algorithm": "Singular 4.4.1 characteristic-zero slimgb, dp order",
        "singular": result,
        "generators": [
    ...
    (core.HERE / "confirm_16_slimgb.json").write_text(
