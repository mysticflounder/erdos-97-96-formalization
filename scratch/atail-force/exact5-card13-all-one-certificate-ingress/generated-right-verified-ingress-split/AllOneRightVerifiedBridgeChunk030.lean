/-
Generated packed-source bridge for verified right chunk 030.
-/
...
theorem sourceChunk030_each_of_flat
    ...
    (h1947 : (!((rowBit rows 1 8 3 && rowBit rows 1 8 1))) = true)
    (h1948 : (!((rowBit rows 2 8 3 && rowBit rows 2 8 2))) = true)
    (h1949 : (!((rowBit rows 2 9 3 && rowBit rows 2 9 2))) = true)
