/-
Generated packed-source ingress for `allOneHitHubRight`.

The row roles are fixed in the original boundary frame: hub 3,
g0 spoke 1, and g1 spoke 2.  The `m` row
family is reserved for the source table carrying the actual fixed-H supports.
-/
import AllOneRightVerified
