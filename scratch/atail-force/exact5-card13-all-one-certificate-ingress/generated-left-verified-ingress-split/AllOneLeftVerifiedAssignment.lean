/-
Generated packed-source ingress for `allOneHitHubLeft`.

The row roles are fixed in the original boundary frame: hub 1,
g0 spoke 2, and g1 spoke 3.  The `m` row
family is reserved for the source table carrying the actual fixed-H supports.
-/
import AllOneLeftVerified
