/-
Generated packed-source bridge for verified left chunk 030.
-/
...
theorem sourceChunk030_each_of_flat
    ...
    (h1947 : (!((rowBit rows 1 8 1 && rowBit rows 1 8 2))) = true)
    (h1948 : (!((rowBit rows 2 8 1 && rowBit rows 2 8 3))) = true)
    (h1949 : (!((rowBit rows 2 9 1 && rowBit rows 2 9 3))) = true)
