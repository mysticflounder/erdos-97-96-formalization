/-
Generated source-faithful composition for middle certificate chunk 071.
-/
import AllOneMiddleVerifiedBridgeChunk071
import AllOneMiddleRankInstancesChunk071

/-!
# Middle source composition chunk 071
...
/-- The live middle source facts satisfy certificate chunk 071. -/
theorem middleSourceChunk071_each
  ...
  exact sourceChunk071_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
