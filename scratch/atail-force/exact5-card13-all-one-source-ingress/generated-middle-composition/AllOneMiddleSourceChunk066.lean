/-
Generated source-faithful composition for middle certificate chunk 066.
-/
import AllOneMiddleVerifiedBridgeChunk066
import AllOneMiddleRankInstancesChunk066

/-!
# Middle source composition chunk 066
...
/-- The live middle source facts satisfy certificate chunk 066. -/
theorem middleSourceChunk066_each
  ...
  exact sourceChunk066_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
