/-
Generated source-faithful composition for middle certificate chunk 082.
-/
import AllOneMiddleVerifiedBridgeChunk082
import AllOneMiddleRankInstancesChunk082

/-!
# Middle source composition chunk 082
...
/-- The live middle source facts satisfy certificate chunk 082. -/
theorem middleSourceChunk082_each
  ...
  exact sourceChunk082_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
