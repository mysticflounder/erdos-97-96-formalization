/-
Generated source-faithful composition for middle certificate chunk 052.
-/
import AllOneMiddleVerifiedBridgeChunk052
import AllOneMiddleRankInstancesChunk052

/-!
# Middle source composition chunk 052
...
/-- The live middle source facts satisfy certificate chunk 052. -/
theorem middleSourceChunk052_each
  ...
  exact sourceChunk052_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
