/-
Generated source-faithful composition for middle certificate chunk 053.
-/
import AllOneMiddleVerifiedBridgeChunk053
import AllOneMiddleRankInstancesChunk053

/-!
# Middle source composition chunk 053
...
/-- The live middle source facts satisfy certificate chunk 053. -/
theorem middleSourceChunk053_each
  ...
  exact sourceChunk053_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
