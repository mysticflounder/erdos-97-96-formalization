/-
Generated source-faithful composition for middle certificate chunk 087.
-/
import AllOneMiddleVerifiedBridgeChunk087
import AllOneMiddleRankInstancesChunk087

/-!
# Middle source composition chunk 087
...
/-- The live middle source facts satisfy certificate chunk 087. -/
theorem middleSourceChunk087_each
  ...
  exact sourceChunk087_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
