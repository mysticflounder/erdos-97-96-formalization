/-
Generated source-faithful composition for middle certificate chunk 107.
-/
import AllOneMiddleVerifiedBridgeChunk107
import AllOneMiddleRankInstancesChunk107

/-!
# Middle source composition chunk 107
...
/-- The live middle source facts satisfy certificate chunk 107. -/
theorem middleSourceChunk107_each
  ...
  exact sourceChunk107_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
