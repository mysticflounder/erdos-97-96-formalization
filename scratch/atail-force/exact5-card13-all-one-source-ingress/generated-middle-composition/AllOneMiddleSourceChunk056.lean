/-
Generated source-faithful composition for middle certificate chunk 056.
-/
import AllOneMiddleVerifiedBridgeChunk056
import AllOneMiddleRankInstancesChunk056

/-!
# Middle source composition chunk 056
...
/-- The live middle source facts satisfy certificate chunk 056. -/
theorem middleSourceChunk056_each
  ...
  exact sourceChunk056_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
