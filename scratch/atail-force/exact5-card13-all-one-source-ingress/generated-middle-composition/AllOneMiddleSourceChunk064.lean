/-
Generated source-faithful composition for middle certificate chunk 064.
-/
import AllOneMiddleVerifiedBridgeChunk064
import AllOneMiddleRankInstancesChunk064

/-!
# Middle source composition chunk 064
...
/-- The live middle source facts satisfy certificate chunk 064. -/
theorem middleSourceChunk064_each
  ...
  exact sourceChunk064_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
