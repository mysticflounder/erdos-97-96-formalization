/-
Generated source-faithful composition for middle certificate chunk 058.
-/
import AllOneMiddleVerifiedBridgeChunk058
import AllOneMiddleRankInstancesChunk058

/-!
# Middle source composition chunk 058
...
/-- The live middle source facts satisfy certificate chunk 058. -/
theorem middleSourceChunk058_each
  ...
  exact sourceChunk058_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
