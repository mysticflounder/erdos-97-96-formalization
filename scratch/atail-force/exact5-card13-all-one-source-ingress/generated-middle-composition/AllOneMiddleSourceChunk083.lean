/-
Generated source-faithful composition for middle certificate chunk 083.
-/
import AllOneMiddleVerifiedBridgeChunk083
import AllOneMiddleRankInstancesChunk083

/-!
# Middle source composition chunk 083
...
/-- The live middle source facts satisfy certificate chunk 083. -/
theorem middleSourceChunk083_each
  ...
  exact sourceChunk083_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
