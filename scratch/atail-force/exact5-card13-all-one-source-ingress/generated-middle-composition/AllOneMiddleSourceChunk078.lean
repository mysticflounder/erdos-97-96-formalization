/-
Generated source-faithful composition for middle certificate chunk 078.
-/
import AllOneMiddleVerifiedBridgeChunk078
import AllOneMiddleRankInstancesChunk078

/-!
# Middle source composition chunk 078
...
/-- The live middle source facts satisfy certificate chunk 078. -/
theorem middleSourceChunk078_each
  ...
  exact sourceChunk078_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
