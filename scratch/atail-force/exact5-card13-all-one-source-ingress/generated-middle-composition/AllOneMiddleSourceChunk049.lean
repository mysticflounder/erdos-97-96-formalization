/-
Generated source-faithful composition for middle certificate chunk 049.
-/
import AllOneMiddleVerifiedBridgeChunk049
import AllOneMiddleRankInstancesChunk049

/-!
# Middle source composition chunk 049
...
/-- The live middle source facts satisfy certificate chunk 049. -/
theorem middleSourceChunk049_each
  ...
  exact sourceChunk049_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
