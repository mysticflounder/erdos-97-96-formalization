/-
Generated source-faithful composition for middle certificate chunk 104.
-/
import AllOneMiddleVerifiedBridgeChunk104
import AllOneMiddleRankInstancesChunk104

/-!
# Middle source composition chunk 104
...
/-- The live middle source facts satisfy certificate chunk 104. -/
theorem middleSourceChunk104_each
  ...
  exact sourceChunk104_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
