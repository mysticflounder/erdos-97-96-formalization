/-
Generated source-faithful composition for middle certificate chunk 051.
-/
import AllOneMiddleVerifiedBridgeChunk051
import AllOneMiddleRankInstancesChunk051

/-!
# Middle source composition chunk 051
...
/-- The live middle source facts satisfy certificate chunk 051. -/
theorem middleSourceChunk051_each
  ...
  exact sourceChunk051_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
