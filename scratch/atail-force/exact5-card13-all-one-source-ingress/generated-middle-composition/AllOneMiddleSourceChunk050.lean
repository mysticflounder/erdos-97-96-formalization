/-
Generated source-faithful composition for middle certificate chunk 050.
-/
import AllOneMiddleVerifiedBridgeChunk050
import AllOneMiddleRankInstancesChunk050

/-!
# Middle source composition chunk 050
...
/-- The live middle source facts satisfy certificate chunk 050. -/
theorem middleSourceChunk050_each
  ...
  exact sourceChunk050_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
