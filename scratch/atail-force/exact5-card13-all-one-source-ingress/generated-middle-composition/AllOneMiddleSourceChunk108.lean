/-
Generated source-faithful composition for middle certificate chunk 108.
-/
import AllOneMiddleVerifiedBridgeChunk108
import AllOneMiddleRankInstancesChunk108

/-!
# Middle source composition chunk 108
...
/-- The live middle source facts satisfy certificate chunk 108. -/
theorem middleSourceChunk108_each
  ...
  exact sourceChunk108_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
