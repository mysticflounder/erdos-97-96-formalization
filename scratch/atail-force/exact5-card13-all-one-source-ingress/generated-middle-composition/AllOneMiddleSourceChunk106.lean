/-
Generated source-faithful composition for middle certificate chunk 106.
-/
import AllOneMiddleVerifiedBridgeChunk106
import AllOneMiddleRankInstancesChunk106

/-!
# Middle source composition chunk 106
...
/-- The live middle source facts satisfy certificate chunk 106. -/
theorem middleSourceChunk106_each
  ...
  exact sourceChunk106_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
