/-
Generated source-faithful composition for middle certificate chunk 089.
-/
import AllOneMiddleVerifiedBridgeChunk089
import AllOneMiddleRankInstancesChunk089

/-!
# Middle source composition chunk 089
...
/-- The live middle source facts satisfy certificate chunk 089. -/
theorem middleSourceChunk089_each
  ...
  exact sourceChunk089_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
