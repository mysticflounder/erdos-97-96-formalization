/-
Generated source-faithful composition for middle certificate chunk 109.
-/
import AllOneMiddleVerifiedBridgeChunk109
import AllOneMiddleRankInstancesChunk109

/-!
# Middle source composition chunk 109
...
/-- The live middle source facts satisfy certificate chunk 109. -/
theorem middleSourceChunk109_each
  ...
  exact sourceChunk109_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
