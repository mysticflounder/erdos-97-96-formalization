/-
Generated source-faithful composition for middle certificate chunk 100.
-/
import AllOneMiddleVerifiedBridgeChunk100
import AllOneMiddleRankInstancesChunk100

/-!
# Middle source composition chunk 100
...
/-- The live middle source facts satisfy certificate chunk 100. -/
theorem middleSourceChunk100_each
  ...
  exact sourceChunk100_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
