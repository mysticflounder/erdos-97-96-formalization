/-
Generated source-faithful composition for middle certificate chunk 045.
-/
import AllOneMiddleVerifiedBridgeChunk045
import AllOneMiddleRankInstancesChunk045

/-!
# Middle source composition chunk 045
...
/-- The live middle source facts satisfy certificate chunk 045. -/
theorem middleSourceChunk045_each
  ...
  exact sourceChunk045_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
