/-
Generated source-faithful composition for middle certificate chunk 060.
-/
import AllOneMiddleVerifiedBridgeChunk060
import AllOneMiddleRankInstancesChunk060

/-!
# Middle source composition chunk 060
...
/-- The live middle source facts satisfy certificate chunk 060. -/
theorem middleSourceChunk060_each
  ...
  exact sourceChunk060_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
