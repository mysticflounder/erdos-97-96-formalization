/-
Generated source-faithful composition for middle certificate chunk 044.
-/
import AllOneMiddleVerifiedBridgeChunk044
import AllOneMiddleRankInstancesChunk044

/-!
# Middle source composition chunk 044
...
/-- The live middle source facts satisfy certificate chunk 044. -/
theorem middleSourceChunk044_each
  ...
  exact sourceChunk044_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
