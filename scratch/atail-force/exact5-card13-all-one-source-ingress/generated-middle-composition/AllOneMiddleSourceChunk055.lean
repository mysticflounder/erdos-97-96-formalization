/-
Generated source-faithful composition for middle certificate chunk 055.
-/
import AllOneMiddleVerifiedBridgeChunk055
import AllOneMiddleRankInstancesChunk055

/-!
# Middle source composition chunk 055
...
/-- The live middle source facts satisfy certificate chunk 055. -/
theorem middleSourceChunk055_each
  ...
  exact sourceChunk055_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
