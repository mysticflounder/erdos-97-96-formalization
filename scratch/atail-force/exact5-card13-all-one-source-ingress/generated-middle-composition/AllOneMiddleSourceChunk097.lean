/-
Generated source-faithful composition for middle certificate chunk 097.
-/
import AllOneMiddleVerifiedBridgeChunk097
import AllOneMiddleRankInstancesChunk097

/-!
# Middle source composition chunk 097
...
/-- The live middle source facts satisfy certificate chunk 097. -/
theorem middleSourceChunk097_each
  ...
  exact sourceChunk097_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
