/-
Generated source-faithful composition for middle certificate chunk 047.
-/
import AllOneMiddleVerifiedBridgeChunk047
import AllOneMiddleRankInstancesChunk047

/-!
# Middle source composition chunk 047
...
/-- The live middle source facts satisfy certificate chunk 047. -/
theorem middleSourceChunk047_each
  ...
  exact sourceChunk047_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
