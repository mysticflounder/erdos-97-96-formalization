/-
Generated source-faithful composition for middle certificate chunk 105.
-/
import AllOneMiddleVerifiedBridgeChunk105
import AllOneMiddleRankInstancesChunk105

/-!
# Middle source composition chunk 105
...
/-- The live middle source facts satisfy certificate chunk 105. -/
theorem middleSourceChunk105_each
  ...
  exact sourceChunk105_each_of_flat
    (sourceRows (CanonicalAllOneSourceOrbitIngress.middle C))
    (sourceBlockers T) (sourceShell T) (sourceQ T) (sourceW T)
