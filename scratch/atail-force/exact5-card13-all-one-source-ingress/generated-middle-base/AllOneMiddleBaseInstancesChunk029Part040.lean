...
/-- Candidate middle source assertion `h1896` (second_apex_row_shell). -/
theorem middleSource_h1896 :
    ((!(rowBit (I.sourceRows) 1 8 4) || (shellBit (sourceShell T) 4))) = true := by
  exact allOne_secondApex_row_implies_shell I (1 : Fin 3) (4 : Fin 13)
