...
/-- Candidate middle source assertion `h1800` (first_shared_pair). -/
theorem middleSource_h1800 :
    (!((firstRowBit (sourceFirstApexRow T) 11 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 0 2 11 && rowBit (I.sourceRows) 0 2 12))) = true := by
