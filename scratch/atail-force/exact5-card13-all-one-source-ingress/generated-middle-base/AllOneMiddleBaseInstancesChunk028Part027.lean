...
/-- Candidate middle source assertion `h1819` (first_shared_pair). -/
theorem middleSource_h1819 :
    (!((firstRowBit (sourceFirstApexRow T) 2 && firstRowBit (sourceFirstApexRow T) 10 && rowBit (I.sourceRows) 2 9 2 && rowBit (I.sourceRows) 2 9 10))) = true := by
