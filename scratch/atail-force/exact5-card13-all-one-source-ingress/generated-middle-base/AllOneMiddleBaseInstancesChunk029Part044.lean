...
/-- Candidate middle source assertion `h1900` (second_apex_row_shell). -/
theorem middleSource_h1900 :
    ((!(rowBit (I.sourceRows) 1 8 9) || (shellBit (sourceShell T) 9))) = true := by
  exact allOne_secondApex_row_implies_shell I (1 : Fin 3) (9 : Fin 13)
