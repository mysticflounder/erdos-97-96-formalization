...
/-- Candidate middle source assertion `h1892` (second_apex_row_shell). -/
theorem middleSource_h1892 :
    ((!(rowBit (I.sourceRows) 0 8 10) || (shellBit (sourceShell T) 10))) = true := by
  exact allOne_secondApex_row_implies_shell I (0 : Fin 3) (10 : Fin 13)
