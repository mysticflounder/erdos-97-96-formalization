...
/-- Candidate middle source assertion `h1794` (first_shared_pair). -/
theorem middleSource_h1794 :
    (!((firstRowBit (sourceFirstApexRow T) 8 && firstRowBit (sourceFirstApexRow T) 10 && rowBit (I.sourceRows) 0 2 8 && rowBit (I.sourceRows) 0 2 10))) = true := by
