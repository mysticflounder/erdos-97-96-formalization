...
/-- Candidate middle source assertion `h1908` (second_apex_row_shell). -/
theorem middleSource_h1908 :
    ((!(rowBit (I.sourceRows) 2 8 7) || (shellBit (sourceShell T) 7))) = true := by
  exact allOne_secondApex_row_implies_shell I (2 : Fin 3) (7 : Fin 13)
