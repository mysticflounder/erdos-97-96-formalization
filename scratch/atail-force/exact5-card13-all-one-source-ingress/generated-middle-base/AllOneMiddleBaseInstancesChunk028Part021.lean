...
/-- Candidate middle source assertion `h1813` (first_shared_pair). -/
theorem middleSource_h1813 :
    (!((firstRowBit (sourceFirstApexRow T) 3 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 1 8 3 && rowBit (I.sourceRows) 1 8 11))) = true := by
