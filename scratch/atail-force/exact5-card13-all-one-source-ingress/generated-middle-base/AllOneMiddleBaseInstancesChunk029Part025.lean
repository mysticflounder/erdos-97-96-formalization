...
/-- Candidate middle source assertion `h1881` (shell_physical). -/
theorem middleSource_h1881 :
    (shellBit (sourceShell T) 1) = true := by
  exact allOne_physical_shell_mem T (1 : Fin 13) (by decide)
