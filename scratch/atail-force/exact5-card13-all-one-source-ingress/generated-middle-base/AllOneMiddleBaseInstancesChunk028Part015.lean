...
/-- Candidate middle source assertion `h1807` (first_shared_pair). -/
theorem middleSource_h1807 :
    (!((firstRowBit (sourceFirstApexRow T) 9 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 0 3 9 && rowBit (I.sourceRows) 0 3 11))) = true := by
