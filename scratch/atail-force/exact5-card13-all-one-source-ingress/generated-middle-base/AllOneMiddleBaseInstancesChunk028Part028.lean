...
/-- Candidate middle source assertion `h1820` (first_shared_pair). -/
theorem middleSource_h1820 :
    (!((firstRowBit (sourceFirstApexRow T) 2 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 2 9 2 && rowBit (I.sourceRows) 2 9 12))) = true := by
