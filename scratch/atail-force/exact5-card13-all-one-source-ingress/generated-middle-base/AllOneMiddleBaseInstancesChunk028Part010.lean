...
/-- Candidate middle source assertion `h1802` (first_shared_pair). -/
theorem middleSource_h1802 :
    (!((firstRowBit (sourceFirstApexRow T) 6 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 0 3 6 && rowBit (I.sourceRows) 0 3 11))) = true := by
