...
/-- Candidate middle source assertion `h1909` (second_apex_row_shell). -/
theorem middleSource_h1909 :
    ((!(rowBit (I.sourceRows) 2 8 9) || (shellBit (sourceShell T) 9))) = true := by
  exact allOne_secondApex_row_implies_shell I (2 : Fin 3) (9 : Fin 13)
