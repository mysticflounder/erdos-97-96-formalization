...
/-- Candidate middle source assertion `h1797` (first_shared_pair). -/
theorem middleSource_h1797 :
    (!((firstRowBit (sourceFirstApexRow T) 9 && firstRowBit (sourceFirstApexRow T) 10 && rowBit (I.sourceRows) 0 2 9 && rowBit (I.sourceRows) 0 2 10))) = true := by
