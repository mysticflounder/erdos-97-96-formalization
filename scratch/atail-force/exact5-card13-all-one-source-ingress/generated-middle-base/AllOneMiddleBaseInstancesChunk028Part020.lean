...
/-- Candidate middle source assertion `h1812` (first_shared_pair). -/
theorem middleSource_h1812 :
    (!((firstRowBit (sourceFirstApexRow T) 3 && firstRowBit (sourceFirstApexRow T) 10 && rowBit (I.sourceRows) 1 8 3 && rowBit (I.sourceRows) 1 8 10))) = true := by
