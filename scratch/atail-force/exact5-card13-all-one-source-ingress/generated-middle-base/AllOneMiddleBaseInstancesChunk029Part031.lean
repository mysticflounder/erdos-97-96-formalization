...
/-- Candidate middle source assertion `h1887` (second_apex_row_shell). -/
theorem middleSource_h1887 :
    ((!(rowBit (I.sourceRows) 0 8 4) || (shellBit (sourceShell T) 4))) = true := by
  exact allOne_secondApex_row_implies_shell I (0 : Fin 3) (4 : Fin 13)
