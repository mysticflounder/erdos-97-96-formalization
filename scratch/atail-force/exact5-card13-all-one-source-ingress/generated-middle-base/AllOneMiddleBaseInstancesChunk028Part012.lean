...
/-- Candidate middle source assertion `h1804` (first_shared_pair). -/
theorem middleSource_h1804 :
    (!((firstRowBit (sourceFirstApexRow T) 8 && firstRowBit (sourceFirstApexRow T) 9 && rowBit (I.sourceRows) 0 3 8 && rowBit (I.sourceRows) 0 3 9))) = true := by
