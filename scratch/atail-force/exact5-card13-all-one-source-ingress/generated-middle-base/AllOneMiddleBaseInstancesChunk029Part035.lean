...
/-- Candidate middle source assertion `h1891` (second_apex_row_shell). -/
theorem middleSource_h1891 :
    ((!(rowBit (I.sourceRows) 0 8 9) || (shellBit (sourceShell T) 9))) = true := by
  exact allOne_secondApex_row_implies_shell I (0 : Fin 3) (9 : Fin 13)
