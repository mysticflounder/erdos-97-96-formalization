...
/-- Candidate middle source assertion `h1899` (second_apex_row_shell). -/
theorem middleSource_h1899 :
    ((!(rowBit (I.sourceRows) 1 8 7) || (shellBit (sourceShell T) 7))) = true := by
  exact allOne_secondApex_row_implies_shell I (1 : Fin 3) (7 : Fin 13)
