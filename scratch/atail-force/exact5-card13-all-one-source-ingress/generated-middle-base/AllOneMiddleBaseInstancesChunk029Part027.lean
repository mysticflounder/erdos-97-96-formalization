...
/-- Candidate middle source assertion `h1883` (shell_physical). -/
theorem middleSource_h1883 :
    (shellBit (sourceShell T) 3) = true := by
  exact allOne_physical_shell_mem T (3 : Fin 13) (by decide)
