...
/-- Candidate middle source assertion `h1796` (first_shared_pair). -/
theorem middleSource_h1796 :
    (!((firstRowBit (sourceFirstApexRow T) 8 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 0 2 8 && rowBit (I.sourceRows) 0 2 12))) = true := by
