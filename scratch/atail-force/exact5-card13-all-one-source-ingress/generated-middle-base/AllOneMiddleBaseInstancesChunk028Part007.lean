...
/-- Candidate middle source assertion `h1799` (first_shared_pair). -/
theorem middleSource_h1799 :
    (!((firstRowBit (sourceFirstApexRow T) 10 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 0 2 10 && rowBit (I.sourceRows) 0 2 12))) = true := by
