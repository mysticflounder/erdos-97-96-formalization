...
/-- Candidate middle source assertion `h1882` (shell_physical). -/
theorem middleSource_h1882 :
    (shellBit (sourceShell T) 2) = true := by
  exact allOne_physical_shell_mem T (2 : Fin 13) (by decide)
