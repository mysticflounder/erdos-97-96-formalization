...
/-- Candidate middle source assertion `h1895` (second_apex_row_shell). -/
theorem middleSource_h1895 :
    ((!(rowBit (I.sourceRows) 1 8 0) || (shellBit (sourceShell T) 0))) = true := by
  exact allOne_secondApex_row_implies_shell I (1 : Fin 3) (0 : Fin 13)
