...
/-- Candidate middle source assertion `h1903` (second_apex_row_shell). -/
theorem middleSource_h1903 :
    ((!(rowBit (I.sourceRows) 1 8 12) || (shellBit (sourceShell T) 12))) = true := by
  exact allOne_secondApex_row_implies_shell I (1 : Fin 3) (12 : Fin 13)
