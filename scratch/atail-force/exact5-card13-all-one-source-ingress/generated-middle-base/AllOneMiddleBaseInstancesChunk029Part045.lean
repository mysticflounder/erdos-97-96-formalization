...
/-- Candidate middle source assertion `h1901` (second_apex_row_shell). -/
theorem middleSource_h1901 :
    ((!(rowBit (I.sourceRows) 1 8 10) || (shellBit (sourceShell T) 10))) = true := by
  exact allOne_secondApex_row_implies_shell I (1 : Fin 3) (10 : Fin 13)
