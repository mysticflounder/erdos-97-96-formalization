...
/-- Candidate middle source assertion `h1798` (first_shared_pair). -/
theorem middleSource_h1798 :
    (!((firstRowBit (sourceFirstApexRow T) 10 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 0 2 10 && rowBit (I.sourceRows) 0 2 11))) = true := by
