...
/-- Candidate middle source assertion `h1906` (second_apex_row_shell). -/
theorem middleSource_h1906 :
    ((!(rowBit (I.sourceRows) 2 8 5) || (shellBit (sourceShell T) 5))) = true := by
  exact allOne_secondApex_row_implies_shell I (2 : Fin 3) (5 : Fin 13)
