...
/-- Candidate middle source assertion `h1907` (second_apex_row_shell). -/
theorem middleSource_h1907 :
    ((!(rowBit (I.sourceRows) 2 8 6) || (shellBit (sourceShell T) 6))) = true := by
  exact allOne_secondApex_row_implies_shell I (2 : Fin 3) (6 : Fin 13)
