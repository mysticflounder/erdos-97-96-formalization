...
/-- Candidate middle source assertion `h1816` (first_shared_pair). -/
theorem middleSource_h1816 :
    (!((firstRowBit (sourceFirstApexRow T) 0 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 2 9 0 && rowBit (I.sourceRows) 2 9 12))) = true := by
