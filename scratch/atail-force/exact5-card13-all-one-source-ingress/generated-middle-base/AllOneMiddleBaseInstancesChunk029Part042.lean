...
/-- Candidate middle source assertion `h1898` (second_apex_row_shell). -/
theorem middleSource_h1898 :
    ((!(rowBit (I.sourceRows) 1 8 6) || (shellBit (sourceShell T) 6))) = true := by
  exact allOne_secondApex_row_implies_shell I (1 : Fin 3) (6 : Fin 13)
