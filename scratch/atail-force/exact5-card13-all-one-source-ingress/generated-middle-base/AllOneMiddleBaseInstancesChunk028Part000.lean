...
/-- Candidate middle source assertion `h1792` (first_shared_pair). -/
theorem middleSource_h1792 :
    (!((firstRowBit (sourceFirstApexRow T) 7 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 0 2 7 && rowBit (I.sourceRows) 0 2 12))) = true := by
