...
/-- Candidate middle source assertion `h1822` (first_shared_pair). -/
theorem middleSource_h1822 :
    (!((firstRowBit (sourceFirstApexRow T) 10 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 2 9 10 && rowBit (I.sourceRows) 2 9 11))) = true := by
