...
/-- Candidate middle source assertion `h1806` (first_shared_pair). -/
theorem middleSource_h1806 :
    (!((firstRowBit (sourceFirstApexRow T) 9 && firstRowBit (sourceFirstApexRow T) 10 && rowBit (I.sourceRows) 0 3 9 && rowBit (I.sourceRows) 0 3 10))) = true := by
