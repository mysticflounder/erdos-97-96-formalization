...
/-- Candidate middle source assertion `h1805` (first_shared_pair). -/
theorem middleSource_h1805 :
    (!((firstRowBit (sourceFirstApexRow T) 8 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 0 3 8 && rowBit (I.sourceRows) 0 3 12))) = true := by
