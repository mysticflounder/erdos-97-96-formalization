...
/-- Candidate middle source assertion `h1821` (first_shared_pair). -/
theorem middleSource_h1821 :
    (!((firstRowBit (sourceFirstApexRow T) 3 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 2 9 3 && rowBit (I.sourceRows) 2 9 11))) = true := by
