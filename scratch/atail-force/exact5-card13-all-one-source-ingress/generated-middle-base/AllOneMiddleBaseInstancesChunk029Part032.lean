...
/-- Candidate middle source assertion `h1888` (second_apex_row_shell). -/
theorem middleSource_h1888 :
    ((!(rowBit (I.sourceRows) 0 8 5) || (shellBit (sourceShell T) 5))) = true := by
  exact allOne_secondApex_row_implies_shell I (0 : Fin 3) (5 : Fin 13)
