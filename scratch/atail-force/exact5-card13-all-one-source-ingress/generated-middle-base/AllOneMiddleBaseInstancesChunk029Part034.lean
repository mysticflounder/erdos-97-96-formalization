...
/-- Candidate middle source assertion `h1890` (second_apex_row_shell). -/
theorem middleSource_h1890 :
    ((!(rowBit (I.sourceRows) 0 8 7) || (shellBit (sourceShell T) 7))) = true := by
  exact allOne_secondApex_row_implies_shell I (0 : Fin 3) (7 : Fin 13)
