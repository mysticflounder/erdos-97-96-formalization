...
/-- Candidate middle source assertion `h1823` (first_shared_pair). -/
theorem middleSource_h1823 :
    (!((firstRowBit (sourceFirstApexRow T) 10 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 2 9 10 && rowBit (I.sourceRows) 2 9 12))) = true := by
