...
/-- Candidate middle source assertion `h1808` (first_shared_pair). -/
theorem middleSource_h1808 :
    (!((firstRowBit (sourceFirstApexRow T) 10 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 0 3 10 && rowBit (I.sourceRows) 0 3 11))) = true := by
