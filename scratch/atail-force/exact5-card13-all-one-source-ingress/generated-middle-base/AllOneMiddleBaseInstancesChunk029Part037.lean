...
/-- Candidate middle source assertion `h1893` (second_apex_row_shell). -/
theorem middleSource_h1893 :
    ((!(rowBit (I.sourceRows) 0 8 11) || (shellBit (sourceShell T) 11))) = true := by
  exact allOne_secondApex_row_implies_shell I (0 : Fin 3) (11 : Fin 13)
