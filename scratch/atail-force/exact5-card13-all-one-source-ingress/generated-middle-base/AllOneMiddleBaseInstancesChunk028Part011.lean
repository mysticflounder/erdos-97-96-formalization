...
/-- Candidate middle source assertion `h1803` (first_shared_pair). -/
theorem middleSource_h1803 :
    (!((firstRowBit (sourceFirstApexRow T) 6 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 0 3 6 && rowBit (I.sourceRows) 0 3 12))) = true := by
