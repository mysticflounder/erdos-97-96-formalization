...
/-- Candidate middle source assertion `h1814` (first_shared_pair). -/
theorem middleSource_h1814 :
    (!((firstRowBit (sourceFirstApexRow T) 0 && firstRowBit (sourceFirstApexRow T) 10 && rowBit (I.sourceRows) 2 9 0 && rowBit (I.sourceRows) 2 9 10))) = true := by
