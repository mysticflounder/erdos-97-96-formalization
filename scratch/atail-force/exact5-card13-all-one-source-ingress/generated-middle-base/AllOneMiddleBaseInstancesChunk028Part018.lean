...
/-- Candidate middle source assertion `h1810` (first_shared_pair). -/
theorem middleSource_h1810 :
    (!((firstRowBit (sourceFirstApexRow T) 11 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 0 3 11 && rowBit (I.sourceRows) 0 3 12))) = true := by
