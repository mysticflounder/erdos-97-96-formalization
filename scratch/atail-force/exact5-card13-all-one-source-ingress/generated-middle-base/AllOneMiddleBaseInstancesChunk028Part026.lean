...
/-- Candidate middle source assertion `h1818` (first_shared_pair). -/
theorem middleSource_h1818 :
    (!((firstRowBit (sourceFirstApexRow T) 1 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 2 9 1 && rowBit (I.sourceRows) 2 9 11))) = true := by
