...
/-- Candidate middle source assertion `h1897` (second_apex_row_shell). -/
theorem middleSource_h1897 :
    ((!(rowBit (I.sourceRows) 1 8 5) || (shellBit (sourceShell T) 5))) = true := by
  exact allOne_secondApex_row_implies_shell I (1 : Fin 3) (5 : Fin 13)
