...
/-- Candidate middle source assertion `h1795` (first_shared_pair). -/
theorem middleSource_h1795 :
    (!((firstRowBit (sourceFirstApexRow T) 8 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 0 2 8 && rowBit (I.sourceRows) 0 2 11))) = true := by
