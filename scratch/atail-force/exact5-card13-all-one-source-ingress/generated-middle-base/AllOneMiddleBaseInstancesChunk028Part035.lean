...
/-- Candidate middle source assertion `h1827` (first_shared_pair). -/
theorem middleSource_h1827 :
    (!((firstRowBit (sourceFirstApexRow T) 1 && firstRowBit (sourceFirstApexRow T) 11 && rowBit (I.sourceRows) 2 8 1 && rowBit (I.sourceRows) 2 8 11))) = true := by
