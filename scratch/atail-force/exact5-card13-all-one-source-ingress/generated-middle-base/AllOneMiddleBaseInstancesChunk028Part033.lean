...
/-- Candidate middle source assertion `h1825` (first_shared_pair). -/
theorem middleSource_h1825 :
    (!((firstRowBit (sourceFirstApexRow T) 1 && firstRowBit (sourceFirstApexRow T) 9 && rowBit (I.sourceRows) 2 8 1 && rowBit (I.sourceRows) 2 8 9))) = true := by
