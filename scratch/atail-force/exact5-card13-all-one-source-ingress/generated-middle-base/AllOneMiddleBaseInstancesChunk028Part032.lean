...
/-- Candidate middle source assertion `h1824` (first_shared_pair). -/
theorem middleSource_h1824 :
    (!((firstRowBit (sourceFirstApexRow T) 11 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 2 9 11 && rowBit (I.sourceRows) 2 9 12))) = true := by
