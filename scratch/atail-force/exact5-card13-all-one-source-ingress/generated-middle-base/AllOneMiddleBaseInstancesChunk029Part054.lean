...
/-- Candidate middle source assertion `h1910` (second_apex_row_shell). -/
theorem middleSource_h1910 :
    ((!(rowBit (I.sourceRows) 2 8 10) || (shellBit (sourceShell T) 10))) = true := by
  exact allOne_secondApex_row_implies_shell I (2 : Fin 3) (10 : Fin 13)
