...
/-- Candidate middle source assertion `h1889` (second_apex_row_shell). -/
theorem middleSource_h1889 :
    ((!(rowBit (I.sourceRows) 0 8 6) || (shellBit (sourceShell T) 6))) = true := by
  exact allOne_secondApex_row_implies_shell I (0 : Fin 3) (6 : Fin 13)
