...
/-- Candidate middle source assertion `h1912` (second_apex_row_shell). -/
theorem middleSource_h1912 :
    ((!(rowBit (I.sourceRows) 2 8 12) || (shellBit (sourceShell T) 12))) = true := by
  exact allOne_secondApex_row_implies_shell I (2 : Fin 3) (12 : Fin 13)
