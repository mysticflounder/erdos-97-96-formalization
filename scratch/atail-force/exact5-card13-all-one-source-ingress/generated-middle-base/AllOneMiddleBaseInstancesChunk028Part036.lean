...
/-- Candidate middle source assertion `h1828` (first_shared_pair). -/
theorem middleSource_h1828 :
    (!((firstRowBit (sourceFirstApexRow T) 1 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 2 8 1 && rowBit (I.sourceRows) 2 8 12))) = true := by
