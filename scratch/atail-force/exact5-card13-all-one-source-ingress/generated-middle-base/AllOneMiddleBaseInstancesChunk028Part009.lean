...
/-- Candidate middle source assertion `h1801` (first_shared_pair). -/
theorem middleSource_h1801 :
    (!((firstRowBit (sourceFirstApexRow T) 6 && firstRowBit (sourceFirstApexRow T) 10 && rowBit (I.sourceRows) 0 3 6 && rowBit (I.sourceRows) 0 3 10))) = true := by
