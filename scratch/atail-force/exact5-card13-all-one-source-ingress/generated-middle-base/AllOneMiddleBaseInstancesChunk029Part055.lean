...
/-- Candidate middle source assertion `h1911` (second_apex_row_shell). -/
theorem middleSource_h1911 :
    ((!(rowBit (I.sourceRows) 2 8 11) || (shellBit (sourceShell T) 11))) = true := by
  exact allOne_secondApex_row_implies_shell I (2 : Fin 3) (11 : Fin 13)
