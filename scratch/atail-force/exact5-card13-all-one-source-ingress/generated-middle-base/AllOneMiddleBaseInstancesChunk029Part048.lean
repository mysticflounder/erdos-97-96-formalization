...
/-- Candidate middle source assertion `h1904` (second_apex_row_shell). -/
theorem middleSource_h1904 :
    ((!(rowBit (I.sourceRows) 2 8 0) || (shellBit (sourceShell T) 0))) = true := by
  exact allOne_secondApex_row_implies_shell I (2 : Fin 3) (0 : Fin 13)
