...
/-- Candidate middle source assertion `h1826` (first_shared_pair). -/
theorem middleSource_h1826 :
    (!((firstRowBit (sourceFirstApexRow T) 1 && firstRowBit (sourceFirstApexRow T) 10 && rowBit (I.sourceRows) 2 8 1 && rowBit (I.sourceRows) 2 8 10))) = true := by
