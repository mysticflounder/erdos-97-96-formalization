...
/-- Candidate middle source assertion `h1811` (first_shared_pair). -/
theorem middleSource_h1811 :
    (!((firstRowBit (sourceFirstApexRow T) 3 && firstRowBit (sourceFirstApexRow T) 9 && rowBit (I.sourceRows) 1 8 3 && rowBit (I.sourceRows) 1 8 9))) = true := by
