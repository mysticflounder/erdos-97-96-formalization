...
/-- Candidate middle source assertion `h1905` (second_apex_row_shell). -/
theorem middleSource_h1905 :
    ((!(rowBit (I.sourceRows) 2 8 4) || (shellBit (sourceShell T) 4))) = true := by
  exact allOne_secondApex_row_implies_shell I (2 : Fin 3) (4 : Fin 13)
