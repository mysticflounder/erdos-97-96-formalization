...
/-- Candidate middle source assertion `h1817` (first_shared_pair). -/
theorem middleSource_h1817 :
    (!((firstRowBit (sourceFirstApexRow T) 1 && firstRowBit (sourceFirstApexRow T) 10 && rowBit (I.sourceRows) 2 9 1 && rowBit (I.sourceRows) 2 9 10))) = true := by
