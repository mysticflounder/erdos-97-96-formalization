...
/-- Candidate middle source assertion `h1902` (second_apex_row_shell). -/
theorem middleSource_h1902 :
    ((!(rowBit (I.sourceRows) 1 8 11) || (shellBit (sourceShell T) 11))) = true := by
  exact allOne_secondApex_row_implies_shell I (1 : Fin 3) (11 : Fin 13)
