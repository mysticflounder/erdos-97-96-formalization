...
/-- Candidate middle source assertion `h1809` (first_shared_pair). -/
theorem middleSource_h1809 :
    (!((firstRowBit (sourceFirstApexRow T) 10 && firstRowBit (sourceFirstApexRow T) 12 && rowBit (I.sourceRows) 0 3 10 && rowBit (I.sourceRows) 0 3 12))) = true := by
