...
/-- Candidate middle source assertion `h1886` (second_apex_row_shell). -/
theorem middleSource_h1886 :
    ((!(rowBit (I.sourceRows) 0 8 0) || (shellBit (sourceShell T) 0))) = true := by
  exact allOne_secondApex_row_implies_shell I (0 : Fin 3) (0 : Fin 13)
