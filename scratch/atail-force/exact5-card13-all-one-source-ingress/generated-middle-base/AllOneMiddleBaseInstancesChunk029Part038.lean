...
/-- Candidate middle source assertion `h1894` (second_apex_row_shell). -/
theorem middleSource_h1894 :
    ((!(rowBit (I.sourceRows) 0 8 12) || (shellBit (sourceShell T) 12))) = true := by
  exact allOne_secondApex_row_implies_shell I (0 : Fin 3) (12 : Fin 13)
