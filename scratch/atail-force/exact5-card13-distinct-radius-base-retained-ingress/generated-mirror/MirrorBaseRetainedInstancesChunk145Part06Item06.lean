...
/-- Manifest-selected source assertion `h37396`. -/
theorem mirrorSource_h37396
    ...
    (!((rowBit (directSourceRows C) 0 4 3 && firstRowBit (directSourceFirstRow T) 3))) = true := by
  exact directSource_mainFour_firstRow_disjoint C _hdistinct (3 : Fin 13)
