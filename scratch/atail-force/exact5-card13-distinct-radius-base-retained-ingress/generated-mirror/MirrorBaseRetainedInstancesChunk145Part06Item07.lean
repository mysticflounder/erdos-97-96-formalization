...
/-- Manifest-selected source assertion `h37398`. -/
theorem mirrorSource_h37398
    ...
    (!((rowBit (directSourceRows C) 0 4 5 && firstRowBit (directSourceFirstRow T) 5))) = true := by
  exact directSource_mainFour_firstRow_disjoint C _hdistinct (5 : Fin 13)
