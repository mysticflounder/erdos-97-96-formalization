...
/-- Manifest-selected source assertion `h37394`. -/
theorem mirrorSource_h37394
    ...
    (!((rowBit (directSourceRows C) 0 4 1 && firstRowBit (directSourceFirstRow T) 1))) = true := by
  exact directSource_mainFour_firstRow_disjoint C _hdistinct (1 : Fin 13)
