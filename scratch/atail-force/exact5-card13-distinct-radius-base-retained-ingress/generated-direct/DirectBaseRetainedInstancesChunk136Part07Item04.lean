...
/-- Manifest-selected source assertion `h37389`. -/
theorem directSource_h37389
    ...
    ((2#4).ule ((bif rowBit (directSourceRows C) 0 4 9 then 1#4 else 0#4) + (bif rowBit (directSourceRows C) 0 4 10 then 1#4 else 0#4) + (bif rowBit (directSourceRows C) 0 4 11 then 1#4 else 0#4) + (bif rowBit (directSourceRows C) 0 4 12 then 1#4 else 0#4))) = true := by
  exact directSource_mainFour_firstStrict_card_ge_two C
