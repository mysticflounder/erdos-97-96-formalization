...
/-- Manifest-selected source assertion `h37393`. -/
theorem directSource_h37393
    ...
    (!((rowBit (directSourceRows C) 0 4 0 && firstRowBit (directSourceFirstRow T) 0))) = true := by
  exact directSource_mainFour_firstRow_disjoint C _hdistinct (0 : Fin 13)
