...
/-- Manifest-selected source assertion `h37392`. -/
theorem directSource_h37392
    ...
    ((((directSourceQ T == 9#4) && rowBit (directSourceRows C) 0 4 9) || ((directSourceQ T == 10#4) && rowBit (directSourceRows C) 0 4 10) || ((directSourceQ T == 11#4) && rowBit (directSourceRows C) 0 4 11) || ((directSourceQ T == 12#4) && rowBit (directSourceRows C) 0 4 12) || ((directSourceW T == 9#4) && rowBit (directSourceRows C) 0 4 9) || ((directSourceW T == 10#4) && rowBit (directSourceRows C) 0 4 10) || ((directSourceW T == 11#4) && rowBit (directSourceRows C) 0 4 11) || ((directSourceW T == 12#4) && rowBit (directSourceRows C) 0 4 12))) = true := by
  exact directSource_frontier_strict_main_occurrence C
