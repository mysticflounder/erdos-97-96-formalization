...
Retained normalized equalities: 17.
-/
...
private theorem normalized_bankClean_incompatible
  ...
  have hK_O_I_sq := congrArg (fun r : ℝ => r ^ 2) hK_O_I
  change dist K (pt 0 0) ^ 2 = dist K I ^ 2 at hK_O_I_sq
  rw [bankClean_dist_sq_coord, bankClean_dist_sq_coord] at hK_O_I_sq
  simp only [pt, Matrix.cons_val_zero, Matrix.cons_val_one] at hK_O_I_sq
  ...
  clear hO_A_E hA_O_G hA_O_K hX_Z_G hX_Z_F hY_O_X hY_O_Z hY_O_E hZ_A_Y hZ_A_G hG_X_E hG_X_K hK_O_Y hK_O_G hK_O_I hF_A_Z hF_A_K
...
theorem bank_clean_anchor_collision
  ...
  have map_dist_eq {P Q R S : ℝ²} (h : dist P Q = dist R S) :
    ...
    rw [hdist, hdist, h]
  apply normalized_bankClean_incompatible (E := e) (F := f) (G := g) (I := i) (K := k) (X := x) (Y := y) (Z := z)
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hO_A_E
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hA_O_G
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hA_O_K
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hX_Z_G
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hX_Z_F
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hY_O_X
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hY_O_Z
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hY_O_E
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hZ_A_Y
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hZ_A_G
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hG_X_E
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hG_X_K
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hK_O_Y
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hK_O_G
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hK_O_I
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hF_A_Z
  · simpa [e, f, g, i, k, x, y, z, hT0, hT1] using map_dist_eq hF_A_K
...
theorem false_of_bank_clean_rows
    ...
    (hF_A_K : dist F A = dist F K)
    : False := by
  exact hOA (bank_clean_anchor_collision hO_A_E hA_O_G hA_O_K hX_Z_G hX_Z_F hY_O_X hY_O_Z hY_O_E hZ_A_Y hZ_A_G hG_X_E hG_X_K hK_O_Y hK_O_G hK_O_I hF_A_Z hF_A_K)
