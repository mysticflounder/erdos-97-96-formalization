#!/usr/bin/env python3
"""Regression tests for the bounded P4 row-cardinality generated tree."""
...
SPEC = importlib.util.spec_from_file_location("p4_row_at_least_four_generate", MODULE_PATH)
...
class GeneratedTreeVerificationTest(unittest.TestCase):
    ...
    @staticmethod
    def fake_load_entries() -> tuple[dict, list[dict]]:
        entry = {"shape": (0, [1, 2, 3, 4, 5, 6, 7]),
                 "dense_literals": [2, 3, 4, 5, 6, 7, 8]}
