...
/-!
# Round-19 three-circle lower-intersection scalar core
...
The three lower circle-intersection inequalities exposed by the `(5,5,5)`
round-19 MEC probe are
...
namespace Problem97
namespace Census554
namespace Residual555Round19MECScalarCore

/-- Any common lower bound for the three numerical gate margins is strictly
below `-4/25`.  The optimizer's best value near `-0.17017` is therefore on
...
/-- The exact lower-chord scalar obstruction behind the numerical round-19
margin.  This is the weakest form needed from the three triangle
inequalities. -/
...
/-- Angle-parameter form used by the round-19 residual.  Here `a` and `b` are
...
end Residual555Round19MECScalarCore
end Census554
end Problem97

#print axioms Problem97.Census554.Residual555Round19MECScalarCore.lower_circle_intersection_inequalities_incompatible
#print axioms Problem97.Census554.Residual555Round19MECScalarCore.common_gate_margin_lt_neg_four_twentyfive
#print axioms Problem97.Census554.Residual555Round19MECScalarCore.lower_chord_margins_incompatible
#print axioms Problem97.Census554.Residual555Round19MECScalarCore.angle_lower_chord_margins_incompatible
#print axioms Problem97.Census554.Residual555Round19MECScalarCore.angle_lower_circle_intersection_inequalities_incompatible
