...
(assert (= x_1 1))
(assert (= y_1 0))
(assert (= x_2 (/ 57900 37253)))
(assert (= y_2 (/ 600 37253)))
(assert (= x_3 (/ 94253 74506)))
(assert (= y_3 (/ 63141 149012)))
(assert (= x_4 (/ 28758 37253)))
(assert (= y_4 (/ 18828 37253)))
(assert (= x_5 (/ 121924 186265)))
(assert (= y_5 (/ 80788 186265)))
(check-sat)
