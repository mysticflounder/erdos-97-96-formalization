#!/usr/bin/env python3
"""Regression tests for the P4 row/radius generated-tree verifier."""
...
SPEC = importlib.util.spec_from_file_location("p4_row_radius_generate", MODULE_PATH)
...
class GeneratedTreeVerificationTest(unittest.TestCase):
    ...
    def fake_load_entries() -> list[dict]:
        entry = {
            "dense_literals": [-1, -2, 111],
            "shape": (0, 1, 2),
            "output_clause_index": 3219,
            "source_core_clause_index": 3219,
        }
