...
namespace Problem97
namespace UniqueFourWeightedReplayScratch

open WeightedKalmansonCutDataSoundnessScratch

/-- Typed reduced payload for the first row-only exact-four core. -/
def rowOnlyFourCut : WeightedKalmansonCutData 7 where
  inequalities :=
    [ { kind := .k2, a := 0, b := 1, c := 2, d := 3, weight := 1 }
    , { kind := .k2, a := 0, b := 1, c := 3, d := 4, weight := 1 }
    , { kind := .k2, a := 0, b := 1, c := 4, d := 5, weight := 1 }
    , { kind := .k1, a := 0, b := 4, c := 5, d := 6, weight := 1 } ]
  rowEqualities :=
    [ { center := 0, reference := 2, point := 4, multiplier := 1 }
    , { center := 1, reference := 5, point := 2, multiplier := 1 }
    , { center := 6, reference := 4, point := 5, multiplier := 1 } ]

/-- Typed reduced payload for the second row-only exact-four core. -/
def rowOnlyFiveCut : WeightedKalmansonCutData 10 where
  inequalities :=
    [ { kind := .k2, a := 0, b := 1, c := 2, d := 3, weight := 1 }
    , { kind := .k2, a := 0, b := 1, c := 3, d := 4, weight := 1 }
    , { kind := .k2, a := 0, b := 1, c := 4, d := 5, weight := 1 }
    , { kind := .k2, a := 0, b := 1, c := 5, d := 6, weight := 1 }
    , { kind := .k1, a := 0, b := 2, c := 3, d := 9, weight := 1 }
    , { kind := .k1, a := 0, b := 3, c := 4, d := 9, weight := 1 }
    , { kind := .k1, a := 0, b := 4, c := 5, d := 9, weight := 1 }
    , { kind := .k1, a := 0, b := 5, c := 6, d := 9, weight := 1 }
    , { kind := .k1, a := 0, b := 6, c := 7, d := 9, weight := 1 }
    , { kind := .k1, a := 0, b := 7, c := 8, d := 9, weight := 1 } ]
  rowEqualities :=
    [ { center := 0, reference := 8, point := 6, multiplier := 1 }
    , { center := 1, reference := 6, point := 2, multiplier := 1 }
    , { center := 9, reference := 2, point := 8, multiplier := 1 } ]

/-- Typed reduced payload for the full-partition four-role core. -/
def fullPartitionFourCut : WeightedKalmansonCutData 4 where
  inequalities :=
    [ { kind := .k1, a := 0, b := 1, c := 2, d := 3, weight := 1 } ]
  rowEqualities :=
    [ { center := 1, reference := 0, point := 2, multiplier := -1 }
    , { center := 3, reference := 1, point := 2, multiplier := 1 }
    , { center := 2, reference := 0, point := 1, multiplier := 1 } ]

/-- Typed reduced payload for the full-partition six-role core. -/
def fullPartitionFiveCut : WeightedKalmansonCutData 6 where
  inequalities :=
    [ { kind := .k2, a := 0, b := 1, c := 3, d := 4, weight := 1 }
    , { kind := .k2, a := 0, b := 1, c := 4, d := 5, weight := 1 }
    , { kind := .k2, a := 1, b := 2, c := 3, d := 4, weight := 1 }
    , { kind := .k2, a := 1, b := 2, c := 4, d := 5, weight := 1 } ]
  rowEqualities :=
    [ { center := 0, reference := 1, point := 5, multiplier := 1 }
    , { center := 1, reference := 0, point := 2, multiplier := -1 }
    , { center := 2, reference := 0, point := 1, multiplier := 1 }
    , { center := 2, reference := 0, point := 5, multiplier := -1 }
    , { center := 3, reference := 0, point := 2, multiplier := 1 } ]

/-- Typed reduced payload for the five-role round-two core. -/
def roundTwoFiveCut : WeightedKalmansonCutData 5 where
  inequalities :=
    [ { kind := .k2, a := 0, b := 1, c := 2, d := 3, weight := 1 }
    , { kind := .k1, a := 0, b := 1, c := 2, d := 4, weight := 1 }
    , { kind := .k1, a := 0, b := 2, c := 3, d := 4, weight := 1 } ]
  rowEqualities :=
    [ { center := 1, reference := 0, point := 3, multiplier := -1 }
    , { center := 4, reference := 1, point := 3, multiplier := 1 }
    , { center := 2, reference := 0, point := 1, multiplier := 1 } ]

theorem rowOnlyFourCut_check : rowOnlyFourCut.check = true := by decide

theorem rowOnlyFiveCut_check : rowOnlyFiveCut.check = true := by
  set_option maxRecDepth 10000 in
    decide

theorem fullPartitionFourCut_check : fullPartitionFourCut.check = true := by decide

theorem fullPartitionFiveCut_check : fullPartitionFiveCut.check = true := by decide

theorem roundTwoFiveCut_check : roundTwoFiveCut.check = true := by decide

#print axioms rowOnlyFourCut_check
#print axioms rowOnlyFiveCut_check
#print axioms fullPartitionFourCut_check
#print axioms fullPartitionFiveCut_check
#print axioms roundTwoFiveCut_check

end UniqueFourWeightedReplayScratch
end Problem97
