...
[
  ...
  { hits := [(1, 8), (1, 10), (4, 10), (4, 11), (6, 1), (6, 14), (8, 11), (8, 14), (10, 1), (10, 7), (11, 7), (11, 8)]
    ...
    forwardData := {
      ...
      path1 := ⟨(8, 14), [.row 8 14 11, .flip 8 11, .row 11 8 7, .flip 11 7], (7, 11)⟩
      path2 := ⟨(7, 10), [.flip 7 10, .row 10 7 1, .flip 10 1, .row 1 10 8], (1, 8)⟩
  ...
  { hits := [(3, 15), (3, 16), (5, 8), (5, 15), (8, 7), (8, 16), (9, 3), (9, 8), (11, 5), (11, 7), (15, 3), (15, 5)]
    ...
    forwardData := {
      ...
      path3 := ⟨(3, 16), [.row 3 16 15, .flip 3 15, .row 15 3 5, .flip 15 5, .row 5 15 8], (5, 8)⟩ }
    reverseData := {
      firstQuad := ⟨0, 7, 8, 13⟩
      firstForm := .innerOuter
      secondQuad := ⟨5, 8, 9, 11⟩
  ...
  { hits := [(4, 6), (4, 10), (6, 1), (6, 7), (6, 9), (6, 14), (9, 10), (9, 14), (10, 1), (10, 7), (14, 6), (14, 9)]
    ...
    forwardData := {
      ...
      path3 := ⟨(9, 10), [.row 9 10 14, .flip 9 14, .row 14 9 6, .flip 14 6, .row 6 14 9], (6, 9)⟩ }
    reverseData := {
  ...
  { hits := [(5, 8), (5, 12), (5, 15), (8, 11), (8, 14), (11, 5), (11, 8), (12, 14), (12, 15), (15, 5), (15, 11), (15, 12)]
    ...
    forwardData := {
      ...
      firstForm := .adjacentSides
      secondQuad := ⟨5, 8, 12, 14⟩
      secondForm := .adjacentSides
      permutation := ⟨3, 1, 0, 2⟩
      path0 := ⟨(5, 11), [.flip 5 11, .row 11 5 8, .flip 11 8, .row 8 11 14], (8, 14)⟩
    ...
    reverseData := {
      ...
      path1 := ⟨(5, 11), [.row 5 11 8, .flip 5 8, .row 8 5 2, .flip 8 2], (2, 8)⟩
      path2 := ⟨(2, 4), [.flip 2 4, .row 4 2 1, .flip 4 1, .row 1 4 11, .flip 1 11, .row 11 1 4, .flip 11 4], (4, 11)⟩
      path3 := ⟨(8, 11), [.flip 8 11, .row 11 8 4, .flip 11 4], (4, 11)⟩ } },
  ...
  { hits := [(6, 7), (6, 14), (7, 4), (7, 9), (9, 3), (9, 14), (10, 3), (10, 7), (13, 4), (13, 6), (14, 6), (14, 9)]
    ...
    forwardData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨2, 1, 0, 3⟩
      path0 := ⟨(6, 7), [.row 6 7 14, .flip 6 14, .row 14 6 9, .flip 14 9, .row 9 14 3, .flip 9 3], (3, 9)⟩
    ...
    reverseData := {
      ...
      path2 := ⟨(9, 10), [.flip 9 10, .row 10 9 2, .flip 10 2, .row 2 10 7, .flip 2 7, .row 7 2 13], (7, 13)⟩
  ...
  { hits := [(1, 10), (1, 13), (2, 6), (2, 13), (6, 1), (6, 7), (6, 9), (6, 14), (9, 10), (9, 14), (10, 1), (10, 7), (14, 6), (14, 9)]
    ...
    forwardData := {
      ...
      path1 := ⟨(1, 13), [.row 1 13 10, .flip 1 10, .row 10 1 7, .flip 10 7], (7, 10)⟩
      path2 := ⟨(6, 7), [.row 6 7 1, .flip 6 1], (1, 6)⟩
      path3 := ⟨(9, 10), [.row 9 10 14, .flip 9 14, .row 14 9 6, .flip 14 6, .row 6 14 9], (6, 9)⟩ }
    reverseData := {
      firstQuad := ⟨3, 10, 14, 15⟩
