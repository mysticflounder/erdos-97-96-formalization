...
/-!
# Child-31 cancellation refinements, shard 2
...
namespace Problem97
namespace ATailBlockerVExactSeventeenThirtyFirstModelRefinementsShard2
...
[
  { hits := [(1, 4), (1, 8), (6, 9), (6, 14), (9, 8), (9, 14), (13, 4), (13, 6), (14, 6), (14, 9)]
    ...
    forwardData := {
      ...
      path1 := ⟨(8, 13), [], (8, 13)⟩
      path2 := ⟨(8, 9), [.flip 8 9, .row 9 8 14, .flip 9 14, .row 14 9 6, .flip 14 6, .row 6 14 9], (6, 9)⟩
  ...
  { hits := [(1, 8), (1, 10), (4, 6), (4, 10), (6, 9), (6, 14), (9, 8), (9, 14), (14, 6), (14, 9)]
    ...
    forwardData := {
      ...
      path2 := ⟨(1, 6), [], (1, 6)⟩
      path3 := ⟨(8, 9), [.flip 8 9, .row 9 8 14, .flip 9 14, .row 14 9 6, .flip 14 6, .row 6 14 9], (6, 9)⟩ }
    reverseData := {
      firstQuad := ⟨7, 8, 10, 15⟩
      firstForm := .adjacentSides
      secondQuad := ⟨6, 10, 12, 15⟩
      secondForm := .innerOuter
      permutation := ⟨0, 3, 2, 1⟩
      path0 := ⟨(7, 8), [.row 7 8 2, .flip 7 2, .row 2 7 10, .flip 2 10, .row 10 2 7, .flip 10 7], (7, 10)⟩
      path1 := ⟨(10, 15), [], (10, 15)⟩
  ...
  { hits := [(1, 8), (1, 13), (2, 6), (2, 13), (6, 9), (6, 14), (9, 8), (9, 14), (14, 6), (14, 9)]
    ...
    reverseData := {
      ...
      path0 := ⟨(7, 8), [.row 7 8 2, .flip 7 2, .row 2 7 10, .flip 2 10, .row 10 2 7, .flip 10 7], (7, 10)⟩
      path1 := ⟨(10, 15), [], (10, 15)⟩
      path2 := ⟨(10, 14), [.flip 10 14, .row 14 10 3, .flip 14 3], (3, 14)⟩
      path3 := ⟨(3, 15), [.flip 3 15, .row 15 3 8, .flip 15 8], (8, 15)⟩ } },
  { hits := [(1, 8), (1, 13), (7, 9), (7, 13), (8, 7), (8, 11), (11, 7), (11, 8), (12, 9), (12, 11)]
    forwardChoices := [{ center := 1, support := {8, 13} },
    ...
    reverseData := {
      ...
      secondForm := .adjacentSides
      permutation := ⟨3, 1, 2, 0⟩
      path0 := ⟨(8, 9), [.row 8 9 5, .flip 8 5, .row 5 8 9], (5, 9)⟩
      path1 := ⟨(3, 15), [.flip 3 15, .row 15 3 8, .flip 15 8], (8, 15)⟩
      path2 := ⟨(4, 5), [.row 4 5 7], (4, 7)⟩
      path3 := ⟨(7, 9), [.flip 7 9, .row 9 7 3, .flip 9 3], (3, 9)⟩ } },
  { hits := [(1, 10), (1, 13), (2, 1), (2, 6), (4, 6), (4, 10), (10, 1), (10, 2), (16, 2), (16, 13)]
    ...
    reverseData := {
      firstQuad := ⟨0, 3, 14, 15⟩
      firstForm := .adjacentSides
      secondQuad := ⟨6, 10, 12, 14⟩
      secondForm := .innerOuter
      permutation := ⟨0, 3, 2, 1⟩
      path0 := ⟨(0, 3), [.row 0 3 14], (0, 14)⟩
      path1 := ⟨(14, 15), [.row 14 15 10, .flip 14 10], (10, 14)⟩
      path2 := ⟨(10, 12), [.flip 10 12, .row 12 10 6, .flip 12 6], (6, 12)⟩
      path3 := ⟨(6, 14), [.row 6 14 15, .flip 6 15, .row 15 6 3, .flip 15 3], (3, 15)⟩ } },
  { hits := [(1, 10), (1, 13), (3, 4), (3, 16), (4, 2), (4, 10), (13, 4), (13, 16), (16, 2), (16, 13)]
    forwardChoices := [{ center := 1, support := {10, 13} },
    ...
    forwardData := {
      ...
      path1 := ⟨(2, 16), [.flip 2 16, .row 16 2 13, .flip 16 13, .row 13 16 4, .flip 13 4], (4, 13)⟩
    ...
    reverseData := {
      ...
      path3 := ⟨(0, 14), [.row 0 14 3, .flip 0 3, .row 3 0 12], (3, 12)⟩ } },
  { hits := [(2, 6), (2, 13), (3, 4), (3, 16), (4, 2), (4, 6), (13, 4), (13, 16), (16, 2), (16, 13)]
    ...
    reverseData := {
      ...
      path2 := ⟨(12, 13), [.flip 12 13, .row 13 12 0, .flip 13 0], (0, 13)⟩
      path3 := ⟨(0, 14), [.row 0 14 3, .flip 0 3, .row 3 0 12], (3, 12)⟩ } },
  { hits := [(3, 4), (3, 16), (4, 2), (4, 6), (7, 4), (7, 13), (13, 6), (13, 16), (16, 2), (16, 13)]
    ...
    forwardData := {
      ...
      permutation := ⟨1, 3, 0, 2⟩
      path0 := ⟨(3, 4), [.row 3 4 16], (3, 16)⟩
      path1 := ⟨(2, 16), [.flip 2 16, .row 16 2 13, .flip 16 13, .row 13 16 6, .flip 13 6], (6, 13)⟩
      path2 := ⟨(4, 6), [.row 4 6 2, .flip 4 2], (2, 4)⟩
    ...
    reverseData := {
      ...
      path2 := ⟨(12, 13), [.flip 12 13, .row 13 12 0, .flip 13 0], (0, 13)⟩
      path3 := ⟨(0, 14), [.row 0 14 3, .flip 0 3, .row 3 0 10], (3, 10)⟩ } },
  { hits := [(4, 6), (4, 10), (6, 1), (6, 14), (9, 10), (9, 14), (10, 1), (10, 3), (14, 3), (14, 6)]
    ...
    forwardData := {
      ...
      path3 := ⟨(1, 10), [.flip 1 10, .row 10 1 3, .flip 10 3], (3, 10)⟩ }
    reverseData := {
  ...
  { hits := [(4, 6), (4, 11), (5, 12), (5, 15), (12, 11), (12, 15), (13, 5), (13, 6), (15, 5), (15, 12)]
    ...
    forwardData := {
      firstQuad := ⟨4, 6, 11, 13⟩
      firstForm := .adjacentSides
      secondQuad := ⟨5, 11, 12, 13⟩
      secondForm := .innerOuter
      permutation := ⟨0, 3, 2, 1⟩
      path0 := ⟨(4, 6), [.row 4 6 11], (4, 11)⟩
      path1 := ⟨(11, 13), [], (11, 13)⟩
      path2 := ⟨(11, 12), [.flip 11 12, .row 12 11 15, .flip 12 15, .row 15 12 5, .flip 15 5, .row 5 15 12], (5, 12)⟩
      path3 := ⟨(5, 13), [.flip 5 13, .row 13 5 6, .flip 13 6], (6, 13)⟩ }
    reverseData := {
      firstQuad := ⟨3, 4, 10, 11⟩
      firstForm := .innerOuter
      secondQuad := ⟨4, 5, 10, 12⟩
      secondForm := .adjacentSides
      permutation := ⟨2, 0, 1, 3⟩
      path0 := ⟨(4, 10), [], (4, 10)⟩
      path1 := ⟨(3, 11), [.row 3 11 10], (3, 10)⟩
      path2 := ⟨(4, 5), [.row 4 5 1, .flip 4 1, .row 1 4 11, .flip 1 11, .row 11 1 4, .flip 11 4], (4, 11)⟩
      path3 := ⟨(10, 12), [.flip 10 12, .row 12 10 5, .flip 12 5], (5, 12)⟩ } },
  { hits := [(5, 8), (5, 12), (8, 11), (8, 16), (11, 5), (11, 8), (13, 5), (13, 16), (15, 11), (15, 12)]
    ...
    forwardData := {
      firstQuad := ⟨5, 11, 12, 15⟩
      firstForm := .adjacentSides
      secondQuad := ⟨5, 8, 13, 16⟩
      secondForm := .adjacentSides
      permutation := ⟨3, 1, 0, 2⟩
      path0 := ⟨(5, 11), [.flip 5 11, .row 11 5 8, .flip 11 8, .row 8 11 16], (8, 16)⟩
    ...
    reverseData := {
      ...
      path2 := ⟨(1, 4), [.row 1 4 5], (1, 5)⟩
      path3 := ⟨(5, 11), [.row 5 11 8, .flip 5 8, .row 8 5 0, .flip 8 0], (0, 8)⟩ } },
  { hits := [(5, 8), (5, 15), (7, 9), (7, 15), (8, 7), (8, 11), (11, 7), (11, 8), (12, 9), (12, 11)]
    ...
    reverseData := {
      ...
      permutation := ⟨3, 1, 2, 0⟩
      path0 := ⟨(8, 9), [.row 8 9 5, .flip 8 5, .row 5 8 9], (5, 9)⟩
      path1 := ⟨(1, 11), [.flip 1 11, .row 11 1 8, .flip 11 8], (8, 11)⟩
      path2 := ⟨(4, 5), [.row 4 5 7], (4, 7)⟩
      path3 := ⟨(7, 9), [.flip 7 9, .row 9 7 1, .flip 9 1], (1, 9)⟩ } },
  { hits := [(5, 12), (5, 15), (8, 7), (8, 14), (11, 5), (11, 7), (12, 14), (12, 15), (15, 5), (15, 12)]
    forwardChoices := [{ center := 5, support := {12, 15} },
        { center := 8, support := {7, 14} },
    ...
    forwardData := {
      ...
      secondForm := .adjacentSides
      permutation := ⟨1, 3, 0, 2⟩
      path0 := ⟨(7, 8), [.flip 7 8, .row 8 7 14], (8, 14)⟩
      path1 := ⟨(11, 14), [], (11, 14)⟩
      path2 := ⟨(5, 11), [.flip 5 11, .row 11 5 7, .flip 11 7], (7, 11)⟩
      path3 := ⟨(12, 14), [.row 12 14 15, .flip 12 15, .row 15 12 5, .flip 15 5, .row 5 15 12], (5, 12)⟩ }
    reverseData := {
      firstQuad := ⟨2, 4, 5, 11⟩
      firstForm := .adjacentSides
      secondQuad := ⟨2, 5, 8, 9⟩
      ...
      path2 := ⟨(2, 5), [], (2, 5)⟩
      path3 := ⟨(8, 9), [.row 8 9 2, .flip 8 2], (2, 8)⟩ } },
  { hits := [(5, 12), (5, 15), (9, 8), (9, 14), (11, 5), (11, 8), (12, 14), (12, 15), (15, 5), (15, 12)]
    forwardChoices := [{ center := 5, support := {12, 15} },
        { center := 9, support := {8, 14} },
        { center := 11, support := {5, 8} },
        { center := 12, support := {14, 15} },
    ...
    forwardData := {
      ...
      path1 := ⟨(11, 14), [], (11, 14)⟩
      path2 := ⟨(5, 11), [.flip 5 11, .row 11 5 8, .flip 11 8], (8, 11)⟩
      path3 := ⟨(12, 14), [.row 12 14 15, .flip 12 15, .row 15 12 5, .flip 15 5, .row 5 15 12], (5, 12)⟩ }
    reverseData := {
      firstQuad := ⟨2, 4, 5, 11⟩
      firstForm := .adjacentSides
      ...
      permutation := ⟨1, 3, 0, 2⟩
      path0 := ⟨(2, 4), [.flip 2 4, .row 4 2 1, .flip 4 1, .row 1 4 11, .flip 1 11, .row 11 1 4, .flip 11 4], (4, 11)⟩
      path1 := ⟨(5, 11), [.row 5 11 8], (5, 8)⟩
      path2 := ⟨(2, 5), [], (2, 5)⟩
      path3 := ⟨(7, 8), [.row 7 8 2, .flip 7 2], (2, 7)⟩ } },
  { hits := [(5, 12), (5, 15), (11, 0), (11, 5), (12, 9), (12, 15), (14, 0), (14, 9), (15, 5), (15, 12)]
    forwardChoices := [{ center := 5, support := {12, 15} },
    ...
    forwardData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨3, 1, 2, 0⟩
      path0 := ⟨(9, 12), [.flip 9 12, .row 12 9 15, .flip 12 15, .row 15 12 5, .flip 15 5, .row 5 15 12], (5, 12)⟩
      path1 := ⟨(0, 14), [.flip 0 14, .row 14 0 9, .flip 14 9], (9, 14)⟩
    ...
    reverseData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨1, 2, 3, 0⟩
      path0 := ⟨(4, 7), [.row 4 7 1, .flip 4 1, .row 1 4 11, .flip 1 11, .row 11 1 4, .flip 11 4], (4, 11)⟩
      path1 := ⟨(2, 11), [], (2, 11)⟩
      path2 := ⟨(5, 11), [.row 5 11 16], (5, 16)⟩
      path3 := ⟨(2, 16), [.row 2 16 7], (2, 7)⟩ } },
  { hits := [(5, 12), (5, 15), (12, 9), (12, 15), (13, 5), (13, 6), (14, 6), (14, 9), (15, 5), (15, 12)]
    forwardChoices := [{ center := 5, support := {12, 15} },
        { center := 12, support := {9, 15} },
        { center := 13, support := {5, 6} },
        { center := 14, support := {6, 9} },
    ...
    forwardData := {
      ...
      path2 := ⟨(9, 12), [.flip 9 12, .row 12 9 15, .flip 12 15, .row 15 12 5, .flip 15 5, .row 5 15 12], (5, 12)⟩
      path3 := ⟨(6, 14), [.flip 6 14, .row 14 6 9, .flip 14 9], (9, 14)⟩ }
    reverseData := {
      firstQuad := ⟨3, 4, 10, 11⟩
      firstForm := .innerOuter
      secondQuad := ⟨2, 4, 7, 10⟩
      ...
      path0 := ⟨(4, 10), [], (4, 10)⟩
      path1 := ⟨(3, 11), [.row 3 11 10], (3, 10)⟩
      path2 := ⟨(4, 7), [.row 4 7 1, .flip 4 1, .row 1 4 11, .flip 1 11, .row 11 1 4, .flip 11 4], (4, 11)⟩
      path3 := ⟨(2, 10), [.row 2 10 7], (2, 7)⟩ } },
  { hits := [(6, 9), (6, 14), (9, 3), (9, 14), (13, 5), (13, 6), (14, 6), (14, 9), (15, 3), (15, 5)]
    ...
    forwardData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨3, 1, 2, 0⟩
      path0 := ⟨(5, 13), [.flip 5 13, .row 13 5 6, .flip 13 6], (6, 13)⟩
      path1 := ⟨(3, 15), [.flip 3 15, .row 15 3 5, .flip 15 5], (5, 15)⟩
      path2 := ⟨(6, 9), [.row 6 9 14, .flip 6 14, .row 14 6 9, .flip 14 9, .row 9 14 3, .flip 9 3], (3, 9)⟩
      path3 := ⟨(3, 13), [], (3, 13)⟩ }
    reverseData := {
      firstQuad := ⟨1, 7, 11, 13⟩
      firstForm := .innerOuter
      ...
      path2 := ⟨(7, 10), [.flip 7 10, .row 10 7 2, .flip 10 2, .row 2 10 7, .flip 2 7, .row 7 2 13], (7, 13)⟩
      path3 := ⟨(3, 11), [.row 3 11 10], (3, 10)⟩ } },
  { hits := [(0, 1), (0, 9), (1, 4), (1, 10), (6, 1), (6, 14), (9, 10), (9, 14), (13, 4), (13, 6), (14, 6), (14, 9)]
  ...
  { hits := [(0, 1), (0, 9), (1, 10), (1, 13), (2, 6), (2, 13), (6, 1), (6, 14), (9, 10), (9, 14), (14, 6), (14, 9)]
    forwardChoices := [{ center := 0, support := {1, 9} },
    ...
    forwardData := {
      ...
      path3 := ⟨(9, 10), [.row 9 10 14, .flip 9 14, .row 14 9 6, .flip 14 6, .row 6 14 1, .flip 6 1], (1, 6)⟩ }
    reverseData := {
      ...
      path2 := ⟨(6, 7), [.flip 6 7, .row 7 6 2, .flip 7 2, .row 2 7 10, .flip 2 10, .row 10 2 15], (10, 15)⟩
      path3 := ⟨(15, 16), [.flip 15 16, .row 16 15 7, .flip 16 7], (7, 16)⟩ } },
  { hits := [(0, 9), (0, 16), (2, 1), (2, 13), (6, 1), (6, 9), (13, 6), (13, 16), (14, 0), (14, 6), (16, 0), (16, 13)]
    ...
    forwardData := {
      ...
      secondForm := .adjacentSides
      permutation := ⟨2, 1, 3, 0⟩
      path0 := ⟨(6, 9), [.row 6 9 1, .flip 6 1], (1, 6)⟩
    ...
    reverseData := {
      ...
      secondForm := .adjacentSides
      permutation := ⟨3, 0, 1, 2⟩
      path0 := ⟨(7, 10), [.flip 7 10, .row 10 7 15], (10, 15)⟩
  ...
  { hits := [(0, 9), (0, 16), (9, 3), (9, 14), (13, 6), (13, 16), (14, 0), (14, 3), (14, 6), (14, 9), (16, 0), (16, 14)]
    forwardChoices := [{ center := 0, support := {9, 16} },
        { center := 9, support := {3, 14} },
        { center := 13, support := {6, 16} },
...
end ATailBlockerVExactSeventeenThirtyFirstModelRefinementsShard2
end Problem97
