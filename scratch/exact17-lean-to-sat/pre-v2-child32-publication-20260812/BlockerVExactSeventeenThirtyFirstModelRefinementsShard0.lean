...
[
  { hits := [(0, 1), (0, 8), (9, 3), (9, 8), (10, 1), (10, 3)]
    forwardChoices := [{ center := 0, support := {1, 8} },
        { center := 9, support := {3, 8} },
        { center := 10, support := {1, 3} }]
    reverseChoices := [{ center := 6, support := {13, 15} },
  ...
  { hits := [(0, 8), (0, 9), (6, 7), (6, 9), (11, 7), (11, 8)]
    ...
    forwardData := {
      ...
      path1 := ⟨(0, 9), [.row 0 9 8], (0, 8)⟩
      path2 := ⟨(0, 7), [], (0, 7)⟩
      path3 := ⟨(8, 11), [.flip 8 11, .row 11 8 7, .flip 11 7], (7, 11)⟩ }
    reverseData := {
      firstQuad := ⟨5, 8, 9, 16⟩
      firstForm := .adjacentSides
  ...
  { hits := [(0, 8), (0, 16), (1, 4), (1, 8), (3, 4), (3, 16)]
    ...
    reverseChoices := [{ center := 13, support := {0, 12} },
  ...
  { hits := [(0, 8), (0, 16), (3, 15), (3, 16), (5, 8), (5, 15)]
    ...
    reverseChoices := [{ center := 11, support := {1, 8} },
        { center := 13, support := {0, 1} },
        { center := 16, support := {0, 8} }]
    forwardData := {
      firstQuad := ⟨0, 5, 8, 15⟩
      firstForm := .innerOuter
      secondQuad := ⟨0, 3, 15, 16⟩
      secondForm := .innerOuter
      permutation := ⟨1, 2, 3, 0⟩
  ...
  { hits := [(0, 9), (0, 16), (6, 9), (6, 14), (8, 14), (8, 16)]
    ...
    reverseChoices := [{ center := 8, support := {0, 2} },
  ...
  { hits := [(4, 10), (4, 11), (8, 11), (8, 14), (9, 10), (9, 14)]
    ...
    forwardData := {
      firstQuad := ⟨8, 9, 10, 14⟩
      firstForm := .innerOuter
      secondQuad := ⟨4, 8, 10, 11⟩
      secondForm := .innerOuter
      permutation := ⟨1, 3, 0, 2⟩
      path0 := ⟨(9, 10), [.row 9 10 14], (9, 14)⟩
      path1 := ⟨(8, 14), [.row 8 14 11], (8, 11)⟩
      path2 := ⟨(8, 10), [], (8, 10)⟩
  ...
  { hits := [(8, 7), (8, 14), (9, 3), (9, 14), (10, 3), (10, 7)]
    forwardChoices := [{ center := 8, support := {7, 14} },
        { center := 9, support := {3, 14} },
        { center := 10, support := {3, 7} }]
    reverseChoices := [{ center := 6, support := {9, 13} },
        { center := 7, support := {2, 13} },
    ...
    forwardData := {
      ...
      path2 := ⟨(3, 8), [], (3, 8)⟩
      path3 := ⟨(9, 14), [.row 9 14 3, .flip 9 3], (3, 9)⟩ }
    reverseData := {
      firstQuad := ⟨2, 7, 8, 13⟩
      firstForm := .adjacentSides
      secondQuad := ⟨6, 8, 9, 13⟩
  ...
  { hits := [(8, 7), (8, 16), (11, 5), (11, 7), (13, 5), (13, 16)]
    forwardChoices := [{ center := 8, support := {7, 16} },
  ...
  { hits := [(9, 3), (9, 8), (11, 5), (11, 8), (15, 3), (15, 5)]
    ...
    forwardData := {
      ...
      secondForm := .innerOuter
      permutation := ⟨3, 1, 2, 0⟩
      path0 := ⟨(5, 11), [.flip 5 11, .row 11 5 8, .flip 11 8], (8, 11)⟩
