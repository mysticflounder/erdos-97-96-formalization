import q1_public_helper

namespace Problem97.Q1PrivateClient
...
theorem bridge
  ...
  simpa only [q1Polynomial, e7Polynomial, e8Polynomial, e9Polynomial] using
    Problem97.Q1PublicHelper.false_of_q1_br_eq_bv hq p7 p8 p9 hbrv hbr hbs hbw hbv1

end Problem97.Q1PrivateClient
