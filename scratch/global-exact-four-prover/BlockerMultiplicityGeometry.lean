...
* A larger first known fiber either gives a requested named cross hit, or a
  fresh source outside the indexed first cap in the first canonical shell.
* The second larger-fiber arm has the symmetric conclusion.
...
#print axioms collisionCrossHit_or_geometricMultiplicity
#print axioms collisionShell_sdiff_firstCap_card_eq_two
