...
open Problem97.ATailRetainedStrictInteriorPairSelector
open Problem97.ATailLocalizedCollisionMutualOmissionCycle
open Problem97.ATailBiApexRobustCapBounds
open Problem97.ATailBlockerMultiplicityGeometry
open Problem97.ATailOrientedPhysicalApexIngress
open Problem97.ATailPhysicalSecondApexCommonDeletion
open Problem97.ATailLargeOppositeCapsBiApexSurface
...
example
  ...
  | firstNonHit data secondInteraction =>
      cases data <;> cases secondInteraction <;> simp_all
  | secondNonHit firstInteraction data =>
      cases firstInteraction <;> cases data <;> simp_all
  | equalCrossRowCenters firstHit secondHit centers_eq firstInteraction secondInteraction =>
      cases firstInteraction <;> cases secondInteraction <;> simp_all
