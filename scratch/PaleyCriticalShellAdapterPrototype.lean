...
/-!
# Prototype physical adapter for literal Paley critical shells

This scratch module connects exact shell membership to the fixed-basis determinant
normalization obstruction.  It is not imported by production code.
-/

open scoped EuclideanGeometry

namespace Problem97.PaleyCriticalShellAdapterPrototype
...
end Problem97.PaleyCriticalShellAdapterPrototype

#print axioms Problem97.PaleyCriticalShellAdapterPrototype.false_of_literal_paley_critical_shells
