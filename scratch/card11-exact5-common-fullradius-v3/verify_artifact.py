#!/usr/bin/env python3
"""Independent verifier for full-radius plus duplicate-center artifacts.
...
SCHEMA = "card11_exact5_common_fullradius.v3"
...
def main() -> int:
    ...
    global_vars = parse_global_variables(manifest, cnf_vars)
    structural = verify_v3_clause_blocks(clauses, manifest, global_vars)
    ...
    verification["v3_structural_audit"] = structural
