#!/usr/bin/env python3
"""Theorem-gated full-radius plus duplicate-center closure obstruction.
...
def main() -> int:
    ...
    summary = {
        ...
        "trust_boundary": (
            ...
            "for UNSAT.  EqualityCore.not_realizes_of_duplicateCenterCore and "
            "duplicateCenterCore_sound justify the added obstruction.  Translation "
            "from a geometric "
