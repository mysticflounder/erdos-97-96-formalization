...
- 290 full-row unit cuts in total, with the recorded per-combo
...
def main() -> None:
    ...
    if len(cuts) != EXPECTED_TOTAL_CUTS:
        raise SystemExit(f"total cuts {len(cuts)} != {EXPECTED_TOTAL_CUTS}")
