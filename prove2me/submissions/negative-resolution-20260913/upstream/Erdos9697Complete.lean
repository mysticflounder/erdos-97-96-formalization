...
/-! ## Source: AxiomAudit.lean -/

section Combined_AxiomAudit

/-! A failing build gate for any nonstandard axiom in an exported result's
transitive proof dependencies. These checks reject sorryAx as well as any new axiom. -/
...
elab "assert_standard_axioms " n:ident : command => do
  ...
  for axiomName in axioms do
    unless [``propext, ``Classical.choice, ``Quot.sound].contains axiomName do
      throwError "{name} depends on the disallowed axiom {axiomName}"
  logInfo m!"Verified {name}: only propext, Classical.choice, and Quot.sound are permitted."

assert_standard_axioms Proof.main_theorem
assert_standard_axioms Proof.main_quantitative
assert_standard_axioms Proof.finite_construction_plane
assert_standard_axioms Proof.finite_construction_real
assert_standard_axioms Proof.threshold_configuration_plane
assert_standard_axioms Proof.threshold_configuration
assert_standard_axioms Proof.logarithmic_index
assert_standard_axioms Proof.threshold_growth
assert_standard_axioms Proof.degreeSizeBound_growth
assert_standard_axioms Proof.degreeSizeBound_double_exponential
assert_standard_axioms Proof.eventual_minimum_degree
assert_standard_axioms Proof.eventual_localized_density
assert_standard_axioms Proof.convex_unit_distances_omega
assert_standard_axioms Proof.bounded_size_minimum_degree
assert_standard_axioms Proof.degreeSizeBound_four
assert_standard_axioms Proof.explicit_erdos_97_counterexample
assert_standard_axioms Proof.erdos_96_false
assert_standard_axioms Proof.erdos_97_false
assert_standard_axioms Proof.erdos_97_general_false
assert_standard_axioms target
assert_standard_axioms Proof.unbounded_density_iff_unbounded_minimum_degree
assert_standard_axioms Proof.small_rotated_copies
assert_standard_axioms Proof.dense_subset_min_degree
assert_standard_axioms Proof.erase_low_degree_density
assert_standard_axioms Proof.boundedCopy_support
assert_standard_axioms Proof.boundedCopy_displacement
assert_standard_axioms Proof.boundedSet_card
assert_standard_axioms Proof.bounded_amplification_unitPairs_bound
assert_standard_axioms Proof.exists_injective_boundedProducts
assert_standard_axioms Proof.middleVertex_card
assert_standard_axioms Proof.middleEdgeCount_formula
assert_standard_axioms Proof.middlePattern
assert_standard_axioms Proof.twoDisks_horizontalBipartition

end Combined_AxiomAudit
