...
import Solutions.Sol_Erdos9796Mission_normalized_mutual_return_height_lt

/-! Kernel validation of the sharp normalized height bound. -/

open scoped EuclideanGeometry

namespace NormalizedHeightBoundKernelValidation
...
theorem normalized_mutual_return_height_lt
  ...
  exact solution hconv hqA hwA hOA hcA hbA hbO hbq hbw hcq hOq
    F hF _hσ hsq hs hh hk hk1 hFq hFw hFO hFc hFb heq1 heq2 L hLq hLc hLO hLb

#print axioms normalized_mutual_return_height_lt

end NormalizedHeightBoundKernelValidation
