/- Generated Prove2Me solution by exact Stage 2 source transformations.
   Target command: Erdos9796Proof.P97.ConvexCyclicOrder.Construct:40612:42398. -/
...
import Theorems.Thm_Problem97_longGap_intermediate_not_in_endpoint_shortCone_signedArea
...
import Theorems.Thm_Problem97_openSegment_center_signedArea_nonneg_transfer
...
theorem Problem97.signedArea2_center_left_lineMap
    (c a b : ℝ²) (r : ℝ) :
...
point on the endpoint chord. -/
theorem Problem97.signedArea2_center_right_lineMap
    (c a b : ℝ²) (r : ℝ) :
...
theorem Problem97.endpointChord_segment_shortArc_signedArea_of_long_gap
    {c a b z : ℝ²}
    (ha : a ≠ c) (hb : b ≠ c)
    (hz : z ∈ segment ℝ a b)
