/- Generated theorem stub from Erdos9796Proof.P97.Dumitrescu.L6 by Stage 2 proof cut; source SHA-256 5734bd5bf1734a3ac1aec799aa89c43c6d0b026d07909ee8e7389ee71d40d90e -/
...
theorem Problem97.Dumitrescu.capPairApexes_card_le_two
    {A : Finset ℝ²} (hA : ConvexIndep A)
    {xy : Finset ℝ²} (hxy_sub : xy ⊆ A) (hxy_card : xy.card = 2) :
    (capPairApexes A xy).card ≤ 2 := by sorry
