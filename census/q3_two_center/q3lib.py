...
Reuses the validated candidate_d_probe encoder primitives read-only
...
DPROBE = os.path.normpath(os.path.join(HERE, "..", "candidate_d_probe"))
sys.path.insert(0, DPROBE)
import encoder as enc  # noqa: E402  (validated D-probe machinery)

enc.RUNS = os.path.join(HERE, "runs")  # never write into candidate_d_probe/
