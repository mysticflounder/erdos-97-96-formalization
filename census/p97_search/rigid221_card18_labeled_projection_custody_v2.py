...
SCHEMA: Final = "p97-rigid221-card18-labeled-projection-lean-source-custody/v2"
LANE_ID_METADATA: Final = "rigid221-card18-labeled-projection-custody-v2-20260828"
...
class Rigid221Card18LabeledProjectionCustodyV2Error(ValueError):
    """The frozen source set, live source tree, or receipt is malformed."""


# Private implementation references retain the copied v1 body; the v2 error
# type is the public contract and is deliberately distinct from v1.
Rigid221Card18LabeledProjectionCustodyError = (
    Rigid221Card18LabeledProjectionCustodyV2Error
)


def _module_source_path(module: str) -> str:
    if type(module) is not str:
        raise Rigid221Card18LabeledProjectionCustodyV2Error(
...
frozen_labeled_projection_lean_source_manifest_v2 = (
    frozen_labeled_projection_lean_source_manifest
)
validate_labeled_projection_source_custody_receipt_v2 = (
    validate_labeled_projection_source_custody_receipt
)
build_labeled_projection_source_custody_receipt_v2 = (
    build_labeled_projection_source_custody_receipt
)
encode_labeled_projection_source_custody_receipt_v2 = (
    encode_labeled_projection_source_custody_receipt
)
parse_labeled_projection_source_custody_receipt_v2 = (
    parse_labeled_projection_source_custody_receipt
)
attest_labeled_projection_source_custody_receipt_v2 = (
