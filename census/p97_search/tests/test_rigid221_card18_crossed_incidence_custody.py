...
from census.p97_search.rigid221_card18_crossed_incidence_custody import (
...
def test_crossed_labeled_and_legacy_receipts_reject_cross_attestation() -> None:
    ...
    labeled_payload = labeled_custody.encode_labeled_projection_source_custody_receipt(
        labeled_custody.build_labeled_projection_source_custody_receipt(REPO_ROOT)
    )
