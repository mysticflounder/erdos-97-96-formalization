...
from census.p97_search import rigid221_card18_crossed_incidence_custody_v2 as v2_custody
from census.p97_search import rigid221_card18_crossed_incidence_custody_v3 as custody
...
from census.p97_search.rigid221_card18_crossed_incidence_custody_v3 import (
...
from census.p97_search.rigid221_card18_crossed_incidence_custody_v3 import (
    Rigid221Card18CrossedIncidenceCustodyV3Error as Rigid221Card18CrossedIncidenceCustodyError,
)
...
def test_v2_and_v3_receipts_reject_cross_attestation() -> None:
    ...
    v3_payload = encode_crossed_incidence_source_custody_receipt(
        build_crossed_incidence_source_custody_receipt(REPO_ROOT)
    )
    with pytest.raises(
        v2_custody.Rigid221Card18CrossedIncidenceCustodyV2Error, match="schema is wrong"
    ):
        v2_custody.attest_crossed_incidence_source_custody_receipt(REPO_ROOT, v3_payload)
    with pytest.raises(
        Rigid221Card18CrossedIncidenceCustodyError, match="schema is wrong"
    ):
        attest_crossed_incidence_source_custody_receipt(REPO_ROOT, v2_payload)
