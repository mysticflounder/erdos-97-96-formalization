...
"""Strict Lean-source custody for the diagnostic Rigid221 card-18 export.
...
SCHEMA: Final = "p97-rigid221-card18-lean-source-custody/v1"
LANE_ID_METADATA: Final = "rigid221-card18-source-export-20260827"
LANE_BASE_HEAD_METADATA: Final = "9988aa98197a2e2d235243d8acc8503dde5bad2c"
...
FROZEN_CONFIGURATION_SHA256: Final = (
    "cefe66262f55d876e365cedf507e3f001a449bad9960a7347c7c8b20cfd8cfd9"
)
...
LEAN_DEPENDENCY_MODULES = (
    ...
    "Erdos9796Proof.P97.Dumitrescu.L1",
    ...
    "Erdos9796Proof.P97.TwoCircleCrossing",
    "Erdos9796Proof.P97.U1CarrierInjection",
    "Erdos9796Proof.P97.U1TwoShortCapReduction",
    "Erdos9796Proof.P97.U5GlobalIncidenceBasic",
    "Erdos9796Proof.P97.U5GlobalIncidenceKernels",
    "Erdos9796Proof.P97.U5GlobalIncidenceQDeletedTetrahedron",
    "Erdos9796Proof.P97.U5GlobalIncidenceSupport",
...
_FROZEN_LEAN_SOURCE_MANIFEST_ROWS = (
    ...
    },
    {
        ...
        "bytes": 41243,
        "sha256": "2f8c444d6269de79c7a672700a9f80e6744fdaddb48263d61239cdbf99cd8210",
    },
    {
        ...
        "bytes": 880556,
        "sha256": "c5e46308208ac2ae75fdf7e6a21db18fd03825af7f44bed7f3f47ffc630b542b",
    },
    {
    ...
    {
        "module": "Erdos9796Proof.P97.Dumitrescu.L1",
        "path": "lean/Erdos9796Proof/P97/Dumitrescu/L1.lean",
        "bytes": 8591,
        "sha256": "170e1886e820b6afa033edfc08e0c4f73057cb7f3c71cc97552cede97ff21fbf",
    },
    {
        "module": "Erdos9796Proof.P97.Foundation",
        "path": "lean/Erdos9796Proof/P97/Foundation.lean",
        "bytes": 3732,
        "sha256": "a391c93c43d33614d2c04166d97d6a5d88b750a5691b6c682233c1d1c9de9bd3",
    },
    {
    ...
    {
        "module": "Erdos9796Proof.P97.TwoCircleCrossing",
        "path": "lean/Erdos9796Proof/P97/TwoCircleCrossing.lean",
        "bytes": 9596,
        "sha256": "28880cee7b78086daa2d3446c0ad28f351e15b5dac17330ac7016380086f295c",
    },
    {
    ...
    {
        "module": "Erdos9796Proof.P97.U5GlobalIncidenceKernels",
        "path": "lean/Erdos9796Proof/P97/U5GlobalIncidenceKernels.lean",
        "bytes": 102770,
        "sha256": "ff9497980ea560781f42298a2eda0de73a40effeb2db0634371bf8adba7ac0a5",
    },
    {
        "module": "Erdos9796Proof.P97.U5GlobalIncidenceQDeletedTetrahedron",
        "path": "lean/Erdos9796Proof/P97/U5GlobalIncidenceQDeletedTetrahedron.lean",
        "bytes": 2146,
        "sha256": "8cb99cede68ac3cf25e695f276c7926cf9356762a8b875ae2f96fe1af01fac6f",
    },
    {
        "module": "Erdos9796Proof.P97.U5GlobalIncidenceSupport",
        "path": "lean/Erdos9796Proof/P97/U5GlobalIncidenceSupport.lean",
        "bytes": 73565,
        "sha256": "6355e9e672bbcef5ef5b8d41d8492f89b924c9c27cb4d6f0c05569a81d430dca",
    },
    {
...
class Rigid221Card18SourceCustodyError(ValueError):
    """The frozen source set, live source tree, or receipt is malformed."""


def _module_source_path(module: str) -> str:
    if type(module) is not str:
        raise Rigid221Card18SourceCustodyError("Lean dependency module is not a string")
    ...
    if (
        ...
        raise Rigid221Card18SourceCustodyError(
...
def frozen_lean_source_manifest() -> tuple[dict[str, Any], ...]:
...
def _open_repo_root(repo_root: Path) -> int:
    ...
    try:
        ...
        if not stat.S_ISDIR(info.st_mode):
            raise Rigid221Card18SourceCustodyError("repository root is not a directory")
        result = descriptor
        descriptor = None
        return result
    except Rigid221Card18SourceCustodyError:
        raise
...
def _validate_source_manifest(manifest: Any) -> None:
    if not isinstance(manifest, list):
        raise Rigid221Card18SourceCustodyError("Lean source manifest is not a list")
    modules: list[str] = []
    paths: list[str] = []
...
def validate_source_custody_receipt(
    ...
    if snapshot["schema"] != SCHEMA:
        raise Rigid221Card18SourceCustodyError("source-custody receipt schema is wrong")
...
def build_source_custody_receipt(repo_root: Path) -> dict[str, Any]:
    ...
    return validate_source_custody_receipt(
        {**body, "receipt_sha256": _sha256_json(body)}
    )


def encode_source_custody_receipt(receipt: Mapping[str, Any]) -> bytes:
    """Return the only accepted canonical byte representation of a receipt."""

    return _canonical_json_bytes(validate_source_custody_receipt(receipt))
...
def parse_source_custody_receipt(payload: bytes) -> dict[str, Any]:
    ...
    return validate_source_custody_receipt(parsed)


def attest_source_custody_receipt(
    repo_root: Path,
    payload: bytes,
) -> dict[str, Any]:
    ...
    _assert_frozen_configuration()
    parsed = parse_source_custody_receipt(payload)
    fresh = build_source_custody_receipt(repo_root)
    if payload != encode_source_custody_receipt(fresh):
        raise Rigid221Card18SourceCustodyError(
