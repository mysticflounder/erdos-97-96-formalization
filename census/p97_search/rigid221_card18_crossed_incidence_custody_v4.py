...
LANE_ID_METADATA: Final = "rigid221-card18-crossed-incidence-custody-v4-20260831"
...
class Rigid221Card18CrossedIncidenceCustodyV4Error(ValueError):
    """The frozen source set, live source tree, or receipt is malformed."""


Rigid221Card18CrossedIncidenceCustodyError = (
    Rigid221Card18CrossedIncidenceCustodyV4Error
)
...
frozen_crossed_incidence_lean_source_manifest_v4 = (
    frozen_crossed_incidence_lean_source_manifest
)
validate_crossed_incidence_source_custody_receipt_v4 = (
    validate_crossed_incidence_source_custody_receipt
)
build_crossed_incidence_source_custody_receipt_v4 = (
    build_crossed_incidence_source_custody_receipt
)
encode_crossed_incidence_source_custody_receipt_v4 = (
    encode_crossed_incidence_source_custody_receipt
)
parse_crossed_incidence_source_custody_receipt_v4 = (
    parse_crossed_incidence_source_custody_receipt
)
attest_crossed_incidence_source_custody_receipt_v4 = (
