...
SCHEMA: Final = "p97-rigid221-card18-labeled-projection-lean-source-custody/v3"
LANE_ID_METADATA: Final = "rigid221-card18-labeled-projection-custody-v3-20260828"
...
class Rigid221Card18LabeledProjectionCustodyV3Error(ValueError):
    """The frozen source set, live source tree, or receipt is malformed."""


# Private implementation references retain the copied v1 body; the v3 error
# type is the public contract and is deliberately distinct from v1.
Rigid221Card18LabeledProjectionCustodyError = (
    Rigid221Card18LabeledProjectionCustodyV3Error
)


def _module_source_path(module: str) -> str:
    if type(module) is not str:
        raise Rigid221Card18LabeledProjectionCustodyV3Error(
...
frozen_labeled_projection_lean_source_manifest_v3 = (
    frozen_labeled_projection_lean_source_manifest
)
validate_labeled_projection_source_custody_receipt_v3 = (
    validate_labeled_projection_source_custody_receipt
)
build_labeled_projection_source_custody_receipt_v3 = (
    build_labeled_projection_source_custody_receipt
)
encode_labeled_projection_source_custody_receipt_v3 = (
    encode_labeled_projection_source_custody_receipt
)
parse_labeled_projection_source_custody_receipt_v3 = (
    parse_labeled_projection_source_custody_receipt
)
attest_labeled_projection_source_custody_receipt_v3 = (
