...
EXPECTED_PREFIX_VARIABLES = 47_211
EXPECTED_PREFIX_CLAUSES = 703_533
...
EXPECTED_POST_ARM_CLAUSES = 704_400
...
SOURCE_PATHS = (
    ...
    (
        "census/card_head/"
        "exact12_apex_first_opposite_shared_pair_surplus_common_five_"
        "membership_family_bank.py"
    ),
    (
        "census/card_head/"
        "exact12_reciprocal_first_opposite_surplus_second_opposite_common_five_"
        "membership_family_bank.py"
    ),
    (
        "census/card_head/"
        "exact12_first_opposite_pair_surplus_second_opposite_common_five_"
        "membership_family_bank.py"
    ),
    (
        "census/card_head/"
    ...
    (
        "census/card_head/"
        "exact12_apex_triple_surplus_second_opposite_common_five_"
        "membership_family_bank.py"
    ),
    (
        "census/card_head/"
        "exact12_surplus_pair_second_opposite_apex_pair_common_five_"
        "membership_family_bank.py"
    ),
    (
        "census/card_head/"
        "exact12_apex_first_surplus_second_common_five_membership_family_bank.py"
    ),
    (
        "census/card_head/"
        "exact12_second_apex_surplus_second_first_common_five_membership_family_bank.py"
    ),
...
class MaterializedArmStaticCanary:
    ...
    apex_first_opposite_shared_pair_surplus_common_five_family_bank: dict[str, Any]
    reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank: dict[
        str, Any
    ]
    first_opposite_pair_surplus_second_opposite_common_five_family_bank: dict[str, Any]
    ...
    core_pair_all_order_common_five_family_bank: dict[str, Any]
    ...
    second_apex_surplus_second_first_common_five_family_bank: dict[str, Any]
...
def materialize_arm_static_canary(
    ...
    try:
        ...
        apex_first_opposite_shared_pair_second_opposite_common_five_family_bank = install_apex_first_opposite_shared_pair_second_opposite_common_five_membership_family_bank(
            repo_root,
            instance,
            layout,
            apex_first_opposite_shared_pair_common_five_family_bank,
        ...
        apex_triple_surplus_second_opposite_common_five_family_bank = install_apex_triple_surplus_second_opposite_common_five_membership_family_bank(
            repo_root,
            instance,
            layout,
            apex_first_opposite_shared_pair_second_opposite_common_five_family_bank,
        ...
        surplus_pair_second_opposite_apex_pair_common_five_family_bank = install_surplus_pair_second_opposite_apex_pair_common_five_membership_family_bank(
            repo_root,
            instance,
            layout,
            apex_triple_surplus_second_opposite_common_five_family_bank,
        ...
        apex_first_opposite_shared_pair_surplus_common_five_family_bank = install_apex_first_opposite_shared_pair_surplus_common_five_membership_family_bank(
            repo_root,
            instance,
            layout,
            second_apex_surplus_second_first_common_five_family_bank,
        ...
        attest_apex_first_opposite_shared_pair_surplus_common_five_membership_family_bank_live_sources(
            repo_root, apex_first_opposite_shared_pair_surplus_common_five_family_bank
        )
        reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank = install_reciprocal_first_opposite_surplus_second_opposite_common_five_membership_family_bank(
            repo_root,
            instance,
            layout,
        ...
        first_opposite_pair_surplus_second_opposite_common_five_family_bank = install_first_opposite_pair_surplus_second_opposite_common_five_membership_family_bank(
            repo_root,
            instance,
            layout,
            reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank,
        ...
        second_opposite_triple_surplus_first_opposite_three_triad_family_bank = install_second_opposite_triple_surplus_first_opposite_three_triad_membership_family_bank(
            repo_root,
            instance,
            layout,
            first_opposite_pair_surplus_second_opposite_common_five_family_bank,
        ...
        raise Exact12NextRowArmStaticCanaryError(str(exc)) from exc
    except Exact12ReciprocalFirstOppositeSurplusSecondOppositeCommonFiveMembershipFamilyBankError as exc:
        raise Exact12NextRowArmStaticCanaryError(str(exc)) from exc
    except (
        Exact12FirstOppositePairSurplusSecondOppositeCommonFiveMembershipFamilyBankError
    ) as exc:
        ...
        raise Exact12NextRowArmStaticCanaryError(str(exc)) from exc
    except Exact12ApexFirstSurplusSecondCommonFiveMembershipFamilyBankError as exc:
        raise Exact12NextRowArmStaticCanaryError(str(exc)) from exc
    except (
        Exact12SecondApexSurplusSecondFirstCommonFiveMembershipFamilyBankError
    ) as exc:
    ...
    mismatches = {
        ...
        for key, actual in frozen_identity.items()
...
def _source_manifest(repo_root: Path) -> list[dict[str, Any]]:
    try:
        ...
        source_paths.update(
            first_opposite_pair_surplus_second_opposite_common_five_source_paths(
                repo_root
            )
        )
        source_paths.update(
        ...
        source_paths.update(
            surplus_pair_second_opposite_apex_pair_common_five_source_paths(repo_root)
        )
        source_paths.update(
...
def _build_job(
    ...
    apex_first_opposite_shared_pair_second_opposite_common_five_family_bank = materialized.apex_first_opposite_shared_pair_second_opposite_common_five_family_bank
    apex_first_opposite_shared_pair_surplus_common_five_family_bank = (
        materialized.apex_first_opposite_shared_pair_surplus_common_five_family_bank
    )
    reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank = materialized.reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank
    first_opposite_pair_surplus_second_opposite_common_five_family_bank = (
        materialized.first_opposite_pair_surplus_second_opposite_common_five_family_bank
    )
    second_opposite_triple_surplus_first_opposite_three_triad_family_bank = (
    ...
    apex_first_surplus_second_common_five_family_bank = (
        materialized.apex_first_surplus_second_common_five_family_bank
    )
    second_apex_surplus_second_first_common_five_family_bank = (
    ...
    payload = {
        ...
        "scope": (
            ...
            "aggregate arm coverage, universal lift, or Lean closure; the "
            "typed terminal consumer is ready, but a verified terminal proof "
            "must still be converted into a Lean DimacsUnsatisfiable witness"
        ),
        "arm_cell_index": SUPPORTED_ARM_CELL_INDEX,
        ...
        "apex_first_opposite_shared_pair_surplus_common_five_membership_family_bank": {
            "schema": apex_first_opposite_shared_pair_surplus_common_five_family_bank.get(
                "schema"
            ),
            "sha256": apex_first_opposite_shared_pair_surplus_common_five_family_bank.get(
                "bank_sha256"
            ),
            "family_id": apex_first_opposite_shared_pair_surplus_common_five_family_bank.get(
                "family_id"
            ),
            "lean_terminal_ingress_ready": False,
        },
        "reciprocal_first_opposite_surplus_second_opposite_common_five_membership_family_bank": {
            "schema": reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank.get(
                "schema"
            ),
            "sha256": reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank.get(
                "bank_sha256"
            ),
            "family_id": reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank.get(
                "family_id"
            ),
            "lean_terminal_ingress_ready": False,
        },
        "first_opposite_pair_surplus_second_opposite_common_five_membership_family_bank": {
            "schema": first_opposite_pair_surplus_second_opposite_common_five_family_bank.get(
                "schema"
            ),
            "sha256": first_opposite_pair_surplus_second_opposite_common_five_family_bank.get(
                "bank_sha256"
            ),
            "family_id": first_opposite_pair_surplus_second_opposite_common_five_family_bank.get(
                "family_id"
            ),
            "lean_terminal_ingress_ready": False,
        },
        "second_opposite_triple_surplus_first_opposite_three_triad_membership_family_bank": {
            "schema": second_opposite_triple_surplus_first_opposite_three_triad_family_bank.get(
                "schema"
            ),
            "sha256": second_opposite_triple_surplus_first_opposite_three_triad_family_bank.get(
                "bank_sha256"
            ),
            "family_id": second_opposite_triple_surplus_first_opposite_three_triad_family_bank.get(
                "family_id"
            ),
            "lean_terminal_ingress_ready": False,
        },
        ...
        "apex_triple_surplus_second_opposite_common_five_membership_family_bank": {
            ...
            "sha256": apex_triple_surplus_second_opposite_common_five_family_bank.get(
                "bank_sha256"
            ),
            "family_id": apex_triple_surplus_second_opposite_common_five_family_bank.get(
                "family_id"
            ),
            "lean_terminal_ingress_ready": False,
        },
        "surplus_pair_second_opposite_apex_pair_common_five_membership_family_bank": {
            "schema": surplus_pair_second_opposite_apex_pair_common_five_family_bank.get(
                "schema"
            ),
            "sha256": surplus_pair_second_opposite_apex_pair_common_five_family_bank.get(
                "bank_sha256"
            ),
            "family_id": surplus_pair_second_opposite_apex_pair_common_five_family_bank.get(
                "family_id"
            ),
            "lean_terminal_ingress_ready": False,
        },
        "apex_first_surplus_second_common_five_membership_family_bank": {
            "schema": apex_first_surplus_second_common_five_family_bank.get("schema"),
            "sha256": apex_first_surplus_second_common_five_family_bank.get(
                "bank_sha256"
            ),
            "family_id": apex_first_surplus_second_common_five_family_bank.get(
                "family_id"
            ),
            "lean_terminal_ingress_ready": False,
        },
        "second_apex_surplus_second_first_common_five_membership_family_bank": {
            "schema": second_apex_surplus_second_first_common_five_family_bank.get(
                "schema"
            ),
            "sha256": second_apex_surplus_second_first_common_five_family_bank.get(
                "bank_sha256"
            ),
            "family_id": second_apex_surplus_second_first_common_five_family_bank.get(
                "family_id"
            ),
            "lean_terminal_ingress_ready": False,
        },
...
def _required_artifact_hashes(
    ...
    return {
        ...
        "positive_membership_bank": _json_sha256(materialized.positive_membership_bank),
        ...
        "apex_first_opposite_shared_pair_surplus_common_five_family_bank": _json_sha256(
            materialized.apex_first_opposite_shared_pair_surplus_common_five_family_bank
        ),
        "reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank": _json_sha256(
            materialized.reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank
        ),
        "first_opposite_pair_surplus_second_opposite_common_five_family_bank": _json_sha256(
            materialized.first_opposite_pair_surplus_second_opposite_common_five_family_bank
        ),
        ...
        "surplus_pair_second_opposite_apex_pair_common_five_family_bank": _json_sha256(
            materialized.surplus_pair_second_opposite_apex_pair_common_five_family_bank
        ),
        "apex_first_surplus_second_common_five_family_bank": _json_sha256(
            materialized.apex_first_surplus_second_common_five_family_bank
        ),
        "second_apex_surplus_second_first_common_five_family_bank": _json_sha256(
            materialized.second_apex_surplus_second_first_common_five_family_bank
        ),
...
def run_arm_static_canary(
    ...
    *,
    ...
    discovery_solver_factory: Callable[
        [MaterializedArmStaticCanary, Mapping[str, Any]], Callable[..., CadicalResult]
    ]
    | None = None,
) -> dict[str, Any]:
    ...
    try:
        ...
        discovery_solver = (
            solver
            if discovery_solver_factory is None
            else discovery_solver_factory(materialized, job)
        )
        ...
        apex_first_opposite_shared_pair_common_five_family_bank_path = (
            workdir / "apex_first_opposite_shared_pair_common_five_family_bank.json"
        )
        ...
        apex_first_opposite_shared_pair_surplus_common_five_family_bank_path = (
            workdir
            / "apex_first_opposite_shared_pair_surplus_common_five_family_bank.json"
        )
        reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank_path = (
            workdir
            / "reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank.json"
        )
        first_opposite_pair_surplus_second_opposite_common_five_family_bank_path = (
            workdir
            / "first_opposite_pair_surplus_second_opposite_common_five_family_bank.json"
        )
        ...
        surplus_pair_second_opposite_apex_pair_common_five_family_bank_path = (
            workdir
            / "surplus_pair_second_opposite_apex_pair_common_five_family_bank.json"
        )
        apex_first_surplus_second_common_five_family_bank_path = (
            workdir / "apex_first_surplus_second_common_five_family_bank.json"
        )
        second_apex_surplus_second_first_common_five_family_bank_path = (
            workdir / "second_apex_surplus_second_first_common_five_family_bank.json"
        )
        ...
        artifacts = {
            ...
            "apex_first_opposite_shared_pair_surplus_common_five_family_bank": _artifact(
                apex_first_opposite_shared_pair_surplus_common_five_family_bank_path
            ),
            "reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank": _artifact(
                reciprocal_first_opposite_surplus_second_opposite_common_five_family_bank_path
            ),
            "first_opposite_pair_surplus_second_opposite_common_five_family_bank": _artifact(
                first_opposite_pair_surplus_second_opposite_common_five_family_bank_path
            ),
            ...
            "surplus_pair_second_opposite_apex_pair_common_five_family_bank": _artifact(
                surplus_pair_second_opposite_apex_pair_common_five_family_bank_path
            ),
            "apex_first_surplus_second_common_five_family_bank": _artifact(
                apex_first_surplus_second_common_five_family_bank_path
            ),
            "second_apex_surplus_second_first_common_five_family_bank": _artifact(
                second_apex_surplus_second_first_common_five_family_bank_path
            ),
...
def main() -> int:
    ...
    try:
        if args.legacy_local_discovery:
            ...
            from .exact12_next_row_arm_static_piqd import (
                run_exact12_arm_static_piqd,
            )

            summary = run_exact12_arm_static_piqd(
                args.repo_root,
                args.workdir,
                args.arm_cell_index,
                piqd_base_url=args.piqd_base_url,
                piqd_journal_root=(
                    args.piqd_journal_root or args.workdir / "piqd-journal"
                ),
                timeout_seconds=args.timeout_seconds,
                nice=args.nice,
            )
