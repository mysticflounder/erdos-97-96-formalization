...
/-- Generator 21 for `R004:u=v:R004NYN` evaluates to zero. -/
theorem rs_R004_ueqv_R004NYN_generator_21_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R004_ueqv_R004NYN_generators.get (Fin.mk 21 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R004_ueqv_R004NYN_generator_21_shape
    (by
      exact (
        eval_sqNormVsDist_zero_of_exactRow_v_member
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s1_030") (center := .Pw) (label := .v) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_030_Pw_v)
          (maskHas_exactRow_of_pid (pid := "s1_030") (center := .Pw) (label := .Q1) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_030_Pw_Q1)
