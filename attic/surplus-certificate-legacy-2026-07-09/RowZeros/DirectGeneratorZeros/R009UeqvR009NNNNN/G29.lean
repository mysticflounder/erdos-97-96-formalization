...
/-- Generator 29 for `R009:u=v:R009NNNNN` evaluates to zero. -/
theorem rs_R009_ueqv_R009NNNNN_generator_29_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R009_ueqv_R009NNNNN_generators.get (Fin.mk 29 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R009_ueqv_R009NNNNN_generator_29_shape
    (by
      exact (
