...
/-- Generator 7 for `R007:u=v:R007YY` evaluates to zero. -/
theorem rs_R007_ueqv_R007YY_generator_07_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R007_ueqv_R007YY_generators.get (Fin.mk 7 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R007_ueqv_R007YY_generator_07_shape
    (by
      exact (
        eval_sqDistUnitXToPoint_zero_of_exactRow_w_member
          ...
          (maskHas_exactRow_of_pid (pid := "s1_038") (center := .u) (label := .s1) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_038_u_s1)
