...
/-- Generator 16 for `R005:u=v:R005YYY` evaluates to zero. -/
theorem rs_R005_ueqv_R005YYY_generator_16_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R005_ueqv_R005YYY_generators.get (Fin.mk 16 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R005_ueqv_R005YYY_generator_16_shape
    (by
      exact (
        eval_sqDistPointToUnitX_zero_of_exactRow_w_member
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s1_015") (center := .s3) (label := .w) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_015_s3_w)
