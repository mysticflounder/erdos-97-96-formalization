...
/-- Generator 1 for `R008:u=v:R008NNYN` evaluates to zero. -/
theorem rs_R008_ueqv_R008NNYN_generator_01_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R008_ueqv_R008NNYN_generators.get (Fin.mk 1 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R008_ueqv_R008NNYN_generator_01_shape
    (by
      exact (
        eval_sqNormDiff_zero_of_exactRow_v_center_members
          ...
          (maskHas_exactRow_of_pid (pid := "s2_007") (center := .v) (label := .Pw) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_007_v_Pw)
