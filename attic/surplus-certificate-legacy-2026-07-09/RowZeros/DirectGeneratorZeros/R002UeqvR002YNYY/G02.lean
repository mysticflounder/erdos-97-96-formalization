...
/-- Generator 2 for `R002:u=v:R002YNYY` evaluates to zero. -/
theorem rs_R002_ueqv_R002YNYY_generator_02_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R002_ueqv_R002YNYY_generators.get (Fin.mk 2 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R002_ueqv_R002YNYY_generator_02_shape
    (by
      exact (
        eval_sqNormDiff_zero_of_exactRow_v_center_members
          ...
          (maskHas_exactRow_of_pid (pid := "s1_006") (center := .v) (label := .Pu) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_006_v_Pu)
