...
/-- Generator 28 for `R013:u=v:R013NNYN` evaluates to zero. -/
theorem rs_R013_ueqv_R013NNYN_generator_28_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R013_ueqv_R013NNYN_generators.get (Fin.mk 28 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R013_ueqv_R013NNYN_generator_28_shape
    (by
      exact (
