...
/-- Generator 16 for `R008:u=v:R008YYNY` evaluates to zero. -/
theorem rs_R008_ueqv_R008YYNY_generator_16_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R008_ueqv_R008YYNY_generators.get (Fin.mk 16 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R008_ueqv_R008YYNY_generator_16_shape
    (by
      exact (
        eval_sqDistUnitXToPoint_zero_of_exactRow_w_member
          ...
          (maskHas_exactRow_of_pid (pid := "s2_004") (center := .s3) (label := .s1) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_004_s3_s1)
