...
/-- Generator 4 for `R014:u=v:R014NNY` evaluates to zero. -/
theorem rs_R014_ueqv_R014NNY_generator_04_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R014_ueqv_R014NNY_generators.get (Fin.mk 4 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R014_ueqv_R014NNY_generator_04_shape
    (by
      exact (
        eval_sqDistToUnitX_zero_of_exactRow_w_center_members
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s3_020") (center := .w) (label := .s3) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_020_w_s3)
          (maskHas_exactRow_of_pid (pid := "s3_020") (center := .w) (label := .Q1) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_020_w_Q1)
