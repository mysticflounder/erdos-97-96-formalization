...
/-- Generator 7 for `R010:u=v:R010NYN` evaluates to zero. -/
theorem rs_R010_ueqv_R010NYN_generator_07_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R010_ueqv_R010NYN_generators.get (Fin.mk 7 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R010_ueqv_R010NYN_generator_07_shape
    (by
      exact (
