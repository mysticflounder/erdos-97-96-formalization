...
/-- Generator 18 for `R002:u=v:R002YNYN` evaluates to zero. -/
theorem rs_R002_ueqv_R002YNYN_generator_18_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R002_ueqv_R002YNYN_generators.get (Fin.mk 18 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R002_ueqv_R002YNYN_generator_18_shape
    (by
      exact (
