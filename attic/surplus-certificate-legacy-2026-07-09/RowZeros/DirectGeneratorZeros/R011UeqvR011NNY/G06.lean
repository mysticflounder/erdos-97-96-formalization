...
/-- Generator 6 for `R011:u=v:R011NNY` evaluates to zero. -/
theorem rs_R011_ueqv_R011NNY_generator_06_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R011_ueqv_R011NNY_generators.get (Fin.mk 6 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R011_ueqv_R011NNY_generator_06_shape
    (by
      exact (
