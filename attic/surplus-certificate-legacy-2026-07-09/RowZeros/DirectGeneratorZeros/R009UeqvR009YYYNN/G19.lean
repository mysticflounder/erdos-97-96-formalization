...
/-- Generator 19 for `R009:u=v:R009YYYNN` evaluates to zero. -/
theorem rs_R009_ueqv_R009YYYNN_generator_19_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R009_ueqv_R009YYYNN_generators.get (Fin.mk 19 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    (endpointPairAssignment pointOf .u .v) (q := twiceVarMinusOnePoly EndpointVar.pwx.index)
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R009_ueqv_R009YYYNN_generator_19_shape
    (by
      exact (
