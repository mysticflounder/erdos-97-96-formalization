...
/-- Generator 24 for `R004:u=v:R004NNY` evaluates to zero. -/
theorem rs_R004_ueqv_R004NNY_generator_24_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R004_ueqv_R004NNY_generators.get (Fin.mk 24 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R004_ueqv_R004NNY_generator_24_shape
    (by
      exact (
        eval_sqDistCenter_zero_of_exactRow_members
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s1_033") (center := .Pu) (label := .u) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_033_Pu_u)
          (maskHas_exactRow_of_pid (pid := "s1_033") (center := .Pu) (label := .Pw) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_033_Pu_Pw)
