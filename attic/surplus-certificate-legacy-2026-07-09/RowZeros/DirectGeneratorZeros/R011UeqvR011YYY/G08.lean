...
/-- Generator 8 for `R011:u=v:R011YYY` evaluates to zero. -/
theorem rs_R011_ueqv_R011YYY_generator_08_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R011_ueqv_R011YYY_generators.get (Fin.mk 8 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R011_ueqv_R011YYY_generator_08_shape
    (by
      exact (
