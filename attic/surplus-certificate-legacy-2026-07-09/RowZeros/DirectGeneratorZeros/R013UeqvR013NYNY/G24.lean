...
/-- Generator 24 for `R013:u=v:R013NYNY` evaluates to zero. -/
theorem rs_R013_ueqv_R013NYNY_generator_24_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R013_ueqv_R013NYNY_generators.get (Fin.mk 24 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R013_ueqv_R013NYNY_generator_24_shape
    (by
      exact (
        eval_sqDistCenter_zero_of_exactRow_members
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s3_012") (center := .Pu) (label := .u) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_012_Pu_u)
          (maskHas_exactRow_of_pid (pid := "s3_012") (center := .Pu) (label := .Q2) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_012_Pu_Q2)
