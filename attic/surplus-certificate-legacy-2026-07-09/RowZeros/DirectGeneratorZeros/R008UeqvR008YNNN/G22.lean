...
/-- Generator 22 for `R008:u=v:R008YNNN` evaluates to zero. -/
theorem rs_R008_ueqv_R008YNNN_generator_22_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R008_ueqv_R008YNNN_generators.get (Fin.mk 22 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R008_ueqv_R008YNNN_generator_22_shape
    (by
      exact (
        eval_sqDistPointToUnitX_zero_of_exactRow_w_member
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s2_010") (center := .Pu) (label := .w) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s2_010_Pu_w)
