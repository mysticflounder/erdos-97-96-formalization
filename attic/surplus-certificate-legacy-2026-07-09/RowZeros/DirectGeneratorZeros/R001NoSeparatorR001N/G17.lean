...
/-- Generator 17 for `R001:no_separator:R001N` evaluates to zero. -/
theorem rs_R001_no_separator_R001N_generator_17_zero
    ...
    evalPoly (endpointS1S3Assignment pointOf) (Problem97.SurplusCertificate.RelaxedSplit.rs_R001_no_separator_R001N_generators.get (Fin.mk 17 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R001_no_separator_R001N_generator_17_shape
    (by
      exact (
        eval_sqDistUnitXToPoint_zero_of_exactRow_w_member
          ...
          (maskHas_exactRow_of_pid (pid := "s1_001") (center := .s3) (label := .Q2) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s1_001_s3_Q2)
