...
/-- Generator 18 for `R013:u=v:R013YYNN` evaluates to zero. -/
theorem rs_R013_ueqv_R013YYNN_generator_18_zero
    ...
    evalPoly (endpointPairAssignment pointOf .u .v) (Problem97.SurplusCertificate.RelaxedSplit.rs_R013_ueqv_R013YYNN_generators.get (Fin.mk 18 (by native_decide))) = 0 := by
  exact evalPoly_eq_zero_of_normalizePoly_eq
    ...
    Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ShapeFacts.rs_R013_ueqv_R013YYNN_generator_18_shape
    (by
      exact (
        eval_sqNormVsDist_zero_of_exactRow_v_member
          ...
          hmetric hmasks
          (maskHas_exactRow_of_pid (pid := "s3_008") (center := .s3) (label := .v) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_008_s3_v)
          (maskHas_exactRow_of_pid (pid := "s3_008") (center := .s3) (label := .Pw) hrow hpidEq Problem97.SurplusCertificate.RelaxedSplit.Bank.RowZeros.ExactMaskBits.exactMaskAll_rs_s3_008_s3_Pw)
