...
/-!
# Endpoint product-row block zero ep_Q2_054, block 25:100-100
...
/-- Checked block `25:100-100` in product-sum row `ep_Q2_054`
evaluates to zero under a metric interpretation of the row shadow. -/
theorem ep_Q2_054_block_25_0100_0100_eval_zero
    ...
    evalPoly (endpointS1S3Assignment pointOf)
      Patterns.EpQ2054TermShards.ep_Q2_054_block_25_0100_0100 = 0 := by
  have hgenerator :
      evalPoly (endpointS1S3Assignment pointOf)
        Patterns.EpQ2054TermShards.ep_Q2_054_generator_25_0100_0100 = 0 := by
  ...
  refine evalPoly_target_eq_zero_of_checkProductSumEq
    ...
    Patterns.EpQ2054TermShards.ep_Q2_054_block_25_0100_0100_valid ?_
  intro p hp
  simp only [Patterns.EpQ2054TermShards.ep_Q2_054_partials_25_0100_0100,
    List.mem_cons, List.not_mem_nil, or_false] at hp
  rcases hp with rfl
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2054TermShards.ep_Q2_054_partial_25_0100_valid
      hgenerator
