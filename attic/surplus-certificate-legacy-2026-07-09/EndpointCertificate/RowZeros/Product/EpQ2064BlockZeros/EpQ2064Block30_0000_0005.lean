...
/-!
# Endpoint product-row block zero ep_Q2_064, block 30:0-5
...
/-- Checked block `30:0-5` in product-sum row `ep_Q2_064`
evaluates to zero under a metric interpretation of the row shadow. -/
theorem ep_Q2_064_block_30_0000_0005_eval_zero
    ...
    evalPoly (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_block_30_0000_0005 = 0 := by
  have hgenerator :
      evalPoly (endpointS1S3Assignment pointOf)
        Patterns.EpQ2064TermShards.ep_Q2_064_generator_30_0000_0005 = 0 := by
  ...
  refine evalPoly_target_eq_zero_of_checkProductSumEq
    ...
    Patterns.EpQ2064TermShards.ep_Q2_064_block_30_0000_0005_valid ?_
  intro p hp
  simp only [Patterns.EpQ2064TermShards.ep_Q2_064_partials_30_0000_0005,
    List.mem_cons, List.not_mem_nil, or_false] at hp
  rcases hp with rfl | rfl | rfl | rfl | rfl | rfl
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_partial_30_0000_valid
      hgenerator
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_partial_30_0001_valid
      hgenerator
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_partial_30_0002_valid
      hgenerator
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_partial_30_0003_valid
      hgenerator
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_partial_30_0004_valid
      hgenerator
  · exact evalPoly_eq_zero_of_mulPoly_eq_right_zero
      (endpointS1S3Assignment pointOf)
      Patterns.EpQ2064TermShards.ep_Q2_064_partial_30_0005_valid
      hgenerator
