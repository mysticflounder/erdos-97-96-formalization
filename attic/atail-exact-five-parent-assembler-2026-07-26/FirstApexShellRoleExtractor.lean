...
import Erdos9796Proof.P97.ATail.FirstApexShellRole
import Erdos9796Proof.P97.N8.FourSubpacket

/-!
# Extracting source-faithful first-apex shell roles

This production adapter constructs `FirstApexShellRolePacket` from the actual
