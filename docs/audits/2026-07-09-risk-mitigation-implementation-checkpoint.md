...
| Card-11 lower-bound gap | `Census554.card_ge_eleven_of_twoLargeCaps` built from cap lower bounds and cap-sum identity | Labeling and full `Card11SelectedCube.cubeOk` remain open |
...
- Geometry theorem axiom query: `propext`, `Classical.choice`, `Quot.sound`.
