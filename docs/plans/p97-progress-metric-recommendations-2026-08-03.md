...
> Status: dated process recommendations; not a current proof-status authority.
...
Ship as `proof-blueprint progress`, or as a proposed wrapper script around the
queries. No such wrapper is present in this repository. It should emit:
