...
- First-opposite PIQD update 2026-09-03 06:11Z: job `b35f2166…`
  ...
  artifacts.
- Step P4.4 (2026-09-03, diagnostic complete): the general-`n` reuse audit found no
  ...
  `S.oppApex2` does not close either outcome. All six card-14 profiles in
  `docs/specs/p97-dr-two-radius-card14-profile-probe-v1.md` are SAT with the
  card-13 core families. The `firstOppositeO1Six` survivor independently
  satisfies the maximal 12,837,786-clause formula containing every currently
  encoded optional generic geometry family. Hence no stable card-13
  obstruction extrapolates even one cardinality. The next proof lane must
  supply genuinely new radius-indexed/all-center information (or localize the
  global-minimal-deletion bad center to `S.oppApex2`), not merely add an
