# Superseded atomic prose manuscript — historical archive only

**RETIRED AS A STATUS AUTHORITY on 4 September 2026.**
The [current authoritative proof](../erdos-97-descent-prose-proof-atomic.md)
is maintained separately. This archive preserves the pre-reconciliation
manuscript, including superseded leaf contracts, old counts, rejected closure
programs, and unintegrated research. Any occurrence of `OPEN`, `current`,
`live`, `latest`, or `authoritative` below belongs to that historical text;
it is **not a current obligation or status assertion**. Agents searching for
active work must exclude `docs/archive/**` and use the current document's
obligation table and its linked source evidence.

Preserved source: `docs/erdos-97-descent-prose-proof-atomic.md` at
`e91a960183e6f9104d51b52cd5c2963ed9267d3a`.
Original UTF-8 payload SHA-256: `01d870ef654bcbd69372be4ba581b5dc7fa565dd2d7504548d3a30e92f351a2f`.
The payload following the separator is preserved byte-for-byte.
