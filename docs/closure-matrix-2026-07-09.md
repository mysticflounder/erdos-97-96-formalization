...
**Correction (2026-08-17):** the generic five-to-six-center adapters and
`collisionFiveCenterDeletion_to_sixCenterAcyclicFaithfulResidual` already
provide the positive faithful lift, but remain off-spine. The immediate target
is now a consumer bridge from that boundary to a live terminal, preserving
